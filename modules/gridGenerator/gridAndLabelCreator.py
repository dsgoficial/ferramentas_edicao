...
from qgis.core import (Qgis, QgsCoordinateReferenceSystem,
                       QgsCoordinateTransform, QgsFillSymbol, QgsGeometry,
                       QgsGeometryGeneratorSymbolLayer,
                       QgsInvertedPolygonRenderer, QgsLineSymbol, QgsMapLayer,
                       QgsPalLayerSettings, QgsPoint, QgsProject,
                       QgsPropertyCollection, QgsRenderContext,
                       QgsRuleBasedLabeling, QgsRuleBasedRenderer,
                       QgsSimpleFillSymbolLayer, QgsSingleSymbolRenderer,
                       QgsSymbolLayerId, QgsSymbolLayerReference,
