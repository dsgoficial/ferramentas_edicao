...
class CreateCustomPolygons(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterNumber(
            self.SIDE_LENGTH, 'Side Length of Polygons', type=QgsProcessingParameterNumber.Double, defaultValue=0.125))
       
        self.addParameter(QgsProcessingParameterNumber(
            self.ROUNDING_FACTOR, 'Rounding Factor', type=QgsProcessingParameterNumber.Double, defaultValue=0.015))
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        (sink, dest_id) = self.parameterAsSink(parameters, self.OUTPUT_LAYER, context,
                                               input_layer.fields(), QgsWkbTypes.Polygon, input_layer.sourceCrs())
