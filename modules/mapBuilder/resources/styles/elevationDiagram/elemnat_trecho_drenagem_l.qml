...
<qgis version="3.24.3-Tisler" styleCategories="Symbology">
  <renderer-v2 symbollevels="1" referencescale="-1" forceraster="0" enableorderby="0" type="RuleRenderer">
    <rules key="{8e201c66-7086-4414-be5d-65a1376e7ddf}">
      <rule key="{47666e68-c08e-4a67-a5c4-20e9bccf8f2c}" label="Visível" filter="&quot;visivel&quot; = 1">
        <rule description="Regime permanente" symbol="0" key="{dfbc5c66-20ad-4025-bd20-505153c8f05f}" label="L10319A" filter="&quot;regime&quot; in (0, 1) and &quot;situacao_em_poligono&quot; not in (2, 3, 4) and &quot;tipo&quot; in (1,2,3)"/>
        <rule symbol="1" key="{9fe301b7-3ba1-4416-8058-7acf2474d21d}" label="L10319B" filter="&quot;regime&quot; in (3, 5) and &quot;situacao_em_poligono&quot; not in (2, 3, 4) and &quot;tipo&quot; in (1,2,3)"/>
        <rule symbol="2" key="{4a1d6d43-d959-4f13-af44-06764de76cc8}" label="Dentro de polígono" filter="&quot;situacao_em_poligono&quot; in (2, 3, 4) OR &quot;tipo&quot; = 4"/>
        <rule symbol="3" key="{fb8e6a60-73d2-41a7-87fc-2ec5e14cca86}" label="Outro" filter="ELSE"/>
      </rule>
    </rules>
    <symbols>
