...
<rules key="{efe3ba51-fcfd-45ad-ae13-48e0302410e3}">
<rule description="Texto genérico" key="{dcb66914-b938-466b-868e-2e8e3fe942ec}" filter=" &quot;carta_mini&quot; is false">
<settings calloutType="simple">
<text-style fontStrikeout="0" textColor="0,0,0,255" previewBkgrdColor="255,255,255,255" useSubstitutions="0" fontUnderline="0" fieldName="texto_edicao" capitalization="0" fontItalic="0" fontWordSpacing="0" fontFamily="Noto Sans" fontKerning="1" fontLetterSpacing="0" multilineHeight="1" textOpacity="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Regular" allowHtml="0" fontSize="10" textOrientation="horizontal" isExpression="0" fontSizeUnit="Point" fontWeight="50" blendMode="0">
...
<alias field="tamanho_txt" name="" index="2"/>
<alias field="cor" name="" index="3"/>
<alias field="carta_mini" name="" index="4"/>
<alias field="espacamento" name="" index="5"/>
<alias field="estilo_fonte" name="" index="6"/>
</aliases>
<defaults>
...
<constraint field="cor" unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0"/>
<constraint field="carta_mini" unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0"/>
<constraint field="espacamento" unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0"/>
<constraint field="estilo_fonte" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
</constraints>
