...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  <renderer-v2 referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{9bcfd0d3-de42-428b-80fa-d55eb5e52754}">
      <rule filter="visivel = 1" label="Visivel" key="{fd3793dc-5266-4481-85f7-b1b9cd2c5e2b}">
        ...
        <rule symbol="16" filter="tipo in (501) and $length >= 20" label="Bueiro linha" key="{54d3c641-a4f0-475c-9944-9db1f7023bbd}"/>
        <rule symbol="17" filter="tipo in (501) and $length &lt; 20" label="Bueiro ponto" key="{54911d9c-35ac-4901-80d2-f582274c2597}"/>
  ...
  <labeling type="rule-based">
    <rules key="{14159be6-134d-46b1-9a6c-e0abfa72a17f}">
      <rule filter="&quot;tipo&quot; in (401,402)" description="Vau" key="{47fbfd70-29ed-4995-b61e-1c3dc9388f03}">
        <settings calloutType="simple">
          <text-style isExpression="0" blendMode="0" textOpacity="1" allowHtml="0" fontUnderline="0" fontWordSpacing="0" fontKerning="1" fontStrikeout="0" fieldName="texto_edicao" useSubstitutions="0" multilineHeight="0.80000000000000004" fontWeight="50" previewBkgrdColor="255,255,255,255" fontFamily="Noto Sans" fontSize="6" fontItalic="1" namedStyle="Condensed Italic" textColor="75,75,75,255" capitalization="0" legendString="Aa" textOrientation="horizontal" fontLetterSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point">
            <families/>
      ...
      <rule filter="tipo in (201,202,203,204)" description="Ponte" key="{b8194fec-2ad7-4157-ae6f-fdc8c580f0b3}">
        <settings calloutType="simple">
          <text-style isExpression="0" blendMode="0" textOpacity="1" allowHtml="0" fontUnderline="0" fontWordSpacing="0" fontKerning="1" fontStrikeout="0" fieldName="texto_edicao" useSubstitutions="0" multilineHeight="0.80000000000000004" fontWeight="50" previewBkgrdColor="255,255,255,255" fontFamily="Noto Sans" fontSize="6" fontItalic="1" namedStyle="Condensed Italic" textColor="75,75,75,255" capitalization="0" legendString="Aa" textOrientation="horizontal" fontLetterSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferJoinStyle="128" bufferNoFill="1" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferDraw="0" bufferColor="255,255,255,255" bufferBlendMode="0"/>
