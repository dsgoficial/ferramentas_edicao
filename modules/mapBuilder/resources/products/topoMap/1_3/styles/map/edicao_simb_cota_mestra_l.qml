...
<qgis version="3.24.3-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  ...
  <labeling type="rule-based">
    <rules key="{bf2026bc-f27d-4561-8efb-0a8b1c80358f}">
      <rule description="Cota mestra" key="{070fa5e5-8ac1-4faf-9426-7927134e87cd}" filter="ELSE">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="1" isExpression="0" useSubstitutions="0" fieldName="texto_edicao" fontWordSpacing="0" fontFamily="Noto Sans" textOrientation="horizontal" fontKerning="1" fontLetterSpacing="0" fontItalic="1" allowHtml="0" previewBkgrdColor="255,255,255,255" fontSizeUnit="Point" fontSize="7" textOpacity="1" legendString="Aa" multilineHeight="1" namedStyle="Condensed Italic" blendMode="0" textColor="166,43,51,255" fontWeight="50" fontUnderline="0" fontStrikeout="0">
            <families/>
          ...
          <placement geometryGenerator="with_variable(&#xd;&#xd;&#xa; 'moldura',&#xd;&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xd;&#xa;THEN &#xd;&#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xd;&#xa;ELSE&#xd;&#xd;&#xa;$geometry&#xd;&#xd;&#xa;END&#xd;&#xd;&#xa;)" preserveRotation="1" overrunDistance="0" maxCurvedCharAngleIn="25" fitInPolygonOnly="0" dist="0" rotationUnit="AngleDegrees" polygonPlacementFlags="2" repeatDistanceUnits="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" centroidInside="0" xOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" rotationAngle="0" offsetType="0" quadOffset="4" geometryGeneratorEnabled="1" distMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" placement="3" distUnits="MM" overrunDistanceUnit="MM" repeatDistance="0" geometryGeneratorType="LineGeometry" layerType="LineGeometry" centroidWhole="0" lineAnchorClipping="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placementFlags="9" priority="5" lineAnchorPercent="0.5" yOffset="0"/>
          <rendering scaleVisibility="0" maxNumLabels="2000" obstacle="0" minFeatureSize="10" obstacleFactor="1" drawLabels="1" unplacedVisibility="0" displayAll="0" mergeLines="1" scaleMin="1000" obstacleType="1" upsidedownLabels="0" fontMinPixelSize="3" zIndex="0" fontMaxPixelSize="10000" labelPerPart="0" fontLimitPixelSize="0" scaleMax="100000" limitNumLabels="0"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" name="name" type="QString"/>
