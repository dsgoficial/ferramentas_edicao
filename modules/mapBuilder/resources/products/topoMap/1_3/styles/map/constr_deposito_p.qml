...
<qgis version="3.24.3-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  <renderer-v2 enableorderby="0" type="RuleRenderer" forceraster="0" symbollevels="0" referencescale="25000">
    <rules key="{15e09ec0-9841-4520-b07a-26e1ce1469e9}">
      <rule key="{dd502e66-043d-4cdc-b98a-e7b7d0ffe2eb}" label="Visível" filter=" &quot;visivel&quot; = 1">
        <rule description="Galpão, armazém" key="{7cd9d25e-c353-460b-9708-b4f3f0dcd74f}" label="P20214E" symbol="0" filter="&quot;tipo&quot; in (101, 110, 108, 111, 112, 132, 198)"/>
        <rule key="{9578b293-d8bc-4df0-9394-00e3dc45ca84}" label="P20214A" symbol="1" filter="&quot;tipo&quot; = 109"/>
        <rule key="{c985b851-ad25-4a76-9625-5c2552703ea0}" label="P20214B" symbol="2" filter="&quot;tipo&quot; in (113, 298, 306, 305, 304, 398)"/>
        <rule description="Tanque dagua" key="{f2dbd971-2a05-4177-a181-42a55334620f}" label="P20214C" symbol="3" filter="&quot;tipo&quot; in (201,204,301)"/>
        <rule key="{2de32ca8-9fc1-41c9-a306-3cfefb65aa34}" label="P10704A" symbol="4" filter="&quot;tipo&quot; = 202"/>
        <rule description="Cisterna" key="{d4f82235-073f-404c-a548-19a152bbb46d}" label="P10704B" symbol="5" filter="&quot;tipo&quot; = 203"/>
        <rule key="{93e1af9a-e884-4697-9b99-1670f82aa670}" symbol="6" filter="ELSE"/>
      </rule>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{9c7d7c75-a55b-44f0-b7d0-6cba29b45ab0}">
      <rule description="Depósito" key="{1ec9783c-39de-4a10-9804-e2b88c207765}" filter="&quot;visivel&quot; = 1">
        <settings calloutType="simple">
          <text-style fontFamily="Noto Sans" fontSizeUnit="Point" fontWordSpacing="0" textOrientation="horizontal" fontKerning="1" textOpacity="1" multilineHeight="0.80000000000000004" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" previewBkgrdColor="255,255,255,255" fieldName="texto_edicao" useSubstitutions="0" fontItalic="0" fontLetterSpacing="0" fontWeight="50" allowHtml="0" legendString="Aa" fontUnderline="0" namedStyle="Condensed" capitalization="0" textColor="75,75,75,255" isExpression="0" fontSize="6" blendMode="0">
            ...
            <text-mask maskType="0" maskJoinStyle="128" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskOpacity="1" maskSize="0.20000000000000001" maskedSymbolLayers="" maskSizeUnits="MM" maskEnabled="1"/>
          ...
          <placement yOffset="-0.5" offsetUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" distMapUnitScale="3x:0,0,0,0,0,0" priority="5" repeatDistance="0" centroidWhole="0" repeatDistanceUnits="MM" lineAnchorClipping="0" geometryGeneratorEnabled="1" dist="0.40000000000000002" rotationUnit="AngleDegrees" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" polygonPlacementFlags="2" rotationAngle="0" overrunDistanceUnit="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" overrunDistance="0" maxCurvedCharAngleIn="25" lineAnchorPercent="0.5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="0" centroidInside="0" distUnits="MM" layerType="PointGeometry" placementFlags="10" maxCurvedCharAngleOut="-25" geometryGenerator="with_variable(&#xd;&#xd;&#xa; 'moldura',&#xd;&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xd;&#xa;THEN &#xd;&#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xd;&#xa;ELSE&#xd;&#xd;&#xa;$geometry&#xd;&#xd;&#xa;END&#xd;&#xd;&#xa;)" lineAnchorType="0" xOffset="0.5" quadOffset="2" offsetType="0" fitInPolygonOnly="0"/>
          <rendering displayAll="0" limitNumLabels="0" fontLimitPixelSize="0" fontMinPixelSize="3" fontMaxPixelSize="10000" labelPerPart="0" scaleMin="0" obstacleFactor="1" maxNumLabels="2000" minFeatureSize="0" scaleMax="0" obstacle="1" unplacedVisibility="0" obstacleType="1" zIndex="0" upsidedownLabels="0" scaleVisibility="0" mergeLines="0" drawLabels="1"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" value="" name="name"/>
              <Option type="Map" name="properties">
