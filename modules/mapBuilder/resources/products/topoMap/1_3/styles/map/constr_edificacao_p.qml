...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 forceraster="0" enableorderby="0" type="RuleRenderer" symbollevels="0" referencescale="-1">
    <rules key="{af709a54-88ca-4a27-bba5-e0a7ac6ce840}">
      <rule filter=" &quot;visivel&quot; = 1" key="{4bdda895-97c4-4ad7-919c-b2b6ccf321c8}" label="Visível">
        ...
        <rule filter="(&quot;tipo&quot; in (803, 603, 605, 698) or (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (13, 17, 19,22, 30))" key="{832b4b14-42b1-4056-9886-114643611ddc}" label="P20418A - Importante" symbol="2"/>
    ...
    <symbols>
      ...
      <symbol clip_to_extent="1" alpha="1" force_rhr="0" type="marker" name="12">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
      ...
      <symbol clip_to_extent="1" alpha="1" force_rhr="0" type="marker" name="13">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
      ...
      <symbol clip_to_extent="1" alpha="1" force_rhr="0" type="marker" name="14">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{87eeb8cb-585d-4b64-8d15-8f550ea77c91}">
      <rule filter="&quot;tipo&quot; = 1212 and &quot;visivel&quot; = 1" description="Sede operacional de fazenda" key="{a4172a78-5dec-4e84-8d53-dd1e97efcbd5}">
        <settings calloutType="simple">
          ...
          <placement yOffset="-0.5" offsetType="0" maxCurvedCharAngleOut="-25" quadOffset="2" distMapUnitScale="3x:0,0,0,0,0,0" xOffset="0.5" geometryGeneratorEnabled="1" lineAnchorPercent="0.5" centroidWhole="0" rotationAngle="0" distUnits="MM" polygonPlacementFlags="2" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" priority="5" dist="0.40000000000000002" placementFlags="10" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" fitInPolygonOnly="0" preserveRotation="1" placement="0" maxCurvedCharAngleIn="25" repeatDistance="0" repeatDistanceUnits="MM" offsetUnits="MM" overrunDistance="0" geometryGeneratorType="PointGeometry" rotationUnit="AngleDegrees" lineAnchorClipping="0" overrunDistanceUnit="MM" layerType="PointGeometry" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)"/>
      ...
      <rule filter="&quot;tipo&quot; = 1218 and &quot;visivel&quot; = 1" description="Curral" key="{24dac5ae-9b5b-4503-8388-bf450ba5b13f}">
        <settings calloutType="simple">
      ...
      <rule filter="&quot;tipo&quot; not in (1212, 1218) and &quot;visivel&quot; = 1" description="Edificação" key="{72c67f43-ca31-4646-a053-64cd44e4058f}">
        <settings calloutType="simple">
          <text-style textColor="36,31,33,255" fontKerning="1" fontSize="6" fontFamily="Noto Sans" allowHtml="0" namedStyle="Condensed" fontWordSpacing="0" textOrientation="horizontal" fontWeight="50" fontItalic="0" fontSizeUnit="Point" fontLetterSpacing="0" multilineHeight="0.80000000000000004" legendString="Aa" isExpression="0" fieldName="texto_edicao" previewBkgrdColor="255,255,255,255" fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" textOpacity="1" blendMode="0" fontStrikeout="0" useSubstitutions="0">
            <families/>
            <text-buffer bufferNoFill="1" bufferSize="1" bufferOpacity="1" bufferJoinStyle="128" bufferDraw="0" bufferColor="255,255,255,255" bufferBlendMode="0" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0"/>
