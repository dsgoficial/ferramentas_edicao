...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  ...
  <labeling type="rule-based">
    <rules key="{f2f92cf6-3d1c-4d1d-806b-fac3b8c14412}">
      <rule filter="&quot;visivel&quot; = 1" key="{ca62034f-dbf9-4d7e-b489-61737a3ec35d}">
        <rule key="{b8d5bca4-fe06-4ee2-b17a-57a9ce889be2}">
