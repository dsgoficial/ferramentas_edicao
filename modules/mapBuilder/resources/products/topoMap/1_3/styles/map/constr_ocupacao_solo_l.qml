...
<qgis version="3.24.3-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  ...
  <labeling type="rule-based">
    <rules key="{99a1e4c2-cca4-4a1a-a721-e638adaea19d}">
      <rule filter="visivel = 1" key="{cf53158c-c32e-4456-9086-213b3ca1b796}" description="Ocupação do solo">
