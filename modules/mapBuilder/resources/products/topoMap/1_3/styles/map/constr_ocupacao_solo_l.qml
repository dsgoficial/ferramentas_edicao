...
<qgis version="3.24.3-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  <renderer-v2 symbollevels="0" type="RuleRenderer" referencescale="-1" forceraster="0" enableorderby="0">
    <rules key="{4681daff-84d1-423c-a18d-3b71f9ec7106}">
      <rule label="Visível" key="{d1d963ba-db4c-45b8-8807-d960ba725f2f}" filter="&quot;visivel&quot; = 1">
        <rule symbol="0" label="L20307A" key="{097e7f89-03b1-4183-a33d-bcb5fb098278}" filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 = 3"/>
  ...
  <labeling type="rule-based">
    <rules key="{4530e72d-808a-4f65-85e3-ed9678eeebe6}">
      <rule description="Ocupação do solo" key="{74b588da-d97f-4057-a94b-e991c3ab1333}" filter="visivel = 1">
        <settings calloutType="simple">
          ...
          <placement geometryGenerator="with_variable(&#xd;&#xd;&#xa; 'moldura',&#xd;&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xd;&#xa;THEN &#xd;&#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xd;&#xa;ELSE&#xd;&#xd;&#xa;$geometry&#xd;&#xd;&#xa;END&#xd;&#xd;&#xa;)" preserveRotation="1" overrunDistance="0" maxCurvedCharAngleIn="25" fitInPolygonOnly="0" dist="0" rotationUnit="AngleDegrees" polygonPlacementFlags="2" repeatDistanceUnits="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" centroidInside="0" xOffset="0.5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" rotationAngle="0" offsetType="0" quadOffset="2" geometryGeneratorEnabled="1" distMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" placement="4" distUnits="MM" overrunDistanceUnit="MM" repeatDistance="0" geometryGeneratorType="LineGeometry" layerType="LineGeometry" centroidWhole="0" lineAnchorClipping="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placementFlags="10" priority="5" lineAnchorPercent="0.5" yOffset="-0.5"/>
