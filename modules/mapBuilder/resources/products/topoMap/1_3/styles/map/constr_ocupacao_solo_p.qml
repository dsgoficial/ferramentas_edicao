...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" referencescale="-1" type="RuleRenderer">
    <rules key="{5adbac42-96ad-4569-9e33-64a725a4a2b7}">
      <rule label="Visível" filter=" &quot;visivel&quot; = 1" key="{85a4068f-9f1d-4ae7-a047-fe2944f76002}">
        <rule description="Campo/quadra e pista de competição" label="Sports Ground" filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (2, 3)" key="{b62df8d3-c1a1-4aee-a484-aa1a15dbd3d5}" symbol="0"/>
        <rule description="Cemitério" label="P20209D" filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (1) and tipo != 104" key="{67ad3d4f-ac6d-44ad-bdce-4a356df21410}" symbol="1"/>
        <rule description="Cemitério" label="P20209D" filter="tipo = 104" key="{a131d610-94e3-415b-a512-7976af042905}" symbol="2"/>
        <rule description="Farol" label="Farol" filter="tipo = 1101" key="{859fca67-2193-42c3-b93c-1698144888de}" symbol="3"/>
        <rule label="Estação Climatológica Principal" filter="&quot;tipo&quot; = 1601" key="{b1c52ccd-d62b-4217-bcd8-9f0886b016e0}" symbol="4"/>
        <rule label="Ruínas" filter="&quot;tipo&quot; = 701" key="{95cd89bd-7348-4071-a4cb-0187b8fcc85b}" symbol="5"/>
    ...
    <symbols>
      ...
      <symbol force_rhr="0" alpha="1" clip_to_extent="1" type="marker" name="4">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
      ...
      <symbol force_rhr="0" alpha="1" clip_to_extent="1" type="marker" name="5">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
      ...
      <symbol force_rhr="0" alpha="1" clip_to_extent="1" type="marker" name="6">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{dd3bbd3f-6172-48ee-adb6-89b99cb47b36}">
      <rule filter="&quot;visivel&quot; = 1" key="{6c22c3f2-981a-4711-a47e-2a2a11554df6}">
        <settings calloutType="simple">
          <text-style multilineHeight="0.80000000000000004" isExpression="0" legendString="Aa" fontFamily="Noto Sans" fontSize="6" previewBkgrdColor="255,255,255,255" fontWeight="50" fontWordSpacing="0" fontUnderline="0" allowHtml="0" fontStrikeout="0" useSubstitutions="0" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontLetterSpacing="0" fontSizeUnit="Point" textOpacity="1" textColor="75,75,75,255" namedStyle="Condensed" blendMode="0" capitalization="0" fontKerning="1" fontItalic="0" fieldName="texto_edicao">
            <families/>
          ...
          <placement overrunDistance="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="1" priority="5" lineAnchorPercent="0.5" geometryGeneratorType="PointGeometry" overrunDistanceUnit="MM" repeatDistanceUnits="MM" offsetType="0" quadOffset="2" rotationAngle="0" preserveRotation="1" centroidWhole="0" centroidInside="0" distUnits="MM" lineAnchorClipping="0" fitInPolygonOnly="0" distMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" geometryGenerator="with_variable(&#xd;&#xd;&#xa; 'moldura',&#xd;&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xd;&#xa;THEN &#xd;&#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xd;&#xa;ELSE&#xd;&#xd;&#xa;$geometry&#xd;&#xd;&#xa;END&#xd;&#xd;&#xa;)" repeatDistance="0" dist="0.40000000000000002" xOffset="0.5" lineAnchorType="0" maxCurvedCharAngleOut="-25" placementFlags="10" placement="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" yOffset="-0.5" layerType="PointGeometry" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" maxCurvedCharAngleIn="25"/>
