...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" referencescale="-1" forceraster="0" symbollevels="0" enableorderby="0">
    <rules key="{9ed15ebd-9075-4a2b-8fe6-a3b74ad93330}">
      <rule label="Visível" key="{16c45c6c-f923-4cd9-885c-e5331feaaad4}" filter="&quot;visivel&quot; =1">
        ...
        <rule symbol="1" label="Sports Ground" key="{bf4038cd-98e9-4bb0-8e9f-cfca9c83912b}" filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (2)" description="Campo Quadra e Pista de competição"/>
        ...
        <rule symbol="5" label="A10811A" key="{2c93065a-c1ef-4d14-b3bb-f108a8ca7108}" filter="&quot;tipo&quot; = 409" description="Pátio aeroportuário"/>
      ...
      <rule symbol="9" label="Não visível" key="{639b1fe3-1879-4565-aa5a-0a24d62cae58}" filter="ELSE"/>
    </rules>
    <symbols>
      ...
      <symbol type="fill" force_rhr="0" name="9" alpha="0.4" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{f125ae48-4dc6-4bc3-aa50-c80f2656def0}">
      <rule key="{99be7c06-b08b-4361-a7f4-7c212e505381}" filter="&quot;visivel&quot; = 1">
        <rule key="{462667ee-5da8-41ef-8262-61bdac464029}" description="Ocupação do solo">
