...
<qgis styleCategories="Symbology|Labeling" version="3.34.0-Prizren" labelsEnabled="1">
  <renderer-v2 referencescale="-1" forceraster="0" type="singleSymbol" symbollevels="0" enableorderby="0">
    <symbols>
      <symbol type="fill" clip_to_extent="1" force_rhr="0" name="0" frame_rate="10" is_animated="0" alpha="1">
        ...
        <layer pass="0" id="{9f70dc9e-4222-47fa-9ec6-892573c0806c}" class="SimpleFill" enabled="1" locked="0">
          <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol type="fill" clip_to_extent="1" force_rhr="0" name="" frame_rate="10" is_animated="0" alpha="1">
        ...
        <layer pass="0" id="{a670f0d3-a1cc-40e5-8179-c5d9c248bbfe}" class="SimpleFill" enabled="1" locked="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
  ...
  <labeling type="rule-based">
    <rules key="{698282f5-b45e-4d1c-9b72-f7ca1dd1802c}">
      <rule description="Named Location" key="{e14dddb7-6c81-436a-9276-9bcec38542db}">
        <settings calloutType="simple">
          <text-style forcedItalic="0" fontWeight="50" allowHtml="0" fontItalic="0" capitalization="1" fieldName="texto_edicao" blendMode="0" fontStrikeout="0" textColor="36,31,33,255" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Regular" fontFamily="Noto Sans" previewBkgrdColor="255,255,255,255" fontKerning="1" useSubstitutions="0" forcedBold="0" textOpacity="1" isExpression="0" fontLetterSpacing="0" fontSize="10" fontUnderline="0" legendString="Aa" multilineHeight="1" fontSizeUnit="Point" fontWordSpacing="0" multilineHeightUnit="Percentage">
            <families/>
