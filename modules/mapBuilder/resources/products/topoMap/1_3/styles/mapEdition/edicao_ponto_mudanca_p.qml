...
<qgis labelsEnabled="0" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" forceraster="0" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{fd0b5490-26b8-4e01-ba62-df57f0a9c6cf}">
      <rule filter="visivel = 1" key="{0aa99ac8-ecc9-4c40-8f8e-71839609560b}" symbol="0"/>
      <rule filter="ELSE" key="{389ec813-86b2-49ef-9620-afd352765980}" symbol="1" label="Não visível"/>
    </rules>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                ...
                <Option name="offset" type="Map">
                  <Option value="true" name="active" type="bool"/>
                  <Option value="array(0,-&quot;desloc&quot;)" name="expression" type="QString"/>
      ...
      <symbol alpha="1" name="1" force_rhr="0" type="marker" clip_to_extent="1">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleMarker">
          ...
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="254,0,254,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="0.15"/>
          <prop k="outline_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="outline_width_unit" v="MM"/>
