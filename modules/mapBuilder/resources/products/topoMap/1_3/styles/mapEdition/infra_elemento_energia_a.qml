...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" referencescale="-1" forceraster="0" symbollevels="0" enableorderby="0">
    <rules key="{d6a0f073-ddcc-430a-897d-73175ec4da29}">
      ...
      <rule symbol="2" label="Não visível" key="{db1bd0f0-08b3-4a7c-8902-dc2fecb107f2}" filter="ELSE"/>
    </rules>
    <symbols>
      ...
      <symbol type="fill" force_rhr="0" name="2" alpha="0.4" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{0a897eac-16d5-435b-8195-736ed85320c1}">
      <rule key="{a4c0e9e8-4594-4772-96fe-9ee322f1ac08}" filter="&quot;visivel&quot; = 1" description="Energia">
