  ...
  <renderer-v2 type="RuleRenderer" referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0">
    <rules key="{19d54618-79b3-47af-bbd0-e84dac371fef}">
      <rule key="{d065bfba-111e-4410-b9f7-971ac015b2f4}" filter="visivel = 1">
        <rule symbol="0" label="L10303A" key="{3ada417b-3ccc-4491-b073-b11457983b92}" filter="&quot;material_construcao&quot; in (1, 2) and  &quot;sobreposto_transportes&quot; = 2"/>
        <rule symbol="1" label="L10303B" key="{11b696a4-12d4-40bb-887d-12c519b150b9}" filter=" &quot;material_construcao&quot; not in (1, 2) and  &quot;sobreposto_transportes&quot; = 2"/>
        <rule symbol="2" label="L10303A em transporte" key="{db44bab4-9298-4e3c-9637-c3d2bf3d307c}" filter="&quot;material_construcao&quot; in (1, 2) and  &quot;sobreposto_transportes&quot; = 1"/>
        <rule symbol="3" label="L10303B em transporte" key="{33417fe8-5b05-4490-b0df-d98fa563a559}" filter="&quot;material_construcao&quot; not in (1, 2) and  &quot;sobreposto_transportes&quot; = 1"/>
        <rule symbol="4" key="{a9073bbc-bb8d-44d3-a788-a5e84cf02cc6}" filter="ELSE"/>
      </rule>
      <rule symbol="5" label="Não visível" key="{f07f8a30-c753-43d1-955b-ac0924c96c72}" filter="ELSE"/>
    </rules>
    <symbols>
