...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" forceraster="0" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{4681daff-84d1-423c-a18d-3b71f9ec7106}">
      <rule filter="&quot;visivel&quot; = 1" key="{d1d963ba-db4c-45b8-8807-d960ba725f2f}" label="Visível">
        <rule filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 = 3" key="{097e7f89-03b1-4183-a33d-bcb5fb098278}" symbol="0" label="L20307A"/>
        <rule filter="ELSE" key="{c2f1b34a-0f27-491c-87d3-38458d2d504c}" symbol="1"/>
      </rule>
      <rule filter="ELSE" key="{3efcc757-667f-4916-b8d5-b249c2eb033a}" symbol="2" label="Não visível"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{31367c77-3a88-4aa3-b6bf-8ddc2f5643ff}">
      <rule filter="&quot;visivel&quot; = 1" key="{b8579aad-62a4-4d74-8394-cd91199779dd}">
        <rule description="Ocupação do solo" key="{c2f1b7db-82e9-45bf-b844-844150e3fc61}">
          <settings calloutType="simple">
            ...
            <placement priority="5" lineAnchorType="0" xOffset="0.5" placement="4" repeatDistanceUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" centroidWhole="0" dist="0" lineAnchorPercent="0.5" rotationAngle="0" lineAnchorClipping="0" maxCurvedCharAngleOut="-25" polygonPlacementFlags="2" repeatDistance="0" fitInPolygonOnly="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="-0.5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" quadOffset="2" distUnits="MM" centroidInside="0" offsetType="0" maxCurvedCharAngleIn="25" placementFlags="10" layerType="LineGeometry" offsetUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" rotationUnit="AngleDegrees" geometryGeneratorType="LineGeometry" overrunDistanceUnit="MM" geometryGenerator="with_variable(&#xd;&#xd;&#xa; 'moldura',&#xd;&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xd;&#xa;THEN &#xd;&#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xd;&#xa;ELSE&#xd;&#xd;&#xa;$geometry&#xd;&#xd;&#xa;END&#xd;&#xd;&#xa;)" geometryGeneratorEnabled="1"/>
