...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  ...
  <labeling type="rule-based">
    <rules key="{72098a59-8785-46aa-a293-20cc982277b0}">
      <rule description="Texto genérico" key="{0b0dad00-4f47-4833-8bd3-a0b1f8262975}">
        <settings calloutType="simple">
          <text-style fontUnderline="0" fontSize="10" legendString="Aa" namedStyle="Regular" multilineHeight="0.80000000000000004" useSubstitutions="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWeight="50" capitalization="0" previewBkgrdColor="255,255,255,255" fontSizeUnit="Point" fontStrikeout="0" fontKerning="1" allowHtml="0" isExpression="0" fontWordSpacing="0" fontItalic="0" fontLetterSpacing="0" blendMode="0" textColor="0,0,0,255" textOpacity="1" fontFamily="Noto Sans" textOrientation="horizontal" fieldName="texto_edicao">
            <families/>
