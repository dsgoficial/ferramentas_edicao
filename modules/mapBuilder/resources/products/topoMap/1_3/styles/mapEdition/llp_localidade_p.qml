...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" forceraster="0" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{86967f63-d2ea-4b62-9369-c19a11fc7bf8}">
      <rule filter="visivel = 1" key="{c86fa671-80cf-4b08-88a6-02d84085a3bb}" symbol="0"/>
      <rule filter="ELSE" key="{cafd49af-5600-4e16-b68b-79c080f19689}" symbol="1" label="Não visível"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{d9855b39-9186-4ff8-ae92-0e2fc7ce91db}">
      <rule filter="&quot;visivel&quot; = 1" description="Visível" key="{002b4eba-fd12-4cc5-8d95-6b6b2e9c7b61}">
        <rule filter="&quot;tipo&quot; in (1, 2, 3) AND populacao >= 500000" description="Cidade 1a Importância" key="{b038d0a4-83ac-401b-9765-0a73063fea51}">
        ...
        <rule filter="&quot;tipo&quot; in (1, 2, 3) AND populacao &lt; 500000 AND populacao >= 100000" description="Cidade 2a Importância" key="{bb68d6ab-2c94-42c5-a40a-2ac2b69248de}">
          <settings calloutType="simple">
        ...
        <rule filter="&quot;tipo&quot; in (1, 2, 3) AND populacao &lt; 100000" description="Cidade 3a Importância" key="{70079d46-1cbe-4746-b7d0-640fe55a763c}">
          <settings calloutType="simple">
        ...
        <rule filter="&quot;tipo&quot; = 4" description="Vila" key="{38c79fb7-ec99-49c3-974d-84a5af650925}">
          <settings calloutType="simple">
        ...
        <rule filter="&quot;tipo&quot; in (5, 6, 7)" description="Outras localidades" key="{14ba3f0b-08a7-427e-a1d9-88c2c1f29cd4}">
          <settings calloutType="simple">
        ...
        <rule filter="&quot;tipo&quot; in (8, 9, 10)" description="Nome local" key="{efb2cd31-312a-4b07-94c0-97a42117d62e}">
          <settings calloutType="simple">
