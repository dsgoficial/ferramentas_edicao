...
<qgis version="3.24.3-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  <renderer-v2 referencescale="-1" symbollevels="0" type="RuleRenderer" enableorderby="0" forceraster="0">
    <rules key="{ec7e5b7e-0649-43c5-98ad-c84f432d69cd}">
      ...
      <rule filter="ELSE" label="Não visível" symbol="6" key="{8f0bc6a0-1f5e-45e3-8d82-d5f13d10ccb2}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{e9d92503-700e-4cf6-8f51-e60dfdf96c0e}">
      <rule filter="indice = 1 and visivel = 1 AND &quot;dentro_de_massa_dagua&quot; != 1" key="{661f3d23-7fb2-4117-9635-56a96cc59dd1}">
