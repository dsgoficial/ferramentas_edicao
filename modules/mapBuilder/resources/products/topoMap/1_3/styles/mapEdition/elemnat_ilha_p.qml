...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" forceraster="0" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{29d58aab-1460-4a96-ad85-cf7cb07c420b}">
      <rule filter="&quot;visivel&quot; = 1" key="{a6e9b795-2f26-4808-8b52-fb87ba31635b}" label="Visível">
      ...
      <rule filter="ELSE" key="{f7e0f9b0-7a89-40cf-a3c5-cb88df88909f}" symbol="2" label="Não visível"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="0.4" name="2" force_rhr="0" type="marker" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{537e2ce5-40f8-4a74-906f-7789621c35e5}">
      <rule filter="visivel = 1" key="{d68f6dbe-8f75-4137-9bab-ac9a829a76d8}">
