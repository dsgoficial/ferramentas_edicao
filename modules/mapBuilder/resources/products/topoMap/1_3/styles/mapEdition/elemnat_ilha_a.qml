...
<qgis styleCategories="Symbology|Labeling" version="3.34.0-Prizren" labelsEnabled="1">
  <renderer-v2 referencescale="-1" forceraster="0" type="RuleRenderer" symbollevels="0" enableorderby="0">
    <rules key="{cae92487-0256-43b2-904f-140487ffeb66}">
      <rule filter="visivel = 1" key="{0dc81367-4632-4b6b-9a0b-f3cc13930a13}" symbol="0"/>
      <rule filter="ELSE" key="{85681d63-180f-45c5-9835-36882eebeac1}" label="Não visível" symbol="1"/>
    </rules>
    <symbols>
      <symbol type="fill" clip_to_extent="1" force_rhr="0" name="0" frame_rate="10" is_animated="0" alpha="1">
        ...
        <layer pass="0" id="{82ae6472-9e41-4240-aaa9-72c8c006725d}" class="SimpleFill" enabled="1" locked="0">
          <Option type="Map">
      ...
      <symbol type="fill" clip_to_extent="1" force_rhr="0" name="1" frame_rate="10" is_animated="0" alpha="0.4">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" name="name" value=""/>
            <Option name="properties"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol type="fill" clip_to_extent="1" force_rhr="0" name="" frame_rate="10" is_animated="0" alpha="1">
        ...
        <layer pass="0" id="{1b44e088-ae29-411d-b423-d464a1db5ecd}" class="SimpleFill" enabled="1" locked="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
  ...
  <labeling type="rule-based">
    <rules key="{f328a0bc-5435-4fb9-aae9-3a20bfb3c713}">
      <rule filter="visivel = 1" key="{79109769-0136-4da3-9533-f7bde6b3cbab}">
        <settings calloutType="simple">
          <text-style forcedItalic="0" fontWeight="50" allowHtml="0" fontItalic="0" capitalization="1" fieldName="texto_edicao" blendMode="0" fontStrikeout="0" textColor="36,31,33,255" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Regular" fontFamily="Noto Sans" previewBkgrdColor="255,255,255,255" fontKerning="1" useSubstitutions="0" forcedBold="0" textOpacity="1" isExpression="0" fontLetterSpacing="0" fontSize="6" fontUnderline="0" legendString="Aa" multilineHeight="0.80000000000000004" fontSizeUnit="Point" fontWordSpacing="0" multilineHeightUnit="Percentage">
            <families/>
