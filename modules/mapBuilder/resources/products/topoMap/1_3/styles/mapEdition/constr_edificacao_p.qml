...
<qgis version="3.24.3-Tisler" styleCategories="Symbology|Labeling" labelsEnabled="1">
  <renderer-v2 symbollevels="0" type="RuleRenderer" forceraster="0" referencescale="-1" enableorderby="0">
    <rules key="{af709a54-88ca-4a27-bba5-e0a7ac6ce840}">
      <rule filter=" &quot;visivel&quot; = 1" label="Visível" key="{4bdda895-97c4-4ad7-919c-b2b6ccf321c8}">
        <rule symbol="0" filter=" (&quot;tipo&quot; in (0, 525, 608, 610, 1212, 1213, 1298, 2029, 2030, 2031) or (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (1, 2, 3, 4, 7, 8, 9, 10, 11, 15, 21, 23, 24, 25)) and &quot;tipo&quot; not in (803, 2429)" label="P20403A - Genérico Não Importante" description="Edificação operacional" key="{55073371-2bcb-4204-962b-25b9718a6ea4}"/>
        ...
        <rule symbol="5" filter="&quot;tipo&quot; = 602 and  &quot;suprimir_bandeira&quot; != 1" label="Templo" key="{d1b9f3af-5809-46e6-8d96-894920a8c2a8}"/>
      ...
      <rule symbol="16" filter="ELSE" label="Não visível" key="{38ea4f92-0f49-4b54-afc7-857a2873c63e}"/>
    </rules>
    <symbols>
      ...
      <symbol name="16" type="marker" force_rhr="0" alpha="0.4" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{371eae11-e2b5-45dd-a956-5acb6e02437c}">
      <rule filter="&quot;tipo&quot; = 1212 and &quot;visivel&quot; = 1" description="Sede operacional de fazenda" key="{c4f8a370-03e8-406e-b7c4-aee183c9a175}">
        <settings calloutType="simple">
          <text-style fontUnderline="0" fontWeight="25" useSubstitutions="0" previewBkgrdColor="255,255,255,255" multilineHeight="0.80000000000000004" fontKerning="1" allowHtml="0" fontFamily="Noto Sans" legendString="Aa" fontLetterSpacing="0" textColor="36,31,33,255" fieldName="texto_edicao" namedStyle="Condensed Light" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOpacity="1" isExpression="0" fontSizeUnit="Point" textOrientation="horizontal" capitalization="0" blendMode="0" fontStrikeout="0" fontWordSpacing="0" fontSize="6" fontItalic="0">
            ...
            <text-mask maskType="0" maskEnabled="1" maskJoinStyle="128" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSize="0.40000000000000002" maskOpacity="1" maskSizeUnits="MM" maskedSymbolLayers=""/>
      ...
      <rule filter="&quot;tipo&quot; = 1218 and &quot;visivel&quot; = 1" description="Curral" key="{fa428b3d-1bd8-496f-a71a-4e5d3f18a62d}">
        <settings calloutType="simple">
      ...
      <rule filter="&quot;tipo&quot; not in (1212, 1218) and &quot;visivel&quot; = 1" description="Edificação" key="{6c760c6a-1224-4e1a-ab83-4d83a63b81f1}">
        <settings calloutType="simple">
          <text-style fontUnderline="0" fontWeight="50" useSubstitutions="0" previewBkgrdColor="255,255,255,255" multilineHeight="0.80000000000000004" fontKerning="1" allowHtml="0" fontFamily="Noto Sans" legendString="Aa" fontLetterSpacing="0" textColor="36,31,33,255" fieldName="texto_edicao" namedStyle="Condensed" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOpacity="1" isExpression="0" fontSizeUnit="Point" textOrientation="horizontal" capitalization="0" blendMode="0" fontStrikeout="0" fontWordSpacing="0" fontSize="6" fontItalic="0">
            <families/>
            <text-buffer bufferSize="1" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferColor="255,255,255,255" bufferDraw="0" bufferBlendMode="0" bufferJoinStyle="128" bufferNoFill="1"/>
