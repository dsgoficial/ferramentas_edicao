...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" forceraster="0" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{9ebfed55-e318-4164-900d-875a903442fa}">
      ...
      <rule filter="ELSE" key="{5c80a8e0-e49d-4b55-90dd-2a5a4078c0e9}" symbol="4" label="Não visível"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{8714d3cb-f955-4093-9ac4-c1a8c48cb032}">
      <rule description="Elemento infraestrutura" key="{c1e82eea-6c81-4d2d-b55e-9c7abdae0aff}">
