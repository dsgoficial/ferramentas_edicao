...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  ...
  <labeling type="rule-based">
    <rules key="{89cb8a9f-b080-47d5-aa2a-6e686b162dc9}">
      <rule key="{99a3485f-a189-4f2c-8fdd-c4700f3642c9}" filter="&quot;visivel&quot; = 1">
        <rule key="{10ab427a-deca-4929-b7e0-688fa2d4fa0d}" description="Ocupação do solo">
