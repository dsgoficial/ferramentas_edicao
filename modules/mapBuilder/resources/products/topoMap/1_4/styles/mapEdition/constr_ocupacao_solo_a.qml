...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" referencescale="-1" type="RuleRenderer">
    <rules key="{9ed15ebd-9075-4a2b-8fe6-a3b74ad93330}">
      <rule filter="&quot;visivel&quot; =1" label="Visível" key="{16c45c6c-f923-4cd9-885c-e5331feaaad4}">
        <rule symbol="0" filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (1)" label="Cemiterio" key="{4a220843-0c95-45b3-a498-24a3731da7e2}"/>
        <rule symbol="1" filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (2)" label="Sports Ground" key="{bf4038cd-98e9-4bb0-8e9f-cfca9c83912b}" description="Campo Quadra e Pista de competição"/>
        <rule symbol="2" filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (3)" label="Pista Competicao Outras" key="{b743f971-44f4-46e7-87c8-634ee8e1ae86}"/>
        <rule symbol="3" filter="tipo = 1001" label="Arquibancada" key="{a51f4739-a69c-4540-be37-f4828ec1db10}"/>
        <rule symbol="4" filter="tipo = 501" label="Piscina" key="{3dbc766a-fb9b-4186-9fa1-23be95ceed87}"/>
        <rule symbol="5" filter="&quot;tipo&quot; = 409" label="A10811A" key="{2c93065a-c1ef-4d14-b3bb-f108a8ca7108}" description="Pátio aeroportuário"/>
        <rule symbol="6" filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (4) and tipo != 409" label="Pátio" key="{e96bb30d-03cf-4bf4-a2cb-57ee3a2d9b05}"/>
        <rule symbol="7" filter="tipo = 901" label="Estacionamento" key="{3c22666c-642a-4bc6-9f25-32a8c2bc6e28}"/>
        <rule symbol="8" filter="tipo = 701" label="Ruina" key="{f921ea0a-a731-4d00-b05a-f260bdc1de20}"/>
        <rule symbol="9" filter="ELSE" key="{6b599614-7f52-4ae0-a795-12d579e93b5b}"/>
      </rule>
      <rule symbol="10" filter="ELSE" label="Não visível" key="{639b1fe3-1879-4565-aa5a-0a24d62cae58}"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="0.4" force_rhr="0" name="10" clip_to_extent="1" type="fill">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{8043f42d-56f4-4a15-b889-8ad8eb8b3e8c}">
      <rule filter="&quot;visivel&quot; = 1" key="{d7f1642c-9d2c-487d-a862-f73e7a0bf718}">
        <rule key="{c8cd5143-c4da-4ae2-bc7f-e61e7e515e65}" description="Ocupação do solo">
          <settings calloutType="simple">
            <text-style legendString="Aa" fontWordSpacing="0" fontLetterSpacing="0" fontSize="6" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" textOpacity="1" fontKerning="1" fontItalic="0" multilineHeight="0.80000000000000004" fontStrikeout="0" allowHtml="0" textColor="36,31,33,255" textOrientation="horizontal" fontSizeUnit="Point" fieldName="texto_edicao" fontWeight="50" blendMode="0" isExpression="0" fontUnderline="0" namedStyle="Condensed" useSubstitutions="0" previewBkgrdColor="255,255,255,255" fontFamily="Noto Sans">
              <families/>
              <text-buffer bufferDraw="0" bufferColor="255,255,255,255" bufferBlendMode="0" bufferSizeUnits="MM" bufferOpacity="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferNoFill="1" bufferJoinStyle="128"/>
              <text-mask maskEnabled="1" maskSize="0.20000000000000001" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskOpacity="1" maskSizeUnits="MM" maskedSymbolLayers="" maskJoinStyle="128" maskType="0"/>
              <background shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeSizeType="0" shapeOffsetUnit="MM" shapeRotation="0" shapeOpacity="1" shapeBorderColor="128,128,128,255" shapeSVGFile="" shapeDraw="0" shapeType="0" shapeBorderWidth="0" shapeSizeY="0" shapeFillColor="255,255,255,255" shapeBorderWidthUnit="MM" shapeOffsetY="0" shapeRadiiUnit="MM" shapeSizeUnit="MM" shapeRadiiX="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeRotationType="0" shapeJoinStyle="64" shapeOffsetX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiY="0" shapeSizeX="0">
              ...
              <shadow shadowOffsetGlobal="1" shadowDraw="0" shadowRadiusAlphaOnly="0" shadowColor="0,0,0,255" shadowUnder="0" shadowOffsetAngle="135" shadowOpacity="0.69999999999999996" shadowBlendMode="6" shadowOffsetUnit="MM" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowRadius="1.5" shadowRadiusUnit="MM" shadowOffsetDist="1" shadowScale="100"/>
              <dd_properties>
                <Option type="Map">
                  <Option value="" name="name" type="QString"/>
                  <Option name="properties"/>
            ...
            <text-format rightDirectionSymbol=">" useMaxLineLengthForAutoWrap="1" autoWrapLength="0" multilineAlign="3" placeDirectionSymbol="0" formatNumbers="0" addDirectionSymbol="0" reverseDirectionSymbol="0" wrapChar="|" leftDirectionSymbol="&lt;" plussign="0" decimals="3"/>
            <placement placementFlags="10" dist="0" lineAnchorPercent="0.5" geometryGenerator="with_variable(&#xd;&#xd;&#xa; 'moldura',&#xd;&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xd;&#xa;THEN &#xd;&#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xd;&#xa;ELSE&#xd;&#xd;&#xa;$geometry&#xd;&#xd;&#xa;END&#xd;&#xd;&#xa; )" priority="5" centroidInside="0" preserveRotation="1" polygonPlacementFlags="2" centroidWhole="0" rotationAngle="0" maxCurvedCharAngleIn="25" maxCurvedCharAngleOut="-25" fitInPolygonOnly="0" overrunDistance="0" yOffset="-0.5" layerType="PolygonGeometry" offsetUnits="MM" lineAnchorType="0" geometryGeneratorEnabled="1" repeatDistance="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" offsetType="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" repeatDistanceUnits="MM" rotationUnit="AngleDegrees" lineAnchorClipping="0" quadOffset="2" xOffset="0.5" placement="8" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PolygonGeometry" distMapUnitScale="3x:0,0,0,0,0,0"/>
            <rendering fontMaxPixelSize="10000" scaleMin="0" upsidedownLabels="0" zIndex="0" minFeatureSize="0" scaleVisibility="0" maxNumLabels="2000" fontMinPixelSize="3" limitNumLabels="0" labelPerPart="0" scaleMax="0" drawLabels="1" obstacleFactor="1" mergeLines="0" fontLimitPixelSize="0" obstacle="1" unplacedVisibility="0" displayAll="0" obstacleType="1"/>
            <dd_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties" type="Map">
