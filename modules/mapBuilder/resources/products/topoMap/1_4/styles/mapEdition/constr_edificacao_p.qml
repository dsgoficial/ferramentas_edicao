  ...
  <renderer-v2 type="RuleRenderer" referencescale="-1" forceraster="0" symbollevels="0" enableorderby="0">
    <rules key="{af709a54-88ca-4a27-bba5-e0a7ac6ce840}">
      <rule key="{4bdda895-97c4-4ad7-919c-b2b6ccf321c8}" filter=" &quot;visivel&quot; = 1" label="Visível">
        ...
        <rule key="{d1b9f3af-5809-46e6-8d96-894920a8c2a8}" symbol="5" filter="&quot;tipo&quot; = 602 and  &quot;suprimir_bandeira&quot; != 1" label="Templo"/>
        ...
        <rule key="{aa50e822-90c2-43db-ac89-691370d86320}" symbol="13" filter="&quot;tipo&quot; = 2601 and  &quot;suprimir_bandeira&quot; != 1" label="P20430A"/>
      ...
      <rule key="{38ea4f92-0f49-4b54-afc7-857a2873c63e}" symbol="17" filter="ELSE" label="Não visível"/>
    </rules>
    <symbols>
      ...
      <symbol type="marker" force_rhr="0" clip_to_extent="1" alpha="0.4" name="17">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
