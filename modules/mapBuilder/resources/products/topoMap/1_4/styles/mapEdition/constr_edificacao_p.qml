...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling" version="3.24.3-Tisler">
  <renderer-v2 type="RuleRenderer" referencescale="-1" forceraster="0" symbollevels="0" enableorderby="0">
    <rules key="{af709a54-88ca-4a27-bba5-e0a7ac6ce840}">
      <rule key="{4bdda895-97c4-4ad7-919c-b2b6ccf321c8}" filter=" &quot;visivel&quot; = 1" label="Visível">
        <rule key="{55073371-2bcb-4204-962b-25b9718a6ea4}" symbol="0" filter=" (&quot;tipo&quot; in (0, 525, 608, 610, 1212, 1213, 1298, 2029, 2030, 2031) or (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (1, 2, 3, 4, 7, 8, 9, 10, 11, 15, 21, 23, 24, 25)) and &quot;tipo&quot; not in (803, 2429)" description="Edificação operacional" label="P20403A - Genérico Não Importante"/>
        ...
        <rule key="{2f0383e8-e941-4dbf-80dd-979aeecab233}" symbol="12" filter="&quot;tipo&quot; = 2601 and  &quot;suprimir_bandeira&quot; != 1" label="P20430A"/>
        <rule key="{7ccb2fca-e544-4540-81d0-bc49b7d09326}" symbol="13" filter="&quot;tipo&quot; = 1046" label="Chaminé"/>
        <rule key="{63b54aab-2b56-45eb-bc0e-4118677465ac}" symbol="14" filter=" (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (29) and  &quot;suprimir_bandeira&quot; != 1" label="P20435A"/>
        <rule key="{f1a08c62-a732-4ad8-92da-b287df07f287}" symbol="15" filter="ELSE"/>
      </rule>
      <rule key="{38ea4f92-0f49-4b54-afc7-857a2873c63e}" symbol="16" filter="ELSE" label="Não visível"/>
    </rules>
    <symbols>
      ...
      <symbol type="marker" force_rhr="0" clip_to_extent="1" alpha="0.4" name="16">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{39cca942-8408-4fdd-a573-48ac63b66117}">
      <rule key="{9292c918-a693-41e0-8736-547ff8dbdae6}" filter="&quot;tipo&quot; = 1212 and &quot;visivel&quot; = 1" description="Sede operacional de fazenda">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" fontItalic="0" fieldName="texto_edicao" blendMode="0" fontLetterSpacing="0" textOpacity="1" textOrientation="horizontal" fontSizeUnit="Point" fontSize="6" multilineHeight="0.80000000000000004" fontWeight="50" textColor="36,31,33,255" allowHtml="0" legendString="Aa" fontWordSpacing="0" previewBkgrdColor="255,255,255,255" fontKerning="1" fontFamily="Noto Sans" namedStyle="Regular" capitalization="0" isExpression="0" fontUnderline="0" useSubstitutions="0">
            <families/>
            ...
            <text-mask maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSize="0.40000000000000002" maskOpacity="1" maskEnabled="1" maskSizeUnits="MM" maskJoinStyle="128" maskedSymbolLayers=""/>
      ...
      <rule key="{da04dda2-03ac-490e-9155-1aa216fd1440}" filter="&quot;tipo&quot; = 1218 and &quot;visivel&quot; = 1" description="Curral">
        <settings calloutType="simple">
      ...
      <rule key="{fc9de5ba-9e03-4060-8c27-56c6a00a9cc0}" filter="&quot;tipo&quot; not in (1212, 1218) and &quot;visivel&quot; = 1" description="Edificação">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" fontItalic="0" fieldName="texto_edicao" blendMode="0" fontLetterSpacing="0" textOpacity="1" textOrientation="horizontal" fontSizeUnit="Point" fontSize="6" multilineHeight="0.80000000000000004" fontWeight="50" textColor="36,31,33,255" allowHtml="0" legendString="Aa" fontWordSpacing="0" previewBkgrdColor="255,255,255,255" fontKerning="1" fontFamily="Noto Sans" namedStyle="Condensed" capitalization="0" isExpression="0" fontUnderline="0" useSubstitutions="0">
            <families/>
            <text-buffer bufferDraw="0" bufferNoFill="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferBlendMode="0" bufferSizeUnits="MM" bufferColor="255,255,255,255" bufferSize="1" bufferJoinStyle="128"/>
