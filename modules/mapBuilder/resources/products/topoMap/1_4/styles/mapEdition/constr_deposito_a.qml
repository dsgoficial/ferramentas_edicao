...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" referencescale="-1" forceraster="0" symbollevels="0" enableorderby="0">
    <rules key="{f90668d0-bcbf-4ab0-b992-a3a7023aa098}">
      <rule key="{ab6cd03f-78b6-4834-a3f7-0603bccf6b32}" filter="&quot;visivel&quot; = 1">
        <rule symbol="0" label="A20403A" key="{f20c2b3e-2a68-4b94-a517-835ef9a264f0}" filter="&quot;tipo&quot; in (112, 101, 110, 111, 198, 108, 132, 113, 109, 298)" description="Reservatório"/>
        <rule symbol="1" label="Tanque de Saneamento" key="{d844d7ad-7bb3-45e6-9704-f4b1878dc8e4}" filter="&quot;tipo&quot; in (201, 202, 204, 301)"/>
        <rule symbol="2" label="Cisterna" key="{d4480d7d-fe8b-4e17-a4ce-c466f3fb0e75}" filter="&quot;tipo&quot; in (203)"/>
        <rule symbol="3" label="A20214D" key="{a4d71eb4-85cb-4c4a-b104-975029b57333}" filter="&quot;tipo&quot; in (304,305,306, 398)" description="Aterro sanitário"/>
        <rule symbol="4" key="{582ca24f-2794-4040-9626-0dd48d5cb8fd}" filter="ELSE"/>
      </rule>
      <rule symbol="5" label="Não visível" key="{4c8e2242-b399-489d-b52f-2f611ce14d63}" filter="ELSE"/>
    </rules>
    <symbols>
      ...
      <symbol type="fill" force_rhr="0" name="5" alpha="0.4" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{2e001b54-39c6-4992-9360-898324ba5db5}">
      <rule key="{2ca0ee97-08aa-4bd1-8a6b-79b744efe0d0}" filter="&quot;visivel&quot; = 1" description="Depósito">
              ...
              <Option type="Map" name="ddProperties">
                ...
                <Option type="Map" name="properties">
                  <Option type="Map" name="MinimumCalloutLength">
                    <Option type="bool" value="true" name="active"/>
                    <Option type="QString" value="if(  &quot;exibir_linha_rotulo&quot; = 1 ,0,5)" name="expression"/>
                    <Option type="int" value="3" name="type"/>
                  </Option>
                </Option>
                <Option type="QString" value="collection" name="type"/>
