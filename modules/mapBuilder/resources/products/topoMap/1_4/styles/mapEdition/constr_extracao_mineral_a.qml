...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" referencescale="-1" forceraster="0" symbollevels="0" enableorderby="0">
    <rules key="{98312c8a-a7ab-461c-a20e-9167acb375f9}">
      <rule symbol="0" key="{2431908f-038f-4ab9-9ccf-957148967b5a}" filter="visivel = 1"/>
      <rule symbol="1" label="Não visível" key="{6e2cb69b-f1f1-42c8-a04f-29e4e0238972}" filter="ELSE"/>
    </rules>
    <symbols>
      <symbol type="fill" force_rhr="0" name="0" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleLine">
          <Option type="Map">
            ...
            <Option type="QString" value="1;0" name="customdash"/>
      ...
      <symbol type="fill" force_rhr="0" name="1" alpha="0.4" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{538e5a98-4c85-46cb-9bb5-c83cc46a046c}">
      <rule key="{4f200774-8999-40e3-b363-60a523c83a21}" filter="&quot;visivel&quot; = 1">
