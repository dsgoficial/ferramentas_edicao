...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  <renderer-v2 referencescale="-1" enableorderby="0" type="RuleRenderer" forceraster="0" symbollevels="0">
    <rules key="{5adbac42-96ad-4569-9e33-64a725a4a2b7}">
      <rule filter=" &quot;visivel&quot; = 1" key="{85a4068f-9f1d-4ae7-a047-fe2944f76002}" label="Visível">
        ...
        <rule description="Cemitério" symbol="2" filter="tipo = 104" key="{6eae34ca-5e74-4064-9f0a-97e94fa5dace}" label="P20209D"/>
        <rule description="Cemitério" symbol="3" filter="tipo = 106" key="{a131d610-94e3-415b-a512-7976af042905}" label="P20209C"/>
        <rule description="Farol" symbol="4" filter="tipo = 1101" key="{f8cabb25-4ee6-4157-9ff1-97926f42d0c3}" label="Farol"/>
        <rule symbol="5" filter="&quot;tipo&quot; in (1601, 1602, 1603, 1604, 1605, 1606, 1607, 1608, 1609, 1610, 1611, 1612, 1613, 1614)" key="{b1c52ccd-d62b-4217-bcd8-9f0886b016e0}" label="Estação Climatológica Principal"/>
      ...
      <rule symbol="8" filter="ELSE" key="{e9df508d-6afa-474a-9578-1fca9604ec2e}" label="Não visível"/>
    </rules>
    <symbols>
      ...
      <symbol force_rhr="0" clip_to_extent="1" type="marker" alpha="0.4" name="8">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer pass="0" class="SimpleMarker" enabled="1" locked="0">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="254,0,254,255" type="QString" name="color"/>
            <Option value="1" type="QString" name="horizontal_anchor_point"/>
            <Option value="bevel" type="QString" name="joinstyle"/>
            <Option value="circle" type="QString" name="name"/>
            <Option value="0,0" type="QString" name="offset"/>
  ...
  <labeling type="rule-based">
    <rules key="{775bdee7-f5af-4d22-b42e-682f292b6b14}">
      <rule filter="&quot;visivel&quot; = 1" key="{ceb1108e-0402-461f-a0a3-2810354b7e90}">
