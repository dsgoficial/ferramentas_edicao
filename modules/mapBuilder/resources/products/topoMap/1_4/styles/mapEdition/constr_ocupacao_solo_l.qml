...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" referencescale="-1" forceraster="0" symbollevels="0" enableorderby="0">
    <rules key="{4681daff-84d1-423c-a18d-3b71f9ec7106}">
      <rule label="Visível" key="{d1d963ba-db4c-45b8-8807-d960ba725f2f}" filter="&quot;visivel&quot; = 1">
        <rule symbol="0" label="L20307A" key="{097e7f89-03b1-4183-a33d-bcb5fb098278}" filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (3,10)"/>
        <rule symbol="1" key="{c2f1b34a-0f27-491c-87d3-38458d2d504c}" filter="ELSE"/>
      </rule>
      <rule symbol="2" label="Não visível" key="{3efcc757-667f-4916-b8d5-b249c2eb033a}" filter="ELSE"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{2cbf7325-7075-4bc5-b725-c00c30d3bb33}">
      <rule key="{e90e787f-9d0c-45d3-82d5-a47b69c1ef2b}" filter="&quot;visivel&quot; = 1">
        <rule key="{a490c24e-14fa-45eb-a5ef-eee2b871163c}" description="Ocupação do solo">
          <settings calloutType="simple">
            <text-style fontSizeUnit="Point" textOpacity="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="0" legendString="Aa" fontUnderline="0" fontKerning="1" useSubstitutions="0" textColor="36,31,33,255" fontStrikeout="0" multilineHeight="0.80000000000000004" capitalization="0" allowHtml="0" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" fontItalic="0" fontWeight="50" fieldName="texto_edicao" fontLetterSpacing="0" fontFamily="Noto Sans" fontSize="6" namedStyle="Condensed" fontWordSpacing="0" blendMode="0">
              <families/>
              ...
              <text-mask maskSize="0.20000000000000001" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskEnabled="1" maskedSymbolLayers="" maskType="0" maskOpacity="1" maskSizeUnits="MM"/>
            ...
            <placement maxCurvedCharAngleOut="-25" polygonPlacementFlags="2" preserveRotation="1" lineAnchorClipping="0" layerType="LineGeometry" rotationUnit="AngleDegrees" lineAnchorType="0" distMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" dist="0" distUnits="MM" overrunDistance="0" repeatDistanceUnits="MM" centroidInside="0" placementFlags="10" placement="4" yOffset="-0.5" rotationAngle="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" quadOffset="2" repeatDistance="0" fitInPolygonOnly="0" geometryGeneratorType="LineGeometry" xOffset="0.5" geometryGenerator="with_variable(&#xd;&#xd;&#xa; 'moldura',&#xd;&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xd;&#xa;THEN &#xd;&#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xd;&#xa;ELSE&#xd;&#xd;&#xa;$geometry&#xd;&#xd;&#xa;END&#xd;&#xd;&#xa;)" maxCurvedCharAngleIn="25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" overrunDistanceUnit="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" priority="5" geometryGeneratorEnabled="1" offsetType="0"/>
            <rendering unplacedVisibility="0" scaleMin="0" labelPerPart="0" obstacleType="1" maxNumLabels="2000" scaleVisibility="0" mergeLines="0" obstacle="1" upsidedownLabels="0" zIndex="0" limitNumLabels="0" scaleMax="0" minFeatureSize="0" fontMaxPixelSize="10000" obstacleFactor="1" displayAll="0" fontMinPixelSize="3" drawLabels="1" fontLimitPixelSize="0"/>
            <dd_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option type="Map" name="properties">
