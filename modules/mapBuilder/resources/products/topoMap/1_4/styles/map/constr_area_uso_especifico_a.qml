...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" referencescale="-1" type="RuleRenderer">
    <rules key="{98312c8a-a7ab-461c-a20e-9167acb375f9}">
      <rule filter="visivel = 1" symbol="0" key="{7047f196-ddaa-4579-9527-7036f3e71124}"/>
    </rules>
    <symbols>
      ...
      <rule filter="&quot;visivel&quot; = 1" description="Área de uso específico" key="{5b5294f7-2f45-40d7-aa57-ebe585f43011}">
        <settings calloutType="simple">
          <text-style fontFamily="Noto Sans" textColor="36,31,33,255" namedStyle="Condensed" fieldName="texto_edicao" isExpression="0" allowHtml="0" previewBkgrdColor="255,255,255,255" fontStrikeout="0" fontLetterSpacing="0" multilineHeight="0.80000000000000004" legendString="Aa" fontUnderline="0" textOrientation="horizontal" fontWordSpacing="0" fontSizeUnit="Point" fontSize="6" fontWeight="50" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOpacity="1" useSubstitutions="0" blendMode="0" fontItalic="0" fontKerning="1" capitalization="0">
            ...
            <shadow shadowOffsetDist="1" shadowOffsetGlobal="1" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowScale="100" shadowColor="0,0,0,255" shadowDraw="0" shadowOffsetUnit="MM" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowRadiusAlphaOnly="0" shadowUnder="0" shadowBlendMode="6" shadowOffsetAngle="135" shadowOpacity="0.69999999999999996" shadowRadiusUnit="MM" shadowRadius="1.5"/>
            <dd_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
          ...
          <text-format placeDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" multilineAlign="0" decimals="3" formatNumbers="0" autoWrapLength="0" wrapChar="|" addDirectionSymbol="0" leftDirectionSymbol="&lt;" plussign="0" rightDirectionSymbol=">" reverseDirectionSymbol="0"/>
          <placement labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" rotationUnit="AngleDegrees" geometryGenerator="with_variable(&#xd;&#xd;&#xa; 'moldura',&#xd;&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xd;&#xa;THEN &#xd;&#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xd;&#xa;ELSE&#xd;&#xd;&#xa;$geometry&#xd;&#xd;&#xa;END&#xd;&#xd;&#xa;)" polygonPlacementFlags="2" overrunDistanceUnit="MM" repeatDistanceUnits="MM" lineAnchorClipping="0" priority="5" xOffset="0.5" dist="0.40000000000000002" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="0" distUnits="MM" overrunDistance="0" offsetType="0" preserveRotation="1" repeatDistance="0" maxCurvedCharAngleOut="-25" yOffset="-0.5" lineAnchorType="0" geometryGeneratorEnabled="1" centroidWhole="0" placementFlags="10" geometryGeneratorType="PolygonGeometry" quadOffset="2" offsetUnits="MM" fitInPolygonOnly="0" layerType="PolygonGeometry" lineAnchorPercent="0.5"/>
          <rendering fontMaxPixelSize="10000" zIndex="0" displayAll="0" obstacleType="1" obstacleFactor="1" upsidedownLabels="0" limitNumLabels="0" drawLabels="1" minFeatureSize="0" scaleMax="0" obstacle="1" mergeLines="0" unplacedVisibility="0" maxNumLabels="2000" fontLimitPixelSize="0" scaleVisibility="0" fontMinPixelSize="3" labelPerPart="0" scaleMin="0"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" name="name" type="QString"/>
              <Option name="properties" type="Map">
