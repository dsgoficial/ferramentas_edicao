...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  ...
  <labeling type="rule-based">
    <rules key="{dda438e5-787a-4f1e-bd4f-abf60144273b}">
      <rule key="{b6c40aa4-5335-4046-85a2-7e9c138a1032}" filter="&quot;visivel&quot; = 1">
        <rule key="{e1932bd0-4035-43da-9c03-3636057b46c8}" description="Ocupação do solo">
