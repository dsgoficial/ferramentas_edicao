...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" referencescale="-1" forceraster="0" symbollevels="0" enableorderby="0">
    <rules key="{98312c8a-a7ab-461c-a20e-9167acb375f9}">
      <rule symbol="0" key="{6e2cb69b-f1f1-42c8-a04f-29e4e0238972}" filter="visivel = 1"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{72a275f7-e4a1-4591-bb84-3ce5e5c583c7}">
      <rule key="{2a1d918c-7b87-4998-b536-775277745174}" filter="&quot;visivel&quot; = 1" description="Extração mineral a">
