...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  ...
  <labeling type="rule-based">
    <rules key="{4db00132-8d5b-43c2-8271-e0dec12eda70}">
      <rule key="{6f59ef75-c107-427d-9128-e8d0d227e61d}" filter="&quot;visivel&quot; = 1">
        <rule key="{c67c0508-937f-4dab-8380-dd40659f66a5}" description="Ocupação do solo">
