...
<qgis styleCategories="Symbology|Labeling" version="3.38.2-Grenoble" labelsEnabled="1">
  <renderer-v2 symbollevels="0" type="RuleRenderer" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{4681daff-84d1-423c-a18d-3b71f9ec7106}">
      <rule filter="&quot;visivel&quot; = 1" label="Visível" key="{d1d963ba-db4c-45b8-8807-d960ba725f2f}">
        <rule filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 = 3" label="L20307A" key="{097e7f89-03b1-4183-a33d-bcb5fb098278}" symbol="0"/>
    ...
    <symbols>
      <symbol force_rhr="0" frame_rate="10" type="line" is_animated="0" clip_to_extent="1" name="0" alpha="1">
        ...
        <layer pass="0" enabled="1" id="{36312618-26c3-490b-ab67-f38a643ae043}" locked="0" class="SimpleLine">
          <Option type="Map">
      ...
      <symbol force_rhr="0" frame_rate="10" type="line" is_animated="0" clip_to_extent="1" name="1" alpha="1">
        ...
        <layer pass="0" enabled="1" id="{3849dcdd-57e9-477f-9e53-adf9516f7b5c}" locked="0" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
  ...
  <labeling type="rule-based">
    <rules key="{4530e72d-808a-4f65-85e3-ed9678eeebe6}">
      <rule filter="visivel = 1" key="{74b588da-d97f-4057-a94b-e991c3ab1333}" description="Ocupação do solo">
