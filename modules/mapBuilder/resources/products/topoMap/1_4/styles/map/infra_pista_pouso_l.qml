...
<qgis version="3.24.3-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  ...
  <labeling type="rule-based">
    <rules key="{564980e7-1a76-4b24-95d0-8eb2f5bde0a0}">
      <rule description="Pista de Pouso" key="{214259c7-f854-4d6e-9aba-daa7810e847f}" filter="&quot;visivel&quot; = 1">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" isExpression="0" useSubstitutions="0" fieldName="texto_edicao" fontWordSpacing="0" fontFamily="Noto Sans" textOrientation="horizontal" fontKerning="1" fontLetterSpacing="0" fontItalic="0" allowHtml="0" previewBkgrdColor="255,255,255,255" fontSizeUnit="Point" fontSize="7" textOpacity="1" legendString="Aa" multilineHeight="0.80000000000000004" namedStyle="Condensed" blendMode="0" textColor="89,94,168,255" fontWeight="50" fontUnderline="0" fontStrikeout="0">
            <families/>
