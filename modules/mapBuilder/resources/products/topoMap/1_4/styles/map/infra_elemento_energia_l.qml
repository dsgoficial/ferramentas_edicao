...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="0" version="3.24.3-Tisler">
  <renderer-v2 type="RuleRenderer" enableorderby="0" forceraster="0" symbollevels="0" referencescale="-1">
    <rules key="{71d0fe17-e5ac-4d25-b377-45492998fde4}">
      <rule key="{b7ae42d8-eb54-43af-9da8-3821db216111}" filter="&quot;visivel&quot; = 1">
        <rule key="{38cdbd8e-f746-40df-98da-0ecf746da3bd}" symbol="0" filter="ELSE"/>
        <rule key="{0555275e-d552-4cb7-93e2-98770713f942}" symbol="1" filter="&quot;tipo&quot; in (302,303)" label="L10115A"/>
      </rule>
    </rules>
    <symbols>
      <symbol force_rhr="0" type="line" alpha="1" clip_to_extent="1" name="0">
        ...
        <layer class="SimpleLine" enabled="1" pass="0" locked="0">
          <Option type="Map">
            ...
            <Option value="255,26,1,255" type="QString" name="line_color"/>
      ...
      <symbol force_rhr="0" type="line" alpha="1" clip_to_extent="1" name="1">
        ...
        <layer class="SimpleLine" enabled="1" pass="0" locked="0">
          <Option type="Map">
            ...
            <Option value="0" type="QString" name="draw_inside_polygon"/>
            <Option value="bevel" type="QString" name="joinstyle"/>
            <Option value="56,70,157,255" type="QString" name="line_color"/>
            <Option value="solid" type="QString" name="line_style"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style useSubstitutions="0" fontStrikeout="0" namedStyle="Regular" fontItalic="0" fontUnderline="0" fieldName="nome" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontLetterSpacing="0" fontFamily="Arial" isExpression="0" legendString="Aa" fontKerning="1" fontSize="6" previewBkgrdColor="255,255,255,255" textColor="0,0,0,255" blendMode="0" textOpacity="1" fontWordSpacing="0" fontSizeUnit="Point" fontWeight="50" multilineHeight="1" capitalization="0" allowHtml="0">
        <families/>
        ...
        <text-mask maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskOpacity="1" maskedSymbolLayers="" maskJoinStyle="128" maskSize="1.5" maskEnabled="0" maskType="0" maskSizeUnits="MM"/>
      ...
      <placement lineAnchorPercent="0.5" geometryGeneratorType="PointGeometry" layerType="LineGeometry" maxCurvedCharAngleOut="-25" rotationUnit="AngleDegrees" yOffset="0" rotationAngle="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" distUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" lineAnchorClipping="0" preserveRotation="1" centroidWhole="0" offsetUnits="MM" maxCurvedCharAngleIn="25" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" centroidInside="0" repeatDistanceUnits="MM" dist="0" priority="5" placement="2" quadOffset="4" geometryGenerator="" offsetType="0" overrunDistanceUnit="MM" lineAnchorType="0" xOffset="0" polygonPlacementFlags="2" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" geometryGeneratorEnabled="0"/>
