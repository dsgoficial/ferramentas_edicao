...
<qgis styleCategories="Symbology|Labeling" version="3.38.2-Grenoble" labelsEnabled="1">
  <renderer-v2 symbollevels="0" type="RuleRenderer" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{7688ed0d-5165-4098-8ca9-83654a6e5bc7}">
      <rule filter="&quot;visivel&quot; = 1" label="Visível" key="{0668bda0-1027-4348-84f1-d8f605ee52a2}">
        <rule filter="&quot;tipo&quot; in (9, 10, 11)" label="Queda dágua" key="{f3342823-0257-4a58-8ff0-fc0b1d1a05d3}" symbol="0"/>
        <rule filter="&quot;tipo&quot; = 12" label="Corredeira" key="{ac214f5a-8815-4f6b-9c2c-8cdad2ad9f91}" symbol="1"/>
        <rule filter="ELSE" key="{6f8f9c58-7213-447e-a47e-b15f14508628}" symbol="2"/>
      </rule>
    </rules>
    <symbols>
      <symbol force_rhr="0" frame_rate="10" type="line" is_animated="0" clip_to_extent="1" name="0" alpha="1">
        ...
        <layer pass="0" enabled="1" id="{312f8a2e-42ca-4129-af32-f4cf682ae301}" locked="0" class="SimpleLine">
          <Option type="Map">
      ...
      <symbol force_rhr="0" frame_rate="10" type="line" is_animated="0" clip_to_extent="1" name="1" alpha="1">
        ...
        <layer pass="0" enabled="1" id="{e1b2914f-17b1-48db-a9d3-b9317fae111f}" locked="0" class="HashLine">
          <Option type="Map">
            <Option type="QString" value="4" name="average_angle_length"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="average_angle_map_unit_scale"/>
            <Option type="QString" value="MM" name="average_angle_unit"/>
            <Option type="QString" value="0" name="hash_angle"/>
            <Option type="QString" value="1.3" name="hash_length"/>
            ...
            <Option type="QString" value="0.5" name="interval"/>
          ...
          <symbol force_rhr="0" frame_rate="10" type="line" is_animated="0" clip_to_extent="1" name="@1@0" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
            ...
            <layer pass="0" enabled="1" id="{c1807e2f-2875-4898-a58a-22b19a02f094}" locked="0" class="SimpleLine">
              <Option type="Map">
                <Option type="QString" value="0" name="align_dash_pattern"/>
                <Option type="QString" value="square" name="capstyle"/>
                <Option type="QString" value="5;2" name="customdash"/>
      ...
      <symbol force_rhr="0" frame_rate="10" type="line" is_animated="0" clip_to_extent="1" name="2" alpha="1">
        ...
        <layer pass="0" enabled="1" id="{f32dc94e-738a-4b06-bfcb-5f792339d612}" locked="0" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
  ...
  <labeling type="rule-based">
    <rules key="{3e050feb-60ac-4c40-afcf-159af97bd66f}">
      <rule filter="&quot;tipo&quot; in (9, 10, 11, 12) and &quot;visivel&quot; = 1" key="{8fbaad56-4eb0-43e7-9ebd-87f97d5e5131}" description="Corredeira e queda dágua">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255,rgb:1,1,1,1" fontKerning="1" fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" forcedBold="0" multilineHeightUnit="Percentage" tabStopDistance="80" tabStopDistanceMapUnitScale="3x:0,0,0,0,0,0" fontLetterSpacing="0" fontItalic="1" namedStyle="Condensed Italic" fontStrikeout="0" isExpression="0" useSubstitutions="0" textOrientation="horizontal" blendMode="0" textOpacity="1" legendString="Aa" tabStopDistanceUnit="Point" textColor="0,160,223,255,rgb:0,0.62745098039215685,0.87450980392156863,1" fontSize="6" fontFamily="Noto Sans" fieldName="texto_edicao" fontWordSpacing="0" fontSizeUnit="Point" fontWeight="50" multilineHeight="0.80000000000000004" capitalization="0" forcedItalic="0" allowHtml="0">
            <families/>
            <text-buffer bufferOpacity="1" bufferJoinStyle="128" bufferNoFill="1" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="0.20000000000000001" bufferColor="255,255,255,255,rgb:1,1,1,1" bufferBlendMode="0" bufferDraw="0"/>
