...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="0" version="3.38.2-Grenoble">
  <renderer-v2 type="RuleRenderer" symbollevels="0" enableorderby="0" referencescale="-1" forceraster="0">
    <rules key="{96ff0596-55d0-456b-aedc-671e575df197}">
      <rule filter="&quot;visivel&quot; = 1" key="{98c14ced-f508-439b-b056-57f7ab6ec2ff}">
        <rule key="{217ef39e-ebc0-4048-ab43-cf16e124aa30}" symbol="0"/>
      </rule>
    </rules>
    <symbols>
      <symbol alpha="1" is_animated="0" type="line" force_rhr="0" name="0" clip_to_extent="1" frame_rate="10">
        ...
        <layer locked="0" id="{31c3e0d0-673c-4697-8daa-473b1611e470}" class="SimpleLine" pass="0" enabled="1">
          <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol alpha="1" is_animated="0" type="line" force_rhr="0" name="" clip_to_extent="1" frame_rate="10">
        ...
        <layer locked="0" id="{8bf88dbb-0f65-4cf1-b5b5-0e0f5c3daeb1}" class="SimpleLine" pass="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
  ...
  <labeling type="rule-based">
    <rules key="{9dd7fca3-4fcd-41e3-890a-9dcf9c19b0a8}">
      <rule description="Vala" key="{dc5cc874-5d5e-4385-a2b6-e211975b1b59}">
        <settings calloutType="simple">
          ...
          <placement maxCurvedCharAngleIn="25" xOffset="0" priority="5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" maximumDistanceUnit="MM" prioritization="PreferCloser" quadOffset="4" preserveRotation="1" geometryGeneratorType="LineGeometry" layerType="LineGeometry" repeatDistance="0" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" rotationUnit="AngleDegrees" polygonPlacementFlags="2" fitInPolygonOnly="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" lineAnchorType="0" placement="3" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" allowDegraded="1" lineAnchorTextPoint="CenterOfText" maximumDistanceMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetUnits="MM" centroidInside="0" geometryGeneratorEnabled="1" repeatDistanceUnits="MM" centroidWhole="0" lineAnchorClipping="0" overrunDistanceUnit="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" lineAnchorPercent="0.5" maximumDistance="0" yOffset="0" overlapHandling="AllowOverlapIfRequired" offsetType="0" dist="0" placementFlags="10" overrunDistance="0"/>
          <rendering obstacleType="1" zIndex="0" unplacedVisibility="0" fontMaxPixelSize="10000" scaleMin="0" scaleMax="0" limitNumLabels="0" labelPerPart="0" scaleVisibility="0" mergeLines="0" upsidedownLabels="0" obstacleFactor="1" fontMinPixelSize="3" obstacle="1" maxNumLabels="2000" minFeatureSize="0" drawLabels="1" fontLimitPixelSize="0"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" value="" name="name"/>
              <Option type="Map" name="properties">
