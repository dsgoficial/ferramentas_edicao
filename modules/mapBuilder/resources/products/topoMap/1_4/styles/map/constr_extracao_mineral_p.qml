...
<qgis styleCategories="Symbology|Labeling" version="3.34.0-Prizren" labelsEnabled="1">
  <renderer-v2 referencescale="-1" forceraster="0" type="RuleRenderer" symbollevels="0" enableorderby="0">
    <rules key="{4697f112-4027-4bf7-b246-91c696f3c4ed}">
      <rule filter="&quot;visivel&quot; = 1" key="{b14bb858-e62b-4bb7-89af-cd399f8effa2}" label="Visível">
        <rule filter=" &quot;situacao_fisica&quot; in (0,3)" key="{9c7bae1c-6173-44d0-8b16-c53fa61cf9f5}" label="Construído" symbol="0"/>
        <rule filter="ELSE" key="{a78dcd09-4a3a-40db-9974-2cc6a47b3896}" label="Não construído" symbol="1"/>
      </rule>
    </rules>
    <symbols>
      <symbol type="marker" clip_to_extent="1" force_rhr="0" name="0" frame_rate="10" is_animated="0" alpha="1">
        ...
        <layer pass="0" id="{bf66aabd-08db-471f-b02c-628ddd2b782f}" class="SvgMarker" enabled="1" locked="0">
          <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol type="marker" clip_to_extent="1" force_rhr="0" name="" frame_rate="10" is_animated="0" alpha="1">
        ...
        <layer pass="0" id="{44b8e138-deb3-4270-accc-c0bbda3dc4a0}" class="SimpleMarker" enabled="1" locked="0">
          <Option type="Map">
            <Option type="QString" name="angle" value="0"/>
  ...
  <labeling type="rule-based">
    <rules key="{8d74f70c-9f11-4a6e-947f-95abf19dbcdf}">
      <rule filter="&quot;visivel&quot; = 1" key="{2aa45574-c62a-402b-8332-1d89e40dd90e}">
        <settings calloutType="simple">
          <text-style forcedItalic="0" fontWeight="50" allowHtml="0" fontItalic="0" capitalization="0" fieldName="texto_edicao" blendMode="0" fontStrikeout="0" textColor="75,75,75,255" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Condensed" fontFamily="Noto Sans" previewBkgrdColor="255,255,255,255" fontKerning="1" useSubstitutions="0" forcedBold="0" textOpacity="1" isExpression="0" fontLetterSpacing="0" fontSize="6" fontUnderline="0" legendString="Aa" multilineHeight="0.80000000000000004" fontSizeUnit="Point" fontWordSpacing="0" multilineHeightUnit="Percentage">
            <families/>
