  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{62a3dea4-17b6-4639-a67e-4acc783c4aec}">
      <rule filter="visivel = 1" key="{dc04f51f-52ab-4781-a847-baf3ae769b72}">
        ...
        <rule filter="tipo = 9 and &quot;visivel&quot; = 1 and situacao_fisica in (0,1,2,3,4)" label="Pista de pouso Constr ou Desc" key="{70e76cbb-c087-493f-a0ab-f1dd6ab7f163}" symbol="1"/>
    ...
    <symbols>
      <symbol force_rhr="0" frame_rate="10" type="marker" is_animated="0" clip_to_extent="1" name="0" alpha="1">
        ...
        <layer pass="0" enabled="1" id="{afa1512f-2477-49ab-96f3-811ce34bb6c2}" locked="0" class="SvgMarker">
          <Option type="Map">
      ...
      <symbol force_rhr="0" frame_rate="10" type="marker" is_animated="0" clip_to_extent="1" name="1" alpha="1">
        ...
        <layer pass="0" enabled="1" id="{3547cd1d-082e-4efd-b80c-adf17f7cc4cf}" locked="0" class="SvgMarker">
          <Option type="Map">
            <Option type="QString" value="0" name="angle"/>
            ...
            <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
            <Option type="QString" value="MM" name="offset_unit"/>
            <Option type="QString" value="57,70,157,255,rgb:0.22352941176470589,0.27450980392156865,0.61568627450980395,1" name="outline_color"/>
            <Option type="QString" value="0" name="outline_width"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="outline_width_map_unit_scale"/>
            <Option type="QString" value="MM" name="outline_width_unit"/>
            <Option name="parameters"/>
      ...
      <symbol force_rhr="0" frame_rate="10" type="marker" is_animated="0" clip_to_extent="1" name="2" alpha="1">
        ...
        <layer pass="0" enabled="1" id="{f1e60c8b-f207-4f54-ada5-af7da1976f57}" locked="0" class="SimpleMarker">
          <Option type="Map">
            <Option type="QString" value="0" name="angle"/>
