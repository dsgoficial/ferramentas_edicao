...
<qgis version="3.24.3-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  <renderer-v2 symbollevels="0" type="RuleRenderer" referencescale="-1" forceraster="0" enableorderby="0">
    <rules key="{62a3dea4-17b6-4639-a67e-4acc783c4aec}">
      <rule key="{dc04f51f-52ab-4781-a847-baf3ae769b72}" filter="visivel = 1">
        <rule symbol="0" label="Heliponto" key="{a0c616e9-fa55-4381-b0a7-d97c14382965}" filter="tipo = 11 and &quot;visivel&quot; = 1 and situacao_fisica in (0,3)"/>
        <rule symbol="1" label="Pista de pouso Constr ou Desc" key="{70e76cbb-c087-493f-a0ab-f1dd6ab7f163}" filter="tipo = 9 and &quot;visivel&quot; = 1 and situacao_fisica in (0,1,2,3,4)"/>
        <rule symbol="2" key="{94bb1444-5afb-462d-a90c-527d08d84045}" filter="ELSE"/>
      </rule>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{433bf7d5-9134-4917-bdaa-dbc5e35c5959}">
      <rule description="Pista de pouso" key="{4a9f78bc-ba7b-4916-a320-4b0413ea38db}">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" isExpression="0" useSubstitutions="0" fieldName="texto_edicao" fontWordSpacing="0" fontFamily="Noto Sans" textOrientation="horizontal" fontKerning="1" fontLetterSpacing="0" fontItalic="0" allowHtml="0" previewBkgrdColor="255,255,255,255" fontSizeUnit="Point" fontSize="6" textOpacity="1" legendString="Aa" multilineHeight="0.80000000000000004" namedStyle="Condensed" blendMode="0" textColor="89,94,168,255" fontWeight="50" fontUnderline="0" fontStrikeout="0">
            <families/>
