...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  <renderer-v2 type="RuleRenderer" enableorderby="0" forceraster="0" symbollevels="0" referencescale="-1">
    <rules key="{ea96e2dd-153d-4f78-9dce-a869c560c2a4}">
      <rule key="{7269d453-0468-4914-bc91-1dcd457f1de2}" filter="&quot;visivel&quot; = 1" label="Visível">
        <rule key="{6a32763d-7f6c-46f0-9c0e-ba697f96bf02}" symbol="0" filter="&quot;tipo&quot; = 8" label="Rocha em água"/>
        <rule key="{797a0e9e-8dba-4922-b847-16ffb024e774}" symbol="1" filter="&quot;tipo&quot; in (9, 10, 11)" label="Queda d'água"/>
        <rule key="{e320e23b-e2ae-48db-9d5e-c4445aae8194}" symbol="2" filter="&quot;tipo&quot; = 12" label="Corredeira"/>
        <rule key="{34502030-54f3-4822-8ee3-c95cdccc5780}" symbol="3" filter="ELSE"/>
      </rule>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{c06cdabf-5518-4074-9225-dd7ceadd2f52}">
      <rule key="{711a611e-d67a-4770-82cb-d04e306c48f0}" description="Corredeira e queda dágua" filter="&quot;tipo&quot; in (9, 10, 11, 12) and &quot;visivel&quot; = 1">
        <settings calloutType="simple">
          <text-style useSubstitutions="0" fontStrikeout="0" namedStyle="Condensed Italic" fontItalic="1" fontUnderline="0" fieldName="texto_edicao" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontLetterSpacing="0" fontFamily="Noto Sans" isExpression="0" legendString="Aa" fontKerning="1" fontSize="6" previewBkgrdColor="255,255,255,255" textColor="0,160,223,255" blendMode="0" textOpacity="1" fontWordSpacing="0" fontSizeUnit="Point" fontWeight="50" multilineHeight="0.80000000000000004" capitalization="0" allowHtml="0">
            <families/>
