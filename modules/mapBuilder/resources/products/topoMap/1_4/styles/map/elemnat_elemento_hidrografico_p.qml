...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  <renderer-v2 enableorderby="0" type="RuleRenderer" forceraster="0" referencescale="-1" symbollevels="0">
    <rules key="{ea96e2dd-153d-4f78-9dce-a869c560c2a4}">
      <rule key="{7269d453-0468-4914-bc91-1dcd457f1de2}" label="Visível" filter="&quot;visivel&quot; = 1">
        <rule key="{6a32763d-7f6c-46f0-9c0e-ba697f96bf02}" symbol="0" label="Rocha em água" filter="&quot;tipo&quot; = 8"/>
        <rule key="{830caa70-6d57-4fe1-a2df-e69c30983698}" symbol="1" description="Olho dágua perm" label="Poço dágua e Poço artesiano - perm" filter="tipo in (1, 2)"/>
        <rule key="{faeb43df-3f87-4af3-9546-07112da87592}" symbol="2" description="Olho dágua perm" label="Olho dágua perm" filter="tipo = 3"/>
        <rule key="{46da6783-6371-4590-b3fe-23b112660dda}" symbol="3" description="Olha dágua temp" label="Olha dágua temp" filter="tipo = 4"/>
        <rule key="{797a0e9e-8dba-4922-b847-16ffb024e774}" symbol="4" label="Queda d'água" filter="&quot;tipo&quot; in (9, 10, 11)"/>
        <rule key="{e320e23b-e2ae-48db-9d5e-c4445aae8194}" symbol="5" label="Corredeira" filter="&quot;tipo&quot; = 12"/>
        <rule key="{34502030-54f3-4822-8ee3-c95cdccc5780}" symbol="6" filter="ELSE"/>
      </rule>
    </rules>
    <symbols>
      ...
      <symbol name="1" alpha="1" clip_to_extent="1" type="marker" force_rhr="0">
        ...
        <layer class="SimpleMarker" enabled="1" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="color" type="QString" value="4,161,223,255"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
      ...
      <symbol name="5" alpha="1" clip_to_extent="1" type="marker" force_rhr="0">
        ...
        <layer class="SvgMarker" enabled="1" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
            <Option name="outline_color" type="QString" value="0,160,222,255"/>
            <Option name="outline_width" type="QString" value="0"/>
            <Option name="outline_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="outline_width_unit" type="QString" value="MM"/>
            <Option name="parameters"/>
          ...
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="0,160,222,255" k="outline_color"/>
          <prop v="0" k="outline_width"/>
          <prop v="3x:0,0,0,0,0,0" k="outline_width_map_unit_scale"/>
          <prop v="MM" k="outline_width_unit"/>
          <prop v="" k="parameters"/>
  ...
  <labeling type="rule-based">
    <rules key="{571710bf-a47d-4da4-9516-71c192dcf1d8}">
      <rule key="{1ec03e56-66e7-44b9-b370-abc3b8cec03b}" description="Corredeira e queda dágua" filter="&quot;tipo&quot; in (9, 10, 11, 12) and &quot;visivel&quot; = 1">
        <settings calloutType="simple">
          <text-style fontWeight="50" namedStyle="Condensed Italic" textOpacity="1" useSubstitutions="0" fontWordSpacing="0" multilineHeight="0.80000000000000004" fontFamily="Noto Sans" fieldName="texto_edicao" legendString="Aa" previewBkgrdColor="255,255,255,255" allowHtml="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" fontStrikeout="0" fontItalic="1" textOrientation="horizontal" blendMode="0" fontSize="6" fontSizeUnit="Point" fontUnderline="0" fontKerning="1" isExpression="0" fontLetterSpacing="0" textColor="0,160,223,255">
            <families/>
            <text-buffer bufferSize="1" bufferColor="255,255,255,255" bufferNoFill="1" bufferBlendMode="0" bufferJoinStyle="128" bufferOpacity="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferDraw="0" bufferSizeUnits="MM"/>
            <text-mask maskEnabled="1" maskOpacity="1" maskJoinStyle="128" maskSize="0.20000000000000001" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskedSymbolLayers="" maskSizeUnits="MM" maskType="0"/>
            <background shapeOffsetY="0" shapeSizeX="0" shapeBorderWidth="0" shapeRotation="0" shapeJoinStyle="64" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSVGFile="" shapeFillColor="255,255,255,255" shapeType="0" shapeRadiiY="0" shapeRadiiX="0" shapeOffsetUnit="MM" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeBorderWidthUnit="MM" shapeOffsetX="0" shapeRotationType="0" shapeDraw="0" shapeSizeUnit="MM" shapeBlendMode="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeOpacity="1" shapeRadiiUnit="MM" shapeSizeType="0">
            ...
            <shadow shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowUnder="0" shadowOffsetGlobal="1" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowColor="0,0,0,255" shadowRadius="1.5" shadowOffsetDist="1" shadowOffsetUnit="MM" shadowRadiusAlphaOnly="0" shadowScale="100" shadowDraw="0" shadowRadiusUnit="MM" shadowOpacity="0.69999999999999996" shadowBlendMode="6" shadowOffsetAngle="135"/>
            <dd_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
          ...
          <text-format autoWrapLength="0" wrapChar="|" useMaxLineLengthForAutoWrap="1" leftDirectionSymbol="&lt;" multilineAlign="0" placeDirectionSymbol="0" plussign="0" formatNumbers="0" addDirectionSymbol="0" reverseDirectionSymbol="0" decimals="3" rightDirectionSymbol=">"/>
          <placement priority="5" quadOffset="2" geometryGeneratorEnabled="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" offsetType="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" repeatDistance="0" overrunDistanceUnit="MM" layerType="PointGeometry" dist="0" distMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" lineAnchorClipping="0" fitInPolygonOnly="0" maxCurvedCharAngleIn="25" lineAnchorType="0" overrunDistance="0" rotationUnit="AngleDegrees" geometryGenerator="with_variable(&#xd;&#xd;&#xa; 'moldura',&#xd;&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xd;&#xa;THEN &#xd;&#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xd;&#xa;ELSE&#xd;&#xd;&#xa;$geometry&#xd;&#xd;&#xa;END&#xd;&#xd;&#xa;)" polygonPlacementFlags="2" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" repeatDistanceUnits="MM" xOffset="0.5" geometryGeneratorType="PointGeometry" rotationAngle="0" placement="0" centroidInside="0" yOffset="-0.5" placementFlags="10" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" centroidWhole="0" maxCurvedCharAngleOut="-25"/>
          <rendering upsidedownLabels="0" minFeatureSize="0" fontMinPixelSize="3" unplacedVisibility="0" fontLimitPixelSize="0" obstacleType="1" obstacle="1" scaleVisibility="0" obstacleFactor="1" fontMaxPixelSize="10000" displayAll="0" mergeLines="0" limitNumLabels="0" scaleMin="0" zIndex="0" maxNumLabels="2000" scaleMax="0" labelPerPart="0" drawLabels="1"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" type="QString" value=""/>
              <Option name="properties" type="Map">
