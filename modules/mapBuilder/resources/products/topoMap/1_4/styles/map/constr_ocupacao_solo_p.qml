...
<qgis version="3.24.3-Tisler" styleCategories="Symbology|Labeling" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{75730559-d610-42d2-87ca-7105e65785fc}">
      <rule key="{390c111c-6f28-4575-bf6c-0a5a38d1991f}" filter="&quot;visivel&quot; = 1">
        <settings calloutType="simple">
          <text-style fontSize="6" isExpression="0" blendMode="0" fontUnderline="0" previewBkgrdColor="255,255,255,255" legendString="Aa" fontWordSpacing="0" fontLetterSpacing="0" useSubstitutions="0" allowHtml="0" fontKerning="1" fontFamily="Noto Sans" textColor="75,75,75,255" textOpacity="1" fontItalic="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" fieldName="texto_edicao" capitalization="0" multilineHeight="0.80000000000000004" fontStrikeout="0" fontWeight="50" textOrientation="horizontal" namedStyle="Condensed">
            <families/>
