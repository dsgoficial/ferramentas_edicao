...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  <renderer-v2 referencescale="-1" enableorderby="0" type="RuleRenderer" forceraster="0" symbollevels="0">
    <rules key="{ec7e5b7e-0649-43c5-98ad-c84f432d69cd}">
      ...
      <rule symbol="6" filter="ELSE" key="{8f0bc6a0-1f5e-45e3-8d82-d5f13d10ccb2}" label="Não visível"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{44eeeae0-7470-45e9-8188-cf8d3567a402}">
      <rule filter="indice = 1 and visivel = 1 AND &quot;dentro_massa_dagua&quot; not in (1)" key="{725718fd-e32d-4b91-9293-e4a0fa43938c}">
        <settings calloutType="simple">
          <text-style fontStrikeout="0" textOpacity="1" blendMode="0" allowHtml="0" fontUnderline="0" fieldName="texto_edicao" fontWeight="50" fontLetterSpacing="0" useSubstitutions="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontKerning="1" fontItalic="1" fontWordSpacing="0" textColor="166,43,51,255" fontFamily="Noto Sans" isExpression="0" legendString="Aa" previewBkgrdColor="255,255,255,255" fontSizeUnit="Point" textOrientation="horizontal" namedStyle="Condensed Italic" multilineHeight="1" capitalization="1" fontSize="7">
            ...
            <text-mask maskOpacity="1" maskSizeUnits="MM" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskType="0" maskSize="0.90000000000000002" maskJoinStyle="128" maskedSymbolLayers="elemnat_curva_nivel_l_b6f00372_ea99_42ec_a460_8b2d49f75168,{726ee8af-3df0-44d0-90db-829b9792358b},0;elemnat_curva_nivel_l_07eba696_3eb3_4834_b55c_16a2640e595f,{25710cad-1fb3-44d5-9456-1335a0349db3},0;elemnat_curva_nivel_l_07eba696_3eb3_4834_b55c_16a2640e595f,{726ee8af-3df0-44d0-90db-829b9792358b},0" maskEnabled="1"/>
