  ...
  <renderer-v2 type="RuleRenderer" referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0">
    <rules key="{56b9a550-d8af-4e2b-a20c-06cfb7818973}">
      <rule label="Visivel" key="{5f6db61d-9076-4f40-9e05-302906dffdfd}" filter="visivel = 1">
        <rule symbol="0" label="Ciclovia" key="{4195075d-e236-41ac-bad4-f03f52199476}" filter="&quot;tipo&quot; = 2"/>
        <rule symbol="1" label="Rua pedestre (acesso)" key="{370aaa5b-2bc3-4ae0-829f-b826e71debec}" filter="&quot;tipo&quot; = 1"/>
        <rule symbol="2" key="{048a1faf-06c9-4c04-9a7e-c8807914b31a}" filter="ELSE"/>
      </rule>
      <rule symbol="3" label="Não visível" key="{62c5f13b-b36a-49a7-8e59-ba62a3fbb380}" filter="ELSE"/>
    </rules>
    <symbols>
      ...
      <symbol type="line" alpha="0.49" force_rhr="0" name="3" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
