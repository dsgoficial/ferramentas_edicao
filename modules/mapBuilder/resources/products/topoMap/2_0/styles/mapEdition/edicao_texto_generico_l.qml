...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  ...
  <labeling type="rule-based">
    <rules key="{354867d4-f450-4a9c-8085-4af06d70d02f}">
      <rule description="Texto genérico" key="{db5114fe-9779-4ec5-8fbe-0e97083888df}">
        <settings calloutType="simple">
          <text-style fontUnderline="0" fontSize="10" legendString="Aa" namedStyle="Regular" multilineHeight="1" useSubstitutions="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWeight="50" capitalization="0" previewBkgrdColor="255,255,255,255" fontSizeUnit="Point" fontStrikeout="0" fontKerning="1" allowHtml="0" isExpression="0" fontWordSpacing="0" fontItalic="0" fontLetterSpacing="0" blendMode="0" textColor="0,0,0,255" textOpacity="1" fontFamily="Noto Sans" textOrientation="horizontal" fieldName="texto_edicao">
            <families/>
          ...
          <text-format placeDirectionSymbol="0" plussign="0" leftDirectionSymbol="&lt;" reverseDirectionSymbol="0" formatNumbers="0" decimals="3" useMaxLineLengthForAutoWrap="1" multilineAlign="4" wrapChar="" autoWrapLength="0" rightDirectionSymbol=">" addDirectionSymbol="0"/>
          <placement priority="10" lineAnchorType="0" xOffset="0" placement="3" repeatDistanceUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" centroidWhole="0" dist="0" lineAnchorPercent="0.5" rotationAngle="0" lineAnchorClipping="0" maxCurvedCharAngleOut="-25" polygonPlacementFlags="2" repeatDistance="0" fitInPolygonOnly="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" quadOffset="4" distUnits="MM" centroidInside="0" offsetType="0" maxCurvedCharAngleIn="25" placementFlags="9" layerType="LineGeometry" offsetUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" rotationUnit="AngleDegrees" geometryGeneratorType="LineGeometry" overrunDistanceUnit="MM" geometryGenerator="with_variable(&#xd;&#xd;&#xa; 'moldura',&#xd;&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xd;&#xa;THEN &#xd;&#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xd;&#xa;ELSE&#xd;&#xd;&#xa;$geometry&#xd;&#xd;&#xa;END&#xd;&#xd;&#xa;)" geometryGeneratorEnabled="1"/>
          <rendering obstacle="0" scaleVisibility="0" drawLabels="1" fontMaxPixelSize="10000" zIndex="0" scaleMin="0" limitNumLabels="0" upsidedownLabels="0" displayAll="0" minFeatureSize="0" obstacleFactor="1" labelPerPart="0" fontMinPixelSize="3" mergeLines="0" unplacedVisibility="0" fontLimitPixelSize="0" scaleMax="0" maxNumLabels="2000" obstacleType="1"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" name="name" type="QString"/>
              <Option name="properties" type="Map">
                <Option name="Color" type="Map">
                  ...
                  <Option value="cor" name="field" type="QString"/>
                  <Option value="2" name="type" type="int"/>
                </Option>
                <Option name="FontLetterSpacing" type="Map">
                  <Option value="true" name="active" type="bool"/>
                  <Option value="espacamento" name="field" type="QString"/>
                  <Option value="2" name="type" type="int"/>
                </Option>
                <Option name="FontStyle" type="Map">
                  <Option value="true" name="active" type="bool"/>
                  <Option value="estilo_fonte" name="field" type="QString"/>
                  <Option value="2" name="type" type="int"/>
                </Option>
