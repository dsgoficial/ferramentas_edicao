...
<qgis version="3.24.3-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  <renderer-v2 referencescale="-1" symbollevels="0" type="RuleRenderer" enableorderby="0" forceraster="0">
    <rules key="{15e09ec0-9841-4520-b07a-26e1ce1469e9}">
      <rule filter=" &quot;visivel&quot; = 1" label="Visível" key="{dd502e66-043d-4cdc-b98a-e7b7d0ffe2eb}">
        <rule filter="&quot;tipo&quot; in (101, 110, 108, 111, 112, 132, 198)" label="P20214E" symbol="0" key="{7cd9d25e-c353-460b-9708-b4f3f0dcd74f}" description="Galpão, armazém"/>
        <rule filter="&quot;tipo&quot; = 109" label="P20214A" symbol="1" key="{9578b293-d8bc-4df0-9394-00e3dc45ca84}"/>
        <rule filter="&quot;tipo&quot; in (113, 298, 306, 305, 304, 398)" label="P20214B" symbol="2" key="{c985b851-ad25-4a76-9625-5c2552703ea0}"/>
        <rule filter="&quot;tipo&quot; in (201,204,301)" label="P20214C" symbol="3" key="{f2dbd971-2a05-4177-a181-42a55334620f}" description="Tanque dagua"/>
        <rule filter="&quot;tipo&quot; = 202" label="P10704A" symbol="4" key="{2de32ca8-9fc1-41c9-a306-3cfefb65aa34}"/>
        <rule filter="&quot;tipo&quot; = 203" label="P10704B" symbol="5" key="{d4f82235-073f-404c-a548-19a152bbb46d}" description="Cisterna"/>
        <rule filter="ELSE" symbol="6" key="{93e1af9a-e884-4697-9b99-1670f82aa670}"/>
      </rule>
      <rule filter="ELSE" label="Não visível" symbol="7" key="{6be90dcb-8a33-4760-8366-126b58834b5a}"/>
    </rules>
    <symbols>
      ...
      <symbol type="marker" force_rhr="0" clip_to_extent="1" name="4" alpha="1">
        ...
        <layer pass="0" class="SvgMarker" locked="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="0" name="angle"/>
            <Option type="QString" value="0,160,222,255" name="color"/>
      ...
      <symbol type="marker" force_rhr="0" clip_to_extent="1" name="7" alpha="0.4">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{1df0d6ba-f48a-45c6-9589-da716505f6ef}">
      <rule filter="&quot;visivel&quot; = 1" key="{55209d5a-6db6-494d-96ef-ed33a6e23dc7}" description="Depósito">
