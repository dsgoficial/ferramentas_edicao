...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" forceraster="0" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{7688ed0d-5165-4098-8ca9-83654a6e5bc7}">
      <rule filter="&quot;visivel&quot; = 1" key="{0668bda0-1027-4348-84f1-d8f605ee52a2}" label="Visível">
        <rule filter="&quot;tipo&quot; in (9, 10, 11)" key="{f3342823-0257-4a58-8ff0-fc0b1d1a05d3}" symbol="0" label="Queda dágua"/>
        <rule filter="&quot;tipo&quot; = 12" key="{ac214f5a-8815-4f6b-9c2c-8cdad2ad9f91}" symbol="1" label="Corredeira"/>
        <rule filter="ELSE" key="{6f8f9c58-7213-447e-a47e-b15f14508628}" symbol="2"/>
      </rule>
      <rule filter="ELSE" key="{ee71826b-4959-42c0-b62a-7121d62aec89}" symbol="3" label="Não visível"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" name="1" force_rhr="0" type="line" clip_to_extent="1">
        ...
        <layer locked="0" enabled="1" pass="0" class="HashLine">
          <Option type="Map">
            ...
            <Option value="1.3" name="hash_length" type="QString"/>
            ...
            <Option value="0.5" name="interval" type="QString"/>
          ...
          <symbol alpha="1" name="@1@0" force_rhr="0" type="line" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol alpha="1" name="2" force_rhr="0" type="line" clip_to_extent="1">
        ...
        <layer locked="0" enabled="1" pass="0" class="SimpleLine">
          <Option type="Map">
            ...
            <Option value="solid" name="line_style" type="QString"/>
            <Option value="1.26" name="line_width" type="QString"/>
            <Option value="MM" name="line_width_unit" type="QString"/>
            <Option value="0" name="offset" type="QString"/>
            <Option value="3x:0,0,0,0,0,0" name="offset_map_unit_scale" type="QString"/>
            <Option value="MM" name="offset_unit" type="QString"/>
