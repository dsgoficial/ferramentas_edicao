  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" forceraster="0" referencescale="-1" symbollevels="0">
    <rules key="{ea96e2dd-153d-4f78-9dce-a869c560c2a4}">
      <rule key="{7269d453-0468-4914-bc91-1dcd457f1de2}" label="Visível" filter="&quot;visivel&quot; = 1">
        ...
        <rule key="{3c96b69a-dcac-41ad-a48b-0eb52f349dbc}" symbol="1" description="Olho dágua perm" label="Olho dágua perm" filter="tipo = 3"/>
        <rule key="{0b1ab826-5b5b-4c7b-8c1f-ef7d1061951e}" symbol="2" description="Olho dágua perm" label="Poço dágua e Poço artesiano - perm" filter="tipo in (1, 2)"/>
        <rule key="{f10fc325-acf7-4e05-8d8a-d7495bc87c9d}" symbol="3" description="Olho dágua perm" label="Olho dágua temp" filter="tipo = 4"/>
      ...
      <rule key="{77951f85-1bd3-46b6-9860-bbe6f91b1e94}" symbol="7" label="Não visível" filter="ELSE"/>
    </rules>
    <symbols>
      ...
      <symbol name="7" alpha="0.4" clip_to_extent="1" type="marker" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
