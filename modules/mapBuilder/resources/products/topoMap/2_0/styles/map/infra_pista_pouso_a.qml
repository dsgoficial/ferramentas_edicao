...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" referencescale="-1" forceraster="0">
    <rules key="{0aad622c-8f19-43fb-8e83-3e6f52a52085}">
      <rule filter="visivel = 1" key="{aa90cfb3-a688-4aea-ade8-b3113e6d38de}">
        <rule filter="&quot;tipo&quot; in (9) and &quot;situacao_fisica&quot; in (0,3) and &quot;simb_ponto&quot; in (1)" label="Pista de pouso" symbol="0" key="{c9d4269e-cd7f-498b-8a89-e2f1d94932a1}"/>
        <rule filter="&quot;tipo&quot; in (9) and &quot;situacao_fisica&quot; not in (0,3) and &quot;simb_ponto&quot; in (1)" label="Pista de pouso" symbol="1" key="{8091d289-7aec-4ced-bf6b-9ae4f8e468be}"/>
        <rule filter=" &quot;tipo&quot; =  9 and situacao_fisica in (0,3) and &quot;simb_ponto&quot; in (2)" label="A10902A" symbol="2" key="{a5de8d6a-a4a0-4fab-9bf9-2a228204d476}"/>
        <rule filter=" &quot;tipo&quot; =  9 and situacao_fisica not in (0,3) and &quot;simb_ponto&quot; in (2)" label="A10902B" symbol="3" key="{b772314c-a8e7-4432-933c-a1c6856a2128}"/>
        <rule filter=" &quot;tipo&quot; = 10" label="A10902C" symbol="4" key="{1d245777-3df3-44db-be79-a5ab6e750cf4}"/>
      </rule>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{bdca9112-f27d-493f-9663-f99eb1efb485}">
      <rule filter="visivel = 1" description="Pista de Pouso" key="{754f0f4b-7558-4e27-afd0-3fdc19cf4e38}">
