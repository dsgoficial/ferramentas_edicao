...
<qgis simplifyAlgorithm="0" labelsEnabled="1" readOnly="0" symbologyReferenceScale="-1" simplifyLocal="1" minScale="100000000" simplifyDrawingTol="1" version="3.24.3-Tisler" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingHints="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" forceraster="0" symbollevels="0" referencescale="-1">
    <rules key="{c73726db-cd31-451a-b365-8ed7defe6d7e}">
      <rule filter=" &quot;carta_simbolizacao&quot; =2" label="Carta mini" key="{ce98d302-d7b4-4ea8-a788-d88db4bde468}">
  ...
  <labeling type="rule-based">
    <rules key="{deb76487-ec0a-43b7-957d-ae5ef5428b90}">
      <rule filter="&quot;carta_simbolizacao&quot; = 2" description="Sigla mini" key="{e8bbae4a-b3c9-4611-88f4-3be2b30b1f93}">
