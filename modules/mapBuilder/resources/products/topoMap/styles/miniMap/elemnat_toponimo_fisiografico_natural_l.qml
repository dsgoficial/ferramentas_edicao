...
<qgis styleCategories="Symbology|Labeling" version="3.22.1-Białowieża" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{b2037d8d-8e3f-4a89-80ea-0697efc70700}">
      <rule filter="&quot;tipo&quot; = 1 and &quot;rotular_carta_mini&quot; = 1" key="{1779a579-cbdf-4184-8609-c096dfde5331}" description="Serra">
        <settings calloutType="simple">
          <text-style fontUnderline="0" namedStyle="Italic" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOpacity="1" allowHtml="0" fontItalic="1" multilineHeight="1" isExpression="0" legendString="Aa" fieldName="texto_edicao" blendMode="0" fontKerning="1" fontStrikeout="0" fontFamily="Noto Sans" textOrientation="horizontal" previewBkgrdColor="255,255,255,255" fontWordSpacing="5" capitalization="1" fontWeight="50" fontLetterSpacing="5" textColor="0,0,0,255" fontSize="4.5" useSubstitutions="0" fontSizeUnit="Point">
            <families/>
          ...
          <placement dist="0" offsetUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistanceUnits="MM" geometryGeneratorEnabled="1" centroidWhole="0" xOffset="0" rotationAngle="0" yOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" geometryGeneratorType="LineGeometry" overrunDistanceUnit="MM" placementFlags="9" polygonPlacementFlags="2" fitInPolygonOnly="0" offsetType="0" placement="3" centroidInside="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" lineAnchorType="0" lineAnchorClipping="0" maxCurvedCharAngleOut="-25" priority="5" distUnits="MM" layerType="LineGeometry" preserveRotation="1" quadOffset="4" rotationUnit="AngleDegrees" maxCurvedCharAngleIn="25" overrunDistance="20" lineAnchorPercent="0.5"/>
      ...
      <rule filter="&quot;tipo&quot; = 12 and &quot;rotular_carta_mini&quot; = 1" key="{be7e9198-9c9a-40a8-9dd6-ee6a1a6e22f3}" description="Praia">
        <settings calloutType="simple">
