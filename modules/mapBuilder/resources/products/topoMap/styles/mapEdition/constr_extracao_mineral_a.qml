...
<qgis styleCategories="Symbology|Labeling" version="3.34.0-Prizren" labelsEnabled="1">
  <renderer-v2 referencescale="-1" forceraster="0" type="RuleRenderer" symbollevels="0" enableorderby="0">
    <rules key="{98312c8a-a7ab-461c-a20e-9167acb375f9}">
      <rule filter="visivel = 1" key="{2431908f-038f-4ab9-9ccf-957148967b5a}" symbol="0"/>
      <rule filter="ELSE" key="{6e2cb69b-f1f1-42c8-a04f-29e4e0238972}" label="Não visível" symbol="1"/>
    </rules>
    <symbols>
      <symbol type="fill" clip_to_extent="1" force_rhr="0" name="0" frame_rate="10" is_animated="0" alpha="1">
        ...
        <layer pass="0" id="{d6521e48-c932-4e12-94a5-2b66bf573b23}" class="SimpleFill" enabled="1" locked="0">
          <Option type="Map">
        ...
        <layer pass="0" id="{f4ba7592-10c3-4cf4-9c04-7c085df46102}" class="SimpleLine" enabled="1" locked="0">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
            <Option type="QString" name="capstyle" value="square"/>
            <Option type="QString" name="customdash" value="1;0"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol type="fill" clip_to_extent="1" force_rhr="0" name="" frame_rate="10" is_animated="0" alpha="1">
        ...
        <layer pass="0" id="{19a5d87f-dfc8-4cf0-ab42-b33867ae874b}" class="SimpleFill" enabled="1" locked="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
  ...
  <labeling type="rule-based">
    <rules key="{107cfac0-52ef-4fb2-8b54-1a3761577eb4}">
      <rule filter="&quot;visivel&quot; = 1" key="{8246a570-f97a-45ea-a95a-ea2733ee2000}">
