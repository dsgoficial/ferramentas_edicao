...
<qgis styleCategories="Symbology|Labeling" version="3.34.0-Prizren" labelsEnabled="1">
  <renderer-v2 referencescale="-1" forceraster="0" type="RuleRenderer" symbollevels="0" enableorderby="0">
    <rules key="{e2d2ca60-1c41-4621-a546-69b4afa41ab8}">
      <rule filter="visivel = 1" key="{55ba5244-441a-4a32-84a4-dfcd24fe4c29}">
        <rule filter="&quot;tipo&quot; in (21,22,23)" key="{71aa2dad-5ea3-47f6-a61a-c545042cbcd2}" label="A10617A" symbol="0"/>
        <rule filter="ELSE" key="{321df377-d56f-46a3-beb3-9f662fdd8246}" symbol="1"/>
      </rule>
      <rule filter="ELSE" key="{9205533b-5760-4667-9a17-24b0a6e8d1cd}" label="Não visível" symbol="2"/>
    </rules>
    <symbols>
      <symbol type="fill" clip_to_extent="1" force_rhr="0" name="0" frame_rate="10" is_animated="0" alpha="1">
        ...
        <layer pass="0" id="{c1abb09b-2411-423d-acc7-5b832da9b50b}" class="SimpleLine" enabled="1" locked="0">
          <Option type="Map">
        ...
        <layer pass="0" id="{8c3bf55e-7787-4a9f-8773-e458437cbe57}" class="HashLine" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option type="QString" name="interval" value="0.8"/>
            ...
            <Option type="QString" name="ring_filter" value="1"/>
          ...
          <symbol type="line" clip_to_extent="1" force_rhr="0" name="@0@1" frame_rate="10" is_animated="0" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" name="name" value=""/>
                <Option name="properties"/>
            ...
            <layer pass="0" id="{edb6fe32-fc80-4e8c-a01b-509c3482a437}" class="SimpleLine" enabled="1" locked="0">
              <Option type="Map">
                <Option type="QString" name="align_dash_pattern" value="0"/>
                <Option type="QString" name="capstyle" value="square"/>
                <Option type="QString" name="customdash" value="5;2"/>
      ...
      <symbol type="fill" clip_to_extent="1" force_rhr="0" name="1" frame_rate="10" is_animated="0" alpha="1">
        ...
        <layer pass="0" id="{9ba9dafa-857a-4ca5-9540-eb73e7001809}" class="SimpleFill" enabled="1" locked="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="color" value="254,0,42,255"/>
            <Option type="QString" name="joinstyle" value="bevel"/>
      ...
      <symbol type="fill" clip_to_extent="1" force_rhr="0" name="2" frame_rate="10" is_animated="0" alpha="0.4">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" name="name" value=""/>
            <Option name="properties"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol type="fill" clip_to_extent="1" force_rhr="0" name="" frame_rate="10" is_animated="0" alpha="1">
        ...
        <layer pass="0" id="{ec4e6e7a-6c80-4f58-91f6-7cfd50cdb44e}" class="SimpleFill" enabled="1" locked="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
  ...
  <labeling type="rule-based">
    <rules key="{b41e6491-4672-4af9-b8c8-79bba53485fa}">
      <rule filter="&quot;visivel&quot; = 1" key="{2a9b8194-c37a-42f2-aa8f-8f4056a6753d}">
        <rule filter="&quot;tipo&quot; in (21,22,23)" description="Rocha" key="{9f8d4e11-a3a9-429b-8283-f87caae566e5}">
          <settings calloutType="simple">
            <text-style forcedItalic="0" fontWeight="50" allowHtml="0" fontItalic="0" capitalization="0" fieldName="texto_edicao" blendMode="0" fontStrikeout="0" textColor="36,31,33,255" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Regular" fontFamily="Noto Sans" previewBkgrdColor="255,255,255,255" fontKerning="1" useSubstitutions="0" forcedBold="0" textOpacity="1" isExpression="0" fontLetterSpacing="0" fontSize="7" fontUnderline="0" legendString="Aa" multilineHeight="0.80000000000000004" fontSizeUnit="Point" fontWordSpacing="0" multilineHeightUnit="Percentage">
              <families/>
            ...
            <placement centroidWhole="0" quadOffset="4" polygonPlacementFlags="2" maxCurvedCharAngleIn="25" placement="1" lineAnchorClipping="0" overrunDistance="0" repeatDistance="0" offsetType="0" xOffset="0" lineAnchorPercent="0.5" preserveRotation="1" layerType="PolygonGeometry" distMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" dist="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" lineAnchorType="0" geometryGeneratorEnabled="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PolygonGeometry" placementFlags="10" rotationUnit="AngleDegrees" centroidInside="1" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" allowDegraded="1" priority="5" rotationAngle="0" yOffset="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorTextPoint="CenterOfText" overrunDistanceUnit="MM" offsetUnits="MM" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" overlapHandling="AllowOverlapIfRequired" repeatDistanceUnits="MM" distUnits="MM"/>
