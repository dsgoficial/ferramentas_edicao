...
<qgis version="3.24.3-Tisler" labelsEnabled="0" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0">
    <rules key="{3591fab3-db81-44b1-ab4d-8f87b1897ff9}">
      <rule key="{0ff76dda-0b16-44d9-bcf9-3056dcdc3233}" filter="visivel = 1">
        <rule symbol="0" key="{5cfa6d24-e771-4da7-a7af-7d5881e671cb}" filter="&quot;material_construcao&quot; in (1, 2)"/>
        <rule symbol="1" key="{d08f5e72-877e-45a7-aeea-437e90f56b55}" filter="&quot;material_construcao&quot; not in (1, 2)"/>
        <rule symbol="2" key="{062f6748-a325-4178-836f-1f3e9c74b7f7}" filter="ELSE"/>
      </rule>
      <rule symbol="3" label="Não visível" key="{b8af5ee8-1394-4ebc-9d72-d4229eff68f9}" filter="ELSE"/>
    </rules>
    <symbols>
      ...
      <symbol type="fill" alpha="0.4" force_rhr="0" name="3" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
