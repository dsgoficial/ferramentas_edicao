...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" forceraster="0" enableorderby="0" symbollevels="0" referencescale="-1">
    <rules key="{d6a0f073-ddcc-430a-897d-73175ec4da29}">
      <rule filter="&quot;visivel&quot; = 1" key="{441dde93-489a-414e-8a81-00e9211942d3}">
        <rule filter="&quot;tipo&quot; in (1801, 1802) or (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (4)" key="{079d7999-4d19-453f-8496-61c2b150cd5b}" symbol="0" label="Est Gerad Energia"/>
        <rule filter="ELSE" key="{3d016883-9351-4699-b2e6-90ff848c9341}" symbol="1"/>
      </rule>
      <rule filter="ELSE" key="{db1bd0f0-08b3-4a7c-8902-dc2fecb107f2}" symbol="2" label="Não visível"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="0.4" name="2" force_rhr="0" type="fill" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{537835f3-136c-4e0e-ad4a-e4536ae10eb9}">
      <rule filter="&quot;visivel&quot; = 1" description="Energia" key="{e1aaaecb-decd-4d90-8fb9-b466664b1b73}">
