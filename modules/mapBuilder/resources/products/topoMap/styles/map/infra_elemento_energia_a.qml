...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 referencescale="-1" symbollevels="0" enableorderby="0" type="RuleRenderer" forceraster="0">
    <rules key="{d6a0f073-ddcc-430a-897d-73175ec4da29}">
      <rule filter="&quot;visivel&quot; = 1" key="{441dde93-489a-414e-8a81-00e9211942d3}">
        <rule symbol="0" label="Est Gerad Energia" filter="&quot;tipo&quot; in (1801, 1802) or (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (4)" key="{079d7999-4d19-453f-8496-61c2b150cd5b}"/>
        <rule symbol="1" filter="ELSE" key="{3d016883-9351-4699-b2e6-90ff848c9341}"/>
      </rule>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{fbff1da4-61dd-40c3-9a2c-cb1c0b6208ff}">
      <rule description="Energia" filter="&quot;visivel&quot; = 1" key="{f3e2edba-c532-436c-8f66-2330889111c5}">
        <settings calloutType="simple">
          ...
          <placement centroidWhole="0" centroidInside="0" lineAnchorType="0" fitInPolygonOnly="0" xOffset="0.5" polygonPlacementFlags="3" priority="5" preserveRotation="1" geometryGeneratorEnabled="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" yOffset="-0.5" offsetUnits="MM" lineAnchorPercent="0.5" dist="0" rotationUnit="AngleDegrees" repeatDistanceUnits="MM" placement="8" quadOffset="2" maxCurvedCharAngleOut="-25" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" distUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" maxCurvedCharAngleIn="25" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistance="0" overrunDistanceUnit="MM" layerType="PolygonGeometry" geometryGenerator="with_variable(&#xd;&#xd;&#xa; 'moldura',&#xd;&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xd;&#xa;THEN &#xd;&#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xd;&#xa;ELSE&#xd;&#xd;&#xa;$geometry&#xd;&#xd;&#xa;END&#xd;&#xd;&#xa;)" placementFlags="10" geometryGeneratorType="PolygonGeometry"/>
