...
<qgis version="3.24.3-Tisler" styleCategories="Symbology|Labeling" labelsEnabled="1">
  <renderer-v2 type="RuleRenderer" referencescale="-1" forceraster="0" symbollevels="0" enableorderby="0">
    <rules key="{35837702-9ae1-4ac6-870a-6fafca7921d3}">
      <rule filter="visivel = 1" key="{3c218643-a1dd-4d6a-92c3-2c1651bf3a3f}">
        <rule filter="&quot;tipo&quot; in (801, 1942)" symbol="0" label="Molhe / Atracadouro" key="{b6806ccb-f60e-4b76-a9f7-cff64a2dd30f}"/>
        <rule filter="ELSE" symbol="1" key="{0a57ddb9-9893-4eb6-8cdb-9663096fb309}"/>
      </rule>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{5e134752-9cc7-4c1b-9dfc-e32038f83f48}">
      <rule description="Elemento infraestrutura" key="{95bd92df-5a4d-4979-a8b8-5770043d0cce}">
        <settings calloutType="simple">
          ...
          <placement predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" distUnits="MM" repeatDistance="0" yOffset="-0.5" polygonPlacementFlags="2" geometryGeneratorEnabled="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" dist="0" priority="5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" rotationUnit="AngleDegrees" lineAnchorClipping="0" lineAnchorPercent="0.5" placement="4" centroidInside="0" overrunDistanceUnit="MM" xOffset="0.5" maxCurvedCharAngleOut="-25" fitInPolygonOnly="0" lineAnchorType="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" offsetUnits="MM" repeatDistanceUnits="MM" quadOffset="2" geometryGeneratorType="LineGeometry" rotationAngle="0" layerType="LineGeometry" offsetType="0" overrunDistance="0" preserveRotation="1" centroidWhole="0"/>
