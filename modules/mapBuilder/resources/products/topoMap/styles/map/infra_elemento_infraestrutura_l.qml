...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer" referencescale="-1">
    <rules key="{35837702-9ae1-4ac6-870a-6fafca7921d3}">
      <rule symbol="0" key="{b8ac73c3-9a05-499b-ad8c-19e683fc6eb7}" label="Molhe / Atracadouro" filter="&quot;tipo&quot; in (801, 1942)"/>
      <rule symbol="1" key="{b3fc4e4c-a6f5-4245-9add-d9232648922e}" filter="ELSE"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" name="1" type="line">
        ...
        <layer pass="0" class="SimpleLine" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option value="0" name="draw_inside_polygon" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
            <Option value="255,5,1,255" name="line_color" type="QString"/>
            <Option value="solid" name="line_style" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{bd9db2a2-5578-460b-b3b0-7f3125d5fad0}">
      <rule description="Elemento infraestrutura" key="{0fd61fd8-12f0-42cd-a76b-d1c18feb0ac4}">
        <settings calloutType="simple">
          <text-style fontLetterSpacing="0" previewBkgrdColor="255,255,255,255" fontWeight="50" fontSizeUnit="Point" fontKerning="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontStrikeout="0" multilineHeight="0.80000000000000004" textOpacity="1" legendString="Aa" fieldName="texto_edicao" textOrientation="horizontal" fontSize="6" fontFamily="Noto Sans" fontUnderline="0" blendMode="0" namedStyle="Condensed" useSubstitutions="0" textColor="75,75,75,255" fontWordSpacing="0" capitalization="0" isExpression="0" allowHtml="0">
            <families/>
