  ...
  <renderer-v2 type="RuleRenderer" referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0">
    <rules key="{af709a54-88ca-4a27-bba5-e0a7ac6ce840}">
      <rule filter=" &quot;visivel&quot; = 1" label="Visível" key="{4bdda895-97c4-4ad7-919c-b2b6ccf321c8}">
        <rule filter=" (&quot;tipo&quot; in (0, 610, 1212, 1213, 1298, 2029) or (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (1, 2, 3, 4, 7, 8, 9, 10, 11, 15, 21, 23, 24, 25)) and &quot;tipo&quot; not in (803, 2429)" label="P20403A - Genérico Não Importante" description="Edificação operacional" symbol="0" key="{1d0aafdd-64b6-4744-852d-94b2496d4aa9}"/>
        <rule filter="(&quot;tipo&quot; in (803) or (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (13, 17, 19, 30))" label="P20418A - Importante" symbol="1" key="{832b4b14-42b1-4056-9886-114643611ddc}"/>
        <rule filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 = 5" label="P20415A" symbol="2" key="{09aaadda-6c3d-4bd5-9c3e-627f3740d93c}"/>
        <rule filter="&quot;tipo&quot; = 601" label="P20423A" symbol="3" key="{62b8aa18-4a6e-42cc-93cc-7852adff26c7}"/>
        <rule filter="&quot;tipo&quot; = 1215" label="Viveiro de plantas" symbol="4" key="{eb65cf86-2307-4c54-aad1-ac9ec26b2d87}"/>
        <rule filter="&quot;tipo&quot; = 1216" label="Viveiro para aquicultura" symbol="5" key="{f5cfde74-1e93-44fa-932a-4adc7f782543}"/>
        <rule filter="&quot;tipo&quot; = 1218" label="P20405D" symbol="6" key="{5f83c3db-6a76-4762-94f8-b032bc99eda9}"/>
        <rule filter="&quot;tipo&quot; = 1401" label="P20429A" symbol="7" key="{b396b6ae-5dd0-4712-b4eb-88b4630fcae8}"/>
        <rule filter="&quot;tipo&quot; in (2025, 2026, 2027, 2028)" label="P20427A" symbol="8" key="{55ff5378-dd40-40e4-aca1-32f560cf6b47}"/>
        <rule filter="&quot;tipo&quot; = 2429" label="Aero - Hangar" symbol="9" key="{460f9292-8a19-43a1-9d8c-bc26dfb57223}"/>
        <rule filter="&quot;tipo&quot; = 2601" label="P20430A" symbol="10" key="{7ccb2fca-e544-4540-81d0-bc49b7d09326}"/>
        <rule filter=" (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (29)" label="P20435A" symbol="11" key="{63b54aab-2b56-45eb-bc0e-4118677465ac}"/>
        <rule filter="ELSE" symbol="12" key="{f1a08c62-a732-4ad8-92da-b287df07f287}"/>
      </rule>
    </rules>
    <symbols>
    ...
    <rules key="{7e289344-dbd9-4e73-a432-eec0051990b1}">
      <rule filter="&quot;tipo&quot; = 1212 and &quot;visivel&quot; = 1" description="Sede operacional de fazenda" key="{c00c9d7c-32c1-4267-b58e-e3020dd80031}">
        <settings calloutType="simple">
          ...
          <text-format multilineAlign="0" formatNumbers="0" plussign="0" useMaxLineLengthForAutoWrap="1" leftDirectionSymbol="&lt;" placeDirectionSymbol="0" wrapChar="|" decimals="3" autoWrapLength="0" rightDirectionSymbol=">" reverseDirectionSymbol="0" addDirectionSymbol="0"/>
          <placement layerType="PointGeometry" repeatDistance="0" fitInPolygonOnly="0" geometryGeneratorType="PointGeometry" placement="0" maxCurvedCharAngleOut="-25" distUnits="MM" overrunDistance="0" preserveRotation="1" centroidWhole="0" geometryGeneratorEnabled="1" xOffset="0.5" lineAnchorType="0" offsetType="0" offsetUnits="MM" centroidInside="0" repeatDistanceUnits="MM" rotationUnit="AngleDegrees" lineAnchorClipping="0" rotationAngle="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" quadOffset="2" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" dist="0.40000000000000002" yOffset="-0.5" polygonPlacementFlags="2" lineAnchorPercent="0.5" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" placementFlags="10" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" overrunDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" priority="5"/>
      ...
      <rule filter="&quot;tipo&quot; = 2429" description="Aero - Hangar" key="{23bd502f-6f2a-45b7-a1c8-38a77a5e1d03}">
        <settings calloutType="simple">
          <text-style fontWeight="50" fontStrikeout="0" fieldName="nome" textColor="0,0,0,255" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWordSpacing="0" allowHtml="0" blendMode="0" fontItalic="0" textOpacity="1" fontKerning="1" fontFamily="Noto Sans" capitalization="0" isExpression="0" fontSizeUnit="Point" previewBkgrdColor="255,255,255,255" fontUnderline="0" legendString="Aa" namedStyle="Condensed" fontLetterSpacing="0" fontSize="6" multilineHeight="1" useSubstitutions="0">
            ...
            <background shapeType="0" shapeSizeY="0" shapeOffsetX="0" shapeBorderWidth="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSVGFile="" shapeBorderColor="128,128,128,255" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiUnit="Point" shapeBlendMode="0" shapeRadiiY="0" shapeJoinStyle="64" shapeFillColor="255,255,255,255" shapeSizeX="0" shapeOffsetY="0" shapeRotation="0" shapeDraw="0" shapeSizeType="0" shapeBorderWidthUnit="Point" shapeRotationType="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiX="0" shapeSizeUnit="Point" shapeOffsetUnit="Point" shapeOpacity="1">
              <symbol clip_to_extent="1" type="marker" name="markerSymbol" alpha="1" force_rhr="0">
                <data_defined_properties>
                  <Option type="Map">
                    <Option type="QString" name="name" value=""/>
          ...
          <placement layerType="PointGeometry" repeatDistance="0" fitInPolygonOnly="0" geometryGeneratorType="PointGeometry" placement="6" maxCurvedCharAngleOut="-25" distUnits="MM" overrunDistance="0" preserveRotation="1" centroidWhole="0" geometryGeneratorEnabled="0" xOffset="0" lineAnchorType="0" offsetType="1" offsetUnits="MM" centroidInside="0" repeatDistanceUnits="MM" rotationUnit="AngleDegrees" lineAnchorClipping="0" rotationAngle="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" dist="0" yOffset="0" polygonPlacementFlags="2" lineAnchorPercent="0.5" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="" placementFlags="10" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" overrunDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" priority="5"/>
          <rendering scaleMax="0" zIndex="0" fontMinPixelSize="3" fontMaxPixelSize="10000" obstacle="1" maxNumLabels="2000" unplacedVisibility="0" obstacleFactor="1" upsidedownLabels="0" displayAll="0" limitNumLabels="0" drawLabels="1" scaleMin="0" labelPerPart="0" mergeLines="0" fontLimitPixelSize="0" obstacleType="1" minFeatureSize="0" scaleVisibility="0"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" name="name" value=""/>
