  ...
  <renderer-v2 referencescale="-1" symbollevels="0" type="RuleRenderer" forceraster="0" enableorderby="0">
    <rules key="{af709a54-88ca-4a27-bba5-e0a7ac6ce840}">
      <rule key="{4bdda895-97c4-4ad7-919c-b2b6ccf321c8}" filter=" &quot;visivel&quot; = 1" label="Visível">
        <rule key="{1d0aafdd-64b6-4744-852d-94b2496d4aa9}" symbol="0" filter=" (&quot;tipo&quot; = 0 or (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (24, 11, 8, 3, 1, 9, 2, 15, 23, 25, 21, 7)) and &quot;tipo&quot; not in (2429)" label="P20403A" description="Edificação operacional"/>
        <rule key="{2c13ba21-feb1-44c7-94dd-c3a568665480}" symbol="1" filter="(&quot;tipo&quot; in (2429) or (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (12, 10, 13, 17, 30, 19, 22, 4) or &quot;tipo&quot; in (2027, 2028 2029, 2030, 2031)) and &quot;tipo&quot; not in (1218)" label="P20418A"/>
        <rule key="{d05c1075-ce2e-4596-8ffb-9c464ea12b2b}" symbol="2" filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 = 5" label="P20415A"/>
        <rule key="{2206c7ec-9232-4947-809d-577712a147c2}" symbol="3" filter="&quot;tipo&quot; in (2025, 2026)" label="P20427A"/>
        <rule key="{7ccb2fca-e544-4540-81d0-bc49b7d09326}" symbol="4" filter="&quot;tipo&quot; = 2601" label="P20430A"/>
        <rule key="{63b54aab-2b56-45eb-bc0e-4118677465ac}" symbol="5" filter=" (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (29)" label="P20435A"/>
        <rule key="{1e337d26-a0c4-4728-820d-028c924da0cd}" symbol="6" filter="&quot;tipo&quot; = 2804" label="P11206A"/>
        <rule key="{600f7ed1-4510-4ec4-a0f9-51b523c4847e}" symbol="7" filter="&quot;tipo&quot; = 1401" label="P20429A"/>
        <rule key="{e982ad82-d248-40a1-8101-55180c2e7976}" symbol="8" filter="&quot;tipo&quot; = 601" label="P20423A"/>
        <rule key="{ee175899-d73f-4256-9cba-8e9802db23c2}" symbol="9" filter="&quot;tipo&quot; = 1218" label="P20405D"/>
        <rule key="{593e8ac9-227a-476b-ade0-e3fdce7c6973}" symbol="10" filter=" &quot;tipo&quot; in (1,2)" label="P20403B" description="Edificação não operacional"/>
      ...
      <symbol name="10" type="marker" clip_to_extent="1" force_rhr="0" alpha="1">
        ...
        <layer locked="0" enabled="1" class="SimpleMarker" pass="0">
          <Option type="Map">
            ...
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="name" type="QString" value="quarter_square"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
            <Option name="outline_color" type="QString" value="0,0,0,255"/>
      ...
      <symbol name="6" type="marker" clip_to_extent="1" force_rhr="0" alpha="1">
        ...
        <layer locked="0" enabled="1" class="SvgMarker" pass="0">
          <Option type="Map">
            ...
            <Option name="parameters"/>
            <Option name="scale_method" type="QString" value="diameter"/>
            <Option name="size" type="QString" value="2.63992"/>
            <Option name="size_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="size_unit" type="QString" value="MM"/>
            <Option name="vertical_anchor_point" type="QString" value="1"/>
          </Option>
    ...
    <rules key="{6dc441da-2e45-4c12-9eab-00bfe06f8cec}">
      <rule key="{8b9e474a-a243-43dd-9d93-bd3607837b1b}" filter="&quot;tipo&quot; = 1212 and &quot;visivel&quot; = 1" description="Sede operacional de fazenda">
        <settings calloutType="simple">
          ...
          <text-format addDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" reverseDirectionSymbol="0" wrapChar="|" autoWrapLength="0" placeDirectionSymbol="0" decimals="3" plussign="0" formatNumbers="0" leftDirectionSymbol="&lt;" multilineAlign="0" rightDirectionSymbol=">"/>
          <placement centroidInside="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" dist="0.40000000000000002" repeatDistance="0" preserveRotation="1" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placementFlags="10" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" quadOffset="2" rotationUnit="AngleDegrees" overrunDistanceUnit="MM" geometryGeneratorType="PointGeometry" yOffset="-0.5" centroidWhole="0" distUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" priority="5" placement="0" maxCurvedCharAngleOut="-25" polygonPlacementFlags="2" overrunDistance="0" lineAnchorClipping="0" lineAnchorType="0" fitInPolygonOnly="0" maxCurvedCharAngleIn="25" xOffset="0.5" layerType="PointGeometry" offsetUnits="MM" offsetType="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" geometryGeneratorEnabled="1"/>
          <rendering minFeatureSize="0" upsidedownLabels="0" fontMaxPixelSize="10000" labelPerPart="0" limitNumLabels="0" displayAll="0" unplacedVisibility="0" zIndex="0" mergeLines="0" fontMinPixelSize="3" fontLimitPixelSize="0" scaleMin="0" obstacle="1" scaleVisibility="0" drawLabels="1" obstacleType="1" obstacleFactor="1" maxNumLabels="2000" scaleMax="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" type="QString" value=""/>
              <Option name="properties" type="Map">
                ...
                <Option name="CalloutDraw" type="Map">
                  <Option name="active" type="bool" value="true"/>
                  <Option name="field" type="QString" value="exibir_linha_rotulo"/>
      ...
      <rule key="{4bcaa5e8-b146-4927-b051-a9eb3e65543a}" filter="&quot;tipo&quot; = 1218 and &quot;visivel&quot; = 1" description="Curral">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" fontKerning="1" fontSizeUnit="Point" textColor="75,75,75,255" fieldName="texto_edicao" fontFamily="Noto Sans" fontWordSpacing="0" fontStrikeout="0" blendMode="0" fontUnderline="0" capitalization="0" multilineHeight="0.80000000000000004" allowHtml="0" useSubstitutions="0" fontWeight="50" fontLetterSpacing="0" isExpression="0" textOpacity="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal" namedStyle="Condensed" fontItalic="0" fontSize="6" legendString="Aa">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferDraw="0" bufferOpacity="1" bufferJoinStyle="128" bufferSize="1" bufferNoFill="1" bufferColor="255,255,255,255"/>
            <text-mask maskSize="0.20000000000000001" maskJoinStyle="128" maskType="0" maskEnabled="1" maskSizeUnits="MM" maskOpacity="1" maskedSymbolLayers="infra_via_deslocamento_l_ce24dd65_e097_46a1_af70_1175a87403a8,{0a9e3586-49f7-4ee8-8195-0c8493e0e053},0;infra_via_deslocamento_l_ce24dd65_e097_46a1_af70_1175a87403a8,{bc07a595-5d0d-41ca-8c3a-9be354d5ca94},0;infra_via_deslocamento_l_ce24dd65_e097_46a1_af70_1175a87403a8,{d91e59d1-098c-4240-ba18-57038fa01222},1;infra_via_deslocamento_l_ce24dd65_e097_46a1_af70_1175a87403a8,{9eecdcb0-2ab3-46c1-896d-438fafa5c5ea},0;infra_via_deslocamento_l_ce24dd65_e097_46a1_af70_1175a87403a8,{abacada7-6415-4698-8775-45ecfcc12a47},0;infra_via_deslocamento_l_ce24dd65_e097_46a1_af70_1175a87403a8,{fed7dc2c-72ea-4d3e-8d77-59c29669d1b7},0;infra_via_deslocamento_l_ce24dd65_e097_46a1_af70_1175a87403a8,{d8b1d7f1-902c-4cd8-8d0d-cb37a340a19c},0;infra_via_deslocamento_l_ce24dd65_e097_46a1_af70_1175a87403a8,{b60c7c00-f8c0-49e1-8621-86f244e3985f},0;infra_via_deslocamento_l_ce24dd65_e097_46a1_af70_1175a87403a8,{72c0d73b-a2fc-4ceb-877d-e019f8061484},0;infra_via_deslocamento_l_ce24dd65_e097_46a1_af70_1175a87403a8,{dfb4681b-e5ad-4379-bd19-2a1fe18ff673},0;infra_via_deslocamento_l_ce24dd65_e097_46a1_af70_1175a87403a8,{c921bc81-6b3a-471e-83e2-a6930ce0f7a2},0;infra_via_deslocamento_l_ce24dd65_e097_46a1_af70_1175a87403a8,{b41d8306-313b-4c76-b5e7-de47feec0efc},0;infra_via_deslocamento_l_ce24dd65_e097_46a1_af70_1175a87403a8,{c0dd6618-ddd6-4175-b89e-7d0e3d0ceb83},0;infra_via_deslocamento_l_ce24dd65_e097_46a1_af70_1175a87403a8,{568ccda1-72cf-49ff-9629-3a055e4e98be},1;infra_via_deslocamento_l_ce24dd65_e097_46a1_af70_1175a87403a8,{a9910ea2-cda8-4926-bd8b-581851fb015c},1;infra_via_deslocamento_l_ce24dd65_e097_46a1_af70_1175a87403a8,{9c14ab03-399e-48d0-a253-46933dff9c91},0;infra_via_deslocamento_l_ce24dd65_e097_46a1_af70_1175a87403a8,{b2135330-a7e6-4ea7-a7b2-f58d824d19ac},0;infra_via_deslocamento_l_ce24dd65_e097_46a1_af70_1175a87403a8,{6c962be9-7f83-4f54-b33c-b86b9a7f7063},0" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeSizeType="0" shapeOffsetUnit="MM" shapeOpacity="1" shapeType="0" shapeSVGFile="" shapeRadiiUnit="MM" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeOffsetX="0" shapeDraw="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeOffsetY="0" shapeRadiiY="0" shapeSizeY="0" shapeBorderWidthUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeJoinStyle="64" shapeRadiiX="0" shapeSizeX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeRotationType="0" shapeSizeUnit="MM" shapeRotation="0" shapeFillColor="255,255,255,255">
      ...
      <rule key="{2bd8e635-6bb0-4472-8422-899a3ecf5847}" filter="&quot;tipo&quot; not in (1212, 1218) and &quot;visivel&quot; = 1" description="Edificação">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" fontKerning="1" fontSizeUnit="Point" textColor="75,75,75,255" fieldName="texto_edicao" fontFamily="Noto Sans" fontWordSpacing="0" fontStrikeout="0" blendMode="0" fontUnderline="0" capitalization="0" multilineHeight="0.80000000000000004" allowHtml="0" useSubstitutions="0" fontWeight="50" fontLetterSpacing="0" isExpression="0" textOpacity="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal" namedStyle="Condensed" fontItalic="0" fontSize="6" legendString="Aa">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferDraw="0" bufferOpacity="1" bufferJoinStyle="128" bufferSize="1" bufferNoFill="1" bufferColor="255,255,255,255"/>
