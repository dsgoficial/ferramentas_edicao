...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  <renderer-v2 forceraster="0" enableorderby="0" referencescale="-1" symbollevels="0" type="RuleRenderer">
    <rules key="{af709a54-88ca-4a27-bba5-e0a7ac6ce840}">
      <rule filter=" &quot;visivel&quot; = 1" label="Visível" key="{4bdda895-97c4-4ad7-919c-b2b6ccf321c8}">
        <rule filter=" (&quot;tipo&quot; in (0, 525, 608, 610, 1212, 1213, 1298, 2029, 2030, 2031) or (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (1, 2, 3, 4, 7, 8, 9, 10, 11, 15, 21, 23, 24, 25)) and &quot;tipo&quot; not in (803, 2429)" symbol="0" label="P20403A - Genérico Não Importante" key="{55073371-2bcb-4204-962b-25b9718a6ea4}" description="Edificação operacional"/>
        <rule filter=" &quot;suprimir_bandeira&quot; = 1 and &quot;tipo&quot; not in (2429,1218,1216,1215,803) and (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 not in (13, 17, 19, 30)" symbol="1" label="Bandeira suprimida" key="{1d0aafdd-64b6-4744-852d-94b2496d4aa9}"/>
        <rule filter="(&quot;tipo&quot; in (803) or (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (13, 17, 19, 30))" symbol="2" label="P20418A - Importante" key="{832b4b14-42b1-4056-9886-114643611ddc}"/>
        <rule filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 = 5 and &quot;tipo&quot; not in (525) and  &quot;suprimir_bandeira&quot; != 1" symbol="3" label="P20415A" key="{09aaadda-6c3d-4bd5-9c3e-627f3740d93c}"/>
        <rule filter="&quot;tipo&quot; = 601 and  &quot;suprimir_bandeira&quot; != 1" symbol="4" label="P20423A" key="{4c74753d-6dd7-4c81-ba11-8ac264737e1a}"/>
        <rule filter="&quot;tipo&quot; = 602 and  &quot;suprimir_bandeira&quot; != 1" symbol="5" label="Templo" key="{62b8aa18-4a6e-42cc-93cc-7852adff26c7}"/>
        <rule filter="&quot;tipo&quot; = 1215" symbol="6" label="Viveiro de plantas" key="{eb65cf86-2307-4c54-aad1-ac9ec26b2d87}"/>
        <rule filter="&quot;tipo&quot; = 1216" symbol="7" label="Viveiro para aquicultura" key="{f5cfde74-1e93-44fa-932a-4adc7f782543}"/>
        <rule filter="&quot;tipo&quot; = 1218" symbol="8" label="P20405D" key="{5f83c3db-6a76-4762-94f8-b032bc99eda9}"/>
        <rule filter="&quot;tipo&quot; = 1401 and  &quot;suprimir_bandeira&quot; != 1" symbol="9" label="P20429A" key="{b396b6ae-5dd0-4712-b4eb-88b4630fcae8}"/>
        <rule filter="&quot;tipo&quot; in (2025, 2026, 2027, 2028) and  &quot;suprimir_bandeira&quot; != 1" symbol="10" label="P20427A" key="{55ff5378-dd40-40e4-aca1-32f560cf6b47}"/>
        <rule filter="&quot;tipo&quot; = 2429" symbol="11" label="Aero - Hangar" key="{460f9292-8a19-43a1-9d8c-bc26dfb57223}"/>
        <rule filter="&quot;tipo&quot; = 2601 and  &quot;suprimir_bandeira&quot; != 1" symbol="12" label="P20430A" key="{7ccb2fca-e544-4540-81d0-bc49b7d09326}"/>
        <rule filter=" (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (29) and  &quot;suprimir_bandeira&quot; != 1" symbol="13" label="P20435A" key="{63b54aab-2b56-45eb-bc0e-4118677465ac}"/>
    ...
    <symbols>
      ...
      <symbol alpha="1" type="marker" clip_to_extent="1" force_rhr="0" name="12">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
      ...
      <symbol alpha="1" type="marker" clip_to_extent="1" force_rhr="0" name="13">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
      ...
      <symbol alpha="1" type="marker" clip_to_extent="1" force_rhr="0" name="14">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{8747b41e-58f9-4e97-b5f7-9f993f8b2d04}">
      <rule filter="&quot;tipo&quot; = 1212 and &quot;visivel&quot; = 1" key="{33429b7c-9bd8-40f1-971c-d9dd466e0733}" description="Sede operacional de fazenda">
        <settings calloutType="simple">
          <text-style fontStrikeout="0" fontSizeUnit="Point" fontUnderline="0" blendMode="0" capitalization="0" textOrientation="horizontal" fontItalic="0" fontWordSpacing="0" useSubstitutions="0" legendString="Aa" fontSize="6" fontWeight="25" namedStyle="Condensed Light" textColor="36,31,33,255" textOpacity="1" previewBkgrdColor="255,255,255,255" allowHtml="0" fontFamily="Noto Sans" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="0" fieldName="texto_edicao" fontLetterSpacing="0" multilineHeight="0.80000000000000004" fontKerning="1">
            <families/>
          ...
          <placement dist="0.40000000000000002" offsetUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" fitInPolygonOnly="0" lineAnchorClipping="0" polygonPlacementFlags="2" lineAnchorPercent="0.5" placement="0" maxCurvedCharAngleIn="25" quadOffset="2" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" layerType="PointGeometry" repeatDistanceUnits="MM" rotationUnit="AngleDegrees" offsetType="0" overrunDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" centroidInside="0" overrunDistanceUnit="MM" geometryGeneratorType="PointGeometry" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" repeatDistance="0" maxCurvedCharAngleOut="-25" priority="5" distUnits="MM" rotationAngle="0" geometryGeneratorEnabled="1" distMapUnitScale="3x:0,0,0,0,0,0" xOffset="0.5" yOffset="-0.5" placementFlags="10"/>
      ...
      <rule filter="&quot;tipo&quot; = 1218 and &quot;visivel&quot; = 1" key="{4592fefe-0102-4639-bd8c-d920b0375ddb}" description="Curral">
        <settings calloutType="simple">
      ...
      <rule filter="&quot;tipo&quot; not in (1212, 1218) and &quot;visivel&quot; = 1" key="{44e054a7-3df6-463f-927e-c6dfdda08d73}" description="Edificação">
        <settings calloutType="simple">
          <text-style fontStrikeout="0" fontSizeUnit="Point" fontUnderline="0" blendMode="0" capitalization="0" textOrientation="horizontal" fontItalic="0" fontWordSpacing="0" useSubstitutions="0" legendString="Aa" fontSize="6" fontWeight="50" namedStyle="Condensed" textColor="36,31,33,255" textOpacity="1" previewBkgrdColor="255,255,255,255" allowHtml="0" fontFamily="Noto Sans" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="0" fieldName="texto_edicao" fontLetterSpacing="0" multilineHeight="0.80000000000000004" fontKerning="1">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferNoFill="1" bufferColor="255,255,255,255" bufferDraw="0" bufferOpacity="1" bufferSizeUnits="MM" bufferJoinStyle="128" bufferBlendMode="0"/>
