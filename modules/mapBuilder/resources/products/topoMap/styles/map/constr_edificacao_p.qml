  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" forceraster="0" symbollevels="0" referencescale="-1">
    <rules key="{af709a54-88ca-4a27-bba5-e0a7ac6ce840}">
      <rule key="{4bdda895-97c4-4ad7-919c-b2b6ccf321c8}" filter=" &quot;visivel&quot; = 1" label="Visível">
        <rule key="{55073371-2bcb-4204-962b-25b9718a6ea4}" description="Edificação operacional" symbol="0" filter=" (&quot;tipo&quot; in (0, 525, 608, 610, 1212, 1213, 1298, 2029, 2030, 2031) or (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (1, 2, 3, 4, 7, 8, 9, 10, 11, 15, 21, 23, 24, 25)) and &quot;tipo&quot; not in (803, 2429)" label="P20403A - Genérico Não Importante"/>
        ...
        <rule key="{832b4b14-42b1-4056-9886-114643611ddc}" symbol="2" filter="(&quot;tipo&quot; in (803) or (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (13, 17, 19, 30))" label="P20418A - Importante"/>
        ...
        <rule key="{62b8aa18-4a6e-42cc-93cc-7852adff26c7}" symbol="5" filter="&quot;tipo&quot; = 602 and  &quot;suprimir_bandeira&quot; != 1" label="Templo"/>
        <rule key="{eb65cf86-2307-4c54-aad1-ac9ec26b2d87}" symbol="6" filter="&quot;tipo&quot; = 1215" label="Viveiro de plantas"/>
        <rule key="{f5cfde74-1e93-44fa-932a-4adc7f782543}" symbol="7" filter="&quot;tipo&quot; = 1216" label="Viveiro para aquicultura"/>
        <rule key="{5f83c3db-6a76-4762-94f8-b032bc99eda9}" symbol="8" filter="&quot;tipo&quot; = 1218" label="P20405D"/>
        <rule key="{b396b6ae-5dd0-4712-b4eb-88b4630fcae8}" symbol="9" filter="&quot;tipo&quot; = 1401 and  &quot;suprimir_bandeira&quot; != 1" label="P20429A"/>
        <rule key="{55ff5378-dd40-40e4-aca1-32f560cf6b47}" symbol="10" filter="&quot;tipo&quot; in (2025, 2026, 2027, 2028) and  &quot;suprimir_bandeira&quot; != 1" label="P20427A"/>
        <rule key="{460f9292-8a19-43a1-9d8c-bc26dfb57223}" symbol="11" filter="&quot;tipo&quot; = 2429" label="Aero - Hangar"/>
        <rule key="{7ccb2fca-e544-4540-81d0-bc49b7d09326}" symbol="12" filter="&quot;tipo&quot; = 2601 and  &quot;suprimir_bandeira&quot; != 1" label="P20430A"/>
        <rule key="{63b54aab-2b56-45eb-bc0e-4118677465ac}" symbol="13" filter=" (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (29) and  &quot;suprimir_bandeira&quot; != 1" label="P20435A"/>
        <rule key="{f1a08c62-a732-4ad8-92da-b287df07f287}" symbol="14" filter="ELSE"/>
      </rule>
    </rules>
    <symbols>
    ...
    <rules key="{800d46f9-fcfa-41d9-94d0-f3ed5e99a923}">
      <rule key="{92c206d0-4782-474e-ab68-4ee1accf1dab}" description="Sede operacional de fazenda" filter="&quot;tipo&quot; = 1212 and &quot;visivel&quot; = 1">
        <settings calloutType="simple">
          ...
          <placement lineAnchorPercent="0.5" geometryGeneratorType="PointGeometry" layerType="PointGeometry" maxCurvedCharAngleOut="-25" rotationUnit="AngleDegrees" yOffset="-0.5" rotationAngle="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" distUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" lineAnchorClipping="0" preserveRotation="1" centroidWhole="0" offsetUnits="MM" maxCurvedCharAngleIn="25" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" centroidInside="0" repeatDistanceUnits="MM" dist="0.40000000000000002" priority="5" placement="0" quadOffset="2" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" offsetType="0" overrunDistanceUnit="MM" lineAnchorType="0" xOffset="0.5" polygonPlacementFlags="2" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" geometryGeneratorEnabled="1"/>
      ...
      <rule key="{c46ac40d-f229-4a7c-b075-1fe96c52d2f6}" description="Curral" filter="&quot;tipo&quot; = 1218 and &quot;visivel&quot; = 1">
        <settings calloutType="simple">
      ...
      <rule key="{f57b8b6e-995a-4ee8-a1a7-3a58ccd9044a}" description="Edificação" filter="&quot;tipo&quot; not in (1212, 1218) and &quot;visivel&quot; = 1">
        <settings calloutType="simple">
          <text-style useSubstitutions="0" fontStrikeout="0" namedStyle="Condensed" fontItalic="0" fontUnderline="0" fieldName="texto_edicao" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontLetterSpacing="0" fontFamily="Noto Sans" isExpression="0" legendString="Aa" fontKerning="1" fontSize="6" previewBkgrdColor="255,255,255,255" textColor="75,75,75,255" blendMode="0" textOpacity="1" fontWordSpacing="0" fontSizeUnit="Point" fontWeight="50" multilineHeight="0.80000000000000004" capitalization="0" allowHtml="0">
            <families/>
            <text-buffer bufferNoFill="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferDraw="0" bufferColor="255,255,255,255" bufferOpacity="1" bufferJoinStyle="128" bufferSize="1" bufferSizeUnits="MM" bufferBlendMode="0"/>
