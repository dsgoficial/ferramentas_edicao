...
<qgis version="3.24.3-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" enableorderby="0" forceraster="0" symbollevels="0" referencescale="-1">
    <rules key="{7a9efdbe-2548-4e64-a3f2-2a3482b5be1e}">
      <rule label="Visível" key="{13610b09-0185-4a86-9089-9a7fc27d07b6}" filter="&quot;visivel&quot; = 1">
        <rule label="Estação geradora de energia" symbol="0" key="{b1804ae4-4c32-4b01-8a4e-6fcf5e5ad631}" filter="&quot;tipo&quot; in (406, 409)"/>
        <rule symbol="1" key="{569c5f98-6eb2-472f-92b5-3ef6489cddc9}" filter="&quot;tipo&quot; = 1401"/>
        <rule label="Substação de energia" symbol="2" key="{595fe633-b083-4911-9fad-c8e84e433727}" filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (18)"/>
        <rule symbol="3" key="{cbf853d9-f8ab-47de-b6ab-0663551ce14a}" filter="ELSE"/>
      </rule>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{491c1c36-695e-4d09-967f-286489e44a6b}">
      <rule key="{ba88a524-b976-4d31-9468-b09354022007}" filter="&quot;visivel&quot; = 1">
        <rule description="Elemento energia" key="{6892c2ca-b444-43d1-a830-6d7eaa60fb1f}">
          <settings calloutType="simple">
            <text-style textOpacity="1" previewBkgrdColor="255,255,255,255" namedStyle="Condensed" fontWeight="50" fieldName="texto_edicao" blendMode="0" legendString="Aa" fontUnderline="0" isExpression="0" multilineHeight="0.80000000000000004" fontSizeMapUnitScale="3x:0,0,0,0,0,0" allowHtml="0" fontItalic="0" fontWordSpacing="0" textColor="75,75,75,255" fontLetterSpacing="0" useSubstitutions="0" fontStrikeout="0" fontKerning="1" textOrientation="horizontal" fontFamily="Noto Sans" capitalization="0" fontSize="6" fontSizeUnit="Point">
              <families/>
              <text-buffer bufferColor="255,255,255,255" bufferJoinStyle="128" bufferSizeUnits="MM" bufferBlendMode="0" bufferDraw="0" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="1" bufferOpacity="1"/>
              <text-mask maskType="0" maskSize="0.20000000000000001" maskOpacity="1" maskSizeUnits="MM" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskedSymbolLayers="" maskEnabled="1"/>
              <background shapeOffsetUnit="MM" shapeSVGFile="" shapeType="0" shapeSizeY="0" shapeOffsetY="0" shapeRadiiX="0" shapeSizeX="0" shapeBorderColor="128,128,128,255" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeRotationType="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeUnit="MM" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeSizeType="0" shapeFillColor="255,255,255,255" shapeRadiiUnit="MM" shapeRadiiY="0" shapeBorderWidthUnit="MM" shapeDraw="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeJoinStyle="64" shapeOpacity="1" shapeBlendMode="0" shapeBorderWidth="0" shapeRotation="0">
              ...
              <shadow shadowColor="0,0,0,255" shadowRadiusAlphaOnly="0" shadowOffsetAngle="135" shadowOpacity="0.69999999999999996" shadowRadiusUnit="MM" shadowRadius="1.5" shadowBlendMode="6" shadowOffsetDist="1" shadowOffsetUnit="MM" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowOffsetGlobal="1" shadowScale="100" shadowDraw="0" shadowUnder="0" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0"/>
              <dd_properties>
                <Option type="Map">
                  <Option type="QString" name="name" value=""/>
                  <Option name="properties"/>
            ...
            <text-format placeDirectionSymbol="0" plussign="0" multilineAlign="0" rightDirectionSymbol=">" useMaxLineLengthForAutoWrap="1" formatNumbers="0" addDirectionSymbol="0" wrapChar="|" autoWrapLength="0" decimals="3" reverseDirectionSymbol="0" leftDirectionSymbol="&lt;"/>
            <placement quadOffset="2" polygonPlacementFlags="2" placement="6" placementFlags="10" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" dist="0" lineAnchorPercent="0.5" overrunDistance="0" overrunDistanceUnit="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" repeatDistanceUnits="MM" offsetUnits="MM" lineAnchorType="0" lineAnchorClipping="0" layerType="PointGeometry" xOffset="0.5" distMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" repeatDistance="0" rotationUnit="AngleDegrees" maxCurvedCharAngleOut="-25" geometryGeneratorEnabled="1" geometryGeneratorType="PointGeometry" maxCurvedCharAngleIn="25" priority="5" yOffset="-0.5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" fitInPolygonOnly="0" distUnits="MM" offsetType="0"/>
            <rendering scaleMin="0" obstacleFactor="1" obstacleType="1" zIndex="0" upsidedownLabels="0" minFeatureSize="0" scaleMax="0" unplacedVisibility="0" labelPerPart="0" fontLimitPixelSize="0" mergeLines="0" limitNumLabels="0" fontMinPixelSize="3" displayAll="1" maxNumLabels="2000" scaleVisibility="0" obstacle="1" fontMaxPixelSize="10000" drawLabels="1"/>
            <dd_properties>
              <Option type="Map">
                <Option type="QString" name="name" value=""/>
                <Option type="Map" name="properties">
