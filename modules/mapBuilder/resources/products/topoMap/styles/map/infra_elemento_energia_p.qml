...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 referencescale="-1" symbollevels="0" enableorderby="0" type="RuleRenderer" forceraster="0">
    <rules key="{7a9efdbe-2548-4e64-a3f2-2a3482b5be1e}">
      <rule label="Visível" filter="&quot;visivel&quot; = 1" key="{13610b09-0185-4a86-9089-9a7fc27d07b6}">
        <rule symbol="0" label="Estação geradora de energia" filter="&quot;tipo&quot; in (406, 409)" key="{b1804ae4-4c32-4b01-8a4e-6fcf5e5ad631}"/>
        <rule symbol="1" filter="&quot;tipo&quot; = 1401" key="{569c5f98-6eb2-472f-92b5-3ef6489cddc9}"/>
        <rule symbol="2" label="Substação de energia" filter="&quot;tipo&quot; = 1801" key="{595fe633-b083-4911-9fad-c8e84e433727}"/>
  ...
  <labeling type="rule-based">
    <rules key="{cca1c092-363f-4c10-8c05-648f9bc617b4}">
      <rule filter="&quot;visivel&quot; = 1" key="{abda4dd0-0766-4438-8cf5-7241a02d5277}">
        <rule description="Elemento energia" key="{64aac3b1-654b-43a9-98de-7fe2a1c6f9e6}">
          <settings calloutType="simple">
            ...
            <placement centroidWhole="0" centroidInside="0" lineAnchorType="0" fitInPolygonOnly="0" xOffset="0.5" polygonPlacementFlags="2" priority="5" preserveRotation="1" geometryGeneratorEnabled="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" yOffset="-0.5" offsetUnits="MM" lineAnchorPercent="0.5" dist="0" rotationUnit="AngleDegrees" repeatDistanceUnits="MM" placement="6" quadOffset="2" maxCurvedCharAngleOut="-25" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" distUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" maxCurvedCharAngleIn="25" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistance="0" overrunDistanceUnit="MM" layerType="PointGeometry" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" placementFlags="10" geometryGeneratorType="PointGeometry"/>
