...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  <renderer-v2 type="RuleRenderer" enableorderby="0" forceraster="0" symbollevels="0" referencescale="-1">
    <rules key="{8bfbb73f-987d-4802-bb68-f5f682daa1d0}">
      <rule key="{b98ceb86-e44f-49c7-bbc8-3953ebad6af2}" filter="&quot;visivel&quot; = 1" label="Visível">
        <rule key="{2bd690c7-e346-4104-8a6c-0a78f971e204}" symbol="0" filter="&quot;tipo&quot; = 301" label="Duto de água"/>
        <rule key="{02a7be97-48a5-4261-8f74-f10b2507da1c}" symbol="1" filter="ELSE"/>
      </rule>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{45e8b7f9-242d-4aee-b4fa-df38b7dab920}">
      <rule key="{d7546e2d-f21f-4dda-9b70-216ba6bf9d13}" filter="&quot;visivel&quot; = 1">
        <settings calloutType="simple">
          <text-style useSubstitutions="0" fontStrikeout="0" namedStyle="Condensed" fontItalic="0" fontUnderline="0" fieldName="texto_edicao" textOrientation="horizontal" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontLetterSpacing="0" fontFamily="Noto Sans" isExpression="0" legendString="Aa" fontKerning="1" fontSize="6" previewBkgrdColor="255,255,255,255" textColor="0,0,0,255" blendMode="0" textOpacity="1" fontWordSpacing="0" fontSizeUnit="Point" fontWeight="50" multilineHeight="1" capitalization="0" allowHtml="0">
            <families/>
          ...
          <placement lineAnchorPercent="0.5" geometryGeneratorType="LineGeometry" layerType="LineGeometry" maxCurvedCharAngleOut="-25" rotationUnit="AngleDegrees" yOffset="0" rotationAngle="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" distUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" lineAnchorClipping="0" preserveRotation="1" centroidWhole="0" offsetUnits="MM" maxCurvedCharAngleIn="25" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" centroidInside="0" repeatDistanceUnits="MM" dist="0" priority="5" placement="2" quadOffset="4" geometryGenerator="with_variable(&#xd;&#xd;&#xa; 'moldura',&#xd;&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xd;&#xa;THEN &#xd;&#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xd;&#xa;ELSE&#xd;&#xd;&#xa;$geometry&#xd;&#xd;&#xa;END&#xd;&#xd;&#xa;)" offsetType="0" overrunDistanceUnit="MM" lineAnchorType="0" xOffset="0" polygonPlacementFlags="2" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" geometryGeneratorEnabled="1"/>
