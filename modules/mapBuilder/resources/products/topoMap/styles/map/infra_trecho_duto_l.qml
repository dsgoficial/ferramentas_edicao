...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 referencescale="-1" symbollevels="0" enableorderby="0" type="RuleRenderer" forceraster="0">
    <rules key="{8bfbb73f-987d-4802-bb68-f5f682daa1d0}">
      <rule label="Visível" filter="&quot;visivel&quot; = 1" key="{b98ceb86-e44f-49c7-bbc8-3953ebad6af2}">
        <rule symbol="0" label="Duto de água" filter="&quot;tipo&quot; = 301" key="{2bd690c7-e346-4104-8a6c-0a78f971e204}"/>
        <rule symbol="1" filter="ELSE" key="{02a7be97-48a5-4261-8f74-f10b2507da1c}"/>
      </rule>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{faf6402b-b645-485b-b89f-e2f6e0fb4de0}">
      <rule filter="&quot;visivel&quot; = 1" key="{0e9af3c5-93b2-415d-adc3-226c65d87d48}">
        <settings calloutType="simple">
          ...
          <placement centroidWhole="0" centroidInside="0" lineAnchorType="0" fitInPolygonOnly="0" xOffset="0" polygonPlacementFlags="2" priority="5" preserveRotation="1" geometryGeneratorEnabled="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" offsetUnits="MM" lineAnchorPercent="0.5" dist="0" rotationUnit="AngleDegrees" repeatDistanceUnits="MM" placement="2" quadOffset="4" maxCurvedCharAngleOut="-25" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" distUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" maxCurvedCharAngleIn="25" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistance="0" overrunDistanceUnit="MM" layerType="LineGeometry" geometryGenerator="with_variable(&#xd;&#xd;&#xa; 'moldura',&#xd;&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xd;&#xa;THEN &#xd;&#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xd;&#xa;ELSE&#xd;&#xd;&#xa;$geometry&#xd;&#xd;&#xa;END&#xd;&#xd;&#xa;)" placementFlags="10" geometryGeneratorType="LineGeometry"/>
