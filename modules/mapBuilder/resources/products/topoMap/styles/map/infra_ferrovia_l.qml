...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 referencescale="-1" symbollevels="0" enableorderby="0" type="mergedFeatureRenderer" forceraster="0">
    <renderer-v2 referencescale="-1" symbollevels="0" enableorderby="0" type="RuleRenderer" forceraster="0">
      <rules key="{43626dff-bb69-4cd6-a9bf-d195403f9a3f}">
        <rule filter="&quot;visivel&quot; = 1" key="{e47bca0f-c81b-4e27-9382-f1a56eb62daf}">
          <rule symbol="0" filter="ELSE" key="{86fb18eb-736c-475c-b792-d9efe7fee37c}"/>
          <rule symbol="1" label="L11105AH" filter="situacao_fisica in (0,3) and bitola in (1,4,5) and eletrificada = 2 and nr_linhas in (0,1)  and em_arruamento = 2 and tipo = 7" key="{90c27566-86ba-41c6-8463-c154ed70aefa}"/>
        </rule>
      </rules>
      <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{5a2c38e7-b274-4a5c-b4bb-3aa967e18af4}">
      <rule filter="&quot;visivel&quot; = 1" key="{8209797c-48c4-4313-901c-491b4f2bb317}">
        <rule filter="situacao_fisica in (0,3) and bitola in (1,4,5) and eletrificada = 2 and nr_linhas in (0,1)  and em_arruamento = 2 and tipo = 7" key="{a7520d0a-875f-4519-8e34-94693867673e}">
          <settings calloutType="simple">
            <text-style fontSize="10" previewBkgrdColor="255,255,255,255" fieldName="nome" fontStrikeout="0" fontFamily="Noto Sans" fontKerning="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textColor="50,50,50,255" fontItalic="1" isExpression="0" allowHtml="0" blendMode="0" fontUnderline="0" useSubstitutions="0" textOrientation="horizontal" legendString="Aa" fontWeight="25" multilineHeight="1" fontSizeUnit="Point" capitalization="0" namedStyle="Condensed Light Italic" textOpacity="1" fontWordSpacing="0" fontLetterSpacing="0">
              <families/>
              <text-buffer bufferSize="1" bufferDraw="0" bufferJoinStyle="128" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="250,250,250,255" bufferNoFill="1" bufferSizeUnits="MM" bufferOpacity="1"/>
              <text-mask maskSizeUnits="MM" maskEnabled="0" maskJoinStyle="128" maskSize="0" maskType="0" maskOpacity="1" maskedSymbolLayers="" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
              <background shapeRotationType="0" shapeRotation="0" shapeOpacity="1" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="0" shapeBorderWidth="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSVGFile="" shapeFillColor="255,255,255,255" shapeOffsetUnit="Point" shapeBorderColor="128,128,128,255" shapeSizeX="0" shapeRadiiX="0" shapeBlendMode="0" shapeSizeUnit="Point" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeRadiiUnit="Point" shapeJoinStyle="64" shapeOffsetX="0" shapeBorderWidthUnit="Point" shapeDraw="0" shapeRadiiY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeType="0">
            ...
            <placement centroidWhole="0" centroidInside="0" lineAnchorType="0" fitInPolygonOnly="0" xOffset="0" polygonPlacementFlags="2" priority="5" preserveRotation="1" geometryGeneratorEnabled="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" offsetUnits="MM" lineAnchorPercent="0.5" dist="0" rotationUnit="AngleDegrees" repeatDistanceUnits="MM" placement="2" quadOffset="4" maxCurvedCharAngleOut="-25" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" distUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" maxCurvedCharAngleIn="25" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistance="0" overrunDistanceUnit="MM" layerType="LineGeometry" geometryGenerator="" placementFlags="10" geometryGeneratorType="PointGeometry"/>
