...
<qgis styleCategories="Symbology|Labeling" version="3.22.1-Białowieża" labelsEnabled="1">
  <renderer-v2 enableorderby="0" symbollevels="0" referencescale="-1" forceraster="0" type="RuleRenderer">
    <rules key="{0aad622c-8f19-43fb-8e83-3e6f52a52085}">
      <rule filter=" &quot;tipo&quot; =  9 and situacao_fisica in (0,3)" key="{22d6fdb3-1c72-479c-8549-66074cbca65f}" symbol="0" label="A10902A"/>
      <rule filter=" &quot;tipo&quot; =  9 and situacao_fisica not in (0,3)" key="{d0035644-de42-4109-b295-d7081690028b}" symbol="1" label="A10902B"/>
      <rule filter=" &quot;tipo&quot; = 10" key="{c1e104b7-414b-4d44-8a57-f23f52a5db38}" symbol="2" label="A10902C"/>
      <rule filter="ELSE" key="{77bb8594-b470-4911-a6e8-a222e89cdb66}" symbol="3"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{c8ee27c3-5fa1-43b6-88a4-84da1c254946}">
      <rule key="{3b4613f6-d7ae-474c-b0fd-068c362af8da}" description="Pista de Pouso">
        <settings calloutType="simple">
          <text-style fontUnderline="0" namedStyle="Condensed" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOpacity="1" allowHtml="0" fontItalic="0" multilineHeight="0.80000000000000004" isExpression="0" legendString="Aa" fieldName="texto_edicao" blendMode="0" fontKerning="1" fontStrikeout="0" fontFamily="Noto Sans" textOrientation="horizontal" previewBkgrdColor="255,255,255,255" fontWordSpacing="0" capitalization="0" fontWeight="50" fontLetterSpacing="0" textColor="56,70,157,255" fontSize="7" useSubstitutions="0" fontSizeUnit="Point">
            <families/>
          ...
          <text-format multilineAlign="1" decimals="3" useMaxLineLengthForAutoWrap="1" wrapChar="|" rightDirectionSymbol=">" placeDirectionSymbol="0" formatNumbers="0" leftDirectionSymbol="&lt;" reverseDirectionSymbol="0" plussign="0" autoWrapLength="0" addDirectionSymbol="0"/>
          <placement dist="0" offsetUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistanceUnits="MM" geometryGeneratorEnabled="1" centroidWhole="0" xOffset="0.5" rotationAngle="0" yOffset="-0.5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="with_variable(&#xd;&#xd;&#xa; 'moldura',&#xd;&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xd;&#xa;THEN &#xd;&#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xd;&#xa;ELSE&#xd;&#xd;&#xa;$geometry&#xd;&#xd;&#xa;END&#xd;&#xd;&#xa;)" geometryGeneratorType="PolygonGeometry" overrunDistanceUnit="MM" placementFlags="10" polygonPlacementFlags="3" fitInPolygonOnly="0" offsetType="0" placement="4" centroidInside="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" lineAnchorType="0" lineAnchorClipping="0" maxCurvedCharAngleOut="-25" priority="5" distUnits="MM" layerType="PolygonGeometry" preserveRotation="1" quadOffset="2" rotationUnit="AngleDegrees" maxCurvedCharAngleIn="25" overrunDistance="0" lineAnchorPercent="0.5"/>
