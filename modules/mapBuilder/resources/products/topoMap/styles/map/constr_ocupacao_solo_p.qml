...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="0">
  <renderer-v2 type="RuleRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <rules key="{5adbac42-96ad-4569-9e33-64a725a4a2b7}">
      <rule filter=" &quot;visivel&quot; = 1" key="{85a4068f-9f1d-4ae7-a047-fe2944f76002}" label="Visivel">
        ...
        <rule filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (1)" description="Cemitério" key="{859fca67-2193-42c3-b93c-1698144888de}" label="P20209D" symbol="1"/>
        <rule filter="&quot;tipo&quot; = 1601" key="{eeca999a-7f38-4c1e-aea1-84b828596e5d}" symbol="2"/>
        <rule filter="ELSE" key="{1c06e6e5-2f0b-4ec6-ab5b-0f29c0ad826e}" symbol="3"/>
      </rule>
    </rules>
    <symbols>
