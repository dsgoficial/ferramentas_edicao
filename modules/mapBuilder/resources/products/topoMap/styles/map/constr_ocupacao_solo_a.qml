...
<qgis version="3.24.3-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0">
    <rules key="{9ed15ebd-9075-4a2b-8fe6-a3b74ad93330}">
      <rule key="{16c45c6c-f923-4cd9-885c-e5331feaaad4}" filter="&quot;visivel&quot; =1">
        <rule symbol="0" label="Cemiterio" key="{4a220843-0c95-45b3-a498-24a3731da7e2}" filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (1)"/>
        <rule symbol="1" label="Sports Ground" key="{bf4038cd-98e9-4bb0-8e9f-cfca9c83912b}" filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (2,3)" description="Campo Quadra e Pista de competição"/>
        <rule symbol="2" label="A10811A" key="{2c93065a-c1ef-4d14-b3bb-f108a8ca7108}" filter="&quot;tipo&quot; = 409" description="Pátio aeroportuário"/>
        <rule symbol="3" label="Pátio de Dutos" key="{f921ea0a-a731-4d00-b05a-f260bdc1de20}" filter="&quot;tipo&quot; = 416"/>
        <rule symbol="4" key="{6b599614-7f52-4ae0-a795-12d579e93b5b}" filter="ELSE"/>
      </rule>
    </rules>
    <symbols>
      <symbol name="0" force_rhr="0" type="fill" clip_to_extent="1" alpha="1">
        ...
        <layer class="CentroidFill" enabled="1" locked="0" pass="0">
          ...
          <symbol name="@0@2" force_rhr="0" type="marker" clip_to_extent="1" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
            ...
            <layer class="SvgMarker" enabled="1" locked="0" pass="0">
              <Option type="Map">
                ...
                <Option value="0.75" name="fixedAspectRatio" type="QString"/>
      ...
      <symbol name="1" force_rhr="0" type="fill" clip_to_extent="1" alpha="1">
        ...
        <layer class="CentroidFill" enabled="1" locked="0" pass="0">
          ...
          <symbol name="@1@1" force_rhr="0" type="marker" clip_to_extent="1" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol name="4" force_rhr="0" type="fill" clip_to_extent="1" alpha="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{0b9721d2-3d2a-4889-94ed-1b2c41fc2fec}">
      <rule key="{a338fd91-35d0-4ae3-b016-9f60446d60ae}" filter="&quot;visivel&quot; = 1">
        <rule key="{9c8a8853-3620-41de-a5e2-748276452b0e}" description="Ocupação do solo">
          <settings calloutType="simple">
            <text-style fontLetterSpacing="0" textOrientation="horizontal" textColor="0,0,0,255" fontWordSpacing="0" fieldName="texto_edicao" fontItalic="0" multilineHeight="0.80000000000000004" fontSizeUnit="Point" fontWeight="50" allowHtml="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="0" legendString="Aa" textOpacity="1" fontStrikeout="0" fontKerning="1" previewBkgrdColor="255,255,255,255" fontFamily="Noto Sans" capitalization="0" namedStyle="Condensed" blendMode="0" useSubstitutions="0" fontUnderline="0" fontSize="6">
              ...
              <text-mask maskJoinStyle="128" maskEnabled="1" maskSize="0.20000000000000001" maskedSymbolLayers="" maskSizeUnits="MM" maskOpacity="1" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
