...
<qgis styleCategories="Symbology|Labeling" version="3.22.1-Białowieża" labelsEnabled="1">
  <renderer-v2 enableorderby="0" symbollevels="0" referencescale="-1" forceraster="0" type="RuleRenderer">
    <rules key="{9ed15ebd-9075-4a2b-8fe6-a3b74ad93330}">
      <rule filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (1)" key="{64172743-95f3-4cfa-a40a-134f00af8238}" symbol="0" label="Cemiterio"/>
      <rule filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (2,3)" key="{680adb26-7a08-46b7-9ad6-d14dfd30db89}" symbol="1" label="Sports Ground" description="Campo Quadra e Pista de competição"/>
      <rule filter="&quot;tipo&quot; = 409" key="{888b1751-710f-44fc-910d-b3f83817c648}" symbol="2" label="A10811A" description="Pátio aeroportuário"/>
      <rule filter="ELSE" key="{7a2f3cfd-1fb8-4ea3-99e9-2f1b2ccdd402}" symbol="3"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{dfa94eaa-5a4d-44af-b260-f03b57f8d6e8}">
      <rule key="{0c1cc224-8775-42b8-bc8d-43178ee2baa6}" description="Ocupação do solo">
