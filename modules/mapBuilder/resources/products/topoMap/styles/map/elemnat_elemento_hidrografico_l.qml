...
<qgis version="3.24.3-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  <renderer-v2 symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0" type="RuleRenderer">
    <rules key="{7688ed0d-5165-4098-8ca9-83654a6e5bc7}">
      <rule key="{f1b5746e-1f84-4aa7-9ef9-2690584acda1}" symbol="0" filter="&quot;tipo&quot; = 12" label="Corredeira"/>
      <rule key="{1440372f-4a84-49c8-8a91-03da1a5f27e5}" symbol="1" filter="&quot;tipo&quot; in (9,10,11)" label="Queda dágua"/>
      <rule key="{6830f428-f899-49ab-9bfe-e55ca7242e3f}" symbol="2" filter="ELSE"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" name="0" type="line" force_rhr="0">
        ...
        <layer class="HashLine" enabled="1" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="interval" type="QString" value="0.7"/>
          ...
          <symbol alpha="1" clip_to_extent="1" name="@0@0" type="line" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
    ...
    <rules key="{638a9bbe-2592-4f26-985f-f2f09551faef}">
      <rule key="{809c29b3-3d9e-4d68-81fb-ed6a48e2190e}" filter="&quot;tipo&quot; in (9,10,11,12)" description="Corredeira e queda dágua">
        <settings calloutType="simple">
          ...
          <placement offsetType="0" dist="0" priority="5" repeatDistanceUnits="MM" fitInPolygonOnly="0" maxCurvedCharAngleOut="-25" overrunDistanceUnit="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" distUnits="MM" yOffset="-0.5" rotationAngle="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" quadOffset="2" preserveRotation="1" centroidInside="0" lineAnchorPercent="0.5" geometryGeneratorEnabled="1" offsetUnits="MM" repeatDistance="0" lineAnchorType="0" centroidWhole="0" xOffset="0.5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="LineGeometry" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" distMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" polygonPlacementFlags="2" geometryGenerator="with_variable(&#xd;&#xd;&#xa; 'moldura',&#xd;&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xd;&#xa;THEN &#xd;&#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xd;&#xa;ELSE&#xd;&#xd;&#xa;$geometry&#xd;&#xd;&#xa;END&#xd;&#xd;&#xa;)" overrunDistance="0" rotationUnit="AngleDegrees" placement="4" maxCurvedCharAngleIn="25" layerType="LineGeometry"/>
          <rendering labelPerPart="0" drawLabels="1" scaleMin="0" maxNumLabels="2000" fontMinPixelSize="3" limitNumLabels="0" zIndex="0" obstacleFactor="1" fontMaxPixelSize="10000" obstacle="1" obstacleType="1" fontLimitPixelSize="0" scaleMax="0" minFeatureSize="0" scaleVisibility="0" unplacedVisibility="0" displayAll="1" upsidedownLabels="0" mergeLines="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" type="QString" value=""/>
              <Option name="properties" type="Map">
