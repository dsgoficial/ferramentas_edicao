...
<qgis styleCategories="Symbology|Labeling" version="3.22.1-Białowieża" labelsEnabled="1">
  <renderer-v2 enableorderby="0" symbollevels="0" referencescale="-1" forceraster="0" type="RuleRenderer">
    <rules key="{9ebfed55-e318-4164-900d-875a903442fa}">
      <rule filter="&quot;tipo&quot; in (1938, 1939, 1940, 1941, 1942, 1943, 1944)" key="{9ea761e5-8685-4634-ac2c-833c2c51ee03}" symbol="0" label="Atracadouro"/>
      <rule filter="&quot;tipo&quot; = 1201" key="{6b1a6f99-4b11-4451-b791-cdf7f549a490}" symbol="1" label="Torre comunicação"/>
      <rule filter="ELSE" key="{e6599a5e-696c-4437-a0c9-a06e68459862}" symbol="2"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" name="1" force_rhr="0" type="marker" clip_to_extent="1">
        ...
        <layer class="SvgMarker" pass="0" locked="0" enabled="1">
          ...
          <prop v="0.00000000000000006,-1.39999999999999991" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="0,0,0,255" k="outline_color"/>
          <prop v="0" k="outline_width"/>
  ...
  <labeling type="rule-based">
    <rules key="{6849fa40-8bbc-4cdc-b9eb-460aafe0870b}">
      <rule key="{2ae38353-da54-4769-86e4-ef3ad22a5abc}" description="Elemento infraestrutura">
