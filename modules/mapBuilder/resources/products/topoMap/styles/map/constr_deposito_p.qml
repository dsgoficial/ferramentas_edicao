...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" type="RuleRenderer" referencescale="-1">
    <rules key="{15e09ec0-9841-4520-b07a-26e1ce1469e9}">
      <rule label="Visível" key="{dd502e66-043d-4cdc-b98a-e7b7d0ffe2eb}" filter=" &quot;visivel&quot; = 1">
        <rule label="P20214E" symbol="0" key="{7cd9d25e-c353-460b-9708-b4f3f0dcd74f}" description="Galpão, armazém" filter="&quot;tipo&quot; in (108, 132, 198)"/>
        <rule label="P20214A" symbol="1" key="{9578b293-d8bc-4df0-9394-00e3dc45ca84}" filter="&quot;tipo&quot; = 109"/>
        <rule label="P20214B" symbol="2" key="{c985b851-ad25-4a76-9625-5c2552703ea0}" filter="&quot;tipo&quot; = 113"/>
        <rule label="P20214C" symbol="3" key="{f2dbd971-2a05-4177-a181-42a55334620f}" description="Tanque dagua" filter="&quot;tipo&quot; in (201,204,301)"/>
        <rule label="P10704A" symbol="4" key="{2de32ca8-9fc1-41c9-a306-3cfefb65aa34}" filter="&quot;tipo&quot; = 202"/>
        <rule label="P10704B" symbol="5" key="{d4f82235-073f-404c-a548-19a152bbb46d}" description="Cisterna" filter="&quot;tipo&quot; = 203"/>
        <rule symbol="6" key="{93e1af9a-e884-4697-9b99-1670f82aa670}" filter="ELSE"/>
      </rule>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" name="4" force_rhr="0" type="marker" clip_to_extent="1">
        ...
        <layer enabled="1" pass="0" locked="0" class="SvgMarker">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
            <Option name="color" value="0,160,222,255" type="QString"/>
            ...
            <Option name="offset" value="0,-1.09999999999999987" type="QString"/>
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
            <Option name="outline_color" value="0,0,0,255" type="QString"/>
            <Option name="outline_width" value="0" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{e0d24a23-de3a-4740-8d21-04573806783d}">
      <rule key="{a777cd25-9169-4daf-9123-dff799a708d2}" description="Depósito" filter="&quot;visivel&quot; = 1">
        <settings calloutType="simple">
          <text-style fontSizeUnit="Point" capitalization="0" legendString="Aa" useSubstitutions="0" fontUnderline="0" fontLetterSpacing="0" fontKerning="1" fieldName="texto_edicao" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" textOpacity="1" allowHtml="0" fontStrikeout="0" textOrientation="horizontal" textColor="75,75,75,255" isExpression="0" fontSize="6" multilineHeight="0.80000000000000004" fontWeight="50" blendMode="0" previewBkgrdColor="255,255,255,255" namedStyle="Condensed" fontFamily="Noto Sans" fontWordSpacing="0">
            <families/>
            ...
            <text-mask maskEnabled="1" maskType="0" maskSizeUnits="MM" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskOpacity="1" maskedSymbolLayers="" maskSize="0.20000000000000001" maskJoinStyle="128"/>
