...
<qgis version="3.24.3-Tisler" styleCategories="Symbology|Labeling" labelsEnabled="1">
  <renderer-v2 forceraster="0" enableorderby="0" symbollevels="0" referencescale="-1" type="RuleRenderer">
    <rules key="{62a3dea4-17b6-4639-a67e-4acc783c4aec}">
      <rule symbol="0" filter="visivel = 1" key="{081a9ce5-307c-4974-a769-21654d7aebf3}"/>
      <rule symbol="1" label="Pista de pouso Constr ou Desc" filter="tipo = 9 and &quot;visivel&quot; = 1 and situacao_fisica in (0,3)" key="{ea5311d0-4336-43ba-905b-22d982976eac}"/>
      <rule symbol="2" label="Pista de pouso Aband ou Destr ou Em constr" filter="tipo = 9 and &quot;visivel&quot; = 1 and situacao_fisica in (1,2,4)" key="{fb803820-f2c6-4662-a535-b221994a06c7}"/>
      <rule symbol="3" filter="ELSE" key="{ab20a2c0-a907-4e78-b874-6e6446e7dc1f}"/>
    </rules>
    <symbols>
      ...
      <symbol name="1" alpha="1" clip_to_extent="1" force_rhr="0" type="marker">
        ...
        <layer class="SvgMarker" pass="0" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="offset_unit" value="MM" type="QString"/>
            <Option name="outline_color" value="57,70,157,255" type="QString"/>
            <Option name="outline_width" value="0" type="QString"/>
            <Option name="outline_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="outline_width_unit" value="MM" type="QString"/>
            <Option name="parameters"/>
            <Option name="scale_method" value="diameter" type="QString"/>
            <Option name="size" value="4.08" type="QString"/>
            <Option name="size_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            <Option name="size_unit" value="MM" type="QString"/>
            <Option name="vertical_anchor_point" value="1" type="QString"/>
          </Option>
  ...
  <labeling type="rule-based">
    <rules key="{c3649f04-c927-47e0-83fb-283e4e41b1f8}">
      <rule filter="&quot;visivel&quot; = 1" key="{c78875f3-e4ac-42eb-b5e4-a3816abf0e62}">
        <rule key="{19d919e7-815c-4177-b172-ed576912c296}">
          <settings calloutType="simple">
            ...
            <placement maxCurvedCharAngleOut="-25" yOffset="-0.5" lineAnchorClipping="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" centroidWhole="0" geometryGeneratorType="PointGeometry" preserveRotation="1" offsetType="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" quadOffset="2" lineAnchorPercent="0.5" geometryGeneratorEnabled="1" maxCurvedCharAngleIn="25" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" repeatDistanceUnits="MM" fitInPolygonOnly="0" placementFlags="10" lineAnchorType="0" offsetUnits="MM" placement="6" distUnits="MM" centroidInside="0" dist="0" overrunDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" overrunDistanceUnit="MM" layerType="PointGeometry" xOffset="0.5" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" priority="5" rotationUnit="AngleDegrees"/>
