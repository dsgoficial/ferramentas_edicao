...
<qgis labelsEnabled="0" styleCategories="Symbology|Labeling" version="3.24.3-Tisler">
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" referencescale="-1" symbollevels="0">
    <rules key="{62a3dea4-17b6-4639-a67e-4acc783c4aec}">
      ...
      <rule symbol="1" filter="tipo = 9 and &quot;visivel&quot; = 1 and situacao_fisica in (0,3)" label="Pista de pouso Constr ou Desc" key="{ea5311d0-4336-43ba-905b-22d982976eac}"/>
      <rule symbol="2" filter="tipo = 9 and &quot;visivel&quot; = 1 and situacao_fisica in (1,2,4)" label="Pista de pouso Aband ou Destr ou Em constr" key="{fb803820-f2c6-4662-a535-b221994a06c7}"/>
      ...
      <symbol alpha="1" force_rhr="0" type="marker" name="1" clip_to_extent="1">
        ...
        <layer pass="0" enabled="1" class="SvgMarker" locked="0">
          <Option type="Map">
            ...
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
            <Option type="QString" name="outline_color" value="57,70,157,255"/>
            <Option type="QString" name="outline_width" value="0"/>
            <Option type="QString" name="outline_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="outline_width_unit" value="MM"/>
            <Option name="parameters"/>
            <Option type="QString" name="scale_method" value="diameter"/>
            <Option type="QString" name="size" value="4.08"/>
            <Option type="QString" name="size_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="size_unit" value="MM"/>
            <Option type="QString" name="vertical_anchor_point" value="1"/>
          </Option>
