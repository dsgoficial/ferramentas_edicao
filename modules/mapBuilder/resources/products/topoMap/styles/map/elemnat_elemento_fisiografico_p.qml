...
<qgis minScale="100000000" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" simplifyDrawingHints="0" version="3.18.3-Zürich" styleCategories="AllStyleCategories" simplifyAlgorithm="0" maxScale="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" readOnly="0">
  <flags>
  ...
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" type="RuleRenderer">
    <rules key="{0c113be7-897d-4344-9d32-864d6fcdc84d}">
      <rule label="Rocha" filter="&quot;tipo&quot; in (21,22)" symbol="0" key="{cae42fa1-7c4a-4db7-9208-d225740a758e}"/>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              ...
              <Option type="Map">
                <Option name="Caverna (20)" type="QString" value="20"/>
              </Option>
              <Option type="Map">
                <Option name="Gruta (19)" type="QString" value="19"/>
              </Option>
              <Option type="Map">
                <Option name="Rocha - Matacão/pedra (21)" type="QString" value="21"/>
              </Option>
              <Option type="Map">
                <Option name="Rocha - Penedo isolado (22)" type="QString" value="22"/>
              </Option>
            </Option>
          </Option>
        </config>
