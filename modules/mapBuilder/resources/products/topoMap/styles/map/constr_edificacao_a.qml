...
<qgis styleCategories="Symbology|Labeling" version="3.22.1-Białowieża" labelsEnabled="1">
  <renderer-v2 enableorderby="0" symbollevels="0" referencescale="-1" forceraster="0" type="RuleRenderer">
    <rules key="{7e7c5e8b-3835-4813-bc90-01d87c84467a}">
      <rule filter="&quot;tipo&quot; in (0) or  (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (2,5,8,10)" key="{0cffb1d5-eca0-449b-a209-2179723ce30f}" symbol="0" label="A20403A" description="Energia, Industria, Genérico"/>
      <rule filter="ELSE" key="{38b829c8-1b5b-4cb4-9bfb-57f61d897541}" symbol="1"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{6c203b34-132a-4b71-b93d-866ff055eca6}">
      <rule key="{038a2ba5-909e-4bf6-b376-81297c8728fd}" description="Edificação">
