  ...
  <renderer-v2 forceraster="0" enableorderby="0" referencescale="-1" symbollevels="0" type="RuleRenderer">
    <rules key="{7e7c5e8b-3835-4813-bc90-01d87c84467a}">
      <rule filter="&quot;visivel&quot; = 1" key="{c9d1e298-fe17-4fe3-b8a6-842e7904d800}">
        <rule filter="&quot;tipo&quot; in (0, 1212, 1298) or (&quot;tipo&quot; - &quot;tipo&quot;%100)/100 in (1, 2, 4, 5, 6, 7, 8, 9, 10, 11, 13, 19, 17, 20, 21,  22, 23, 24, 26, 30)" symbol="0" label="A20403A" key="{3026e123-049d-4763-bc61-54758e1d138a}" description="Energia, Industria, Genérico"/>
        <rule filter="&quot;tipo&quot; = 1216" symbol="1" label="A20405A" key="{5dea4b5f-b74b-4539-924c-c5be6d2d8914}"/>
        <rule filter="&quot;tipo&quot; = 1215" symbol="2" key="{78509594-2c3b-4a2e-83ba-c2cfb831b683}"/>
        <rule filter="ELSE" symbol="3" key="{e9053e2d-98dd-4112-a0e5-90e560cbd045}"/>
      </rule>
    </rules>
    <symbols>
        ...
        <rule key="{701f6f67-a0ac-4c1e-befb-ed1bdf338a7c}" description="Edificação">
          <settings calloutType="simple">
            <text-style fontStrikeout="0" fontSizeUnit="Point" fontUnderline="0" blendMode="0" capitalization="0" textOrientation="horizontal" fontItalic="0" fontWordSpacing="0" useSubstitutions="0" legendString="Aa" fontSize="6" fontWeight="50" namedStyle="Condensed" textColor="36,31,33,255" textOpacity="1" previewBkgrdColor="255,255,255,255" allowHtml="0" fontFamily="Noto Sans" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="0" fieldName="texto_edicao" fontLetterSpacing="0" multilineHeight="0.80000000000000004" fontKerning="1">
              ...
              <shadow shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowOffsetGlobal="1" shadowOffsetAngle="135" shadowRadiusAlphaOnly="0" shadowOpacity="0.69999999999999996" shadowBlendMode="6" shadowOffsetUnit="MM" shadowRadiusUnit="MM" shadowOffsetDist="1" shadowScale="100" shadowDraw="0" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowRadius="1.5" shadowColor="0,0,0,255" shadowUnder="0"/>
              <dd_properties>
                <Option type="Map">
                  <Option value="" type="QString" name="name"/>
                  <Option name="properties"/>
            ...
            <text-format plussign="0" multilineAlign="0" autoWrapLength="0" wrapChar="|" reverseDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" decimals="3" addDirectionSymbol="0" leftDirectionSymbol="&lt;" rightDirectionSymbol=">" placeDirectionSymbol="0" formatNumbers="0"/>
            <placement dist="0" offsetUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" fitInPolygonOnly="0" lineAnchorClipping="0" polygonPlacementFlags="3" lineAnchorPercent="0.5" placement="8" maxCurvedCharAngleIn="25" quadOffset="2" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" layerType="PolygonGeometry" repeatDistanceUnits="MM" rotationUnit="AngleDegrees" offsetType="0" overrunDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" geometryGenerator="with_variable(&#xd;&#xd;&#xd;&#xa; 'moldura',&#xd;&#xd;&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xd;&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xd;&#xd;&#xa;THEN &#xd;&#xd;&#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xd;&#xd;&#xa;ELSE&#xd;&#xd;&#xd;&#xa;$geometry&#xd;&#xd;&#xd;&#xa;END&#xd;&#xd;&#xd;&#xa;)" centroidInside="0" overrunDistanceUnit="MM" geometryGeneratorType="PolygonGeometry" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" repeatDistance="0" maxCurvedCharAngleOut="-25" priority="5" distUnits="MM" rotationAngle="0" geometryGeneratorEnabled="1" distMapUnitScale="3x:0,0,0,0,0,0" xOffset="0.5" yOffset="-0.5" placementFlags="10"/>
            <rendering obstacleFactor="1" maxNumLabels="2000" labelPerPart="0" unplacedVisibility="0" mergeLines="0" obstacleType="1" zIndex="0" displayAll="0" scaleMin="0" scaleMax="0" fontLimitPixelSize="0" fontMinPixelSize="3" fontMaxPixelSize="10000" obstacle="1" upsidedownLabels="0" drawLabels="1" minFeatureSize="0" limitNumLabels="0" scaleVisibility="0"/>
            <dd_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option type="Map" name="properties">
