...
<qgis version="3.24.3-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" referencescale="-1" symbollevels="0" enableorderby="0" forceraster="0">
    <rules key="{7e7c5e8b-3835-4813-bc90-01d87c84467a}">
      <rule filter="&quot;visivel&quot; = 1" key="{c9d1e298-fe17-4fe3-b8a6-842e7904d800}">
        ...
        <rule symbol="1" filter="&quot;tipo&quot; = 1218" label="Curral" key="{21ac745b-7262-4ade-9412-c81c6cfa8665}"/>
        <rule symbol="2" filter="&quot;tipo&quot; = 1216" label="A20405A" key="{5dea4b5f-b74b-4539-924c-c5be6d2d8914}"/>
  ...
  <labeling type="rule-based">
    <rules key="{d3fc36e8-6cd1-4559-9014-c5e08a182780}">
      <rule description="Sede operacional de fazenda" filter="&quot;tipo&quot; = 1212 and &quot;visivel&quot; = 1" key="{68243a92-a610-4a92-83e2-e8eaf580ce42}">
      ...
      <rule description="Curral" filter="&quot;tipo&quot; = 1218 and &quot;visivel&quot; = 1" key="{6d4cdb0b-31f2-417a-b753-16bfc8bf1e1c}">
        <settings calloutType="simple">
      ...
      <rule description="Edificação" filter="&quot;tipo&quot; not in (1212, 1218) and &quot;visivel&quot; = 1" key="{64c9a6ac-c00b-4657-97a0-4426d0cc14fa}">
        <settings calloutType="simple">
          <text-style fontLetterSpacing="0" fontSize="6" allowHtml="0" fontWordSpacing="0" capitalization="0" legendString="Aa" fontSizeUnit="Point" fontUnderline="0" multilineHeight="0.80000000000000004" textOrientation="horizontal" textOpacity="1" isExpression="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Condensed" fontItalic="0" previewBkgrdColor="255,255,255,255" useSubstitutions="0" fontFamily="Noto Sans" blendMode="0" fontStrikeout="0" textColor="36,31,33,255" fieldName="texto_edicao" fontKerning="1" fontWeight="50">
            <families/>
            <text-buffer bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferNoFill="1" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferBlendMode="0" bufferSize="1" bufferOpacity="1"/>
