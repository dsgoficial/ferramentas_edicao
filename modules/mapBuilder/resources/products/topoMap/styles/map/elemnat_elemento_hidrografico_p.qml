...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 referencescale="-1" symbollevels="0" enableorderby="0" type="RuleRenderer" forceraster="0">
    <rules key="{ea96e2dd-153d-4f78-9dce-a869c560c2a4}">
      <rule label="Visível" filter="&quot;visivel&quot; = 1" key="{7269d453-0468-4914-bc91-1dcd457f1de2}">
        <rule symbol="0" label="Rocha em água" filter="&quot;tipo&quot; = 8" key="{6a32763d-7f6c-46f0-9c0e-ba697f96bf02}"/>
        <rule symbol="1" label="Queda d'água" filter="&quot;tipo&quot; in (9, 10, 11)" key="{797a0e9e-8dba-4922-b847-16ffb024e774}"/>
        <rule symbol="2" label="Corredeira" filter="&quot;tipo&quot; = 12" key="{e320e23b-e2ae-48db-9d5e-c4445aae8194}"/>
        <rule symbol="3" filter="ELSE" key="{34502030-54f3-4822-8ee3-c95cdccc5780}"/>
      </rule>
    </rules>
    <symbols>
