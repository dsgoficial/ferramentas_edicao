...
<qgis version="3.24.3-Tisler" styleCategories="Symbology|Labeling" labelsEnabled="1">
  <renderer-v2 forceraster="0" type="RuleRenderer" referencescale="-1" symbollevels="0" enableorderby="0">
    <rules key="{ea96e2dd-153d-4f78-9dce-a869c560c2a4}">
      <rule label="Visível" filter="&quot;visivel&quot; = 1" key="{7269d453-0468-4914-bc91-1dcd457f1de2}">
        <rule label="Rocha em água" filter="&quot;tipo&quot; = 8" symbol="0" key="{6a32763d-7f6c-46f0-9c0e-ba697f96bf02}"/>
        <rule label="Queda d'água" filter="&quot;tipo&quot; in (9, 10, 11)" symbol="1" key="{797a0e9e-8dba-4922-b847-16ffb024e774}"/>
        <rule label="Corredeira" filter="&quot;tipo&quot; = 12" symbol="2" key="{e320e23b-e2ae-48db-9d5e-c4445aae8194}"/>
        <rule filter="ELSE" symbol="3" key="{34502030-54f3-4822-8ee3-c95cdccc5780}"/>
      </rule>
    </rules>
    <symbols>
      <symbol force_rhr="0" type="marker" alpha="1" name="0" clip_to_extent="1">
        ...
        <layer class="SvgMarker" pass="0" locked="0" enabled="1">
          <Option type="Map">
            ...
            <Option type="QString" value="base64:" name="name"/>
      ...
      <symbol force_rhr="0" type="marker" alpha="1" name="2" clip_to_extent="1">
        ...
        <layer class="SvgMarker" pass="0" locked="0" enabled="1">
          <Option type="Map">
            ...
            <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
            <Option type="QString" value="MM" name="offset_unit"/>
            <Option type="QString" value="0,160,222,255" name="outline_color"/>
            <Option type="QString" value="0" name="outline_width"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="outline_width_map_unit_scale"/>
            <Option type="QString" value="MM" name="outline_width_unit"/>
            <Option name="parameters"/>
  ...
  <labeling type="rule-based">
    <rules key="{2ba45586-7c34-4b57-aca2-3797040aacd2}">
      <rule description="Corredeira e queda dágua" filter="&quot;tipo&quot; in (9, 10, 11, 12) and &quot;visivel&quot; = 1" key="{5ff338cd-3c99-4cd3-86fb-31263d579158}">
        <settings calloutType="simple">
          <text-style fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" allowHtml="0" fontWordSpacing="0" previewBkgrdColor="255,255,255,255" namedStyle="Condensed Italic" fontFamily="Noto Sans" fontSize="6" textColor="0,160,223,255" fontWeight="50" capitalization="0" fontLetterSpacing="0" fontItalic="1" fontStrikeout="0" fieldName="texto_edicao" legendString="Aa" blendMode="0" multilineHeight="0.80000000000000004" useSubstitutions="0" isExpression="0" textOpacity="1" textOrientation="horizontal" fontKerning="1" fontSizeUnit="Point">
            <families/>
