...
<qgis version="3.24.3-Tisler" styleCategories="Symbology|Labeling" labelsEnabled="1">
  <renderer-v2 symbollevels="0" referencescale="-1" type="RuleRenderer" forceraster="0" enableorderby="0">
    <rules key="{ea96e2dd-153d-4f78-9dce-a869c560c2a4}">
      <rule key="{df7e02c1-5dd6-4edc-b725-46246306cb69}" symbol="0" filter="&quot;tipo&quot; in (9,10,11)" label="Queda dágua"/>
      <rule key="{45c34cea-3e18-4c68-a9e2-0767ff4657d6}" symbol="1" filter="&quot;tipo&quot; = 12" label="Corredeira"/>
      <rule key="{048411e9-3a7f-40b8-b24a-eb2bfcf293c6}" symbol="2" filter="&quot;tipo&quot; = 8" label="Rocha em água"/>
      <rule key="{997c3743-40ba-4c08-a934-1a2f8fe7a220}" symbol="3" filter="ELSE"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" type="marker" name="0" alpha="1" force_rhr="0">
        ...
        <layer pass="0" enabled="1" class="SimpleMarker" locked="0">
          <Option type="Map">
            ...
            <Option value="0,160,223,255" type="QString" name="outline_color"/>
      ...
      <symbol clip_to_extent="1" type="marker" name="1" alpha="1" force_rhr="0">
        ...
        <layer pass="0" enabled="1" class="SvgMarker" locked="0">
          <Option type="Map">
            ...
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="offset_unit"/>
            <Option value="0,160,222,255" type="QString" name="outline_color"/>
  ...
  <labeling type="rule-based">
    <rules key="{21dd56aa-c55d-4f5f-9d69-9d4c8e76141d}">
      <rule key="{14715b59-9ef5-4b2e-9eae-b2b5a7c34f57}" description="Corredeira e queda dágua" filter="&quot;tipo&quot; in (9,10,11,12)">
        <settings calloutType="simple">
          <text-style fontWordSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" fontFamily="Noto Sans" fontLetterSpacing="0" blendMode="0" fontWeight="50" isExpression="0" textOpacity="1" legendString="Aa" fontStrikeout="0" fontItalic="1" fontSizeUnit="Point" capitalization="0" fontUnderline="0" textColor="0,160,223,255" fieldName="texto_edicao" fontSize="6" multilineHeight="0.80000000000000004" fontKerning="1" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" namedStyle="Condensed Italic" allowHtml="0">
            <families/>
          ...
          <rendering limitNumLabels="0" obstacleType="1" scaleMin="0" fontLimitPixelSize="0" scaleVisibility="0" drawLabels="1" zIndex="0" displayAll="1" upsidedownLabels="0" obstacleFactor="1" unplacedVisibility="0" fontMaxPixelSize="10000" mergeLines="0" scaleMax="0" maxNumLabels="2000" obstacle="1" labelPerPart="0" minFeatureSize="0" fontMinPixelSize="3"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" type="QString" name="name"/>
              <Option type="Map" name="properties">
