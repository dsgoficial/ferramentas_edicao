  ...
  <renderer-v2 type="RuleRenderer" symbollevels="0" enableorderby="0" referencescale="-1" forceraster="0">
    <rules key="{19d54618-79b3-47af-bbd0-e84dac371fef}">
      <rule filter="visivel = 1" key="{d065bfba-111e-4410-b9f7-971ac015b2f4}">
        <rule label="L10303A" symbol="0" filter="&quot;material_construcao&quot; in (1, 2) and  &quot;sobreposto_transportes&quot; = 2" key="{3ada417b-3ccc-4491-b073-b11457983b92}"/>
        <rule label="L10303B" symbol="1" filter=" &quot;material_construcao&quot; not in (1, 2) and  &quot;sobreposto_transportes&quot; = 2" key="{11b696a4-12d4-40bb-887d-12c519b150b9}"/>
        <rule label="L10303A em transporte" symbol="2" filter="&quot;material_construcao&quot; in (1, 2) and  &quot;sobreposto_transportes&quot; = 1" key="{db44bab4-9298-4e3c-9637-c3d2bf3d307c}"/>
        <rule label="L10303B em transporte" symbol="3" filter="&quot;material_construcao&quot; not in (1, 2) and  &quot;sobreposto_transportes&quot; = 1" key="{33417fe8-5b05-4490-b0df-d98fa563a559}"/>
        <rule symbol="4" filter="ELSE" key="{a9073bbc-bb8d-44d3-a788-a5e84cf02cc6}"/>
      </rule>
    </rules>
    <symbols>
