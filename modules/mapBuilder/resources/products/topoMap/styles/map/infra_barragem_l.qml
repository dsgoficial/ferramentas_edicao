...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="0" version="3.24.3-Tisler">
  <renderer-v2 type="RuleRenderer" enableorderby="0" forceraster="0" symbollevels="0" referencescale="-1">
    <rules key="{19d54618-79b3-47af-bbd0-e84dac371fef}">
      <rule key="{d065bfba-111e-4410-b9f7-971ac015b2f4}" filter="visivel = 1">
        <rule key="{3ada417b-3ccc-4491-b073-b11457983b92}" symbol="0" filter="&quot;material_construcao&quot; in (1, 2) and  &quot;sobreposto_transportes&quot; = 2" label="L10303A"/>
        <rule key="{11b696a4-12d4-40bb-887d-12c519b150b9}" symbol="1" filter=" &quot;material_construcao&quot; not in (1, 2) and  &quot;sobreposto_transportes&quot; = 2" label="L10303B"/>
        <rule key="{db44bab4-9298-4e3c-9637-c3d2bf3d307c}" symbol="2" filter="&quot;material_construcao&quot; in (1, 2) and  &quot;sobreposto_transportes&quot; = 1" label="L10303A em transporte"/>
        <rule key="{33417fe8-5b05-4490-b0df-d98fa563a559}" symbol="3" filter="&quot;material_construcao&quot; not in (1, 2) and  &quot;sobreposto_transportes&quot; = 1" label="L10303B em transporte"/>
        <rule key="{a9073bbc-bb8d-44d3-a788-a5e84cf02cc6}" symbol="4" filter="ELSE"/>
      </rule>
    </rules>
    <symbols>
