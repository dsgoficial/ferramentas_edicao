...
<qgis version="3.24.3-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  <renderer-v2 enableorderby="0" referencescale="-1" symbollevels="0" type="RuleRenderer" forceraster="0">
    <rules key="{f90668d0-bcbf-4ab0-b992-a3a7023aa098}">
      <rule key="{ab6cd03f-78b6-4834-a3f7-0603bccf6b32}" filter="&quot;visivel&quot; = 1">
        <rule symbol="0" key="{f20c2b3e-2a68-4b94-a517-835ef9a264f0}" description="Reservatório" filter="&quot;tipo&quot; in (108, 132, 201, 204, 113, 109, 301)" label="A20403A"/>
        <rule symbol="1" key="{a4d71eb4-85cb-4c4a-b104-975029b57333}" description="Aterro sanitário" filter="&quot;tipo&quot; in (108, 132, 305)" label="A20214D"/>
        <rule symbol="2" key="{582ca24f-2794-4040-9626-0dd48d5cb8fd}" filter="ELSE"/>
      </rule>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{aebead30-6cac-4bdd-83b2-f2693af61b8d}">
      <rule key="{03a8fb6e-0b1b-45e7-a492-dbcb8bf72eb2}" description="Depósito" filter="&quot;visivel&quot; = 1">
