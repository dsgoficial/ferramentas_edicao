...
<qgis version="3.24.3-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0">
    <rules key="{f90668d0-bcbf-4ab0-b992-a3a7023aa098}">
      <rule filter="&quot;visivel&quot; = 1" key="{ab6cd03f-78b6-4834-a3f7-0603bccf6b32}">
        <rule filter="&quot;tipo&quot; in (108, 132, 204, 113, 109)" label="A20403A" description="Reservatório" symbol="0" key="{f20c2b3e-2a68-4b94-a517-835ef9a264f0}"/>
        <rule filter="&quot;tipo&quot; in (201, 301)" label="Tanque de Saneamento" symbol="1" key="{d4480d7d-fe8b-4e17-a4ce-c466f3fb0e75}"/>
        <rule filter="&quot;tipo&quot; in (108, 132, 305)" label="A20214D" description="Aterro sanitário" symbol="2" key="{a4d71eb4-85cb-4c4a-b104-975029b57333}"/>
        <rule filter="ELSE" symbol="3" key="{582ca24f-2794-4040-9626-0dd48d5cb8fd}"/>
      </rule>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{2d5436fc-550c-4826-9316-67085d205951}">
      <rule filter="&quot;visivel&quot; = 1" description="Depósito" key="{1ff96e13-302a-4381-911b-033889f2c633}">
