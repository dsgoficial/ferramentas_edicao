...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  <renderer-v2 enableorderby="0" forceraster="0" type="mergedFeatureRenderer" symbollevels="0" referencescale="-1">
    <renderer-v2 enableorderby="0" forceraster="0" type="RuleRenderer" symbollevels="1" referencescale="-1">
      <rules key="{8e201c66-7086-4414-be5d-65a1376e7ddf}">
        <rule symbol="0" filter="&quot;visivel&quot; = 1 and situacao_em_poligono = 1" description="Fora de polígono" key="{3a7e1be6-ff14-4ba0-9061-4fc15c872bfb}"/>
        <rule symbol="1" filter="visivel = 1 and situacao_em_poligono != 1" key="{4a86f678-7531-4208-a64d-663c398da85e}"/>
        <rule label="Não visível" symbol="2" filter="ELSE" key="{832a1c41-20cc-43dc-a0ff-31a9bf9b91e1}"/>
      </rules>
      <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{7d14931b-d98a-4daa-b464-f46df6ff5821}">
      <rule filter="&quot;situacao_em_poligono&quot; in (1) and &quot;visivel&quot; = 1" description="Trecho de drenagem" key="{f15103d4-3ce5-4759-ab7d-b51fd0c6c0e9}">
        <settings calloutType="simple">
          <text-style fieldName="texto_edicao" legendString="Aa" fontFamily="Noto Sans" textColor="255,255,255,255" isExpression="0" fontWordSpacing="0" useSubstitutions="0" textOpacity="1" fontKerning="1" fontSizeUnit="Point" previewBkgrdColor="255,255,255,255" fontWeight="50" fontSize="7" textOrientation="horizontal" fontStrikeout="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Condensed Italic" fontUnderline="0" allowHtml="0" capitalization="0" fontLetterSpacing="0" fontItalic="1" multilineHeight="1">
            <families/>
            <text-buffer bufferJoinStyle="128" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferDraw="1" bufferBlendMode="0" bufferColor="0,160,223,255" bufferOpacity="1" bufferSizeUnits="Point" bufferNoFill="0">
          ...
          <placement placement="3" rotationAngle="0" dist="0.5" quadOffset="4" maxCurvedCharAngleIn="30" xOffset="0" centroidInside="0" overrunDistance="0" offsetUnits="MM" fitInPolygonOnly="0" overrunDistanceUnit="MM" yOffset="0" offsetType="0" rotationUnit="AngleDegrees" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="0" lineAnchorType="0" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" layerType="LineGeometry" polygonPlacementFlags="2" repeatDistance="300" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa; )" geometryGeneratorType="LineGeometry" placementFlags="10" maxCurvedCharAngleOut="-30" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" distUnits="MM" priority="6" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" centroidWhole="0" lineAnchorPercent="0.5"/>
          <rendering drawLabels="1" obstacleFactor="2" fontMinPixelSize="3" mergeLines="1" zIndex="0" minFeatureSize="20" maxNumLabels="2" fontMaxPixelSize="10000" obstacleType="0" scaleVisibility="0" upsidedownLabels="0" labelPerPart="0" fontLimitPixelSize="0" scaleMin="0" scaleMax="0" obstacle="0" limitNumLabels="0" displayAll="0" unplacedVisibility="0"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" name="name" type="QString"/>
              <Option name="properties" type="Map">
      ...
      <rule filter="&quot;situacao_em_poligono&quot; in (2,3) and &quot;visivel&quot; = 1" description="Massa Dagua" key="{fe9b7a23-8830-4816-a523-b5a250d6ba60}">
        <settings calloutType="simple">
