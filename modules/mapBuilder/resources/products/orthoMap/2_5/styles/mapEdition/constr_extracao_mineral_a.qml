...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  <renderer-v2 enableorderby="0" forceraster="0" type="RuleRenderer" symbollevels="0" referencescale="-1">
    <rules key="{3ccc5d55-92a5-4304-8639-9866a52997f5}">
      <rule symbol="0" filter="visivel = 1 and situacao_fisica in (0,3)" key="{7a662cd7-610c-49c5-bfaf-8dcc2220ef53}"/>
      <rule symbol="1" filter="visivel = 1 and situacao_fisica in (1,2,4)" key="{85208607-21e9-4544-b7c4-d442e07c0872}"/>
      <rule label="Não visível" symbol="2" filter="ELSE" key="{2f935f96-2ac6-4ae1-b8d3-8e1414149e93}"/>
    </rules>
    <symbols>
      ...
      <symbol force_rhr="0" name="2" alpha="0.4" type="fill" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" class="CentroidFill" pass="0">
          ...
          <symbol force_rhr="0" name="@2@3" alpha="1" type="marker" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{73424cdf-56d1-42f4-a6cc-c25ae52bf33d}">
      <rule filter="&quot;visivel&quot; = 1" description="Extração Mineral" key="{2adbfbe8-4e02-4d29-b3d8-30b0dc9736e0}">
