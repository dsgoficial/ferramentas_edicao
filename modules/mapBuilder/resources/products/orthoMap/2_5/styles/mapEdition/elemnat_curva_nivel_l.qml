...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 forceraster="0" symbollevels="0" referencescale="-1" enableorderby="0" type="RuleRenderer">
    <rules key="{0b5260cb-68fa-44a7-9937-3b05983fbf19}">
      <rule filter=" &quot;visivel&quot; = 1 AND &quot;dentro_massa_dagua&quot; not in (1)" label="visivel" key="{4853bd36-c72a-48c9-afcf-462433ad773a}">
        <rule filter="(( @equidistancia IS NOT NULL and  &quot;cota&quot;%(5* to_int(@equidistancia)) = 0 ) &#xd;&#xa;OR &#xd;&#xa;(@equidistancia IS NULL and &quot;indice&quot; = 1))&#xd;&#xa; and &quot;depressao&quot; = 2" symbol="0" label="Curva de nível mestra" key="{deb7a634-0a8a-4b21-b802-85c667582ef4}"/>
        <rule filter="(( @equidistancia IS NOT NULL and  &quot;cota&quot;%to_int(@equidistancia) = 0  and  &quot;cota&quot;%(5* to_int(@equidistancia)) != 0) &#xd;&#xa;OR &#xd;&#xa;(@equidistancia IS NULL and &quot;indice&quot; = 2))&#xd;&#xa;  and &quot;depressao&quot;=2" symbol="1" label="Curva de nível normal" key="{2ec6beb6-6309-4246-8713-dae8c8227a2f}"/>
        <rule filter="((@equidistancia IS NOT NULL and  &quot;cota&quot;%(to_int(@equidistancia)/2) = 0  and  &quot;cota&quot;%(to_int(@equidistancia)) != 0 and  @exibir_auxiliar = 1) &#xd;&#xa;OR &#xd;&#xa;(@equidistancia IS NULL and &quot;indice&quot; = 3))&#xd;&#xa; and &quot;depressao&quot; = 2&#xd;&#xa;" symbol="2" label="Curva de nível auxiliar" key="{3ed6ab00-ff3e-4c8b-b7b3-64284f2a3543}"/>
        <rule filter="(( @equidistancia IS NOT NULL and  &quot;cota&quot;%(5* to_int(@equidistancia)) = 0 ) &#xd;&#xa;OR &#xd;&#xa;(@equidistancia IS NULL and &quot;indice&quot; = 1))&#xd;&#xa; and &quot;depressao&quot; = 1" symbol="3" label="Curva de nível em depressão (mestra)" key="{babeea22-322d-417e-8941-b703129ea60c}"/>
        <rule filter="(( @equidistancia IS NOT NULL and  &quot;cota&quot;%to_int(@equidistancia) = 0 and  &quot;cota&quot;%(5*to_int(@equidistancia)) != 0) &#xd;&#xa;OR &#xd;&#xa;(@equidistancia IS NULL and &quot;indice&quot; = 2))&#xd;&#xa;  and &quot;depressao&quot;=1" symbol="4" label="Curva de nível em depressão (normal)" key="{cef3b486-d663-49c4-af84-f6eec2b16adf}"/>
        <rule filter="((@equidistancia IS NOT NULL and  &quot;cota&quot;%(to_int(@equidistancia)/2) = 0 and  &quot;cota&quot;%(to_int(@equidistancia)) != 0  and  @exibir_auxiliar = 1) &#xd;&#xa;OR &#xd;&#xa;(@equidistancia IS NULL and &quot;indice&quot; = 3))&#xd;&#xa; and &quot;depressao&quot; = 1&#xd;&#xa;" symbol="5" label="Curva de nível em depressão (auxiliar)" key="{4058f258-7ce7-41bd-9aa3-636c64bdd022}"/>
      </rule>
      <rule filter="ELSE" symbol="6" label="Não visível" key="{5d0e800f-f2e6-4b37-ba23-18f4f86208a0}"/>
    </rules>
    <symbols>
      ...
      <symbol name="3" clip_to_extent="1" alpha="1" type="line" force_rhr="0">
        ...
        <layer locked="0" pass="0" enabled="1" class="HashLine">
          ...
          <symbol name="@3@0" clip_to_extent="1" alpha="1" type="line" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol name="4" clip_to_extent="1" alpha="1" type="line" force_rhr="0">
        ...
        <layer locked="0" pass="0" enabled="1" class="HashLine">
          ...
          <symbol name="@4@0" clip_to_extent="1" alpha="1" type="line" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol name="5" clip_to_extent="1" alpha="1" type="line" force_rhr="0">
        ...
        <layer locked="0" pass="0" enabled="1" class="HashLine">
          ...
          <symbol name="@5@0" clip_to_extent="1" alpha="1" type="line" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
        ...
        <layer locked="0" pass="0" enabled="1" class="HashLine">
          ...
          <symbol name="@5@1" clip_to_extent="1" alpha="1" type="line" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
      ...
      <symbol name="6" clip_to_extent="1" alpha="0.4" type="line" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{21e231ff-f1a0-4dd6-b6d3-4e1cbc40ea74}">
      <rule description="Cota texto de edição" filter="visivel = 1 AND &quot;dentro_massa_dagua&quot; not in (1) AND &#xd;&#xa;(( @equidistancia IS NOT NULL and  &quot;cota&quot;%(5* to_int(@equidistancia)) = 0 ) &#xd;&#xa;OR &#xd;&#xa;(@equidistancia IS NULL and &quot;indice&quot; = 1))" key="{9ff1df1a-0769-4033-be59-e73a037b3432}">
        <settings calloutType="simple">
          <text-style namedStyle="Condensed Italic" isExpression="0" fontUnderline="0" previewBkgrdColor="255,255,255,255" fontLetterSpacing="0" capitalization="1" fieldName="texto_edicao" fontSizeUnit="Point" fontKerning="1" textOrientation="horizontal" fontStrikeout="0" blendMode="0" textOpacity="1" fontSize="7" fontWeight="50" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontFamily="Noto Sans" allowHtml="0" legendString="Aa" fontWordSpacing="0" multilineHeight="1" textColor="255,255,255,255" fontItalic="1" useSubstitutions="0">
            <families/>
            <text-buffer bufferOpacity="1" bufferJoinStyle="128" bufferSize="0.5" bufferDraw="1" bufferSizeUnits="Point" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="0,0,0,255" bufferNoFill="1">
            ...
            <shadow shadowOffsetUnit="MM" shadowUnder="0" shadowColor="0,0,0,255" shadowRadiusUnit="MM" shadowRadiusAlphaOnly="0" shadowOpacity="0.69999999999999996" shadowScale="100" shadowOffsetDist="1" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowOffsetAngle="135" shadowRadius="1.5" shadowDraw="0" shadowOffsetGlobal="1" shadowBlendMode="6" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0"/>
            <dd_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
          ...
          <text-format reverseDirectionSymbol="0" formatNumbers="0" autoWrapLength="0" useMaxLineLengthForAutoWrap="1" multilineAlign="0" wrapChar="" addDirectionSymbol="0" leftDirectionSymbol="&lt;" decimals="3" rightDirectionSymbol=">" placeDirectionSymbol="0" plussign="0"/>
          <placement offsetType="0" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="150" rotationAngle="0" repeatDistanceUnits="MM" rotationUnit="AngleDegrees" lineAnchorPercent="0.5" fitInPolygonOnly="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" quadOffset="4" placement="3" centroidWhole="0" centroidInside="0" polygonPlacementFlags="2" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" geometryGeneratorEnabled="1" geometryGeneratorType="LineGeometry" dist="0" maxCurvedCharAngleIn="25" overrunDistanceUnit="MM" priority="5" overrunDistance="0" placementFlags="9" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" distUnits="MM" layerType="LineGeometry" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" maxCurvedCharAngleOut="-25" lineAnchorClipping="0" offsetUnits="MM" preserveRotation="1"/>
          <rendering scaleMin="0" displayAll="0" obstacle="0" fontMaxPixelSize="10000" obstacleFactor="1" zIndex="0" upsidedownLabels="0" minFeatureSize="15" obstacleType="0" labelPerPart="0" limitNumLabels="0" scaleMax="0" fontLimitPixelSize="0" scaleVisibility="0" drawLabels="1" unplacedVisibility="0" fontMinPixelSize="3" maxNumLabels="2000" mergeLines="1"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" type="QString" value=""/>
              <Option name="properties" type="Map">
