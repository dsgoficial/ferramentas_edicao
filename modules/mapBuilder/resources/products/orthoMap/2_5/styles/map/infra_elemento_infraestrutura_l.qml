...
<qgis version="3.24.3-Tisler" styleCategories="Symbology|Labeling" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{4ae8ef00-de9e-46fd-99b4-380d47e589aa}">
      <rule description="Elemento infraestrutura" key="{e011ea3e-b75d-4b0b-931a-75b59259dc13}" filter="visivel = 1">
        <settings calloutType="simple">
          ...
          <placement distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" rotationUnit="AngleDegrees" geometryGeneratorType="LineGeometry" yOffset="-0.5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" dist="0.40000000000000002" lineAnchorPercent="0.5" lineAnchorType="0" offsetUnits="MM" xOffset="0.5" repeatDistanceUnits="MM" lineAnchorClipping="0" layerType="LineGeometry" preserveRotation="1" overrunDistanceUnit="MM" placement="4" centroidInside="0" rotationAngle="0" priority="5" fitInPolygonOnly="0" placementFlags="10" centroidWhole="0" geometryGeneratorEnabled="1" quadOffset="2" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" polygonPlacementFlags="2" overrunDistance="0" repeatDistance="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetType="0" distUnits="MM"/>
