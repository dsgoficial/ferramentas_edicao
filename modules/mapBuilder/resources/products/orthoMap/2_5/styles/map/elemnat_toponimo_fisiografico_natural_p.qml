...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{6da1942f-4341-4204-9496-9b81a273888d}">
      <rule filter="tipo in (2,4,5,6,7,12) and visivel = 1" description="Morro, Chapada, Maciço, Planalto, Planície, Praia" key="{65e5982d-d7c5-4346-9746-53a27f26e792}">
      ...
      <rule filter="tipo in (3,17) and visivel = 1" description="Pico ou Montanha" key="{25f3e3a5-dce7-4dd5-b300-c092d819b2a2}">
        <settings calloutType="simple">
      ...
      <rule filter="tipo in (9,10,11) and visivel = 1" description="Península ou Cabo ou Ponta" key="{5fb44ef3-061b-45cb-8b33-d657b3e2b957}">
        <settings calloutType="simple">
