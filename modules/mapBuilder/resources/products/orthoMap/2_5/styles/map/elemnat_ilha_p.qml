...
<qgis version="3.24.3-Tisler" styleCategories="Symbology|Labeling" labelsEnabled="1">
      ...
      <symbol alpha="1" name="0" force_rhr="0" clip_to_extent="1" type="marker">
        ...
        <layer enabled="1" locked="0" class="SimpleMarker" pass="0">
          <Option type="Map">
            ...
            <Option name="outline_color" value="114,155,111,0" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{0e69acd5-5a19-4d1a-8b62-730f10c1afa6}">
      <rule description="Ilha" key="{8192cb3b-af5f-480d-ad2f-dccab332230e}" filter="visivel = 1">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" allowHtml="0" fontSizeUnit="Point" fontWeight="50" fontUnderline="0" fontStrikeout="0" fieldName="texto_edicao" blendMode="0" fontSize="7" legendString="Aa" textOrientation="horizontal" namedStyle="Condensed Italic" textOpacity="1" fontKerning="1" fontItalic="1" fontWordSpacing="0" useSubstitutions="0" fontFamily="Noto Sans" capitalization="1" fontLetterSpacing="0" multilineHeight="0.80000000000000004" textColor="255,255,255,255" isExpression="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0">
            <families/>
          ...
          <text-format leftDirectionSymbol="&lt;" plussign="0" autoWrapLength="0" multilineAlign="3" wrapChar="|" rightDirectionSymbol=">" reverseDirectionSymbol="0" formatNumbers="0" decimals="3" useMaxLineLengthForAutoWrap="1" addDirectionSymbol="0" placeDirectionSymbol="0"/>
          <placement distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" rotationUnit="AngleDegrees" geometryGeneratorType="PointGeometry" yOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" dist="0" lineAnchorPercent="0.5" lineAnchorType="0" offsetUnits="MM" xOffset="0" repeatDistanceUnits="MM" lineAnchorClipping="0" layerType="PointGeometry" preserveRotation="1" overrunDistanceUnit="MM" placement="0" centroidInside="1" rotationAngle="0" priority="5" fitInPolygonOnly="0" placementFlags="10" centroidWhole="0" geometryGeneratorEnabled="1" quadOffset="4" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" polygonPlacementFlags="2" overrunDistance="0" repeatDistance="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetType="0" distUnits="MM"/>
