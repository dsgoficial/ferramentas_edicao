...
<qgis version="3.22.1-Białowieża" styleCategories="Symbology|Labeling" labelsEnabled="1">
  <renderer-v2 enableorderby="0" type="RuleRenderer" symbollevels="0" referencescale="-1" forceraster="0">
    <rules key="{2506e7ea-bfda-4f32-a4ef-b216a9a0b016}">
      <rule filter="  &quot;rotular_carta_mini&quot; = 1 and &quot;simbolizar_carta_mini&quot; = 1" key="{4e0453e5-9c9b-4677-8d59-65c5a7e09ea9}">
        <rule filter="&quot;tipo&quot; = 6" label="Povoado" symbol="0" key="{8a9a3034-db02-4586-a72f-a4ee69c7f03b}"/>
        <rule filter="&quot;tipo&quot; in (5,7)" label="Lugarejo ou Núcleo" symbol="1" key="{6c0b0d77-33b6-4edc-b628-d6986a4091e1}"/>
        <rule filter="ELSE" symbol="2" key="{180df886-181c-4c95-abcb-ae5538b4f3d9}"/>
      </rule>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{8f1e6411-bb9c-4530-b124-731391fc5557}">
      <rule filter=" &quot;tipo&quot; in (5,6,7) and &quot;rotular_carta_mini&quot; = 1" description="Outras localidades" key="{39b5bbd1-6efd-4f20-9198-5bdce6e723f0}">
