...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  <renderer-v2 symbollevels="0" referencescale="-1" type="RuleRenderer" forceraster="0" enableorderby="0">
    <rules key="{2506e7ea-bfda-4f32-a4ef-b216a9a0b016}">
      <rule filter="  &quot;rotular_carta_mini&quot; = 1 and &quot;simbolizar_carta_mini&quot; = 1" key="{4e0453e5-9c9b-4677-8d59-65c5a7e09ea9}">
        <rule filter="&quot;tipo&quot; = 6" key="{8a9a3034-db02-4586-a72f-a4ee69c7f03b}" label="Povoado" symbol="0"/>
        <rule filter="&quot;tipo&quot; in (5,7)" key="{6c0b0d77-33b6-4edc-b628-d6986a4091e1}" label="Lugarejo ou Núcleo" symbol="1"/>
      </rule>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{b753041b-2503-467f-bd9c-7657e137b5ba}">
      <rule filter="&quot;tipo&quot; in (5,6,7) and &quot;rotular_carta_mini&quot; = 1" key="{4f106e87-17de-4abc-903c-d220709e0ed4}" description="Outras localidades">
