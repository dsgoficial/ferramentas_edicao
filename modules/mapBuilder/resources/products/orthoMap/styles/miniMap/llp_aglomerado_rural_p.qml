...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling" version="3.24.3-Tisler">
  <renderer-v2 symbollevels="0" referencescale="-1" type="RuleRenderer" forceraster="0" enableorderby="0">
    <rules key="{2506e7ea-bfda-4f32-a4ef-b216a9a0b016}">
      <rule filter="visivel = 1 and &quot;rotular_carta_mini&quot; = 1 and &quot;simbolizar_carta_mini&quot; = 1" key="{4e0453e5-9c9b-4677-8d59-65c5a7e09ea9}">
        <rule filter="&quot;tipo&quot; = 6" key="{8a9a3034-db02-4586-a72f-a4ee69c7f03b}" symbol="0" label="Povoado"/>
        <rule filter="&quot;tipo&quot; in (5,7)" key="{6c0b0d77-33b6-4edc-b628-d6986a4091e1}" symbol="1" label="Lugarejo ou Núcleo"/>
      </rule>
      <rule filter="visivel = 1 and rotular_carta_mini = 1" key="{1026a7f2-80de-4ee4-bdcc-9586a836c2fe}" symbol="2"/>
    </rules>
    <symbols>
