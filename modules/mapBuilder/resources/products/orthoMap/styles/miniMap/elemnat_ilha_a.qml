...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  ...
  <labeling type="rule-based">
    <rules key="{5410200a-6667-40b5-904f-eda7cf1ae03d}">
      <rule filter="&quot;rotular_carta_mini&quot; = 1" key="{87f60893-ee32-48f7-8895-e34cd81a6c20}">
        <settings calloutType="simple">
          ...
          <placement quadOffset="4" offsetType="0" placement="0" yOffset="0" overrunDistance="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" centroidWhole="0" priority="5" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" rotationUnit="AngleDegrees" centroidInside="1" maxCurvedCharAngleOut="-25" geometryGeneratorEnabled="1" overrunDistanceUnit="MM" lineAnchorType="0" dist="0" distUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placementFlags="10" offsetUnits="MM" rotationAngle="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" geometryGeneratorType="PolygonGeometry" polygonPlacementFlags="3" preserveRotation="1" repeatDistance="0" layerType="PolygonGeometry" xOffset="0" maxCurvedCharAngleIn="25" lineAnchorClipping="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0"/>
