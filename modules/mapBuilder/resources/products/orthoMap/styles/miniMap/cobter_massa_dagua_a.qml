...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  ...
  <labeling type="rule-based">
    <rules key="{9fa8d4b5-14f8-4a55-a201-87e542f5bbbb}">
      <rule filter="&quot;rotular_carta_mini&quot; = 1 and visivel =1" key="{39066f8f-d831-4b27-8495-0929beb9fa42}">
        <settings calloutType="simple">
          ...
          <placement quadOffset="4" offsetType="0" placement="0" yOffset="0" overrunDistance="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa; )" centroidWhole="0" priority="6" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" rotationUnit="AngleDegrees" centroidInside="1" maxCurvedCharAngleOut="-30" geometryGeneratorEnabled="1" overrunDistanceUnit="MM" lineAnchorType="0" dist="0" distUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placementFlags="14" offsetUnits="MM" rotationAngle="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" geometryGeneratorType="PolygonGeometry" polygonPlacementFlags="3" preserveRotation="0" repeatDistance="300" layerType="PolygonGeometry" xOffset="0" maxCurvedCharAngleIn="30" lineAnchorClipping="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0"/>
          <rendering fontLimitPixelSize="0" minFeatureSize="0" scaleMax="0" obstacleType="0" displayAll="0" obstacle="0" scaleMin="0" unplacedVisibility="0" labelPerPart="0" mergeLines="1" fontMaxPixelSize="10000" upsidedownLabels="0" limitNumLabels="0" drawLabels="1" obstacleFactor="2" zIndex="0" scaleVisibility="0" fontMinPixelSize="3" maxNumLabels="2"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" value="" name="name"/>
