...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling" version="3.24.3-Tisler">
  <renderer-v2 type="mergedFeatureRenderer" symbollevels="0" referencescale="-1" enableorderby="0" forceraster="0">
    <renderer-v2 type="RuleRenderer" symbollevels="1" referencescale="-1" enableorderby="0" forceraster="0">
      <rules key="{8e201c66-7086-4414-be5d-65a1376e7ddf}">
        <rule key="{7fe1c635-bbbd-49e9-9405-2d2e954b0aa0}" symbol="0" description="Fora de polígono" filter=" &quot;situacao_em_poligono&quot; = 1 and &quot;simbolizar_carta_mini&quot; = 1"/>
  ...
  <labeling type="rule-based">
    <rules key="{65c342d4-a3c3-449a-a3d4-a565c8672be6}">
      <rule key="{ae4e8cb2-a901-430f-81eb-ceb5478c6101}" description="Trecho de drenagem" filter="&quot;situacao_em_poligono&quot; in (1) and &quot;simbolizar_carta_mini&quot; = 1 and &quot;rotular_carta_mini&quot; = 1">
        <settings calloutType="simple">
          <text-style textColor="255,255,255,255" fontKerning="1" fieldName="texto_edicao" fontWordSpacing="0" fontFamily="Noto Sans" textOrientation="horizontal" namedStyle="Condensed Italic" isExpression="0" fontSizeUnit="Point" allowHtml="0" capitalization="0" fontLetterSpacing="0" fontItalic="1" previewBkgrdColor="255,255,255,255" multilineHeight="1" fontStrikeout="0" legendString="Aa" textOpacity="1" fontWeight="50" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" useSubstitutions="0" fontSize="5.5" blendMode="0">
            <families/>
            <text-buffer bufferOpacity="1" bufferColor="0,160,223,255" bufferDraw="1" bufferBlendMode="0" bufferJoinStyle="128" bufferNoFill="0" bufferSize="0.5" bufferSizeUnits="Point" bufferSizeMapUnitScale="3x:0,0,0,0,0,0">
            ...
            <text-mask maskType="0" maskEnabled="0" maskOpacity="1" maskJoinStyle="128" maskSizeUnits="MM" maskSize="0.20000000000000001" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskedSymbolLayers=""/>
      ...
      <rule key="{a7dc77e1-db1d-47f7-bc13-78bff5b01cde}" description="Massa Dagua" filter="&quot;situacao_em_poligono&quot; in (2) and &quot;simbolizar_carta_mini&quot; = 1 and &quot;rotular_carta_mini&quot; = 1">
        <settings calloutType="simple">
          <text-style textColor="255,255,255,255" fontKerning="1" fieldName="texto_edicao" fontWordSpacing="0" fontFamily="Noto Sans" textOrientation="horizontal" namedStyle="Condensed Italic" isExpression="0" fontSizeUnit="Point" allowHtml="0" capitalization="1" fontLetterSpacing="0" fontItalic="1" previewBkgrdColor="255,255,255,255" multilineHeight="1" fontStrikeout="0" legendString="Aa" textOpacity="1" fontWeight="50" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" useSubstitutions="0" fontSize="5.5" blendMode="0">
            <families/>
            <text-buffer bufferOpacity="1" bufferColor="0,160,223,255" bufferDraw="1" bufferBlendMode="0" bufferJoinStyle="128" bufferNoFill="0" bufferSize="0.5" bufferSizeUnits="Point" bufferSizeMapUnitScale="3x:0,0,0,0,0,0">
              <effect type="effectStack" enabled="0">
                <effect type="dropShadow">
