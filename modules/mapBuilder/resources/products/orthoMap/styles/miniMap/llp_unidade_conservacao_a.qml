...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  ...
  <labeling type="rule-based">
    <rules key="{826a976e-ba19-430c-9785-5719dbcf6b7c}">
      <rule filter="&quot;rotular_carta_mini&quot;  = 1" key="{5ef934d9-dbde-48e3-b283-255d23d8728b}">
        <settings calloutType="simple">
          <text-style fontItalic="0" fontStrikeout="0" textColor="255,255,255,255" isExpression="0" textOrientation="horizontal" fieldName="texto_edicao" previewBkgrdColor="255,255,255,255" fontLetterSpacing="0" useSubstitutions="0" fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" fontFamily="Noto Sans" multilineHeight="0.80000000000000004" blendMode="0" fontWeight="50" textOpacity="1" allowHtml="0" fontWordSpacing="0" namedStyle="Condensed" fontSize="5.5" capitalization="1" legendString="Aa" fontKerning="1">
            <families/>
          ...
          <placement quadOffset="4" offsetType="0" placement="0" yOffset="0" overrunDistance="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" centroidWhole="0" priority="5" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" rotationUnit="AngleDegrees" centroidInside="0" maxCurvedCharAngleOut="-25" geometryGeneratorEnabled="1" overrunDistanceUnit="MM" lineAnchorType="0" dist="0" distUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placementFlags="10" offsetUnits="MM" rotationAngle="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" geometryGeneratorType="PolygonGeometry" polygonPlacementFlags="3" preserveRotation="1" repeatDistance="0" layerType="PolygonGeometry" xOffset="0" maxCurvedCharAngleIn="25" lineAnchorClipping="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0"/>
