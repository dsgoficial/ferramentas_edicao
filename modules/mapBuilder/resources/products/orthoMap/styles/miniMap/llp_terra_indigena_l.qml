  ...
  <renderer-v2 symbollevels="0" referencescale="-1" type="mergedFeatureRenderer" forceraster="0" enableorderby="0">
    <renderer-v2 symbollevels="0" referencescale="-1" type="RuleRenderer" forceraster="0" enableorderby="0">
      <rules key="{ff3995e7-5994-44a3-800a-da9a9d3e9d9f}">
        <rule key="{9c92df26-c811-4d10-a901-eb05595d9370}" symbol="0" label="A10418A" description="Terra Indigena"/>
      </rules>
      <symbols>
              ...
              <Option type="Map">
                ...
                <Option name="properties" type="Map">
                  <Option name="outlineColor" type="Map">
                    ...
                    <Option name="expression" value="project_color('cinza-21_201-201-201_#C9C9C9')" type="QString"/>
            ...
            <data_defined_properties>
              <Option type="Map">
                ...
                <Option name="properties" type="Map">
                  <Option name="outlineColor" type="Map">
                    <Option name="active" value="true" type="bool"/>
                    <Option name="expression" value="project_color('verde-346_115-255-125_#73FF7D')" type="QString"/>
                    <Option name="type" value="3" type="int"/>
                  </Option>
                </Option>
                <Option name="type" value="collection" type="QString"/>
