...
<qgis version="3.22.5-Białowieża" labelsEnabled="0" styleCategories="Symbology|Labeling">
  <renderer-v2 enableorderby="0" referencescale="-1" type="mergedFeatureRenderer" symbollevels="0" forceraster="0">
    <renderer-v2 enableorderby="0" referencescale="-1" type="RuleRenderer" symbollevels="1" forceraster="0">
      <rules key="{8b45b4bb-4fb7-44a3-aa62-5672c279e3b9}">
        <rule symbol="0" filter="&quot;tipo&quot; in (2,4) and &quot;situacao_fisica&quot; IN (0,3) and &quot;revestimento&quot; = 3 and &quot;jurisdicao&quot; in (1,2) and &quot;simbolizar_carta_mini&quot; = 1" label="L11302Q" key="{abacada7-6415-4698-8775-45ecfcc12a47}"/>
        <rule symbol="1" filter="&quot;tipo&quot; in (2,4) and &quot;situacao_fisica&quot; IN (0,3) and &quot;revestimento&quot; != 3 and &quot;jurisdicao&quot; in (1,2) and &quot;simbolizar_carta_mini&quot; = 1" label="L11302R" key="{0a9e3586-49f7-4ee8-8195-0c8493e0e053}"/>
      </rules>
      <symbols>
