  ...
  <renderer-v2 symbollevels="0" referencescale="-1" type="mergedFeatureRenderer" forceraster="0" enableorderby="0">
    <renderer-v2 symbollevels="0" referencescale="-1" type="RuleRenderer" forceraster="0" enableorderby="0">
      <rules key="{3d3f8704-48a8-47c0-9af0-d9ff5f0488b4}">
        <rule filter=" &quot;tipo&quot; = 1" key="{17019f96-f021-4eb6-8346-dbbfa61f9c13}" label="A10416A" symbol="0" description="País"/>
        <rule filter=" &quot;tipo&quot; = 2" key="{471239a7-9fc7-4ca6-b1c4-724ef4879021}" label="A10421A" symbol="1" description="Unidade Federação"/>
      </rules>
      <symbols>
        <symbol force_rhr="0" type="line" name="0" clip_to_extent="1" alpha="1">
          ...
          <layer class="SimpleLine" pass="3" enabled="1" locked="0">
            <Option type="Map">
              ...
              <Option type="QString" value="180,127,140,255" name="line_color"/>
        ...
        <symbol force_rhr="0" type="line" name="1" clip_to_extent="1" alpha="1">
          ...
          <layer class="SimpleLine" pass="0" enabled="1" locked="0">
            <Option type="Map">
              ...
              <Option type="QString" value="0" name="draw_inside_polygon"/>
              <Option type="QString" value="bevel" name="joinstyle"/>
              <Option type="QString" value="194,151,165,255" name="line_color"/>
              <Option type="QString" value="solid" name="line_style"/>
            ...
            <data_defined_properties>
              <Option type="Map">
                ...
                <Option type="Map" name="properties">
                  <Option type="Map" name="outlineColor">
                    <Option type="bool" value="true" name="active"/>
                    <Option type="QString" value="project_color('marrom42_194-151-165_#C297A5')" name="expression"/>
                    <Option type="int" value="3" name="type"/>
                  </Option>
                </Option>
                <Option type="QString" value="collection" name="type"/>
