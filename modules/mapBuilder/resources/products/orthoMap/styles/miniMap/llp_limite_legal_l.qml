...
<qgis labelsEnabled="0" styleCategories="Symbology|Labeling" version="3.22.5-Białowieża">
  <renderer-v2 forceraster="0" symbollevels="0" referencescale="-1" type="mergedFeatureRenderer" enableorderby="0">
    <renderer-v2 forceraster="0" symbollevels="0" referencescale="-1" type="RuleRenderer" enableorderby="0">
      <rules key="{3d3f8704-48a8-47c0-9af0-d9ff5f0488b4}">
        <rule symbol="0" label="A10416A" description="País" filter=" &quot;tipo&quot; = 1" key="{17019f96-f021-4eb6-8346-dbbfa61f9c13}"/>
        <rule symbol="1" label="A10421A" description="Unidade Federação" filter=" &quot;tipo&quot; = 2" key="{471239a7-9fc7-4ca6-b1c4-724ef4879021}"/>
      </rules>
      <symbols>
        ...
        <symbol alpha="1" type="line" force_rhr="0" clip_to_extent="1" name="1">
          ...
          <layer enabled="1" class="MarkerLine" pass="0" locked="0">
            ...
            <symbol alpha="1" type="marker" force_rhr="0" clip_to_extent="1" name="@1@2">
              <data_defined_properties>
                <Option type="Map">
                  <Option value="" type="QString" name="name"/>
                  <Option name="properties"/>
