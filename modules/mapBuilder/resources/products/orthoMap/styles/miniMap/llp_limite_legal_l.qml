...
<qgis version="3.22.4-Białowieża" labelsEnabled="0" styleCategories="Symbology|Labeling">
  <renderer-v2 forceraster="0" enableorderby="0" symbollevels="0" type="mergedFeatureRenderer" referencescale="-1">
    <renderer-v2 forceraster="0" enableorderby="0" symbollevels="0" type="RuleRenderer" referencescale="-1">
      <rules key="{3d3f8704-48a8-47c0-9af0-d9ff5f0488b4}">
        <rule description="País" key="{17019f96-f021-4eb6-8346-dbbfa61f9c13}" label="A10416A" symbol="0" filter=" &quot;tipo&quot; = 1"/>
        <rule description="Unidade Federação" key="{471239a7-9fc7-4ca6-b1c4-724ef4879021}" label="A10421A" symbol="1" filter=" &quot;tipo&quot; = 2"/>
      </rules>
      <symbols>
        ...
        <symbol clip_to_extent="1" name="1" type="line" force_rhr="0" alpha="1">
          ...
          <layer class="MarkerLine" pass="0" enabled="1" locked="0">
            ...
            <symbol clip_to_extent="1" name="@1@2" type="marker" force_rhr="0" alpha="1">
              <data_defined_properties>
                <Option type="Map">
                  <Option name="name" type="QString" value=""/>
                  <Option name="properties"/>
