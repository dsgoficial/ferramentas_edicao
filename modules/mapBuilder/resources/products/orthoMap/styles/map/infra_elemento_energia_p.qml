...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  ...
  <labeling type="rule-based">
    <rules key="{2f2bf1d4-674e-42fb-a0c5-7dd90f9e0a99}">
      <rule key="{e347eae5-22cd-4c47-a6df-f3b3c17e3aff}" description="Elemento energia" filter="&quot;visivel&quot; = 1">
        <settings calloutType="simple">
          <text-style legendString="Aa" isExpression="0" fieldName="texto_edicao" fontSizeUnit="Point" fontSize="7" textOrientation="horizontal" capitalization="0" useSubstitutions="0" fontStrikeout="0" textColor="255,255,255,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" allowHtml="0" multilineHeight="0.80000000000000004" fontFamily="Noto Sans" blendMode="0" namedStyle="Condensed" fontWeight="50" fontUnderline="0" textOpacity="1" fontKerning="1" fontItalic="0" fontWordSpacing="0" fontLetterSpacing="0" previewBkgrdColor="255,255,255,255">
            <families/>
          ...
          <placement lineAnchorPercent="0.5" centroidInside="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" polygonPlacementFlags="2" quadOffset="2" offsetUnits="MM" overrunDistanceUnit="MM" dist="1.5" repeatDistance="0" rotationUnit="AngleDegrees" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" layerType="PointGeometry" distUnits="MM" fitInPolygonOnly="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" priority="5" rotationAngle="0" maxCurvedCharAngleOut="-25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" lineAnchorClipping="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" placementFlags="10" offsetType="0" overrunDistance="0" xOffset="0.5" geometryGeneratorEnabled="1" placement="0" preserveRotation="1" geometryGeneratorType="PointGeometry" maxCurvedCharAngleIn="25" yOffset="-0.5" distMapUnitScale="3x:0,0,0,0,0,0"/>
