  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" referencescale="-1" enableorderby="0">
    ...
    <symbols>
      <symbol name="0" force_rhr="0" clip_to_extent="1" type="marker" alpha="1">
        ...
        <layer locked="0" class="EllipseMarker" pass="0" enabled="1">
          <Option type="Map">
    ...
    <rules key="{26e0ca94-c13b-43a0-80bd-05efa3794f9c}">
      <rule description="Elemento energia" key="{f2c2c659-0a98-4996-b009-b2493ef7c3ef}" filter="&quot;visivel&quot; = 1">
        <settings calloutType="simple">
          ...
          <placement maxCurvedCharAngleOut="-25" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" xOffset="0.5" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="PointGeometry" centroidWhole="0" yOffset="-0.5" overrunDistance="0" centroidInside="0" distUnits="MM" placement="0" placementFlags="10" lineAnchorPercent="0.5" repeatDistance="0" geometryGeneratorType="PointGeometry" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" fitInPolygonOnly="0" rotationAngle="0" offsetUnits="MM" priority="5" repeatDistanceUnits="MM" lineAnchorClipping="0" geometryGeneratorEnabled="1" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" overrunDistanceUnit="MM" polygonPlacementFlags="2" dist="1.5" quadOffset="2" rotationUnit="AngleDegrees" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" offsetType="0"/>
          <rendering maxNumLabels="2000" obstacleFactor="1" drawLabels="1" fontLimitPixelSize="0" scaleMax="0" scaleMin="0" fontMaxPixelSize="10000" mergeLines="0" scaleVisibility="0" obstacle="1" fontMinPixelSize="3" minFeatureSize="0" displayAll="0" obstacleType="1" unplacedVisibility="0" upsidedownLabels="0" zIndex="0" limitNumLabels="0" labelPerPart="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
              <Option name="properties" type="Map">
