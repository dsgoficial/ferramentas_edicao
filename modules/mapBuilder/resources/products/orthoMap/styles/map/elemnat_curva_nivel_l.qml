...
<qgis version="3.22.4-Białowieża" styleCategories="Symbology|Labeling" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{fd7b8981-8014-44e2-bd95-9279b122cc3c}">
      <rule key="{bdeeb554-a2ab-4713-a732-0910d80cce4d}" filter="&quot;indice&quot; = 1" description="Cota texto de edição">
      ...
      <rule key="{71d11e2f-3084-41d4-9d5d-4024993c0aad}" filter="&quot;indice&quot; = 1 AND &quot;texto_edicao&quot; IS NULL AND array_contains(array_foreach(@map_layers,   layer_property( @element , 'name'))  , 'edicao_simb_cota_mestra_l')" description="Simb cota mestra">
        <settings calloutType="simple">
