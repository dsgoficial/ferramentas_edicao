...
<qgis styleCategories="Symbology|Labeling" version="3.20.2-Odense" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{f41dd965-39c3-48c0-9c7c-4fb7553f0532}">
      <rule filter="&quot;indice&quot; = 1" key="{6b5ab67c-947e-4ebe-a893-ec44c2f75c4e}" description="Cota texto de edição">
      ...
      <rule filter="&quot;indice&quot; = 1 AND &quot;texto_edicao&quot; IS NULL AND array_contains(array_foreach(@map_layers,   layer_property( @element , 'name'))  , 'edicao_simb_cota_mestra_l')" key="{7589efe1-39e7-4a53-bdda-b51ceeaf791b}" description="Simb cota mestra">
        <settings calloutType="simple">
