...
<qgis version="3.24.3-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  ...
  <labeling type="rule-based">
    <rules key="{a314848c-c273-4092-8c49-416de113ce5f}">
      <rule key="{ff3f20df-8a60-46d5-9faa-1eab0e6b921c}" filter="(( @equidistancia IS NOT NULL and  &quot;cota&quot;%(5* to_int(@equidistancia)) = 0 ) &#xd;&#xa;OR &#xd;&#xa;(@equidistancia IS NULL and &quot;indice&quot; = 1))" description="Cota texto de edição">
