  ...
  <renderer-v2 enableorderby="0" type="mergedFeatureRenderer" referencescale="-1" symbollevels="0" forceraster="0">
    <renderer-v2 enableorderby="0" type="RuleRenderer" referencescale="-1" symbollevels="1" forceraster="0">
      <rules key="{8b45b4bb-4fb7-44a3-aa62-5672c279e3b9}">
        <rule key="{0fa9ec2a-e271-4655-bef3-dd192c58d919}" label="L11302_Fed_Pav" symbol="0" filter="&quot;tipo&quot; in (2,4) and &quot;situacao_fisica&quot; IN (0,3) and &quot;revestimento&quot; = 3 and &quot;jurisdicao&quot; in (1) and &quot;visivel&quot; = 1"/>
        <rule key="{3bfc9391-3e8d-480d-af75-baf8ce3f927d}" label="L11302_Fed_NPav" symbol="1" filter="&quot;tipo&quot; in (2,4) and &quot;situacao_fisica&quot; IN (0,3) and &quot;revestimento&quot; != 3 and &quot;jurisdicao&quot; in (1) and &quot;visivel&quot; = 1"/>
        <rule key="{abacada7-6415-4698-8775-45ecfcc12a47}" label="L11302_Est_Pav" symbol="2" filter="&quot;tipo&quot; in (2,4) and &quot;situacao_fisica&quot; IN (0,3) and &quot;revestimento&quot; = 3 and &quot;jurisdicao&quot; in (2) and &quot;visivel&quot; = 1"/>
        <rule key="{0a9e3586-49f7-4ee8-8195-0c8493e0e053}" label="L11302_Est_NPav" symbol="3" filter="&quot;tipo&quot; in (2,4) and &quot;situacao_fisica&quot; IN (0,3) and &quot;revestimento&quot; != 3 and &quot;jurisdicao&quot; in (2) and &quot;visivel&quot; = 1"/>
      </rules>
      <symbols>
