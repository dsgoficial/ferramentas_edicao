...
<qgis version="3.22.1-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  <renderer-v2 symbollevels="0" enableorderby="0" type="RuleRenderer" forceraster="0" referencescale="-1">
    <rules key="{3ccc5d55-92a5-4304-8639-9866a52997f5}">
      <rule symbol="0" key="{85208607-21e9-4544-b7c4-d442e07c0872}" filter=" &quot;visivel&quot; = 1"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{2c69679a-1436-4047-937f-14fe49f43b17}">
      <rule description="Extração Mineral" key="{a05dd487-8be5-4eef-9021-de79d02493d2}" filter=" &quot;visivel&quot; = 1">
