...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  <renderer-v2 enableorderby="0" symbollevels="0" referencescale="-1" type="RuleRenderer" forceraster="0">
    <rules key="{3ccc5d55-92a5-4304-8639-9866a52997f5}">
      <rule symbol="0" key="{7a662cd7-610c-49c5-bfaf-8dcc2220ef53}" filter="visivel = 1 and situacao_fisica in (0,3)"/>
      <rule symbol="1" key="{85208607-21e9-4544-b7c4-d442e07c0872}" filter="visivel = 1 and situacao_fisica in (1,2,4)"/>
    </rules>
    <symbols>
      <symbol alpha="1" force_rhr="0" type="fill" name="0" clip_to_extent="1">
            ...
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="outlineColor">
                  ...
                  <Option type="QString" name="expression" value="project_color('cinza-07_237-237-237_#EDEDED')"/>
        ...
        <layer pass="0" class="CentroidFill" enabled="1" locked="0">
          ...
          <symbol alpha="1" force_rhr="0" type="marker" name="@0@2" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" name="name" value=""/>
                <Option name="properties"/>
      ...
      <symbol alpha="1" force_rhr="0" type="fill" name="1" clip_to_extent="1">
        ...
        <layer pass="0" class="CentroidFill" enabled="1" locked="0">
          ...
          <symbol alpha="1" force_rhr="0" type="marker" name="@1@2" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" name="name" value=""/>
                <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{ad0b0c94-51e1-408b-97b2-82619308788c}">
      <rule description="Extração Mineral" key="{41c885af-eadc-4a9b-8049-2e8ce7ab7e5d}" filter="&quot;visivel&quot; = 1">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" allowHtml="0" textColor="255,255,255,255" fontItalic="0" fontFamily="Noto Sans" blendMode="0" textOrientation="horizontal" fieldName="texto_edicao" useSubstitutions="0" isExpression="0" textOpacity="1" fontUnderline="0" fontWeight="50" fontWordSpacing="0" namedStyle="Condensed" fontStrikeout="0" fontSizeUnit="Point" fontLetterSpacing="0" capitalization="0" fontKerning="1" multilineHeight="0.80000000000000004" fontSize="7" legendString="Aa" fontSizeMapUnitScale="3x:0,0,0,0,0,0">
            <families/>
          ...
          <placement maxCurvedCharAngleOut="-25" priority="5" placementFlags="10" rotationUnit="AngleDegrees" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" overrunDistanceUnit="MM" offsetUnits="MM" maxCurvedCharAngleIn="25" geometryGeneratorEnabled="1" dist="0.40000000000000002" lineAnchorClipping="0" offsetType="0" geometryGeneratorType="PolygonGeometry" preserveRotation="1" quadOffset="2" distUnits="MM" centroidInside="0" repeatDistanceUnits="MM" lineAnchorType="0" centroidWhole="0" rotationAngle="0" placement="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" fitInPolygonOnly="0" lineAnchorPercent="0.5" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" layerType="PolygonGeometry" polygonPlacementFlags="3" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" distMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" xOffset="0.5" yOffset="-0.5"/>
          <rendering limitNumLabels="0" unplacedVisibility="0" drawLabels="1" mergeLines="0" upsidedownLabels="0" obstacle="1" obstacleType="0" minFeatureSize="0" scaleVisibility="0" displayAll="0" maxNumLabels="2000" scaleMax="0" labelPerPart="0" obstacleFactor="1.3999999999999999" fontMaxPixelSize="10000" fontLimitPixelSize="0" zIndex="0" scaleMin="0" fontMinPixelSize="3"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" name="name" value=""/>
              <Option type="Map" name="properties">
