...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  <renderer-v2 enableorderby="0" type="RuleRenderer" referencescale="-1" symbollevels="0" forceraster="0">
    <rules key="{3ccc5d55-92a5-4304-8639-9866a52997f5}">
      <rule key="{85208607-21e9-4544-b7c4-d442e07c0872}" symbol="0" filter=" &quot;visivel&quot; = 1"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{482b9279-9454-4b55-838a-f6864cbf82af}">
      <rule key="{7a746557-9c49-493c-a9cd-b02d9457edb7}" description="Extração Mineral" filter="&quot;visivel&quot; = 1">
        <settings calloutType="simple">
          ...
          <rendering maxNumLabels="2000" unplacedVisibility="0" fontMinPixelSize="3" limitNumLabels="0" mergeLines="0" drawLabels="1" upsidedownLabels="0" minFeatureSize="0" scaleMin="0" obstacle="1" obstacleFactor="1.3999999999999999" fontLimitPixelSize="0" zIndex="0" displayAll="0" labelPerPart="0" scaleVisibility="0" fontMaxPixelSize="10000" scaleMax="0" obstacleType="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
              <Option name="properties" type="Map">
