...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  <renderer-v2 enableorderby="0" type="mergedFeatureRenderer" referencescale="-1" symbollevels="0" forceraster="0">
    <renderer-v2 enableorderby="0" type="RuleRenderer" referencescale="-1" symbollevels="0" forceraster="0">
      <rules key="{ff3995e7-5994-44a3-800a-da9a9d3e9d9f}">
        <rule key="{1e2d5c72-25d9-463c-98b6-25688afbcd8e}" label="A10418A" description="Area Militar" symbol="0" filter="sobreposto = 2"/>
        <rule key="{4cb62d00-cb4e-430b-9e64-a271c5211c1c}" label="Area Militar tracejado" description="Terra Indigena" symbol="1" filter="sobreposto = 1"/>
      </rules>
      <symbols>
              ...
              <Option type="Map">
                ...
                <Option name="properties" type="Map">
                  <Option name="outlineColor" type="Map">
                    ...
                    <Option name="expression" value="project_color('cinza42_148-148-148_#949494')" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{4aa7db83-25fc-42a6-b899-91cc06d5c694}">
      <rule key="{07a166b4-6af4-460d-8c3c-7aec71875a18}" description="Texto aproximado" filter="&quot;geometria_aproximada&quot; = 1 and  &quot;exibir_rotulo_aproximado&quot; = 1">
