...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling" version="3.24.3-Tisler">
  <renderer-v2 symbollevels="0" referencescale="-1" type="mergedFeatureRenderer" forceraster="0" enableorderby="0">
    <renderer-v2 symbollevels="0" referencescale="-1" type="RuleRenderer" forceraster="0" enableorderby="0">
      <rules key="{ff3995e7-5994-44a3-800a-da9a9d3e9d9f}">
        <rule filter="sobreposto = 2" key="{1e2d5c72-25d9-463c-98b6-25688afbcd8e}" symbol="0" label="A10418A" description="Area Militar"/>
        <rule filter="sobreposto = 1" key="{4cb62d00-cb4e-430b-9e64-a271c5211c1c}" symbol="1" label="Area Militar tracejado" description="Terra Indigena"/>
      </rules>
      <symbols>
              ...
              <Option type="Map">
                ...
                <Option name="properties" type="Map">
                  <Option name="outlineColor" type="Map">
                    ...
                    <Option name="expression" value="project_color('cinza54_139-139-139_#8B8B8B')" type="QString"/>
        ...
        <symbol name="1" alpha="1" clip_to_extent="1" type="line" force_rhr="0">
          ...
          <layer locked="0" enabled="1" class="SimpleLine" pass="0">
            <Option type="Map">
              <Option name="align_dash_pattern" value="0" type="QString"/>
              <Option name="capstyle" value="square" type="QString"/>
              <Option name="customdash" value="3.5;1;1;1;2.5;1;1;27" type="QString"/>
              <Option name="customdash_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
              <Option name="customdash_unit" value="MM" type="QString"/>
              <Option name="dash_pattern_offset" value="0" type="QString"/>
              <Option name="dash_pattern_offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
            ...
            <prop v="0" k="align_dash_pattern"/>
            <prop v="square" k="capstyle"/>
            <prop v="3.5;1;1;1;2.5;1;1;27" k="customdash"/>
            <prop v="3x:0,0,0,0,0,0" k="customdash_map_unit_scale"/>
            <prop v="MM" k="customdash_unit"/>
            <prop v="0" k="dash_pattern_offset"/>
            <prop v="3x:0,0,0,0,0,0" k="dash_pattern_offset_map_unit_scale"/>
  ...
  <labeling type="rule-based">
    <rules key="{4a60fe5e-c478-41d4-99ae-322f40572b5f}">
      <rule filter="&quot;geometria_aproximada&quot; = 1 and  &quot;exibir_rotulo_aproximado&quot; = 1" key="{06986856-49fb-4d58-8802-fea368648c6c}" description="Texto aproximado">
        <settings calloutType="simple">
          <text-style textOpacity="1" fieldName="'APROXIMADO'" previewBkgrdColor="255,255,255,255" fontKerning="1" fontUnderline="0" fontLetterSpacing="0" textColor="255,255,255,255" useSubstitutions="0" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" allowHtml="0" legendString="Aa" textOrientation="horizontal" fontWeight="50" fontFamily="Noto Sans" fontWordSpacing="0" fontItalic="0" multilineHeight="1" fontSize="6" namedStyle="Condensed" blendMode="0" capitalization="1" fontSizeUnit="Point" isExpression="1">
            <families/>
            <text-buffer bufferBlendMode="0" bufferDraw="1" bufferOpacity="1" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="75,75,75,255" bufferSizeUnits="Point" bufferSize="1" bufferNoFill="1"/>
