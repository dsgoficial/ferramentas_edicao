...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  <renderer-v2 referencescale="-1" enableorderby="0" type="mergedFeatureRenderer" symbollevels="0" forceraster="0">
    <renderer-v2 referencescale="-1" enableorderby="0" type="RuleRenderer" symbollevels="0" forceraster="0">
      <rules key="{ff3995e7-5994-44a3-800a-da9a9d3e9d9f}">
        <rule description="Unidade de conservação" label="A10420A" key="{63b39a76-52b4-4be5-9fcb-60910375814a}" symbol="0" filter="sobreposto = 2"/>
        <rule description="Unidade de conservação" label="A10420A sobreposto" key="{6f8527a2-61b5-4534-8c2f-b780432d5412}" symbol="1" filter="sobreposto = 1"/>
      </rules>
      <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{b6a7fd03-ff4a-4b8c-ae4f-58e7c4d6f50d}">
      <rule description="Texto aproximado" key="{cb67031f-b153-4271-abf6-9ffcdc12fd2d}" filter=" &quot;geometria_aproximada&quot; = 1 and  &quot;exibir_rotulo_aproximado&quot; = 1 ">
