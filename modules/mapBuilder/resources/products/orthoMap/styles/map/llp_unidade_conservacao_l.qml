...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  <renderer-v2 enableorderby="0" type="mergedFeatureRenderer" referencescale="-1" symbollevels="0" forceraster="0">
    <renderer-v2 enableorderby="0" type="RuleRenderer" referencescale="-1" symbollevels="0" forceraster="0">
      <rules key="{ff3995e7-5994-44a3-800a-da9a9d3e9d9f}">
        <rule key="{63b39a76-52b4-4be5-9fcb-60910375814a}" label="A10420A" description="Unidade de conservação" symbol="0" filter="sobreposto = 2"/>
        <rule key="{6f8527a2-61b5-4534-8c2f-b780432d5412}" label="A10420A sobreposto" description="Unidade de conservação" symbol="1" filter="sobreposto = 1"/>
      </rules>
      <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{a679b47b-02f6-4f8b-bc12-249530174f44}">
      <rule key="{cda4b110-aec6-4899-9cd5-99cf96b10a9d}" description="Texto aproximado" filter="&quot;geometria_aproximada&quot; = 1 and  &quot;exibir_rotulo_aproximado&quot; = 1">
