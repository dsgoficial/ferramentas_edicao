...
<qgis labelsEnabled="1" styleCategories="Symbology|Labeling" version="3.24.3-Tisler">
  <renderer-v2 symbollevels="0" referencescale="-1" type="mergedFeatureRenderer" forceraster="0" enableorderby="0">
    <renderer-v2 symbollevels="0" referencescale="-1" type="RuleRenderer" forceraster="0" enableorderby="0">
      <rules key="{ff3995e7-5994-44a3-800a-da9a9d3e9d9f}">
        <rule filter="sobreposto = 2" key="{63b39a76-52b4-4be5-9fcb-60910375814a}" symbol="0" label="A10420A" description="Unidade de conservação"/>
        <rule filter="sobreposto = 1" key="{6f8527a2-61b5-4534-8c2f-b780432d5412}" symbol="1" label="A10420A sobreposto" description="Unidade de conservação"/>
      </rules>
      <symbols>
              ...
              <Option type="Map">
                ...
                <Option name="properties" type="Map">
                  <Option name="outlineColor" type="Map">
                    ...
                    <Option name="expression" value="project_color('verde42_131-194-164_#83C2A4')" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{81416729-ec00-4c3e-9ce2-213e43d500d4}">
      <rule filter="&quot;geometria_aproximada&quot; = 1 and  &quot;exibir_rotulo_aproximado&quot; = 1" key="{12283ba5-52ec-4e3c-b7d1-2122d2ce0c18}" description="Texto aproximado">
