...
<qgis version="3.24.3-Tisler" styleCategories="Symbology|Labeling" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{c6e278fc-6cf3-4393-a345-4949c128f47c}">
      <rule description="Elemento infraestrutura" key="{fabec1f2-995d-41cb-aa7f-1852fc835dee}" filter="visivel = 1">
        <settings calloutType="simple">
          ...
          <placement distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" rotationUnit="AngleDegrees" geometryGeneratorType="PolygonGeometry" yOffset="-0.5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" dist="0.40000000000000002" lineAnchorPercent="0.5" lineAnchorType="0" offsetUnits="MM" xOffset="0.5" repeatDistanceUnits="MM" lineAnchorClipping="0" layerType="PolygonGeometry" preserveRotation="1" overrunDistanceUnit="MM" placement="0" centroidInside="0" rotationAngle="0" priority="5" fitInPolygonOnly="0" placementFlags="10" centroidWhole="0" geometryGeneratorEnabled="1" quadOffset="2" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" polygonPlacementFlags="2" overrunDistance="0" repeatDistance="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetType="0" distUnits="MM"/>
