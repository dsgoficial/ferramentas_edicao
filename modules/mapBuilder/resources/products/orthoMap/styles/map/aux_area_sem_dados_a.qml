...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  ...
  <labeling type="rule-based">
    <rules key="{93f86d84-2f32-4f9b-983d-38bfa338a996}">
      <rule key="{9ee4b55d-2510-4f16-bf39-4f83a618d7ff}" filter="&quot;rotular_carta_mini&quot; = 1">
        <settings calloutType="simple">
          <text-style legendString="Aa" isExpression="0" fieldName="texto_edicao" fontSizeUnit="Point" fontSize="6" textOrientation="horizontal" capitalization="1" useSubstitutions="0" fontStrikeout="0" textColor="75,75,75,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" allowHtml="0" multilineHeight="0.80000000000000004" fontFamily="Noto Sans" blendMode="0" namedStyle="Condensed" fontWeight="50" fontUnderline="0" textOpacity="1" fontKerning="1" fontItalic="0" fontWordSpacing="0" fontLetterSpacing="0" previewBkgrdColor="255,255,255,255">
            <families/>
            <text-buffer bufferColor="255,255,255,255" bufferOpacity="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferJoinStyle="128" bufferSize="0.20000000000000001" bufferNoFill="1" bufferBlendMode="0" bufferDraw="1"/>
