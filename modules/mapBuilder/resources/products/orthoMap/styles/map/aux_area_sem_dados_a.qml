...
<qgis version="3.22.1-Białowieża" styleCategories="Symbology|Labeling" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{86e1be64-0e03-40ac-a8fc-8a591df58426}">
      <rule filter=" &quot;rotular_carta_mini&quot; = 1" key="{07975663-e681-4645-b328-15cd725f0cee}">
        <settings calloutType="simple">
          <text-style textOrientation="horizontal" fontLetterSpacing="0" previewBkgrdColor="255,255,255,255" multilineHeight="0.80000000000000004" fontWordSpacing="0" allowHtml="0" fontUnderline="0" useSubstitutions="0" capitalization="1" isExpression="0" textColor="0,0,0,255" fontStrikeout="0" fontSize="6" fontItalic="0" legendString="Aa" fontKerning="1" fieldName="texto_edicao" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontSizeUnit="Point" textOpacity="1" namedStyle="Condensed" fontFamily="Noto Sans" fontWeight="50">
            <families/>
            <text-buffer bufferJoinStyle="128" bufferBlendMode="0" bufferDraw="1" bufferSize="0.20000000000000001" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferOpacity="1" bufferNoFill="1" bufferSizeUnits="MM"/>
          ...
          <rendering obstacle="1" minFeatureSize="0" fontMaxPixelSize="10000" unplacedVisibility="0" scaleMax="0" upsidedownLabels="0" zIndex="0" scaleMin="0" scaleVisibility="0" maxNumLabels="2000" displayAll="0" drawLabels="1" mergeLines="0" limitNumLabels="0" fontMinPixelSize="3" obstacleType="0" fontLimitPixelSize="0" obstacleFactor="1.2" labelPerPart="0"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" type="QString" name="name"/>
