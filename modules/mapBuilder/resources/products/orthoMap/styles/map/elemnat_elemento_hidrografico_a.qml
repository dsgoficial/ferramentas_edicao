...
<qgis version="3.24.3-Tisler" styleCategories="Symbology|Labeling" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{a0771303-f737-45fc-8bb2-24f1f2eefb79}">
      <rule key="{1563b9ef-9f65-4d65-981a-c9cfdb2394cd}" filter="visivel = 1">
        <settings calloutType="simple">
          <text-style previewBkgrdColor="255,255,255,255" allowHtml="0" fontSizeUnit="Point" fontWeight="50" fontUnderline="0" fontStrikeout="0" fieldName="texto_edicao" blendMode="0" fontSize="7" legendString="Aa" textOrientation="horizontal" namedStyle="Condensed Italic" textOpacity="1" fontKerning="1" fontItalic="1" fontWordSpacing="0" useSubstitutions="0" fontFamily="Noto Sans" capitalization="0" fontLetterSpacing="0" multilineHeight="1" textColor="255,255,255,255" isExpression="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0">
            <families/>
            ...
            <text-mask maskSizeUnits="MM" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskSize="0.20000000000000001" maskEnabled="1" maskedSymbolLayers="" maskOpacity="1"/>
          ...
          <placement distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-30" rotationUnit="AngleDegrees" geometryGeneratorType="PolygonGeometry" yOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" dist="0.5" lineAnchorPercent="0.5" lineAnchorType="0" offsetUnits="MM" xOffset="0" repeatDistanceUnits="MM" lineAnchorClipping="0" layerType="PolygonGeometry" preserveRotation="0" overrunDistanceUnit="MM" placement="0" centroidInside="1" rotationAngle="0" priority="9" fitInPolygonOnly="0" placementFlags="14" centroidWhole="0" geometryGeneratorEnabled="1" quadOffset="4" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="30" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa; )" polygonPlacementFlags="3" overrunDistance="0" repeatDistance="300" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetType="0" distUnits="MM"/>
          <rendering scaleMin="0" minFeatureSize="0" scaleMax="0" scaleVisibility="0" limitNumLabels="0" labelPerPart="0" fontMinPixelSize="3" mergeLines="1" drawLabels="1" obstacleType="0" fontLimitPixelSize="0" fontMaxPixelSize="10000" maxNumLabels="2" zIndex="0" unplacedVisibility="0" displayAll="0" upsidedownLabels="0" obstacleFactor="2" obstacle="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
