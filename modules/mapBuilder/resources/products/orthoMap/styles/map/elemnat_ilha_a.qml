...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  ...
  <labeling type="rule-based">
    <rules key="{a1bf5b3e-682c-4dcc-8516-f602b5eaf389}">
      <rule key="{74478a02-cc97-40a6-a762-41638d9c585f}">
        <settings calloutType="simple">
          ...
          <placement lineAnchorPercent="0.5" centroidInside="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" polygonPlacementFlags="3" quadOffset="4" offsetUnits="MM" overrunDistanceUnit="MM" dist="0" repeatDistance="0" rotationUnit="AngleDegrees" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" layerType="PolygonGeometry" distUnits="MM" fitInPolygonOnly="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" priority="5" rotationAngle="0" maxCurvedCharAngleOut="-25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" lineAnchorClipping="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" placementFlags="10" offsetType="0" overrunDistance="0" xOffset="0" geometryGeneratorEnabled="1" placement="0" preserveRotation="1" geometryGeneratorType="PolygonGeometry" maxCurvedCharAngleIn="25" yOffset="0" distMapUnitScale="3x:0,0,0,0,0,0"/>
          <rendering maxNumLabels="2000" unplacedVisibility="0" fontMinPixelSize="3" limitNumLabels="0" mergeLines="0" drawLabels="1" upsidedownLabels="0" minFeatureSize="0" scaleMin="0" obstacle="0" obstacleFactor="1" fontLimitPixelSize="0" zIndex="0" displayAll="0" labelPerPart="0" scaleVisibility="0" fontMaxPixelSize="10000" scaleMax="0" obstacleType="1"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
