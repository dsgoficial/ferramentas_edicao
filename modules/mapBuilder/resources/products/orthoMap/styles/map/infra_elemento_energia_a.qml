...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  ...
  <labeling type="rule-based">
    <rules key="{406f4a90-ed87-4bf6-b531-b34e80df901f}">
      <rule key="{02da393c-e793-4e14-bb00-8c7a05e106e1}" description="Elemento energia">
        <settings calloutType="simple">
          ...
          <placement lineAnchorPercent="0.5" centroidInside="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" polygonPlacementFlags="3" quadOffset="2" offsetUnits="MM" overrunDistanceUnit="MM" dist="0.40000000000000002" repeatDistance="0" rotationUnit="AngleDegrees" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" layerType="PolygonGeometry" distUnits="MM" fitInPolygonOnly="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" priority="5" rotationAngle="0" maxCurvedCharAngleOut="-25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" lineAnchorClipping="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" placementFlags="10" offsetType="0" overrunDistance="0" xOffset="0.5" geometryGeneratorEnabled="1" placement="0" preserveRotation="1" geometryGeneratorType="PolygonGeometry" maxCurvedCharAngleIn="25" yOffset="-0.5" distMapUnitScale="3x:0,0,0,0,0,0"/>
          <rendering maxNumLabels="2000" unplacedVisibility="0" fontMinPixelSize="3" limitNumLabels="0" mergeLines="0" drawLabels="1" upsidedownLabels="0" minFeatureSize="0" scaleMin="0" obstacle="1" obstacleFactor="1" fontLimitPixelSize="0" zIndex="0" displayAll="0" labelPerPart="0" scaleVisibility="0" fontMaxPixelSize="10000" scaleMax="0" obstacleType="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
              <Option name="properties" type="Map">
