...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{acbedc1c-2e71-4778-a1ae-6d5aed7d9db0}">
      <rule description="Elemento energia" key="{2611258b-b444-4284-ad43-d2a0ada1f6e8}">
        <settings calloutType="simple">
          ...
          <placement maxCurvedCharAngleOut="-25" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" xOffset="0.5" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="PolygonGeometry" centroidWhole="0" yOffset="-0.5" overrunDistance="0" centroidInside="0" distUnits="MM" placement="0" placementFlags="10" lineAnchorPercent="0.5" repeatDistance="0" geometryGeneratorType="PolygonGeometry" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" fitInPolygonOnly="0" rotationAngle="0" offsetUnits="MM" priority="5" repeatDistanceUnits="MM" lineAnchorClipping="0" geometryGeneratorEnabled="1" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" preserveRotation="1" overrunDistanceUnit="MM" polygonPlacementFlags="3" dist="0.40000000000000002" quadOffset="2" rotationUnit="AngleDegrees" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" offsetType="0"/>
          <rendering maxNumLabels="2000" obstacleFactor="1" drawLabels="1" fontLimitPixelSize="0" scaleMax="0" scaleMin="0" fontMaxPixelSize="10000" mergeLines="0" scaleVisibility="0" obstacle="1" fontMinPixelSize="3" minFeatureSize="0" displayAll="0" obstacleType="0" unplacedVisibility="0" upsidedownLabels="0" zIndex="0" limitNumLabels="0" labelPerPart="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
              <Option name="properties" type="Map">
