...
<qgis version="3.24.3-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
              ...
              <data_defined_properties>
                <Option type="Map">
                  ...
                  <Option type="Map" name="properties">
                    <Option type="Map" name="fillColor">
                      <Option type="bool" name="active" value="true"/>
                      <Option type="QString" name="expression" value="project_color('azul72-42_121-135-200_#7987C8')"/>
                      <Option type="int" name="type" value="3"/>
                    </Option>
                    <Option type="Map" name="outlineColor">
                      <Option type="bool" name="active" value="true"/>
  ...
  <labeling type="rule-based">
    <rules key="{84beee85-a94a-4519-8d27-731f7cf6c3f8}">
      <rule description="Elemento energia" key="{38344a9c-31b8-456d-9cc1-7985bdf6c80b}">
        <settings calloutType="simple">
          <text-style blendMode="0" capitalization="0" legendString="Aa" fieldName="texto_edicao" textOrientation="horizontal" multilineHeight="0.80000000000000004" fontItalic="0" fontWordSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" allowHtml="0" fontSizeUnit="Point" textColor="255,255,255,255" fontFamily="Noto Sans" namedStyle="Condensed" isExpression="0" fontKerning="1" fontUnderline="0" fontStrikeout="0" fontSize="7" textOpacity="1" previewBkgrdColor="255,255,255,255" fontWeight="50" fontLetterSpacing="0" useSubstitutions="0">
            <families/>
            ...
            <text-mask maskedSymbolLayers="" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskSize="0.20000000000000001" maskType="0" maskEnabled="1" maskOpacity="1" maskSizeUnits="MM"/>
          ...
          <placement dist="0.40000000000000002" polygonPlacementFlags="3" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" xOffset="0.5" layerType="PolygonGeometry" rotationUnit="AngleDegrees" offsetType="0" quadOffset="2" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" preserveRotation="1" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" priority="5" lineAnchorClipping="0" lineAnchorType="0" geometryGeneratorType="PolygonGeometry" centroidInside="0" yOffset="-0.5" centroidWhole="0" repeatDistance="0" overrunDistance="0" overrunDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placement="0" placementFlags="10" lineAnchorPercent="0.5" offsetUnits="MM" distUnits="MM" rotationAngle="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" repeatDistanceUnits="MM" geometryGeneratorEnabled="1"/>
          <rendering obstacleType="0" limitNumLabels="0" minFeatureSize="0" zIndex="0" fontMaxPixelSize="10000" drawLabels="1" fontMinPixelSize="3" upsidedownLabels="0" fontLimitPixelSize="0" unplacedVisibility="0" labelPerPart="0" scaleMax="0" maxNumLabels="2000" obstacleFactor="1" displayAll="0" mergeLines="0" scaleMin="0" obstacle="1" scaleVisibility="0"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" name="name" value=""/>
              <Option type="Map" name="properties">
