...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  ...
  <labeling type="rule-based">
    <rules key="{439dc765-ad4c-4925-be3d-ccd432b90737}">
      <rule key="{cadadbf4-2774-4364-a28c-50d21a10a91f}">
        <settings calloutType="simple">
          ...
          <placement lineAnchorPercent="0.5" centroidInside="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" polygonPlacementFlags="2" quadOffset="4" offsetUnits="MM" overrunDistanceUnit="MM" dist="0.40000000000000002" repeatDistance="300" rotationUnit="AngleDegrees" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa; )" layerType="PointGeometry" distUnits="MM" fitInPolygonOnly="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" priority="5" rotationAngle="0" maxCurvedCharAngleOut="-30" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" lineAnchorClipping="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" placementFlags="14" offsetType="0" overrunDistance="0" xOffset="0" geometryGeneratorEnabled="1" placement="0" preserveRotation="0" geometryGeneratorType="PointGeometry" maxCurvedCharAngleIn="30" yOffset="0" distMapUnitScale="3x:0,0,0,0,0,0"/>
          <rendering maxNumLabels="2" unplacedVisibility="0" fontMinPixelSize="3" limitNumLabels="0" mergeLines="1" drawLabels="1" upsidedownLabels="0" minFeatureSize="30" scaleMin="0" obstacle="1" obstacleFactor="2" fontLimitPixelSize="0" zIndex="0" displayAll="0" labelPerPart="0" scaleVisibility="0" fontMaxPixelSize="10000" scaleMax="0" obstacleType="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
