...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
      ...
      <symbol name="0" alpha="1" type="fill" clip_to_extent="1" force_rhr="0">
        ...
        <layer enabled="1" locked="0" class="SimpleFill" pass="0">
          <Option type="Map">
            ...
            <Option name="outline_color" value="225,89,137,0" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{c8a51d4a-8671-431e-a3e7-35c62f08d5ed}">
      <rule key="{da703f23-13b6-49b4-ace2-dfdd7903bd6d}" filter="ELSE">
        <settings calloutType="simple">
          ...
          <placement lineAnchorPercent="0.5" centroidInside="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" polygonPlacementFlags="3" quadOffset="4" offsetUnits="MM" overrunDistanceUnit="MM" dist="0" repeatDistance="300" rotationUnit="AngleDegrees" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa; )" layerType="PolygonGeometry" distUnits="MM" fitInPolygonOnly="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" priority="6" rotationAngle="0" maxCurvedCharAngleOut="-30" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" lineAnchorClipping="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" placementFlags="14" offsetType="0" overrunDistance="0" xOffset="0" geometryGeneratorEnabled="1" placement="0" preserveRotation="0" geometryGeneratorType="PolygonGeometry" maxCurvedCharAngleIn="30" yOffset="0" distMapUnitScale="3x:0,0,0,0,0,0"/>
          <rendering maxNumLabels="2" unplacedVisibility="0" fontMinPixelSize="3" limitNumLabels="0" mergeLines="1" drawLabels="1" upsidedownLabels="0" minFeatureSize="0" scaleMin="0" obstacle="0" obstacleFactor="1.2" fontLimitPixelSize="0" zIndex="0" displayAll="0" labelPerPart="0" scaleVisibility="0" fontMaxPixelSize="10000" scaleMax="0" obstacleType="1"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
