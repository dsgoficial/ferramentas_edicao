...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{e0b5cc02-ee8b-4b5b-99f1-63a057006a50}">
      <rule description="Extração Mineral" key="{d8058b24-0107-4e9f-ac5e-474f26c362dc}" filter="&quot;visivel&quot; = 1">
        <settings calloutType="simple">
          ...
          <placement maxCurvedCharAngleOut="-25" priority="5" placementFlags="10" rotationUnit="AngleDegrees" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" overrunDistanceUnit="MM" offsetUnits="MM" maxCurvedCharAngleIn="25" geometryGeneratorEnabled="1" dist="0.40000000000000002" lineAnchorClipping="0" offsetType="0" geometryGeneratorType="PointGeometry" preserveRotation="1" quadOffset="2" distUnits="MM" centroidInside="0" repeatDistanceUnits="MM" lineAnchorType="0" centroidWhole="0" rotationAngle="0" placement="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" fitInPolygonOnly="0" lineAnchorPercent="0.5" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" layerType="PointGeometry" polygonPlacementFlags="2" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" distMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" xOffset="0.5" yOffset="-0.5"/>
          <rendering limitNumLabels="0" unplacedVisibility="0" drawLabels="1" mergeLines="0" upsidedownLabels="0" obstacle="1" obstacleType="1" minFeatureSize="0" scaleVisibility="0" displayAll="0" maxNumLabels="2000" scaleMax="0" labelPerPart="0" obstacleFactor="1" fontMaxPixelSize="10000" fontLimitPixelSize="0" zIndex="0" scaleMin="0" fontMinPixelSize="3"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" name="name" value=""/>
              <Option type="Map" name="properties">
