...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  <renderer-v2 enableorderby="0" type="RuleRenderer" referencescale="-1" symbollevels="0" forceraster="0">
    <rules key="{307e5843-9080-4729-87cd-a271460ba60b}">
      <rule key="{14a3cfa5-2823-48dd-8a3c-568fe681f529}" label="Extração mineral visível" symbol="0" filter=" &quot;visivel&quot; = 1"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{d4319e42-33e1-456a-9104-6427f0953869}">
      <rule key="{d848614c-f4ab-45c0-98cd-3a2fb5b70b2f}" description="Extração Mineral" filter="&quot;visivel&quot; = 1">
