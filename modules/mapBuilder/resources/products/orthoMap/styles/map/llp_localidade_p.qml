...
<qgis styleCategories="Symbology|Labeling" labelsEnabled="1" version="3.24.3-Tisler">
  ...
  <labeling type="rule-based">
    <rules key="{4cf00bb8-7481-48ce-bbd0-4f902a47869d}">
      <rule key="{8d987c70-08a7-45e7-8a7b-4e8a90c5ade4}" filter="visivel = 1">
        <rule key="{83e1626f-5833-4edc-b777-31828e56dc53}" description="Cidade 1a importância" filter="tipo in (1,2,3) AND populacao >= 500000">
        ...
        <rule key="{8fe87c95-c677-4714-b8ae-ea8d4609cd6e}" description="Cidade 2a importância" filter="tipo in (1,2,3) AND populacao &lt; 500000 AND populacao >= 100000">
          <settings calloutType="simple">
        ...
        <rule key="{c77fb6ef-f946-46d0-8a4f-582858983a10}" description="Cidade 3a importância" filter="tipo in (1,2,3) AND populacao &lt; 100000">
          <settings calloutType="simple">
        ...
        <rule key="{6f774bd9-9f58-4cee-a518-6627e31c3430}" description="Vila 4a importância" filter="tipo = 4">
          <settings calloutType="simple">
