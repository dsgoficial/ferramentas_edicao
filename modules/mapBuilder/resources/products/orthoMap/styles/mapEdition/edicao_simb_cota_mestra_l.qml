...
<qgis version="3.24.3-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  ...
  <labeling type="rule-based">
    <rules key="{153fe766-f91b-4c02-8bb2-4fd03a0eafa7}">
      <rule key="{c1f7cbea-c8fe-4ccf-a450-77710215af3d}" filter="ELSE">
        <settings calloutType="simple">
          <text-style fontSize="7" textOpacity="1" previewBkgrdColor="255,255,255,255" fontLetterSpacing="0" capitalization="1" useSubstitutions="1" blendMode="0" fontStrikeout="0" fontKerning="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" multilineHeight="1" fontUnderline="0" allowHtml="0" fieldName="texto_edicao" fontWeight="50" fontSizeUnit="Point" textOrientation="horizontal" fontFamily="Noto Sans" isExpression="0" namedStyle="Condensed Italic" legendString="Aa" fontItalic="1" textColor="255,255,255,255" fontWordSpacing="0">
            <families/>
