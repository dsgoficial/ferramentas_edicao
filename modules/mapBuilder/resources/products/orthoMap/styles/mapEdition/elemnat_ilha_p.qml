...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  <renderer-v2 enableorderby="0" forceraster="0" type="RuleRenderer" symbollevels="0" referencescale="-1">
    <rules key="{166ceec1-020f-45e1-ab68-32db49f8905f}">
      <rule symbol="0" filter="visivel = 1" key="{27c2e58d-6df4-4a9a-b820-612a7d23d3a7}"/>
      <rule label="Não visível" symbol="1" filter="ELSE" key="{0f72203b-756e-4789-a904-7cdad3d1167f}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{8cc64a86-7cc8-4353-a997-19283bbe4602}">
      <rule filter="visivel = 1" description="Ilha" key="{5a7a34fa-d88d-4d94-8046-163c53c4e357}">
