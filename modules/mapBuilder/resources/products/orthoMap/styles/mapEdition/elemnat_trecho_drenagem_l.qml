...
<qgis version="3.22.1-Białowieża" styleCategories="Symbology|Labeling" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{0bd5a9b0-55ce-4487-9f0a-c3dde185ed53}">
      <rule filter=" &quot;situacao_em_poligono&quot; in (1) and &quot;visivel&quot; = 1" description="Trecho de drenagem" key="{29e435ef-e548-4401-b57f-948819c415e2}">
      ...
      <rule filter=" &quot;situacao_em_poligono&quot; in (2) and &quot;visivel&quot; = 1" description="Massa Dagua" key="{3be0a133-f5f9-438a-9f1b-4fc2abc7740c}">
        <settings calloutType="simple">
