...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  <renderer-v2 enableorderby="0" forceraster="0" type="RuleRenderer" symbollevels="0" referencescale="-1">
    <rules key="{c54e4a5b-32be-4ce3-b686-bd86b0720db0}">
      <rule symbol="0" filter="apresentar_simbologia = 1 and visivel = 1" key="{2dc5cd94-0491-4672-9a68-30bed32442fc}"/>
      <rule symbol="1" filter="apresentar_simbologia = 2 and visivel = 1" key="{d950b82b-a37f-481d-892a-e8eb3fc8b618}"/>
      <rule label="Não visível" symbol="2" filter="ELSE" key="{cd647a0c-ab16-4f9b-a2c5-f555bae7340a}"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" name="0" alpha="1" type="fill" clip_to_extent="1">
        ...
        <layer enabled="1" locked="0" class="SimpleFill" pass="0">
          ...
          <prop v="54,37,213,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="225,89,137,0" k="outline_color"/>
      ...
      <symbol force_rhr="0" name="2" alpha="0.3" type="fill" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" class="SimpleFill" pass="0">
          <Option type="Map">
            ...
            <Option value="3x:0,0,0,0,0,0" name="offset_map_unit_scale" type="QString"/>
            <Option value="MM" name="offset_unit" type="QString"/>
            <Option value="0,173,240,255" name="outline_color" type="QString"/>
            <Option value="solid" name="outline_style" type="QString"/>
            <Option value="0.2" name="outline_width" type="QString"/>
            <Option value="MM" name="outline_width_unit" type="QString"/>
            <Option value="solid" name="style" type="QString"/>
          ...
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="0,173,240,255" k="outline_color"/>
          <prop v="solid" k="outline_style"/>
          <prop v="0.2" k="outline_width"/>
          <prop v="MM" k="outline_width_unit"/>
          <prop v="solid" k="style"/>
    ...
    <rules key="{b4a1377a-a789-403c-8587-840c10652f98}">
      <rule filter="visivel = 1" key="{625cfd5f-686d-41bf-90fc-52a1e19d2cbe}">
        <settings calloutType="simple">
          ...
          <placement placement="0" rotationAngle="0" dist="0" quadOffset="4" maxCurvedCharAngleIn="30" xOffset="0" centroidInside="1" overrunDistance="0" offsetUnits="MM" fitInPolygonOnly="0" overrunDistanceUnit="MM" yOffset="0" offsetType="0" rotationUnit="AngleDegrees" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="0" lineAnchorType="0" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" layerType="PolygonGeometry" polygonPlacementFlags="3" repeatDistance="300" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa; )" geometryGeneratorType="PolygonGeometry" placementFlags="14" maxCurvedCharAngleOut="-30" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" distUnits="MM" priority="6" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" centroidWhole="0" lineAnchorPercent="0.5"/>
          <rendering drawLabels="1" obstacleFactor="1.2" fontMinPixelSize="3" mergeLines="1" zIndex="0" minFeatureSize="0" maxNumLabels="2" fontMaxPixelSize="10000" obstacleType="1" scaleVisibility="0" upsidedownLabels="0" labelPerPart="0" fontLimitPixelSize="0" scaleMin="0" scaleMax="0" obstacle="0" limitNumLabels="0" displayAll="0" unplacedVisibility="0"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" name="name" type="QString"/>
              <Option name="properties" type="Map">
