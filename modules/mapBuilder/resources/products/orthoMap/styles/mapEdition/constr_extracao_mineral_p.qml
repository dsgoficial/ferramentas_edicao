...
<qgis version="3.22.1-Białowieża" styleCategories="Symbology|Labeling|Actions" labelsEnabled="1">
  <renderer-v2 symbollevels="0" enableorderby="0" type="RuleRenderer" forceraster="0" referencescale="-1">
    <rules key="{307e5843-9080-4729-87cd-a271460ba60b}">
      <rule symbol="0" key="{14a3cfa5-2823-48dd-8a3c-568fe681f529}" filter=" &quot;visivel&quot; = 1" label="Extração mineral visível"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{9aa435c1-b41f-469e-a615-deffc2271895}">
      <rule description="Extração Mineral" key="{00064362-a9d9-4acf-9708-4e7bbe292500}" filter=" &quot;visivel&quot; = 1">
