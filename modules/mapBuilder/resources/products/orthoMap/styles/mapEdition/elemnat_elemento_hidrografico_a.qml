...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  <renderer-v2 enableorderby="0" forceraster="0" type="RuleRenderer" symbollevels="0" referencescale="-1">
    <rules key="{4cbbd819-2358-4d0f-9954-5752ba91ba9f}">
      <rule symbol="0" filter="visivel = 1" key="{79412d4f-cf7d-4a4e-90db-6581b8a053e1}"/>
      <rule label="Não visível" symbol="1" filter="ELSE" key="{4deeb2e2-b9ac-48c1-ab61-9924f6d0ea4c}"/>
    </rules>
    <symbols>
      ...
      <symbol force_rhr="0" name="1" alpha="0.3" type="fill" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{e9eb1b7a-080b-4747-992b-848bde55082b}">
      <rule filter="visivel = 1" key="{a8cb35f3-9d6e-4e60-83b2-0dd14b304b60}">
        <settings calloutType="simple">
          ...
          <placement placement="0" rotationAngle="0" dist="0.5" quadOffset="4" maxCurvedCharAngleIn="30" xOffset="0" centroidInside="1" overrunDistance="0" offsetUnits="MM" fitInPolygonOnly="0" overrunDistanceUnit="MM" yOffset="0" offsetType="0" rotationUnit="AngleDegrees" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="0" lineAnchorType="0" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" layerType="PolygonGeometry" polygonPlacementFlags="3" repeatDistance="300" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa; )" geometryGeneratorType="PolygonGeometry" placementFlags="14" maxCurvedCharAngleOut="-30" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorClipping="0" distUnits="MM" priority="9" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" centroidWhole="0" lineAnchorPercent="0.5"/>
