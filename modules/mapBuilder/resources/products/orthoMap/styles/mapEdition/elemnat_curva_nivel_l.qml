...
<qgis version="3.22.1-Białowieża" styleCategories="Symbology|Labeling" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{f5f105e2-b494-4df9-8f81-7942d46a3634}">
      <rule key="{a85b7b6a-a205-406a-97f2-ac32eecefeed}" filter="(( @equidistancia IS NOT NULL and  &quot;cota&quot;%(5* to_int(@equidistancia)) = 0 ) &#xd;&#xa;OR &#xd;&#xa;(@equidistancia IS NULL and &quot;indice&quot; = 1))" description="Cota texto de edição">
