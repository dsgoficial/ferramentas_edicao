...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  <renderer-v2 enableorderby="0" forceraster="0" type="RuleRenderer" symbollevels="0" referencescale="-1">
    <rules key="{7effc230-86ff-453e-9492-07beaf1b5c7e}">
      <rule symbol="0" filter="visivel = 1" key="{8e54e0a7-467d-4029-9c5b-6d23865d3416}"/>
      <rule label="Não visível" symbol="1" filter="ELSE" key="{9dd375be-b92c-4364-8219-851886d787b0}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{fc0786a1-5ab5-4d7c-887a-34106d546147}">
      <rule filter="tipo in (2,4,5,6,7,12) and visivel = 1" description="Morro, Chapada, Maciço, Planalto, Planície, Praia" key="{df2719ed-2417-4c0b-8b65-576afc246d2f}">
        <settings calloutType="simple">
          <text-style fieldName="texto_edicao" legendString="Aa" fontFamily="Noto Sans" textColor="255,255,255,255" isExpression="0" fontWordSpacing="0" useSubstitutions="0" textOpacity="1" fontKerning="1" fontSizeUnit="Point" previewBkgrdColor="255,255,255,255" fontWeight="50" fontSize="7" textOrientation="horizontal" fontStrikeout="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Condensed Italic" fontUnderline="0" allowHtml="0" capitalization="0" fontLetterSpacing="0" fontItalic="1" multilineHeight="0.80000000000000004">
            <families/>
      ...
      <rule filter="tipo in (3,17) and visivel = 1" description="Pico ou Montanha" key="{8aae5854-08d8-472a-90e1-dd776c8d1123}">
        <settings calloutType="simple">
      ...
      <rule filter="tipo in (9,10,11) and visivel = 1" description="Península ou Cabo ou Ponta" key="{38497467-d5f7-42f8-86fe-751c31483b2c}">
        <settings calloutType="simple">
