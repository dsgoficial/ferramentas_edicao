...
<qgis labelsEnabled="1" version="3.22.1-Białowieża" styleCategories="Symbology|Labeling">
  <renderer-v2 symbollevels="0" type="RuleRenderer" forceraster="0" referencescale="-1" enableorderby="0">
    <rules key="{11d8bceb-2eb2-451c-8d92-1cd59a642a2a}">
      <rule filter=" &quot;rotular_carta_mini&quot; = 1" key="{2d25dba3-bacb-428d-b92d-fd963d0061ae}">
        <rule symbol="0" label="Capital Federal" filter="&quot;representar_simbolo&quot; = 1 AND  &quot;tipo&quot; = 3 " key="{3352847a-3d1a-4e1e-bcd2-4a9d64bc4efe}"/>
        <rule symbol="1" label="Capital Estadual" filter="&quot;representar_simbolo&quot; = 1 AND  &quot;tipo&quot; = 2" key="{55f1ee39-53f9-4c7e-8659-b602cb6b5537}"/>
        <rule symbol="2" label="Cidade" filter="&quot;representar_simbolo&quot; = 1 AND  &quot;tipo&quot; = 1" key="{b29691e7-ec6a-4334-8138-0f9b70adea57}"/>
        <rule symbol="3" label="Vila" filter="&quot;representar_simbolo&quot; = 1 AND  &quot;tipo&quot; = 4" key="{fe78f6ae-60b2-4114-adf1-dbc7a0d974be}"/>
        <rule symbol="4" filter="ELSE" key="{d680d595-4011-4b50-882d-025607bf3a3c}"/>
      </rule>
    </rules>
    <symbols>
