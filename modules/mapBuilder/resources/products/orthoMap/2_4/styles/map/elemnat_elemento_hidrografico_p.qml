...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
      ...
      <symbol alpha="1" force_rhr="0" type="marker" name="0" clip_to_extent="1">
        ...
        <layer class="SimpleMarker" locked="0" enabled="1" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" value="213,180,60,0" name="outline_color"/>
  ...
  <labeling type="rule-based">
    <rules key="{9f9f9e7f-28ec-4421-ad49-f74975635e2a}">
      <rule filter="visivel = 1" key="{400fbe82-a85f-49d0-b02a-9588b1adc533}" description="Elemento hidrografico p">
        <settings calloutType="simple">
          <text-style fontWeight="50" blendMode="0" useSubstitutions="0" allowHtml="0" fontFamily="Noto Sans" legendString="Aa" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" multilineHeight="0.80000000000000004" fontSize="7" isExpression="0" capitalization="0" textOpacity="1" fontItalic="1" fontUnderline="0" fontKerning="1" fontWordSpacing="0" fontLetterSpacing="0" textOrientation="horizontal" namedStyle="Condensed Italic" fontSizeUnit="Point" textColor="255,255,255,255" fieldName="texto_edicao">
            <families/>
          ...
          <placement yOffset="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" fitInPolygonOnly="0" preserveRotation="0" priority="5" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="300" overrunDistance="0" offsetType="0" placement="0" lineAnchorClipping="0" maxCurvedCharAngleOut="-30" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa; )" geometryGeneratorEnabled="1" xOffset="0" dist="0.40000000000000002" quadOffset="4" lineAnchorPercent="0.5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" layerType="PointGeometry" centroidInside="0" polygonPlacementFlags="2" lineAnchorType="0" geometryGeneratorType="PointGeometry" overrunDistanceUnit="MM" offsetUnits="MM" rotationAngle="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="30" distUnits="MM" placementFlags="14" rotationUnit="AngleDegrees" centroidWhole="0"/>
          <rendering mergeLines="1" zIndex="0" displayAll="0" fontMinPixelSize="3" drawLabels="1" unplacedVisibility="0" minFeatureSize="30" scaleMax="0" scaleMin="0" fontLimitPixelSize="0" upsidedownLabels="0" maxNumLabels="2" fontMaxPixelSize="10000" obstacle="1" obstacleFactor="2" labelPerPart="0" obstacleType="0" scaleVisibility="0" limitNumLabels="0"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" value="" name="name"/>
