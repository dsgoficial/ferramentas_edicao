...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  ...
  <labeling type="rule-based">
    <rules key="{44b38993-9ba2-4eaf-8bea-dfd4758af8ed}">
      <rule filter="visivel = 1" key="{da28798f-bab7-4c3d-b725-4366563321aa}" description="Elemento hidrografico A">
        <settings calloutType="simple">
          ...
          <placement yOffset="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" fitInPolygonOnly="0" preserveRotation="0" priority="9" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="300" overrunDistance="0" offsetType="0" placement="0" lineAnchorClipping="0" maxCurvedCharAngleOut="-30" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa; )" geometryGeneratorEnabled="1" xOffset="0" dist="0.5" quadOffset="4" lineAnchorPercent="0.5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" layerType="PolygonGeometry" centroidInside="1" polygonPlacementFlags="3" lineAnchorType="0" geometryGeneratorType="PolygonGeometry" overrunDistanceUnit="MM" offsetUnits="MM" rotationAngle="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="30" distUnits="MM" placementFlags="14" rotationUnit="AngleDegrees" centroidWhole="0"/>
          <rendering mergeLines="1" zIndex="0" displayAll="0" fontMinPixelSize="3" drawLabels="1" unplacedVisibility="0" minFeatureSize="0" scaleMax="0" scaleMin="0" fontLimitPixelSize="0" upsidedownLabels="0" maxNumLabels="2" fontMaxPixelSize="10000" obstacle="0" obstacleFactor="2" labelPerPart="0" obstacleType="0" scaleVisibility="0" limitNumLabels="0"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" value="" name="name"/>
