...
<qgis version="3.24.3-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  <renderer-v2 forceraster="0" symbollevels="0" referencescale="-1" type="RuleRenderer" enableorderby="0">
    <rules key="{307e5843-9080-4729-87cd-a271460ba60b}">
      <rule key="{393fc64e-74f6-43c7-bf3e-d1a97c2c1d80}" symbol="0" label="Extração mineral visível" filter=" visivel = 1 and situacao_fisica in (0,3)"/>
      <rule key="{14a3cfa5-2823-48dd-8a3c-568fe681f529}" symbol="1" label="Extração mineral visível" filter=" visivel = 1 and situacao_fisica in (1,2,4)"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="marker" name="0" clip_to_extent="1" force_rhr="0">
        ...
        <layer pass="0" enabled="1" locked="0" class="SvgMarker">
          <Option type="Map">
            ...
            <Option type="QString" value="diameter" name="scale_method"/>
            <Option type="QString" value="1.93829" name="size"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="size_map_unit_scale"/>
            <Option type="QString" value="MM" name="size_unit"/>
            <Option type="QString" value="1" name="vertical_anchor_point"/>
          </Option>
  ...
  <labeling type="rule-based">
    <rules key="{f77bfb5e-9899-427f-b33e-f162e46a1770}">
      <rule key="{d85f40d3-79a0-4e14-9c74-8f8cc44e3928}" filter="&quot;visivel&quot; = 1" description="Extração Mineral">
        <settings calloutType="simple">
          ...
          <placement dist="1.2000000000000002" priority="5" rotationAngle="0" quadOffset="2" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" repeatDistance="0" placementFlags="10" layerType="PointGeometry" distMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" polygonPlacementFlags="2" repeatDistanceUnits="MM" geometryGeneratorEnabled="1" overrunDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" geometryGeneratorType="PointGeometry" maxCurvedCharAngleIn="25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" lineAnchorClipping="0" lineAnchorType="0" yOffset="-0.5" offsetUnits="MM" placement="0" fitInPolygonOnly="0" xOffset="0.5" centroidWhole="0" preserveRotation="1" lineAnchorPercent="0.5" distUnits="MM" rotationUnit="AngleDegrees"/>
