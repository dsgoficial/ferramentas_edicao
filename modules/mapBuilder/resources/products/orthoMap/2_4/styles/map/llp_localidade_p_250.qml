...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 symbollevels="0" enableorderby="0" referencescale="-1" type="RuleRenderer" forceraster="0">
    <rules key="{97adfe7c-3bcc-42f9-8f42-b6d2e9daf9e4}">
      <rule filter="visivel = 1" key="{66879f71-d335-4056-850b-acb80c328375}">
        <rule filter="&quot;tipo&quot; = 3 " key="{0a1d5d5f-74ee-49d0-97d8-11992b5cd3ae}" symbol="0" label="Capital Federal"/>
        <rule filter="&quot;tipo&quot; = 2" key="{87192e3f-a28d-45c4-b620-79896c854635}" symbol="1" label="Capital Estadual"/>
        <rule filter="&quot;tipo&quot; = 1" key="{cdc34388-3877-4cd4-aad3-0c473bac51c6}" symbol="2" label="Cidade"/>
        <rule filter="&quot;tipo&quot; = 4" key="{acabce6e-2af6-4adb-b0be-e5b4d1acaf8d}" symbol="3" label="Vila"/>
      </rule>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{84697d45-8e67-4c3c-b805-7d8fd4eb7bb6}">
      <rule filter="tipo in (1,2,3) AND populacao >= 500000 and visivel = 1" key="{4c9a898e-ed66-4028-b058-2716103ec9b7}" description="Cidade 1a importância">
        <settings calloutType="simple">
          <text-style fontWeight="75" blendMode="0" useSubstitutions="0" allowHtml="0" fontFamily="Noto Sans" legendString="Aa" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" multilineHeight="0.80000000000000004" fontSize="14" isExpression="0" capitalization="1" textOpacity="1" fontItalic="0" fontUnderline="0" fontKerning="1" fontWordSpacing="0" fontLetterSpacing="0" textOrientation="horizontal" namedStyle="Condensed Bold" fontSizeUnit="Point" textColor="255,255,255,255" fieldName="texto_edicao">
            <families/>
            <text-buffer bufferBlendMode="0" bufferJoinStyle="128" bufferDraw="1" bufferSize="1" bufferNoFill="1" bufferSizeUnits="Point" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="0,0,0,255" bufferOpacity="1"/>
            <text-mask maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskOpacity="1" maskEnabled="1" maskSize="0.20000000000000001" maskedSymbolLayers="" maskJoinStyle="128" maskSizeUnits="MM"/>
          ...
          <placement yOffset="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" fitInPolygonOnly="0" preserveRotation="1" priority="5" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" overrunDistance="0" offsetType="0" placement="0" lineAnchorClipping="0" maxCurvedCharAngleOut="-25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" geometryGeneratorEnabled="1" xOffset="0" dist="0" quadOffset="4" lineAnchorPercent="0.5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" layerType="PointGeometry" centroidInside="0" polygonPlacementFlags="2" lineAnchorType="0" geometryGeneratorType="PointGeometry" overrunDistanceUnit="MM" offsetUnits="MM" rotationAngle="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" distUnits="MM" placementFlags="10" rotationUnit="AngleDegrees" centroidWhole="0"/>
      ...
      <rule filter="tipo in (1,2,3) AND populacao &lt; 500000 AND populacao >= 100000 and visivel = 1" key="{289e2931-f0a6-4571-b311-556df24a3147}" description="Cidade 2a importância">
        <settings calloutType="simple">
          <text-style fontWeight="75" blendMode="0" useSubstitutions="0" allowHtml="0" fontFamily="Noto Sans" legendString="Aa" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" multilineHeight="0.80000000000000004" fontSize="10" isExpression="0" capitalization="1" textOpacity="1" fontItalic="0" fontUnderline="0" fontKerning="1" fontWordSpacing="0" fontLetterSpacing="0" textOrientation="horizontal" namedStyle="Condensed Bold" fontSizeUnit="Point" textColor="255,255,255,255" fieldName="texto_edicao">
            <families/>
            <text-buffer bufferBlendMode="0" bufferJoinStyle="128" bufferDraw="1" bufferSize="1" bufferNoFill="1" bufferSizeUnits="Point" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="0,0,0,255" bufferOpacity="1"/>
            <text-mask maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskOpacity="1" maskEnabled="1" maskSize="0.20000000000000001" maskedSymbolLayers="" maskJoinStyle="128" maskSizeUnits="MM"/>
            <background shapeBorderWidth="0" shapeOffsetX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeFillColor="255,255,255,255" shapeSizeUnit="MM" shapeRadiiY="0" shapeSizeType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeRadiiX="0" shapeRadiiUnit="MM" shapeBlendMode="0" shapeJoinStyle="64" shapeDraw="0" shapeType="0" shapeBorderWidthUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="MM" shapeRotationType="0" shapeRotation="0" shapeSizeX="0" shapeOpacity="1" shapeOffsetY="0" shapeSVGFile="">
      ...
      <rule filter="tipo in (1,2,3) AND populacao &lt; 100000 and visivel = 1" key="{7c9ea766-44f0-43ea-b934-9ddf6f782714}" description="Cidade 3a importância">
        <settings calloutType="simple">
          <text-style fontWeight="75" blendMode="0" useSubstitutions="0" allowHtml="0" fontFamily="Noto Sans" legendString="Aa" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" multilineHeight="0.80000000000000004" fontSize="10" isExpression="0" capitalization="0" textOpacity="1" fontItalic="0" fontUnderline="0" fontKerning="1" fontWordSpacing="0" fontLetterSpacing="0" textOrientation="horizontal" namedStyle="Condensed Bold" fontSizeUnit="Point" textColor="255,255,255,255" fieldName="texto_edicao">
            <families/>
            <text-buffer bufferBlendMode="0" bufferJoinStyle="128" bufferDraw="1" bufferSize="1" bufferNoFill="1" bufferSizeUnits="Point" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="0,0,0,255" bufferOpacity="1"/>
            <text-mask maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskOpacity="1" maskEnabled="1" maskSize="0.20000000000000001" maskedSymbolLayers="" maskJoinStyle="128" maskSizeUnits="MM"/>
            <background shapeBorderWidth="0" shapeOffsetX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeFillColor="255,255,255,255" shapeSizeUnit="MM" shapeRadiiY="0" shapeSizeType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeRadiiX="0" shapeRadiiUnit="MM" shapeBlendMode="0" shapeJoinStyle="64" shapeDraw="0" shapeType="0" shapeBorderWidthUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="MM" shapeRotationType="0" shapeRotation="0" shapeSizeX="0" shapeOpacity="1" shapeOffsetY="0" shapeSVGFile="">
      ...
      <rule filter="tipo = 4 and visivel = 1" key="{c1e18af1-2a0a-4ad5-9931-bcc17a26823b}" description="Vila 4a importância">
        <settings calloutType="simple">
          <text-style fontWeight="50" blendMode="0" useSubstitutions="0" allowHtml="0" fontFamily="Noto Sans" legendString="Aa" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" multilineHeight="0.80000000000000004" fontSize="10" isExpression="0" capitalization="0" textOpacity="1" fontItalic="0" fontUnderline="0" fontKerning="1" fontWordSpacing="0" fontLetterSpacing="0" textOrientation="horizontal" namedStyle="Condensed" fontSizeUnit="Point" textColor="255,255,255,255" fieldName="texto_edicao">
            <families/>
            <text-buffer bufferBlendMode="0" bufferJoinStyle="128" bufferDraw="1" bufferSize="1" bufferNoFill="1" bufferSizeUnits="Point" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="0,0,0,255" bufferOpacity="1"/>
            <text-mask maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskOpacity="1" maskEnabled="1" maskSize="0.20000000000000001" maskedSymbolLayers="" maskJoinStyle="128" maskSizeUnits="MM"/>
            <background shapeBorderWidth="0" shapeOffsetX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeFillColor="255,255,255,255" shapeSizeUnit="MM" shapeRadiiY="0" shapeSizeType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeRadiiX="0" shapeRadiiUnit="MM" shapeBlendMode="0" shapeJoinStyle="64" shapeDraw="0" shapeType="0" shapeBorderWidthUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="MM" shapeRotationType="0" shapeRotation="0" shapeSizeX="0" shapeOpacity="1" shapeOffsetY="0" shapeSVGFile="">
