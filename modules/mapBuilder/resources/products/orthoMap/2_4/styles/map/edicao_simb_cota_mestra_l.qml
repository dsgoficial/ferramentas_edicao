...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  ...
  <labeling type="rule-based">
    <rules key="{53e20916-de2b-4e26-aede-8fc1e473768c}">
      <rule filter="ELSE" key="{e50fe00c-20a0-4bbf-afdf-eb985b96521c}" description="Cota mestra">
        <settings calloutType="simple">
          <text-style fontWeight="50" blendMode="0" useSubstitutions="1" allowHtml="0" fontFamily="Noto Sans" legendString="Aa" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" multilineHeight="1" fontSize="7" isExpression="0" capitalization="1" textOpacity="1" fontItalic="1" fontUnderline="0" fontKerning="1" fontWordSpacing="0" fontLetterSpacing="0" textOrientation="horizontal" namedStyle="Condensed Italic" fontSizeUnit="Point" textColor="255,255,255,255" fieldName="texto_edicao">
            <families/>
            ...
            <substitutions>
              <replacement replace="ZERO" wholeWord="1" caseSensitive="0" match="0"/>
            </substitutions>
          </text-style>
          ...
          <placement yOffset="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" fitInPolygonOnly="0" preserveRotation="1" priority="5" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" overrunDistance="0" offsetType="0" placement="3" lineAnchorClipping="0" maxCurvedCharAngleOut="-25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="with_variable('distancia',&#xd;&#xa;if( @project_units in ('degrees', 'graus'), 0.0005, 50)&#xd;&#xa;,&#xd;&#xa;collect_geometries( aggregate(&#xd;&#xa;  'edicao_simb_cota_mestra_l', &#xd;&#xa;  'array_agg',&#xd;&#xa;  intersection(buffer($geometry, @distancia),geometry(@parent)),&#xd;&#xa;  intersects(&#xd;&#xa;    $geometry,&#xd;&#xa;    geometry(@parent))&#xd;&#xa;))&#xd;&#xa;)" geometryGeneratorEnabled="1" xOffset="0" dist="0" quadOffset="4" lineAnchorPercent="0.5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" layerType="LineGeometry" centroidInside="0" polygonPlacementFlags="2" lineAnchorType="0" geometryGeneratorType="LineGeometry" overrunDistanceUnit="MM" offsetUnits="MM" rotationAngle="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" distUnits="MM" placementFlags="9" rotationUnit="AngleDegrees" centroidWhole="0"/>
          <rendering mergeLines="0" zIndex="0" displayAll="1" fontMinPixelSize="3" drawLabels="1" unplacedVisibility="0" minFeatureSize="0" scaleMax="0" scaleMin="0" fontLimitPixelSize="0" upsidedownLabels="0" maxNumLabels="2000" fontMaxPixelSize="10000" obstacle="0" obstacleFactor="1" labelPerPart="1" obstacleType="0" scaleVisibility="0" limitNumLabels="0"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" value="" name="name"/>
