...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 symbollevels="0" enableorderby="0" referencescale="-1" type="RuleRenderer" forceraster="0">
    <rules key="{c54e4a5b-32be-4ce3-b686-bd86b0720db0}">
      <rule filter="apresentar_simbologia = 1 and visivel = 1" key="{2dc5cd94-0491-4672-9a68-30bed32442fc}" symbol="0"/>
      <rule filter="apresentar_simbologia = 2 and visivel = 1" key="{d950b82b-a37f-481d-892a-e8eb3fc8b618}" symbol="1"/>
    </rules>
    <symbols>
      <symbol alpha="1" force_rhr="0" type="fill" name="0" clip_to_extent="1">
        ...
        <layer class="SimpleFill" locked="0" enabled="1" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" value="54,37,213,255" name="color"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
            <Option type="QString" value="0,0" name="offset"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
            <Option type="QString" value="MM" name="offset_unit"/>
            <Option type="QString" value="225,89,137,0" name="outline_color"/>
  ...
  <labeling type="rule-based">
    <rules key="{61a05e6a-eedf-497d-8abc-72ae2d9994a8}">
      <rule filter="visivel = 1" key="{054f2d32-3c5b-4864-bd93-1d792c6a09eb}" description="Massa dagua">
        <settings calloutType="simple">
          <text-style fontWeight="50" blendMode="0" useSubstitutions="0" allowHtml="0" fontFamily="Noto Sans" legendString="Aa" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" multilineHeight="0.80000000000000004" fontSize="7" isExpression="0" capitalization="1" textOpacity="1" fontItalic="1" fontUnderline="0" fontKerning="1" fontWordSpacing="0" fontLetterSpacing="0" textOrientation="horizontal" namedStyle="Condensed Italic" fontSizeUnit="Point" textColor="255,255,255,255" fieldName="texto_edicao">
            <families/>
            <text-buffer bufferBlendMode="0" bufferJoinStyle="128" bufferDraw="1" bufferSize="1" bufferNoFill="0" bufferSizeUnits="Point" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="0,173,240,255" bufferOpacity="1">
            ...
            <text-mask maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskOpacity="1" maskEnabled="1" maskSize="0.20000000000000001" maskedSymbolLayers="elemnat_terreno_sujeito_inundacao_a_f5fa6c98_ba17_40dd_b300_ad932d816338,{055b8edb-e294-45c0-aa6c-3244628fea0d},0,0" maskJoinStyle="128" maskSizeUnits="MM"/>
          ...
          <text-format leftDirectionSymbol="&lt;" useMaxLineLengthForAutoWrap="1" addDirectionSymbol="0" formatNumbers="0" decimals="3" plussign="0" multilineAlign="0" rightDirectionSymbol=">" placeDirectionSymbol="0" wrapChar="|" autoWrapLength="0" reverseDirectionSymbol="0"/>
          <placement yOffset="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" fitInPolygonOnly="0" preserveRotation="0" priority="6" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="300" overrunDistance="0" offsetType="0" placement="0" lineAnchorClipping="0" maxCurvedCharAngleOut="-30" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa; )" geometryGeneratorEnabled="1" xOffset="0" dist="0" quadOffset="4" lineAnchorPercent="0.5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" layerType="PolygonGeometry" centroidInside="1" polygonPlacementFlags="3" lineAnchorType="0" geometryGeneratorType="PolygonGeometry" overrunDistanceUnit="MM" offsetUnits="MM" rotationAngle="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="30" distUnits="MM" placementFlags="14" rotationUnit="AngleDegrees" centroidWhole="0"/>
          <rendering mergeLines="1" zIndex="0" displayAll="0" fontMinPixelSize="3" drawLabels="1" unplacedVisibility="0" minFeatureSize="0" scaleMax="0" scaleMin="0" fontLimitPixelSize="0" upsidedownLabels="0" maxNumLabels="2" fontMaxPixelSize="10000" obstacle="0" obstacleFactor="1.2" labelPerPart="0" obstacleType="1" scaleVisibility="0" limitNumLabels="0"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" value="" name="name"/>
              <Option type="Map" name="properties">
