...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  ...
  <labeling type="rule-based">
    <rules key="{fc92cd8b-6ffd-4a52-80d0-6696467bc8e9}">
      <rule filter="ELSE" key="{26809b72-486c-4ec8-83d4-69c7bc0123e7}" description="Area sem dados">
        <settings calloutType="simple">
          <text-style fontWeight="50" blendMode="0" useSubstitutions="0" allowHtml="0" fontFamily="Noto Sans" legendString="Aa" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" multilineHeight="0.80000000000000004" fontSize="6" isExpression="0" capitalization="1" textOpacity="1" fontItalic="0" fontUnderline="0" fontKerning="1" fontWordSpacing="0" fontLetterSpacing="0" textOrientation="horizontal" namedStyle="Condensed" fontSizeUnit="Point" textColor="0,0,0,255" fieldName="texto_edicao">
            <families/>
            <text-buffer bufferBlendMode="0" bufferJoinStyle="128" bufferDraw="1" bufferSize="0.20000000000000001" bufferNoFill="1" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferOpacity="1"/>
          ...
          <placement yOffset="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" fitInPolygonOnly="1" preserveRotation="1" priority="5" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" overrunDistance="0" offsetType="0" placement="0" lineAnchorClipping="0" maxCurvedCharAngleOut="-25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" geometryGeneratorEnabled="1" xOffset="0" dist="0" quadOffset="4" lineAnchorPercent="0.5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" layerType="PolygonGeometry" centroidInside="1" polygonPlacementFlags="2" lineAnchorType="0" geometryGeneratorType="PolygonGeometry" overrunDistanceUnit="MM" offsetUnits="MM" rotationAngle="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" distUnits="MM" placementFlags="10" rotationUnit="AngleDegrees" centroidWhole="0"/>
          <rendering mergeLines="0" zIndex="0" displayAll="0" fontMinPixelSize="3" drawLabels="1" unplacedVisibility="0" minFeatureSize="0" scaleMax="0" scaleMin="0" fontLimitPixelSize="0" upsidedownLabels="0" maxNumLabels="2000" fontMaxPixelSize="10000" obstacle="1" obstacleFactor="1.2" labelPerPart="0" obstacleType="0" scaleVisibility="0" limitNumLabels="0"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" value="" name="name"/>
              <Option type="Map" name="properties">
