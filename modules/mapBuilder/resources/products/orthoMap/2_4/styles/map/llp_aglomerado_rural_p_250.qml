...
<qgis labelsEnabled="1" version="3.24.3-Tisler" styleCategories="Symbology|Labeling">
  <renderer-v2 symbollevels="0" enableorderby="0" referencescale="-1" type="RuleRenderer" forceraster="0">
    <rules key="{d4243c00-da47-41f8-979b-3f58586135f8}">
      <rule filter="visivel = 1" key="{0758490b-dc6e-4207-b1d5-85d2fb42db58}">
        <rule filter="tipo = 6" key="{0c679765-cb08-415e-9375-71119727610b}" symbol="0" label="Povoado"/>
        <rule filter="tipo in (5,7)" key="{4a4a97e2-2538-4f8f-a2e0-5c39ba9b41a8}" symbol="1" label="Lugarejo / Núcelo"/>
      </rule>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{3cfe8130-ff41-44ed-b5a9-1afa13adbb09}">
      <rule filter="tipo = 6 and visivel = 1" key="{98bbd783-9417-4a8b-b46d-d1153cac4800}" description="Povoado 5a importância 8pt">
        <settings calloutType="simple">
          <text-style fontWeight="50" blendMode="0" useSubstitutions="0" allowHtml="0" fontFamily="Noto Sans" legendString="Aa" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" multilineHeight="0.80000000000000004" fontSize="8" isExpression="0" capitalization="0" textOpacity="1" fontItalic="0" fontUnderline="0" fontKerning="1" fontWordSpacing="0" fontLetterSpacing="0" textOrientation="horizontal" namedStyle="Condensed" fontSizeUnit="Point" textColor="255,255,255,255" fieldName="texto_edicao">
            <families/>
          ...
          <placement yOffset="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" fitInPolygonOnly="0" preserveRotation="1" priority="5" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" overrunDistance="0" offsetType="0" placement="0" lineAnchorClipping="0" maxCurvedCharAngleOut="-25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" geometryGeneratorEnabled="1" xOffset="0" dist="0.40000000000000002" quadOffset="4" lineAnchorPercent="0.5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" layerType="PointGeometry" centroidInside="0" polygonPlacementFlags="2" lineAnchorType="0" geometryGeneratorType="PointGeometry" overrunDistanceUnit="MM" offsetUnits="MM" rotationAngle="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" distUnits="MM" placementFlags="10" rotationUnit="AngleDegrees" centroidWhole="0"/>
      ...
      <rule filter="tipo in (5,7) and visivel = 1" key="{e17138dc-0dcb-4eac-a081-5eb3d8bc0346}" description="Lugarejo / Núcleo 5a importância 7pt">
        <settings calloutType="simple">
          <text-style fontWeight="50" blendMode="0" useSubstitutions="0" allowHtml="0" fontFamily="Noto Sans" legendString="Aa" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" multilineHeight="0.80000000000000004" fontSize="7" isExpression="0" capitalization="0" textOpacity="1" fontItalic="0" fontUnderline="0" fontKerning="1" fontWordSpacing="0" fontLetterSpacing="0" textOrientation="horizontal" namedStyle="Condensed" fontSizeUnit="Point" textColor="255,255,255,255" fieldName="texto_edicao">
            <families/>
            <text-buffer bufferBlendMode="0" bufferJoinStyle="64" bufferDraw="1" bufferSize="1" bufferNoFill="1" bufferSizeUnits="Point" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="0,0,0,255" bufferOpacity="1"/>
            <text-mask maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskOpacity="1" maskEnabled="1" maskSize="0.20000000000000001" maskedSymbolLayers="" maskJoinStyle="128" maskSizeUnits="MM"/>
            <background shapeBorderWidth="0" shapeOffsetX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeFillColor="255,255,255,255" shapeSizeUnit="MM" shapeRadiiY="0" shapeSizeType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeRadiiX="0" shapeRadiiUnit="MM" shapeBlendMode="0" shapeJoinStyle="64" shapeDraw="0" shapeType="0" shapeBorderWidthUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="MM" shapeRotationType="0" shapeRotation="0" shapeSizeX="0" shapeOpacity="1" shapeOffsetY="0" shapeSVGFile="">
              <symbol alpha="1" force_rhr="0" type="marker" name="markerSymbol" clip_to_extent="1">
                <data_defined_properties>
