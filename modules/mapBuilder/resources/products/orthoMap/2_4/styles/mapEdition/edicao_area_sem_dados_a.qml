...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{735ae8a4-d4ae-4b20-a1a2-c8b6d97d18c2}">
      <rule filter="ELSE" key="{0577e3fc-0f42-4a78-ab8f-cb5c5330b811}">
        <settings calloutType="simple">
          <text-style fieldName="texto_edicao" legendString="Aa" fontFamily="Noto Sans" textColor="0,0,0,255" isExpression="0" fontWordSpacing="0" useSubstitutions="0" textOpacity="1" fontKerning="1" fontSizeUnit="Point" previewBkgrdColor="255,255,255,255" fontWeight="50" fontSize="6" textOrientation="horizontal" fontStrikeout="0" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Condensed" fontUnderline="0" allowHtml="0" capitalization="1" fontLetterSpacing="0" fontItalic="0" multilineHeight="0.80000000000000004">
            <families/>
            <text-buffer bufferJoinStyle="128" bufferSize="0.20000000000000001" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferDraw="1" bufferBlendMode="0" bufferColor="255,255,255,255" bufferOpacity="1" bufferSizeUnits="MM" bufferNoFill="1"/>
