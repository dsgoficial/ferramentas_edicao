...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  <renderer-v2 enableorderby="0" forceraster="0" type="RuleRenderer" symbollevels="0" referencescale="-1">
    <rules key="{2009f314-8b04-4348-9c5e-9411abb25ab7}">
      <rule symbol="0" filter="visivel = 1" key="{1c5dfad1-d177-4ac8-85a4-b270a5f1618b}"/>
      <rule label="Não visível" symbol="1" filter="ELSE" key="{d98035c0-216d-4f94-a104-b545c58fc099}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{2d4d6b4e-3fc3-4caa-9549-b6e3e3fb0e6e}">
      <rule filter="visivel = 1" key="{aef68dad-7575-4122-9e15-d61d9b2b2c67}">
