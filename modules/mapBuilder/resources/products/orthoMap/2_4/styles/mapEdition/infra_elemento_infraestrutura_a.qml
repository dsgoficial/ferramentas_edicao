...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  <renderer-v2 enableorderby="0" forceraster="0" type="RuleRenderer" symbollevels="0" referencescale="-1">
    <rules key="{4a8dd8c8-7240-4145-a4ae-c7f67d3a3402}">
      <rule symbol="0" filter="visivel = 1" key="{4eccdc3a-77cf-4d42-8639-34e5830260e8}"/>
      <rule label="Não visível" symbol="1" filter="ELSE" key="{a4f7e618-9fb2-4b1f-ae32-0e6ad259bcf0}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{0e91fd89-e5e6-4c30-8f5c-bb0449e674e9}">
      <rule filter="visivel = 1" description="Elemento infraestrutura" key="{11ea8cc8-a13e-4708-9e93-7443a5720b0c}">
