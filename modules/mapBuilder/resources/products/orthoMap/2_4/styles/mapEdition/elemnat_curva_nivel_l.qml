...
<qgis version="3.24.3-Tisler" labelsEnabled="1" styleCategories="Symbology|Labeling">
  <renderer-v2 type="RuleRenderer" referencescale="-1" enableorderby="0" forceraster="0" symbollevels="0">
    <rules key="{0b5260cb-68fa-44a7-9937-3b05983fbf19}">
      <rule label="visivel" key="{4853bd36-c72a-48c9-afcf-462433ad773a}" filter=" &quot;visivel&quot; = 1 AND &quot;dentro_de_massa_dagua&quot; != 1">
        <rule symbol="0" label="Curva de nível mestra" key="{deb7a634-0a8a-4b21-b802-85c667582ef4}" filter="(( @equidistancia IS NOT NULL and  &quot;cota&quot;%(5* to_int(@equidistancia)) = 0 ) &#xd;&#xa;OR &#xd;&#xa;(@equidistancia IS NULL and &quot;indice&quot; = 1))&#xd;&#xa; and &quot;depressao&quot; = 2"/>
        <rule symbol="1" label="Curva de nível normal" key="{2ec6beb6-6309-4246-8713-dae8c8227a2f}" filter="(( @equidistancia IS NOT NULL and  &quot;cota&quot;%to_int(@equidistancia) = 0  and  &quot;cota&quot;%(5* to_int(@equidistancia)) != 0) &#xd;&#xa;OR &#xd;&#xa;(@equidistancia IS NULL and &quot;indice&quot; = 2))&#xd;&#xa;  and &quot;depressao&quot;=2"/>
        <rule symbol="2" label="Curva de nível auxiliar" key="{3ed6ab00-ff3e-4c8b-b7b3-64284f2a3543}" filter="((@equidistancia IS NOT NULL and  &quot;cota&quot;%(to_int(@equidistancia)/2) = 0  and  &quot;cota&quot;%(to_int(@equidistancia)) != 0 and  @exibir_auxiliar = 1) &#xd;&#xa;OR &#xd;&#xa;(@equidistancia IS NULL and &quot;indice&quot; = 3))&#xd;&#xa; and &quot;depressao&quot; = 2&#xd;&#xa;"/>
        <rule symbol="3" label="Curva de nível em depressão (mestra)" key="{babeea22-322d-417e-8941-b703129ea60c}" filter="(( @equidistancia IS NOT NULL and  &quot;cota&quot;%(5* to_int(@equidistancia)) = 0 ) &#xd;&#xa;OR &#xd;&#xa;(@equidistancia IS NULL and &quot;indice&quot; = 1))&#xd;&#xa; and &quot;depressao&quot; = 1"/>
        <rule symbol="4" label="Curva de nível em depressão (normal)" key="{cef3b486-d663-49c4-af84-f6eec2b16adf}" filter="(( @equidistancia IS NOT NULL and  &quot;cota&quot;%to_int(@equidistancia) = 0 and  &quot;cota&quot;%(5*to_int(@equidistancia)) != 0) &#xd;&#xa;OR &#xd;&#xa;(@equidistancia IS NULL and &quot;indice&quot; = 2))&#xd;&#xa;  and &quot;depressao&quot;=1"/>
        <rule symbol="5" label="Curva de nível em depressão (auxiliar)" key="{4058f258-7ce7-41bd-9aa3-636c64bdd022}" filter="((@equidistancia IS NOT NULL and  &quot;cota&quot;%(to_int(@equidistancia)/2) = 0 and  &quot;cota&quot;%(to_int(@equidistancia)) != 0  and  @exibir_auxiliar = 1) &#xd;&#xa;OR &#xd;&#xa;(@equidistancia IS NULL and &quot;indice&quot; = 3))&#xd;&#xa; and &quot;depressao&quot; = 1&#xd;&#xa;"/>
      </rule>
      <rule symbol="6" label="Não visível" key="{5d0e800f-f2e6-4b37-ba23-18f4f86208a0}" filter="ELSE"/>
    </rules>
    <symbols>
      ...
      <symbol type="line" alpha="1" force_rhr="0" name="3" clip_to_extent="1">
        ...
        <layer enabled="1" locked="0" pass="0" class="HashLine">
          ...
          <symbol type="line" alpha="1" force_rhr="0" name="@3@0" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
      ...
      <symbol type="line" alpha="1" force_rhr="0" name="4" clip_to_extent="1">
        ...
        <layer enabled="1" locked="0" pass="0" class="HashLine">
          ...
          <symbol type="line" alpha="1" force_rhr="0" name="@4@0" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
      ...
      <symbol type="line" alpha="1" force_rhr="0" name="5" clip_to_extent="1">
        ...
        <layer enabled="1" locked="0" pass="0" class="HashLine">
          ...
          <symbol type="line" alpha="1" force_rhr="0" name="@5@0" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
      ...
      <symbol type="line" alpha="0.4" force_rhr="0" name="6" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{d5df0ca4-ada4-4c5c-94f9-c0e8f0ca1b5e}">
      <rule key="{5c4e85c3-5b56-4caf-b2b8-287122d51fa7}" filter="visivel = 1 AND &quot;dentro_de_massa_dagua&quot; != 1 AND &#xd;&#xa;(( @equidistancia IS NOT NULL and  &quot;cota&quot;%(5* to_int(@equidistancia)) = 0 ) &#xd;&#xa;OR &#xd;&#xa;(@equidistancia IS NULL and &quot;indice&quot; = 1))" description="Cota texto de edição">
        <settings calloutType="simple">
          <text-style fontSize="7" textOpacity="1" previewBkgrdColor="255,255,255,255" fontLetterSpacing="0" capitalization="1" useSubstitutions="0" blendMode="0" fontStrikeout="0" fontKerning="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" multilineHeight="1" fontUnderline="0" allowHtml="0" fieldName="texto_edicao" fontWeight="50" fontSizeUnit="Point" textOrientation="horizontal" fontFamily="Noto Sans" isExpression="0" namedStyle="Condensed Italic" legendString="Aa" fontItalic="1" textColor="255,255,255,255" fontWordSpacing="0">
            <families/>
            <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferNoFill="1" bufferBlendMode="0" bufferColor="0,0,0,255" bufferSizeUnits="Point" bufferOpacity="1" bufferDraw="1" bufferSize="0.5">
          ...
          <placement geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" polygonPlacementFlags="2" layerType="LineGeometry" yOffset="0" fitInPolygonOnly="0" centroidWhole="0" repeatDistance="150" offsetUnits="MM" lineAnchorClipping="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" distUnits="MM" maxCurvedCharAngleIn="25" quadOffset="4" distMapUnitScale="3x:0,0,0,0,0,0" placementFlags="9" priority="5" placement="3" centroidInside="0" rotationAngle="0" preserveRotation="1" lineAnchorPercent="0.5" lineAnchorType="0" offsetType="0" geometryGeneratorType="LineGeometry" overrunDistanceUnit="MM" repeatDistanceUnits="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" maxCurvedCharAngleOut="-25" dist="0" geometryGeneratorEnabled="1"/>
          <rendering displayAll="0" fontMinPixelSize="3" scaleMax="0" zIndex="0" obstacleType="0" drawLabels="1" limitNumLabels="0" unplacedVisibility="0" fontLimitPixelSize="0" upsidedownLabels="0" scaleMin="0" maxNumLabels="2000" obstacle="0" obstacleFactor="1" fontMaxPixelSize="10000" labelPerPart="0" mergeLines="1" minFeatureSize="15" scaleVisibility="0"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" value="" name="name"/>
              <Option type="Map" name="properties">
