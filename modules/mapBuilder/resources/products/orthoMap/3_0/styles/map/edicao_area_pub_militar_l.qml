...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  <renderer-v2 enableorderby="0" forceraster="0" type="mergedFeatureRenderer" symbollevels="0" referencescale="-1">
    <renderer-v2 enableorderby="0" forceraster="0" type="RuleRenderer" symbollevels="0" referencescale="-1">
      <rules key="{ff3995e7-5994-44a3-800a-da9a9d3e9d9f}">
        <rule label="A10418A" symbol="0" filter="sobreposto = 2 and visivel = 1" description="Area Militar" key="{1e2d5c72-25d9-463c-98b6-25688afbcd8e}"/>
        <rule label="Area Militar tracejado" symbol="1" filter="sobreposto = 1 and visivel = 1" description="Terra Indigena" key="{4cb62d00-cb4e-430b-9e64-a271c5211c1c}"/>
      </rules>
      <symbols>
        <symbol force_rhr="0" name="0" alpha="1" type="line" clip_to_extent="1">
          ...
          <layer enabled="1" locked="0" class="SimpleLine" pass="0">
            <Option type="Map">
              ...
              <Option value="148,148,148,255" name="line_color" type="QString"/>
  ...
  <labeling type="rule-based">
    <rules key="{a626ca50-bdf3-4f71-bee7-a31599043c18}">
      <rule filter="&quot;geometria_aproximada&quot; = 1 and  &quot;exibir_rotulo_aproximado&quot; = 1 and visivel = 1" description="Texto aproximado" key="{27e3e02e-10b2-460f-a37c-3437b84629d2}">
