...
<qgis styleCategories="Symbology|Labeling" version="3.24.3-Tisler" labelsEnabled="1">
  <renderer-v2 enableorderby="0" forceraster="0" type="RuleRenderer" symbollevels="0" referencescale="-1">
    <rules key="{6b2cc6a8-b4e3-4c75-b1f0-755a3eb62389}">
      <rule symbol="0" filter="visivel = 1" key="{819c1ecd-2911-46c0-af21-bab362e42262}"/>
      <rule label="Não visível" symbol="1" filter="ELSE" key="{a796d561-0af6-4c45-b568-cfd2be81ebd2}"/>
    </rules>
    <symbols>
      ...
      <symbol force_rhr="0" name="1" alpha="0.3" type="marker" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
  ...
  <labeling type="rule-based">
    <rules key="{5c4bf715-1067-4a26-808f-b10dcbc9cd4f}">
      <rule filter="visivel = 1" key="{d6e77261-64d1-42e1-aa3f-99629a820498}">
        <rule filter="tipo in (1,2,3) AND populacao >= 500000" description="Cidade 1a importância" key="{70500eee-ad10-4026-801b-9ba097cd08e9}">
        ...
        <rule filter="tipo in (1,2,3) AND populacao &lt; 500000 AND populacao >= 100000" description="Cidade 2a importância" key="{b804c681-efe0-4e9c-9697-a6c75a98ca99}">
          <settings calloutType="simple">
        ...
        <rule filter="tipo in (1,2,3) AND populacao &lt; 100000" description="Cidade 3a importância" key="{41f687bb-37a0-4a7d-9e23-e41902054f76}">
          <settings calloutType="simple">
        ...
        <rule filter="tipo = 4" description="Vila 4a importância" key="{4373ca71-6b11-4ca2-be1f-750bad44f0fa}">
          <settings calloutType="simple">
