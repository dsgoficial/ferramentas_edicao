...
class MapScale:
	...
	def build(self, composition: QgsPrintLayout, data: dict):
		...
		text_label_direita = "ESCALA 1:" + '{:.3f}'.format((int(scale)*1e6))
		...
		text_label_escala = "ESCALA 1:" + '{:.3f}'.format((int(scale)*1e6))
		...
		text_label_e1 = str(int((scale*1e5)))
		...
		text_label_e2 = str(int((scale*1e5)*2))
		...
		text_label_e3 = str(int((scale*1e5)*4))
		...
		text_label_e4 = str(int((scale*1e5)*6))
		...
		text_label_e5 = str(int((scale*1e5)*8)) + ' m'		
