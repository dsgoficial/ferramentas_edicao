...
class HTMLHelpCreator(object):
    ...
    def __init__(self):
        self.html_repository = os.path.join(os.path.dirname(os.path.abspath(__file__)),"toolbox", "html")
        self.image_repository = os.path.join(os.path.dirname(os.path.abspath(__file__)),"toolbox", 'images')
