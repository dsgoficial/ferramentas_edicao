...
<qgis labelsEnabled="1" version="3.12.2-București" styleCategories="Symbology|Labeling|Fields|Forms">
  ...
  <labeling type="rule-based">
    <rules key="{bf3876e3-aaed-4f42-87e8-c61cb0910aca}">
      ...
      <rule key="{7c805d3f-154a-4106-8916-2f216fbce19f}">
        <settings calloutType="simple">
      ...
      <rule active="0" key="{ff8717f0-d596-443c-b227-011b1719d93b}" description="nome">
        <settings calloutType="simple">
