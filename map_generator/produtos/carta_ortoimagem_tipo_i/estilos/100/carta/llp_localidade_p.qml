...
<qgis simplifyLocal="1" styleCategories="AllStyleCategories" version="3.12.2-București" readOnly="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyDrawingTol="1" simplifyDrawingHints="0" labelsEnabled="1" simplifyMaxScale="1" simplifyAlgorithm="0" maxScale="0">
  ...
  <labeling type="rule-based">
    <rules key="{6ff93911-2232-4655-a4bb-f2e80eea6748}">
      <rule filter=" &quot;tipo&quot;  in (1,2,3)" key="{a42b3743-748b-468a-a268-24bf89700a15}" description="Cidade">
      ...
      <rule filter=" &quot;tipo&quot; in (4)" key="{c0bf1b16-67d0-4469-afc8-18813ec10706}" description="Vila">
        <settings calloutType="simple">
      ...
      <rule filter=" &quot;tipo&quot; in (6)" key="{cfb214bb-8531-4e37-9568-7f0f8dbee960}" description="Povoado">
        <settings calloutType="simple">
      ...
      <rule filter=" &quot;tipo&quot; in (5, 7)" key="{4fe1f8ec-51bc-4982-aaac-d9c2224d0b40}" description="Núcleo ou vilarejo">
        <settings calloutType="simple">
      ...
      <rule filter=" &quot;tipo&quot;  in (8, 9)" key="{72d9080d-392e-4fc8-abf4-c0e3695304c5}" description="Nome Local">
        <settings calloutType="simple">
