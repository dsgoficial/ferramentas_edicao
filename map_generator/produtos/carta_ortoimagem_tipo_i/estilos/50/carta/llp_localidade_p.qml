...
<qgis simplifyLocal="1" styleCategories="AllStyleCategories" version="3.12.2-București" readOnly="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyDrawingTol="1" simplifyDrawingHints="0" labelsEnabled="1" simplifyMaxScale="1" simplifyAlgorithm="0" maxScale="0">
  ...
  <labeling type="rule-based">
    <rules key="{549db456-4a01-43e3-b268-b9ac63610955}">
      <rule filter=" &quot;tipo&quot;  in (1,2,3)" key="{356e6865-ed75-415c-beb0-cd95fe428076}" description="Cidade">
      ...
      <rule filter=" &quot;tipo&quot; in (4)" key="{7a9655f0-9207-43c3-847b-599625363bc2}" description="Vila">
        <settings calloutType="simple">
      ...
      <rule filter=" &quot;tipo&quot; in (6)" key="{d739e97e-9fe1-432b-bb88-cb8c467df556}" description="Povoado">
        <settings calloutType="simple">
      ...
      <rule filter=" &quot;tipo&quot; in (5, 7)" key="{e62eb52d-5327-4b78-997b-9302d8416dc7}" description="Núcleo ou vilarejo">
        <settings calloutType="simple">
      ...
      <rule filter=" &quot;tipo&quot;  in (8, 9)" key="{c7596dbe-ae1d-421b-9c05-a930b529b220}" description="Nome Local">
        <settings calloutType="simple">
