...
<qgis simplifyLocal="1" styleCategories="AllStyleCategories" version="3.12.2-București" readOnly="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyDrawingTol="1" simplifyDrawingHints="0" labelsEnabled="1" simplifyMaxScale="1" simplifyAlgorithm="0" maxScale="0">
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" symbollevels="0" forceraster="0">
    <rules key="{4dc685c4-fe59-4438-a83f-c2407312e0b2}">
      <rule symbol="0" filter="&quot;mi&quot; =  @mi " key="{3da95000-516b-4697-98ff-2a5ea2bb8af0}"/>
    </rules>
    <symbols>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style isExpression="0" textColor="0,0,0,255" fontItalic="0" fontFamily="MS Shell Dlg 2" fontSizeUnit="Point" textOrientation="horizontal" fontCapitals="0" blendMode="0" fontWordSpacing="0" multilineHeight="1" previewBkgrdColor="255,255,255,255" textOpacity="1" fieldName="nome" fontLetterSpacing="0" fontWeight="50" fontSize="10" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" namedStyle="" fontStrikeout="0" fontKerning="1" useSubstitutions="0">
      ...
      <placement preserveRotation="1" xOffset="0" maxCurvedCharAngleOut="-25" quadOffset="4" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" layerType="UnknownGeometry" repeatDistanceUnits="MM" fitInPolygonOnly="0" geometryGenerator="" distUnits="MM" geometryGeneratorType="PointGeometry" dist="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistanceUnit="MM" geometryGeneratorEnabled="0" centroidWhole="0" rotationAngle="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" placement="0" offsetType="0" centroidInside="0" offsetUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" priority="5" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" maxCurvedCharAngleIn="25"/>
      <rendering scaleMin="0" fontLimitPixelSize="0" minFeatureSize="0" labelPerPart="0" obstacle="1" scaleVisibility="0" fontMaxPixelSize="10000" displayAll="0" drawLabels="0" mergeLines="0" limitNumLabels="0" scaleMax="0" maxNumLabels="2000" obstacleFactor="2" upsidedownLabels="0" fontMinPixelSize="0" obstacleType="1" zIndex="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" type="QString" value=""/>
          <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias name="" index="2" field="mi"/>
    <alias name="" index="3" field="inom"/>
    <alias name="" index="4" field="denominador_escala"/>
    <alias name="" index="5" field="area_otf"/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="denominador_escala"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="nome" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="mi" constraints="0" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" field="inom" constraints="0" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" field="denominador_escala" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" field="denominador_escala" exp=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column width="-1" name="mi" type="field" hidden="0"/>
      <column width="-1" name="inom" type="field" hidden="0"/>
      <column width="-1" name="denominador_escala" type="field" hidden="0"/>
