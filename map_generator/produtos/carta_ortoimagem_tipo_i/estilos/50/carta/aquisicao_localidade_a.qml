...
<qgis simplifyLocal="1" styleCategories="AllStyleCategories" version="3.12.2-București" readOnly="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyDrawingTol="1" simplifyDrawingHints="0" labelsEnabled="1" simplifyMaxScale="1" simplifyAlgorithm="0" maxScale="0">
  ...
  <labeling type="rule-based">
    <rules key="{1c9db8ee-f6a2-43c0-b884-3ee1e8709171}">
      <rule filter=" &quot;tipo&quot;  in (1,2,3)" key="{6bf64873-4006-4dde-a325-b835a5182971}" description="Cidade">
      ...
      <rule filter=" &quot;tipo&quot; in (4)" key="{1fa2f87d-10c6-4710-8e61-056a73de7802}" description="Vila">
        <settings calloutType="simple">
      ...
      <rule filter=" &quot;tipo&quot; in (6)" key="{417d3c9f-85c5-4f2f-8492-aa102ec8e2f2}" description="Povoado">
        <settings calloutType="simple">
      ...
      <rule filter=" &quot;tipo&quot; in (5, 7)" key="{2b3fc835-bcde-401b-b905-7ad3de22f714}" description="Núcleo ou vilarejo">
        <settings calloutType="simple">
      ...
      <rule filter=" &quot;tipo&quot; in (8,9)" key="{a94802f7-845c-4875-9e69-5a967749ffcc}" description="Nome local ou bairro">
        <settings calloutType="simple">
