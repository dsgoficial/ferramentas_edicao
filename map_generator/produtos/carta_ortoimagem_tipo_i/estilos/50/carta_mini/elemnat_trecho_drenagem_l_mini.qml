...
<qgis simplifyLocal="1" styleCategories="AllStyleCategories" version="3.12.2-București" readOnly="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyDrawingTol="1" simplifyDrawingHints="0" labelsEnabled="1" simplifyMaxScale="1" simplifyAlgorithm="0" maxScale="0">
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" symbollevels="0" forceraster="0">
    <rules key="{de76fc58-0ec6-4208-ab99-f68f68e142a1}">
      <rule symbol="0" filter=" &quot;situacao_em_poligono&quot; in (1)" key="{d00d6361-2b35-49db-b8a3-68f95fcda93c}"/>
      <rule symbol="1" filter="ELSE" key="{f5563ba1-d9e7-4e1c-80e4-2f54d201d308}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{0beb64a5-11bd-4ce7-a98b-9101a73c422f}">
      <rule filter=" &quot;situacao_em_poligono&quot; in (1,2)" key="{0ceb2e3d-4530-4425-a108-c8f1b34723e9}">
        <settings calloutType="simple">
          <text-style isExpression="0" textColor="255,255,255,255" fontItalic="0" fontFamily="Times New Roman" fontSizeUnit="MM" textOrientation="horizontal" fontCapitals="0" blendMode="0" fontWordSpacing="0.09375" multilineHeight="1" previewBkgrdColor="255,255,255,255" textOpacity="1" fieldName="nome" fontLetterSpacing="0.15625" fontWeight="50" fontSize="2" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" namedStyle="Normal" fontStrikeout="0" fontKerning="1" useSubstitutions="0">
          ...
          <placement preserveRotation="0" xOffset="0" maxCurvedCharAngleOut="-35" quadOffset="4" placementFlags="14" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="300" layerType="LineGeometry" repeatDistanceUnits="MM" fitInPolygonOnly="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_moldura_edicao_a', 'mi', @mi)),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection( simplify_vw( $geometry,80),  &#xd;&#xa;@moldura&#xd;&#xa;)&#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa; )" distUnits="MM" geometryGeneratorType="LineGeometry" dist="1" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistanceUnit="MM" geometryGeneratorEnabled="1" centroidWhole="0" rotationAngle="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" placement="3" offsetType="0" centroidInside="0" offsetUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" priority="8" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" maxCurvedCharAngleIn="35"/>
          <rendering scaleMin="0" fontLimitPixelSize="0" minFeatureSize="10" labelPerPart="0" obstacle="0" scaleVisibility="0" fontMaxPixelSize="10000" displayAll="0" drawLabels="1" mergeLines="1" limitNumLabels="0" scaleMax="0" maxNumLabels="2" obstacleFactor="2" upsidedownLabels="0" fontMinPixelSize="3" obstacleType="0" zIndex="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" type="QString" value=""/>
