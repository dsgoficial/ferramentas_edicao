...
<qgis simplifyLocal="1" styleCategories="AllStyleCategories" version="3.12.2-București" readOnly="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyDrawingTol="1" simplifyDrawingHints="0" labelsEnabled="1" simplifyMaxScale="1" simplifyAlgorithm="0" maxScale="0">
  ...
  <labeling type="rule-based">
    <rules key="{e93d17f8-7ff2-477d-b9fe-274e4ac5ed84}">
      <rule filter="left(array_get(split(&quot;sigla&quot;, ';'), 0) ,strpos(array_get(split(&quot;sigla&quot;, ';'), 0),'-')-1) = 'BR' and intersects($geometry,  geometry(get_feature('aux_moldura_edicao_a', 'mi', @mi)))" key="{5f726b7e-92bf-4632-819a-f155cef48100}" description="federal 1">
        <settings calloutType="simple">
          <text-style isExpression="1" textColor="0,0,0,255" fontItalic="0" fontFamily="Arial" fontSizeUnit="MM" textOrientation="horizontal" fontCapitals="0" blendMode="0" fontWordSpacing="0" multilineHeight="1" previewBkgrdColor="255,255,255,255" textOpacity="1" fieldName="right(array_get(split(&quot;sigla&quot;, ';'), 0) ,strpos(array_get(split(&quot;sigla&quot;, ';'), 0),'-'))" fontLetterSpacing="0" fontWeight="50" fontSize="1.2" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" namedStyle="Normal" fontStrikeout="0" fontKerning="1" useSubstitutions="0">
          ...
          <placement preserveRotation="0" xOffset="0" maxCurvedCharAngleOut="-25" quadOffset="4" placementFlags="9" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="150" layerType="LineGeometry" repeatDistanceUnits="MM" fitInPolygonOnly="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_moldura_edicao_a', 'mi', @mi)),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa; )" distUnits="MM" geometryGeneratorType="LineGeometry" dist="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistanceUnit="MM" geometryGeneratorEnabled="1" centroidWhole="0" rotationAngle="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" placement="4" offsetType="0" centroidInside="0" offsetUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" priority="7" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" maxCurvedCharAngleIn="25"/>
      ...
      <rule filter="left(array_get(split(&quot;sigla&quot;, ';'), 0) ,strpos(array_get(split(&quot;sigla&quot;, ';'), 0),'-')-1) != 'BR' and intersects($geometry,  geometry(get_feature('aux_moldura_edicao_a', 'mi', @mi)))" key="{1d03ffc0-963d-4275-87c2-ff0416cabba2}" description="estadual 1">
        <settings calloutType="simple">
          <text-style isExpression="1" textColor="0,0,0,255" fontItalic="0" fontFamily="Arial" fontSizeUnit="MM" textOrientation="horizontal" fontCapitals="0" blendMode="0" fontWordSpacing="0" multilineHeight="1" previewBkgrdColor="255,255,255,255" textOpacity="1" fieldName="right(array_get(split(&quot;sigla&quot;, ';'), 0) ,strpos(array_get(split(&quot;sigla&quot;, ';'), 0),'-'))" fontLetterSpacing="0" fontWeight="50" fontSize="1.2" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" namedStyle="Normal" fontStrikeout="0" fontKerning="1" useSubstitutions="0">
            <text-buffer bufferDraw="0" bufferJoinStyle="128" bufferColor="255,255,255,255" bufferOpacity="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferBlendMode="0" bufferNoFill="1" bufferSizeUnits="MM"/>
            <text-mask maskEnabled="0" maskedSymbolLayers="" maskOpacity="1" maskSize="0" maskSizeUnits="MM" maskJoinStyle="128" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
