...
<qgis simplifyLocal="1" styleCategories="AllStyleCategories" version="3.12.2-București" readOnly="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyDrawingTol="1" simplifyDrawingHints="0" labelsEnabled="1" simplifyMaxScale="1" simplifyAlgorithm="0" maxScale="0">
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" symbollevels="0" forceraster="0">
    <rules key="{a19816fb-85c6-4544-8ef8-4abeba6ab938}">
      <rule symbol="0" label="Area_Militar" filter=" &quot;tipo&quot;  = 36" key="{289e10f7-aa2a-4152-95f7-bf753722a650}"/>
      <rule symbol="1" label="Terra_Indigena" filter=" &quot;tipo&quot;  = 2" key="{4a4e3eca-ea41-465e-8fd7-f8b2cda162c0}"/>
      <rule symbol="2" label="Reserva" filter="ELSE" key="{6329794f-050c-4e3d-99d6-66d37fa89d60}"/>
    </rules>
    <symbols>
      <symbol name="0" clip_to_extent="1" type="line" alpha="1" force_rhr="0">
        ...
        <layer enabled="1" class="MarkerLine" pass="0" locked="0">
          ...
          <prop k="offset" v="-1"/>
          <prop k="offset_along_line" v="2.6"/>
      ...
      <symbol name="1" clip_to_extent="1" type="line" alpha="1" force_rhr="0">
        ...
        <layer enabled="1" class="SimpleLine" pass="0" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="255,78,39,255"/>
          <prop k="line_style" v="dash"/>
          <prop k="line_width" v="0.35"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="-1"/>
      ...
      <symbol name="2" clip_to_extent="1" type="line" alpha="1" force_rhr="0">
        ...
        <layer enabled="1" class="SimpleLine" pass="0" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="62,162,0,255"/>
          <prop k="line_style" v="dash"/>
          <prop k="line_width" v="0.35"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="-1"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style isExpression="1" textColor="255,255,255,255" fontItalic="0" fontFamily="Arial" fontSizeUnit="MM" textOrientation="horizontal" fontCapitals="1" blendMode="0" fontWordSpacing="0" multilineHeight="1" previewBkgrdColor="255,255,255,255" textOpacity="1" fieldName="'          Aproximado          '     " fontLetterSpacing="0" fontWeight="50" fontSize="1.5" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" namedStyle="Normal" fontStrikeout="0" fontKerning="1" useSubstitutions="0">
        <text-buffer bufferDraw="1" bufferJoinStyle="128" bufferColor="0,0,0,255" bufferOpacity="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="0.3" bufferBlendMode="0" bufferNoFill="1" bufferSizeUnits="MM"/>
      ...
      <placement preserveRotation="0" xOffset="0" maxCurvedCharAngleOut="-25" quadOffset="4" placementFlags="14" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="150" layerType="LineGeometry" repeatDistanceUnits="MM" fitInPolygonOnly="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_moldura_edicao_a', 'mi', @mi)),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa; )" distUnits="MM" geometryGeneratorType="LineGeometry" dist="1.2" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistanceUnit="MM" geometryGeneratorEnabled="1" centroidWhole="0" rotationAngle="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" placement="3" offsetType="0" centroidInside="0" offsetUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" priority="6" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" maxCurvedCharAngleIn="25"/>
      <rendering scaleMin="0" fontLimitPixelSize="0" minFeatureSize="5" labelPerPart="0" obstacle="0" scaleVisibility="0" fontMaxPixelSize="10000" displayAll="0" drawLabels="1" mergeLines="1" limitNumLabels="0" scaleMax="0" maxNumLabels="2000" obstacleFactor="1" upsidedownLabels="0" fontMinPixelSize="3" obstacleType="0" zIndex="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" type="QString" value=""/>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Estação Ecológica – ESEC (31)" type="QString" value="31"/>
              <Option name="Floresta – FLO (26)" type="QString" value="26"/>
              <Option name="Monumento Natural – MONA (33)" type="QString" value="33"/>
              <Option name="Parque – PAR (32)" type="QString" value="32"/>
              <Option name="Refúgio de Vida Silvestre – RVS (35)" type="QString" value="35"/>
              <Option name="Reserva Biológica – REBIO (34)" type="QString" value="34"/>
              <Option name="Reserva Extrativista – RESEX (28)" type="QString" value="28"/>
              <Option name="Reserva Particular do Patrimônio Natural – RPPN (30)" type="QString" value="30"/>
              <Option name="Reserva de Desenvolvimento Sustentável – RDS (27)" type="QString" value="27"/>
              <Option name="Reserva de Fauna – REFAU (29)" type="QString" value="29"/>
              <Option name="Terra indígena (2)" type="QString" value="2"/>
              <Option name="Terra pública (1)" type="QString" value="1"/>
              <Option name="Área de Proteção Ambiental – APA (24)" type="QString" value="24"/>
              <Option name="Área de Relevante Interesse Ecológico – ARIE (25)" type="QString" value="25"/>
              <Option name="Área militar (36)" type="QString" value="36"/>
            </Option>
          </Option>
        </config>
      </editWidget>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              <Option name="A SER PREENCHIDO (9999)" type="QString" value="9999"/>
              <Option name="Contorno massa dágua (2)" type="QString" value="2"/>
              <Option name="Costa visível da carta (5)" type="QString" value="5"/>
              <Option name="Cumeada (3)" type="QString" value="3"/>
              <Option name="Ferrovia (7)" type="QString" value="7"/>
              <Option name="Linha seca (4)" type="QString" value="4"/>
              <Option name="Massa dágua (9)" type="QString" value="9"/>
              <Option name="Não aplicável (97)" type="QString" value="97"/>
              <Option name="Não identificado (96)" type="QString" value="96"/>
              <Option name="Rodovia (6)" type="QString" value="6"/>
              <Option name="Trecho de drenagem (8)" type="QString" value="8"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" index="3" field="tipo_delimitacao"/>
    <alias name="" index="4" field="geometria_aproximada"/>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="tipo_delimitacao"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" field="tipo_delimitacao" constraints="1" exp_strength="0" notnull_strength="1"/>
    <constraint unique_strength="0" field="geometria_aproximada" constraints="1" exp_strength="0" notnull_strength="1"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column width="275" name="tipo" type="field" hidden="0"/>
      <column width="219" name="tipo_delimitacao" type="field" hidden="0"/>
      <column width="-1" name="geometria_aproximada" type="field" hidden="0"/>
...
def my_form_open(diálogo, camada, feição):
  ...
  <editable>
    ...
    <field name="tipo_delimitacao" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="tipo_delimitacao" labelOnTop="0"/>
