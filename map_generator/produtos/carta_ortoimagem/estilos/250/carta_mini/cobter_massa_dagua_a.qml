...
<qgis simplifyLocal="1" styleCategories="AllStyleCategories" version="3.12.2-București" readOnly="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyDrawingTol="1" simplifyDrawingHints="0" labelsEnabled="1" simplifyMaxScale="1" simplifyAlgorithm="0" maxScale="0">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style isExpression="0" textColor="255,255,255,255" fontItalic="0" fontFamily="Times New Roman" fontSizeUnit="MM" textOrientation="horizontal" fontCapitals="1" blendMode="0" fontWordSpacing="0" multilineHeight="1" previewBkgrdColor="255,255,255,255" textOpacity="1" fieldName="nome" fontLetterSpacing="0" fontWeight="50" fontSize="2" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" namedStyle="Normal" fontStrikeout="0" fontKerning="1" useSubstitutions="0">
        <text-buffer bufferDraw="1" bufferJoinStyle="128" bufferColor="0,153,255,255" bufferOpacity="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="0.45" bufferBlendMode="0" bufferNoFill="1" bufferSizeUnits="MM"/>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Baía (sem fluxo) (4)" type="QString" value="4"/>
              <Option name="Canal (com fluxo) (2)" type="QString" value="2"/>
              <Option name="Enseada (sem fluxo) (5)" type="QString" value="5"/>
              <Option name="Lago ou Lagoa (sem fluxo) (7)" type="QString" value="7"/>
              <Option name="Laguna (com fluxo) (9)" type="QString" value="9"/>
              <Option name="Meando Abandonado (sem fluxo) (6)" type="QString" value="6"/>
              <Option name="Oceano (sem fluxo) (3)" type="QString" value="3"/>
              <Option name="Represa/açude com fluxo (10)" type="QString" value="10"/>
              <Option name="Represa/açude sem fluxo (11)" type="QString" value="11"/>
              <Option name="Rio (com fluxo) (1)" type="QString" value="1"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="&quot;area_otf&quot;">
    <columns>
      <column width="-1" name="id" type="field" hidden="0"/>
      <column width="242" name="nome" type="field" hidden="0"/>
      ...
      <column width="161" name="area_otf" type="field" hidden="0"/>
