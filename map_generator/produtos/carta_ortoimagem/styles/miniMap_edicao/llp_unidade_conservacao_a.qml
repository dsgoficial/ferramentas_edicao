...
<qgis styleCategories="Symbology|Labeling" version="3.22.1-Białowieża" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{98f71650-962f-40a5-8538-b7b4e2ca12c2}">
      <rule key="{63769e1d-204b-478d-b8f1-b23d6d7d953a}" filter=" &quot;rotular_carta_mini&quot;  = 1">
        <settings calloutType="simple">
          <text-style fontUnderline="0" fontWordSpacing="0" fontSize="4.5" isExpression="0" namedStyle="Condensed Light" fontLetterSpacing="0" textColor="255,255,255,255" fontFamily="Noto Sans" textOrientation="horizontal" previewBkgrdColor="255,255,255,255" fontKerning="1" fontStrikeout="0" useSubstitutions="0" textOpacity="1" fontItalic="0" capitalization="1" legendString="Aa" allowHtml="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontWeight="25" multilineHeight="0.80000000000000004" fieldName="texto_edicao">
            <families/>
          ...
          <placement placement="0" yOffset="0" repeatDistance="0" polygonPlacementFlags="2" placementFlags="10" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" offsetUnits="MM" priority="5" lineAnchorPercent="0.5" lineAnchorClipping="0" centroidWhole="1" rotationAngle="0" overrunDistance="0" geometryGeneratorType="PolygonGeometry" quadOffset="4" fitInPolygonOnly="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleIn="25" maxCurvedCharAngleOut="-25" repeatDistanceUnits="MM" xOffset="0" geometryGeneratorEnabled="1" distUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" preserveRotation="1" layerType="PolygonGeometry" offsetType="0" rotationUnit="AngleDegrees" dist="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0"/>
