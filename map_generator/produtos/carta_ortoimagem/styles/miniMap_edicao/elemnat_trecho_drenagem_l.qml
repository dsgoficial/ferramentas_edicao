...
<qgis styleCategories="Symbology|Labeling" version="3.22.1-Białowieża" labelsEnabled="1">
  <renderer-v2 symbollevels="0" referencescale="-1" type="mergedFeatureRenderer" forceraster="0" enableorderby="0">
    <renderer-v2 symbollevels="1" referencescale="-1" type="RuleRenderer" forceraster="0" enableorderby="0">
      <rules key="{8e201c66-7086-4414-be5d-65a1376e7ddf}">
        <rule key="{7fe1c635-bbbd-49e9-9405-2d2e954b0aa0}" symbol="0" description="Fora de polígono" filter="&quot;simbolizar_carta_mini&quot; = 1"/>
      </rules>
      <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{864ccbcc-6e56-4f27-a545-c7ec0bf870fb}">
      <rule key="{6abbef34-969b-46bc-958d-30c53b2d811b}" description="Trecho de drenagem" filter=" &quot;situacao_em_poligono&quot; in (1) and &quot;simbolizar_carta_mini&quot; = 1 and &quot;rotular_carta_mini&quot; = 1">
        <settings calloutType="simple">
          <text-style fontUnderline="0" fontWordSpacing="0.09375" fontSize="4.5" isExpression="0" namedStyle="Condensed Italic" fontLetterSpacing="0.15625" textColor="255,255,255,255" fontFamily="Noto Sans" textOrientation="horizontal" previewBkgrdColor="255,255,255,255" fontKerning="1" fontStrikeout="0" useSubstitutions="0" textOpacity="1" fontItalic="1" capitalization="0" legendString="Aa" allowHtml="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontWeight="50" multilineHeight="1" fieldName="texto_edicao">
            <families/>
      ...
      <rule key="{9c522280-5f19-445c-89c9-7865d60cb1d3}" description="Massa Dagua" filter=" &quot;situacao_em_poligono&quot; in (2) and &quot;simbolizar_carta_mini&quot; = 1 and &quot;rotular_carta_mini&quot; = 1">
        <settings calloutType="simple">
