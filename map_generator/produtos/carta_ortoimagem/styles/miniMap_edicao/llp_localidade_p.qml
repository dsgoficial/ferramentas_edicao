...
<qgis styleCategories="Symbology|Labeling" version="3.22.1-Białowieża" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{62cee83d-1d09-4ab7-a766-00958c4e1cfd}">
      <rule key="{52829bf2-efef-4172-939c-3f936da2dcf1}" description="Capital Federal" filter=" &quot;tipo&quot; = 3">
        <settings calloutType="simple">
          <text-style fontUnderline="0" fontWordSpacing="0" fontSize="6" isExpression="0" namedStyle="Condensed Bold" fontLetterSpacing="0" textColor="255,255,255,255" fontFamily="Noto Sans" textOrientation="horizontal" previewBkgrdColor="255,255,255,255" fontKerning="1" fontStrikeout="0" useSubstitutions="0" textOpacity="1" fontItalic="0" capitalization="1" legendString="Aa" allowHtml="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontWeight="75" multilineHeight="0.80000000000000004" fieldName="texto_edicao">
            <families/>
            <text-buffer bufferSize="1" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferDraw="1" bufferNoFill="1" bufferBlendMode="0" bufferColor="0,0,0,255" bufferSizeUnits="Point" bufferOpacity="1"/>
          ...
          <text-format multilineAlign="3" autoWrapLength="0" formatNumbers="0" addDirectionSymbol="0" decimals="3" rightDirectionSymbol=">" placeDirectionSymbol="0" reverseDirectionSymbol="0" leftDirectionSymbol="&lt;" plussign="0" wrapChar="|" useMaxLineLengthForAutoWrap="1"/>
          <placement placement="0" yOffset="0" repeatDistance="0" polygonPlacementFlags="2" placementFlags="10" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" offsetUnits="MM" priority="5" lineAnchorPercent="0.5" lineAnchorClipping="0" centroidWhole="0" rotationAngle="0" overrunDistance="0" geometryGeneratorType="PointGeometry" quadOffset="4" fitInPolygonOnly="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleIn="25" maxCurvedCharAngleOut="-25" repeatDistanceUnits="MM" xOffset="0" geometryGeneratorEnabled="1" distUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" preserveRotation="1" layerType="PointGeometry" offsetType="0" rotationUnit="AngleDegrees" dist="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0"/>
          <rendering drawLabels="1" fontMaxPixelSize="10000" obstacle="1" unplacedVisibility="0" scaleMin="0" limitNumLabels="0" labelPerPart="0" obstacleType="1" scaleVisibility="0" fontMinPixelSize="3" scaleMax="0" mergeLines="0" obstacleFactor="1" maxNumLabels="2000" upsidedownLabels="0" minFeatureSize="0" zIndex="0" fontLimitPixelSize="0" displayAll="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
      ...
      <rule key="{ef762b1c-9793-4ac2-8d76-7690ddefddd5}" description="Capital Estadual" filter=" &quot;tipo&quot; = 2">
        <settings calloutType="simple">
          <text-style fontUnderline="0" fontWordSpacing="0" fontSize="6" isExpression="0" namedStyle="Condensed Bold" fontLetterSpacing="0" textColor="255,255,255,255" fontFamily="Noto Sans" textOrientation="horizontal" previewBkgrdColor="255,255,255,255" fontKerning="1" fontStrikeout="0" useSubstitutions="0" textOpacity="1" fontItalic="0" capitalization="1" legendString="Aa" allowHtml="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontWeight="75" multilineHeight="0.80000000000000004" fieldName="texto_edicao">
            <families/>
            <text-buffer bufferSize="1" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferDraw="1" bufferNoFill="1" bufferBlendMode="0" bufferColor="0,0,0,255" bufferSizeUnits="Point" bufferOpacity="1"/>
      ...
      <rule key="{00bde452-d8e2-403e-b9cf-a5bc0c1de0c0}" description="Cidade" filter=" &quot;tipo&quot; = 1">
        <settings calloutType="simple">
          <text-style fontUnderline="0" fontWordSpacing="0" fontSize="6" isExpression="0" namedStyle="Condensed Bold" fontLetterSpacing="0" textColor="255,255,255,255" fontFamily="Noto Sans" textOrientation="horizontal" previewBkgrdColor="255,255,255,255" fontKerning="1" fontStrikeout="0" useSubstitutions="0" textOpacity="1" fontItalic="0" capitalization="0" legendString="Aa" allowHtml="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontWeight="75" multilineHeight="0.80000000000000004" fieldName="texto_edicao">
            <families/>
            <text-buffer bufferSize="1" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferDraw="1" bufferNoFill="1" bufferBlendMode="0" bufferColor="0,0,0,255" bufferSizeUnits="Point" bufferOpacity="1"/>
            <text-mask maskSizeUnits="MM" maskOpacity="1" maskSize="0.20000000000000001" maskEnabled="1" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskedSymbolLayers="" maskJoinStyle="128"/>
            <background shapeRadiiX="0" shapeRadiiY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeType="0" shapeSizeUnit="MM" shapeBorderWidth="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeJoinStyle="64" shapeDraw="0" shapeBlendMode="0" shapeBorderWidthUnit="MM" shapeRotation="0" shapeOffsetX="0" shapeSizeY="0" shapeRotationType="0" shapeOffsetUnit="MM" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeOffsetY="0" shapeSVGFile="" shapeFillColor="255,255,255,255" shapeRadiiUnit="MM" shapeSizeX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255">
      ...
      <rule key="{41741a54-8850-4f42-b461-94537572f436}" description="Vila" filter=" &quot;tipo&quot; = 4">
        <settings calloutType="simple">
          <text-style fontUnderline="0" fontWordSpacing="0" fontSize="4.5" isExpression="0" namedStyle="Condensed" fontLetterSpacing="0" textColor="255,255,255,255" fontFamily="Noto Sans" textOrientation="horizontal" previewBkgrdColor="255,255,255,255" fontKerning="1" fontStrikeout="0" useSubstitutions="0" textOpacity="1" fontItalic="0" capitalization="0" legendString="Aa" allowHtml="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontWeight="50" multilineHeight="0.80000000000000004" fieldName="texto_edicao">
            <families/>
            <text-buffer bufferSize="1" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferDraw="1" bufferNoFill="1" bufferBlendMode="0" bufferColor="0,0,0,255" bufferSizeUnits="Point" bufferOpacity="1"/>
            <text-mask maskSizeUnits="MM" maskOpacity="1" maskSize="0.20000000000000001" maskEnabled="1" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskedSymbolLayers="" maskJoinStyle="128"/>
            <background shapeRadiiX="0" shapeRadiiY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeType="0" shapeSizeUnit="MM" shapeBorderWidth="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeJoinStyle="64" shapeDraw="0" shapeBlendMode="0" shapeBorderWidthUnit="MM" shapeRotation="0" shapeOffsetX="0" shapeSizeY="0" shapeRotationType="0" shapeOffsetUnit="MM" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeOffsetY="0" shapeSVGFile="" shapeFillColor="255,255,255,255" shapeRadiiUnit="MM" shapeSizeX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255">
