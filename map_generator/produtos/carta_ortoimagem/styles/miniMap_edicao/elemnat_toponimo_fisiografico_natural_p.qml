...
<qgis styleCategories="Symbology|Labeling" version="3.22.1-Białowieża" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{55d762f2-490f-4618-a08d-6bd9c932b8e5}">
      <rule key="{7a1bc74f-65af-4ebe-a469-f22be3cc9d11}" description="Toponimo Fisiografico P" filter=" &quot;rotular_carta_mini&quot; = 1">
        <settings calloutType="simple">
          <text-style fontUnderline="0" fontWordSpacing="0" fontSize="4.5" isExpression="0" namedStyle="Italic" fontLetterSpacing="0" textColor="255,255,255,255" fontFamily="Noto Sans" textOrientation="horizontal" previewBkgrdColor="255,255,255,255" fontKerning="1" fontStrikeout="0" useSubstitutions="0" textOpacity="1" fontItalic="1" capitalization="0" legendString="Aa" allowHtml="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontWeight="50" multilineHeight="0.80000000000000004" fieldName="texto_edicao">
            <families/>
