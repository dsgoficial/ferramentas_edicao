...
<qgis styleCategories="Symbology|Labeling" version="3.22.1-Białowieża" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{27cfeccb-8a50-4003-8f8c-e069db1166da}">
      <rule key="{efe72bef-38c6-4ba3-bcb1-d4da8c65c42b}" filter=" &quot;tipo&quot; in (4,5,7,6,3,11) and &quot;rotular_carta_mini&quot; = 1">
        <settings calloutType="simple">
          <text-style fontUnderline="0" fontWordSpacing="0.09375" fontSize="4.5" isExpression="0" namedStyle="Condensed Italic" fontLetterSpacing="0.15625" textColor="255,255,255,255" fontFamily="Noto Sans" textOrientation="horizontal" previewBkgrdColor="255,255,255,255" fontKerning="1" fontStrikeout="0" useSubstitutions="0" textOpacity="1" fontItalic="1" capitalization="1" legendString="Aa" allowHtml="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontWeight="50" multilineHeight="0.80000000000000004" fieldName="texto_edicao">
            <families/>
          ...
          <placement placement="0" yOffset="0" repeatDistance="300" polygonPlacementFlags="3" placementFlags="14" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('aux_label', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa; )" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" offsetUnits="MM" priority="9" lineAnchorPercent="0.5" lineAnchorClipping="0" centroidWhole="1" rotationAngle="0" overrunDistance="0" geometryGeneratorType="PolygonGeometry" quadOffset="4" fitInPolygonOnly="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleIn="30" maxCurvedCharAngleOut="-30" repeatDistanceUnits="MM" xOffset="0" geometryGeneratorEnabled="1" distUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" preserveRotation="0" layerType="PolygonGeometry" offsetType="0" rotationUnit="AngleDegrees" dist="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0"/>
          <rendering drawLabels="1" fontMaxPixelSize="10000" obstacle="0" unplacedVisibility="0" scaleMin="0" limitNumLabels="0" labelPerPart="0" obstacleType="0" scaleVisibility="0" fontMinPixelSize="3" scaleMax="0" mergeLines="1" obstacleFactor="2" maxNumLabels="2" upsidedownLabels="0" minFeatureSize="30" zIndex="0" fontLimitPixelSize="0" displayAll="0"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
