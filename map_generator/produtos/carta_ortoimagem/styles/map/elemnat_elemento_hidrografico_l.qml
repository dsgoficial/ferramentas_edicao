...
<rules key="{a8cf7b62-5be4-4218-b34a-b27ce3edf239}">
<rule key="{b7c42b8b-aebf-443e-a2c5-5fdacb2981c1}">
...
<families/>
<text-buffer bufferBlendMode="0" bufferSize="1.2" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="Point" bufferColor="0,160,223,255" bufferDraw="1" bufferOpacity="1" bufferJoinStyle="128" bufferNoFill="0">
...
<text-mask maskedSymbolLayers="" maskSizeUnits="MM" maskJoinStyle="128" maskEnabled="0" maskType="0" maskSize="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskOpacity="1"/>
...
<placement placement="4" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('auxiliar_moldura', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa; )" layerType="LineGeometry" fitInPolygonOnly="0" maxCurvedCharAngleOut="-30" geometryGeneratorEnabled="1" yOffset="0" polygonPlacementFlags="2" rotationAngle="0" quadOffset="4" overrunDistanceUnit="MM" distUnits="MM" preserveRotation="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="30" centroidWhole="0" offsetUnits="MM" centroidInside="0" offsetType="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" dist="0.69999999999999996" repeatDistance="0" lineAnchorType="0" lineAnchorClipping="0" distMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" priority="9" repeatDistanceUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistance="0" placementFlags="14" xOffset="0" geometryGeneratorType="LineGeometry"/>
