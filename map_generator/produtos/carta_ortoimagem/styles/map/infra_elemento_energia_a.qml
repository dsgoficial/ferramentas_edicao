<qgis readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" styleCategories="AllStyleCategories" simplifyDrawingHints="0" minScale="100000000" labelsEnabled="1" maxScale="0" version="3.20.2-Odense" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyLocal="1">
<flags>
...
<Option type="QString" name="line_color" value="224,224,224,255"/>
...
<rules key="{202cdbd4-5466-4b9f-b645-20d3715536b5}">
<rule description="Elemento energia" key="{5e7997af-2e4d-41ca-b92f-a7a2c0e034d2}">
...
<placement placement="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('auxiliar_moldura', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" layerType="PolygonGeometry" fitInPolygonOnly="0" maxCurvedCharAngleOut="-25" geometryGeneratorEnabled="1" yOffset="-0.5" polygonPlacementFlags="2" rotationAngle="0" quadOffset="2" overrunDistanceUnit="MM" distUnits="MM" preserveRotation="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" centroidWhole="0" offsetUnits="MM" centroidInside="0" offsetType="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" dist="0" repeatDistance="0" lineAnchorType="0" lineAnchorClipping="0" distMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" priority="5" repeatDistanceUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistance="0" placementFlags="10" xOffset="0.5" geometryGeneratorType="PolygonGeometry"/>
...
<DiagramCategory sizeScale="3x:0,0,0,0,0,0" lineSizeScale="3x:0,0,0,0,0,0" enabled="0" lineSizeType="MM" rotationOffset="270" showAxis="1" scaleBasedVisibility="0" diagramOrientation="Up" spacing="5" spacingUnit="MM" penColor="#000000" penWidth="0" scaleDependency="Area" labelPlacementMethod="XHeight" direction="0" sizeType="MM" minimumSize="0" minScaleDenominator="0" backgroundColor="#ffffff" backgroundAlpha="255" spacingUnitScale="3x:0,0,0,0,0,0" maxScaleDenominator="1e+08" height="15" width="15" barWidth="5" opacity="1" penAlpha="255">
...
<DiagramLayerSettings zIndex="0" obstacle="0" showAll="1" dist="0" priority="0" linePlacementFlags="18" placement="1">
<properties>
<Option type="Map">
<Option type="QString" name="name" value=""/>
<Option name="properties"/>
...
<constraint unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0" field="area_otf"/>
</constraints>
...
<expressionfields>
<field type="6" name="area_otf" subType="0" comment="" expression="$area" typeName="" length="0" precision="0"/>
<field type="6" name="area_otf" subType="0" comment="" expression="$area" typeName="" length="0" precision="0"/>
<field type="6" name="area_otf" subType="0" comment="" expression="$area" typeName="" length="0" precision="0"/>
</expressionfields>
<attributeactions>
...
<column type="field" width="-1" hidden="0" name="area_otf"/>
