...
<rules key="{39bfd2be-8b78-46f5-9fe9-e94f4104bb1a}">
<rule description="Ilha" key="{d1341d98-9ffd-457d-af02-95fdecfe34bd}">
...
<placement placement="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('auxiliar_moldura', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection(centroid($geometry),  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" layerType="PointGeometry" fitInPolygonOnly="0" maxCurvedCharAngleOut="-25" geometryGeneratorEnabled="1" yOffset="0" polygonPlacementFlags="2" rotationAngle="0" quadOffset="4" overrunDistanceUnit="MM" distUnits="MM" preserveRotation="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" centroidWhole="0" offsetUnits="MM" centroidInside="1" offsetType="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" dist="0" repeatDistance="0" lineAnchorType="0" lineAnchorClipping="0" distMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" priority="5" repeatDistanceUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistance="0" placementFlags="10" xOffset="0" geometryGeneratorType="PointGeometry"/>
