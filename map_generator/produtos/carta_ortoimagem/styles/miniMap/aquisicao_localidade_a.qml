...
<qgis simplifyLocal="1" styleCategories="AllStyleCategories" version="3.12.2-București" readOnly="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyDrawingTol="1" simplifyDrawingHints="0" labelsEnabled="1" simplifyMaxScale="1" simplifyAlgorithm="0" maxScale="0">
  ...
  <labeling type="rule-based">
    <rules key="{e1d72b9a-9f5d-478d-bcd5-f3679b180485}">
      <rule filter=" &quot;tipo&quot;  in (1,2,3)" key="{813e7460-82cb-4802-8748-52ece219479d}" description="Cidade">
        <settings calloutType="simple">
          ...
          <rendering scaleMin="0" fontLimitPixelSize="0" minFeatureSize="0" labelPerPart="0" obstacle="0" scaleVisibility="0" fontMaxPixelSize="10000" displayAll="0" drawLabels="1" mergeLines="0" limitNumLabels="0" scaleMax="0" maxNumLabels="2000" obstacleFactor="1" upsidedownLabels="0" fontMinPixelSize="3" obstacleType="0" zIndex="1"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" type="QString" value=""/>
      ...
      <rule filter=" &quot;tipo&quot;  = 4" key="{c1ca8494-088f-491c-be01-5b3785840509}" description="Vila">
        <settings calloutType="simple">
      ...
      <rule filter=" &quot;tipo&quot; in (6)" key="{99972b8e-3f30-4f16-9bd6-d9d44a3ea989}" description="Povoado">
        <settings calloutType="simple">
