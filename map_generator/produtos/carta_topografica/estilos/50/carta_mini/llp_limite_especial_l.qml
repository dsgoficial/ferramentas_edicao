...
<rule filter="tipo = 2" symbol="0" label="A10418A" description="Terra Indigena" key="{4cb62d00-cb4e-430b-9e64-a271c5211c1c}"/>
<rule filter="tipo = 5" symbol="1" label="A10420A" description="Unidade de conservação" key="{6f8527a2-61b5-4534-8c2f-b780432d5412}"/>
