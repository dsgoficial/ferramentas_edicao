...
<rule description="Named Location" key="{cdace7c8-6823-4a24-aa3e-babe7f4a387a}">
<settings calloutType="simple">
<text-style fontUnderline="0" fontSize="10" blendMode="0" namedStyle="Condensed Light" capitalization="1" textOpacity="1" textOrientation="horizontal" fieldName="texto_edicao" useSubstitutions="0" fontSizeUnit="Point" allowHtml="0" fontStrikeout="0" isExpression="0" fontWordSpacing="0" fontLetterSpacing="0" textColor="0,0,0,255" multilineHeight="1" fontFamily="Noto Sans" previewBkgrdColor="255,255,255,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontWeight="25" fontKerning="1">
...
<placement centroidWhole="0" repeatDistance="0" overrunDistanceUnit="MM" geometryGeneratorEnabled="1" fitInPolygonOnly="0" rotationAngle="0" lineAnchorPercent="0.5" overrunDistance="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('auxiliar_moldura', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" geometryGeneratorType="PolygonGeometry" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" placement="0" maxCurvedCharAngleIn="25" polygonPlacementFlags="2" yOffset="0" maxCurvedCharAngleOut="-25" repeatDistanceUnits="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" dist="0" quadOffset="4" offsetType="0" distUnits="MM" preserveRotation="1" priority="5" centroidInside="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" layerType="PolygonGeometry" placementFlags="10"/>
...
<DiagramLayerSettings dist="0" linePlacementFlags="18" priority="0" showAll="1" placement="1" zIndex="0" obstacle="0">
<properties>
<Option type="Map">
<Option name="name" value="" type="QString"/>
<Option name="properties"/>
...
<default field="geometria_aproximada" expression="" applyOnUpdate="0"/>
...
<constraint unique_strength="0" field="geometria_aproximada" constraints="1" notnull_strength="1" exp_strength="0"/>
...
<expressionfields>
<field precision="0" name="area_otf" typeName="" comment="" type="6" expression="$area" length="0" subType="0"/>
</expressionfields>
<attributeactions>
...
<column name="geometria_aproximada" width="-1" type="field" hidden="0"/>
...
<column name="area_otf" width="-1" type="field" hidden="0"/>
