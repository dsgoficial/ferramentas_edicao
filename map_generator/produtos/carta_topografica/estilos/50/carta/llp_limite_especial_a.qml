...
<alias name="" index="17" field="tamanho_txt"/>
...
<constraint constraints="1" notnull_strength="1" unique_strength="0" field="geometria_aproximada" exp_strength="0"/>
...
<column name="geometria_aproximada" hidden="0" width="-1" type="field"/>
