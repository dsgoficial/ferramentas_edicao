...
<rule symbol="0" key="{1021944e-1404-481f-92b6-0a561711263e}" filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 = 3" label="L20307A"/>
<rule symbol="1" key="{88e2c562-c955-4793-a4a5-7fb87d83d59c}" filter="ELSE"/>
</rules>
<symbols>
...
<rules key="{3e6d999d-0c96-487a-bea0-18d773aa9006}">
<rule key="{b385b9d7-6472-4ddc-9538-a810cd110225}" description="Ocupação do solo">
...
<Option type="Map">
<Option name="Arquibancada (1001)" value="1001" type="QString"/>
</Option>
<Option type="Map">
...
<column name="tipo" hidden="0" width="187" type="field"/>
