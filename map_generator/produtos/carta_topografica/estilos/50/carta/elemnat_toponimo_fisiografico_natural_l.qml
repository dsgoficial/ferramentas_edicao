...
<text-style fontFamily="Noto Sans" fontStrikeout="0" fontSizeUnit="Point" fontSize="16" capitalization="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" fontLetterSpacing="5" textColor="0,0,0,255" multilineHeight="1" blendMode="0" fontWordSpacing="5" textOpacity="1" isExpression="0" fontWeight="50" textOrientation="horizontal" fieldName="texto_edicao" namedStyle="Italic" fontItalic="1" previewBkgrdColor="255,255,255,255" allowHtml="0" fontKerning="1" useSubstitutions="0">
...
<alias name="" field="espacamento" index="14"/>
...
<column hidden="0" width="210" type="field" name="texto_edicao"/>
<column hidden="0" width="-1" type="field" name="carta_mini"/>
<column hidden="0" width="147" type="field" name="lenght_otf"/>
