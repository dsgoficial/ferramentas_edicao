...
<qgis version="3.18.3-Zürich" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" simplifyDrawingHints="0" readOnly="0" maxScale="0" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="1" simplifyLocal="1" minScale="100000000">
  ...
  <labeling type="rule-based">
    <rules key="{01e69a11-66a2-41fd-9915-1de96316ada9}">
      <rule description="Trecho de Drenagem" key="{7c83dcea-df31-4fe4-a030-529d93eb90e0}" filter="&quot;classe&quot; =  'elemnat_trecho_drenagem_l' &#xd;&#xd;&#xa;and &quot;carta_mini&quot; is false">
        <settings calloutType="simple">
          <text-style fontStrikeout="0" textColor="0,160,223,255" previewBkgrdColor="255,255,255,255" useSubstitutions="0" fontUnderline="0" fieldName="texto_edicao" capitalization="0" fontItalic="1" fontWordSpacing="0" fontFamily="Noto Sans" fontKerning="1" fontLetterSpacing="0" multilineHeight="1" textOpacity="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Condensed Italic" allowHtml="0" fontSize="10" textOrientation="horizontal" isExpression="0" fontSizeUnit="Point" fontWeight="50" blendMode="0">
          ...
          <placement placement="3" yOffset="0" polygonPlacementFlags="2" distMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" layerType="LineGeometry" quadOffset="4" fitInPolygonOnly="0" placementFlags="9" overrunDistance="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" centroidInside="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="with_variable(&#xd;&#xd;&#xa; 'moldura',&#xd;&#xd;&#xa; geometry(get_feature('auxiliar_moldura', 'id', '1')),&#xd;&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xd;&#xa;THEN &#xd;&#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xd;&#xa;ELSE&#xd;&#xd;&#xa;$geometry&#xd;&#xd;&#xa;END&#xd;&#xd;&#xa;)" dist="0" maxCurvedCharAngleOut="-25" repeatDistance="0" rotationAngle="0" distUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" offsetType="0" offsetUnits="MM" preserveRotation="1" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistanceUnit="MM" lineAnchorType="0" geometryGeneratorEnabled="1" centroidWhole="0" lineAnchorPercent="0.5" geometryGeneratorType="LineGeometry" priority="5"/>
      ...
      <rule description="Massa dagua" key="{a0ba0e56-7550-445e-a906-0b071db5af8a}" filter="&quot;classe&quot; = 'cobter_massa_dagua_a'&#xd;&#xd;&#xa;and &quot;carta_mini&quot; is false">
        <settings calloutType="simple">
          <text-style fontStrikeout="0" textColor="0,160,223,255" previewBkgrdColor="255,255,255,255" useSubstitutions="0" fontUnderline="0" fieldName="texto_edicao" capitalization="1" fontItalic="1" fontWordSpacing="0" fontFamily="Noto Sans" fontKerning="1" fontLetterSpacing="0" multilineHeight="1" textOpacity="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Condensed Italic" allowHtml="0" fontSize="10" textOrientation="horizontal" isExpression="0" fontSizeUnit="Point" fontWeight="50" blendMode="0">
            <text-buffer bufferJoinStyle="128" bufferOpacity="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferDraw="0" bufferSizeUnits="MM" bufferNoFill="1" bufferSize="1" bufferBlendMode="0"/>
            <text-mask maskOpacity="1" maskSize="0.2" maskEnabled="1" maskedSymbolLayers="" maskJoinStyle="128" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSizeUnits="MM"/>
            <background shapeRotationType="0" shapeBorderWidthUnit="MM" shapeOffsetY="0" shapeRotation="0" shapeRadiiUnit="MM" shapeDraw="0" shapeOffsetX="0" shapeRadiiX="0" shapeBorderWidth="0" shapeSizeX="0" shapeSizeType="0" shapeJoinStyle="64" shapeOpacity="1" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiY="0" shapeBlendMode="0" shapeSizeY="0" shapeType="0" shapeSVGFile="" shapeOffsetUnit="MM" shapeSizeUnit="MM" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeFillColor="255,255,255,255" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255">
              <symbol force_rhr="0" type="marker" alpha="1" clip_to_extent="1" name="markerSymbol">
  ...
  <DiagramLayerSettings showAll="1" obstacle="0" dist="0" priority="0" linePlacementFlags="18" zIndex="0" placement="2">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="tamanho">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" value="false" name="IsMultiline"/>
  ...
  <aliases>
    ...
    <alias field="texto_edicao" name="" index="1"/>
    <alias field="classe" name="" index="2"/>
    <alias field="tamanho" name="" index="3"/>
    <alias field="escala" name="" index="4"/>
    <alias field="carta_mini" name="" index="5"/>
  ...
  <defaults>
    ...
    <default field="tamanho" expression="'47376.00327554059'" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="texto_edicao" unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0"/>
    <constraint field="classe" unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0"/>
    <constraint field="tamanho" unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0"/>
    <constraint field="escala" unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0"/>
    <constraint field="carta_mini" unique_strength="0" notnull_strength="1" constraints="1" exp_strength="0"/>
    <constraint field="lenght_otf" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
  </constraints>
  ...
  <expressionfields>
    <field length="0" type="6" subType="0" typeName="" name="lenght_otf" precision="0" comment="" expression="$length"/>
    <field length="0" type="6" subType="0" typeName="" name="lenght_otf" precision="0" comment="" expression="$length"/>
  </expressionfields>
  <attributeactions>
    <defaultAction key="Canvas" value="{00000000-0000-0000-0000-000000000000}"/>
  </attributeactions>
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="&quot;massa_dagua&quot;">
    <columns>
      <column type="field" width="-1" name="id" hidden="0"/>
      <column type="field" width="-1" name="carta_mini" hidden="0"/>
      <column type="field" width="159" name="lenght_otf" hidden="0"/>
      <column type="actions" width="-1" hidden="1"/>
      <column type="field" width="-1" name="classe" hidden="0"/>
      <column type="field" width="-1" name="tamanho" hidden="0"/>
