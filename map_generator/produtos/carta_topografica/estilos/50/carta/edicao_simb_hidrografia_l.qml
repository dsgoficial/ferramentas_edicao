...
<rules key="{62969c95-813d-449f-99f0-e90e48f5fd17}">
<rule key="{56e1e416-a4c0-42cb-a0bf-3a31ad014080}" filter="&quot;classe&quot; =  'elemnat_trecho_drenagem_l' &#xd;&#xa;and &quot;carta_mini&quot; is false" description="Trecho de Drenagem">
...
<placement xOffset="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationAngle="0" fitInPolygonOnly="0" dist="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" layerType="LineGeometry" placementFlags="9" repeatDistanceUnits="MM" maxCurvedCharAngleOut="-25" centroidInside="0" lineAnchorType="0" overrunDistance="0" priority="5" placement="3" distUnits="MM" offsetType="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('auxiliar_moldura', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" geometryGeneratorType="LineGeometry" centroidWhole="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" polygonPlacementFlags="2" maxCurvedCharAngleIn="25" preserveRotation="1" lineAnchorPercent="0.5" offsetUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="1" yOffset="0" quadOffset="4" labelOffsetMapUnitScale="3x:0,0,0,0,0,0"/>
...
<rule key="{5ec96056-10f5-46f3-b0fd-7e65bbb3226f}" filter="&quot;classe&quot; = 'cobter_massa_dagua_a'&#xd;&#xa;and &quot;carta_mini&quot; is false" description="Massa dagua">
<settings calloutType="simple">
...
<default applyOnUpdate="0" expression="'47376.00327554059'" field="tamanho"/>
...
<attributetableconfig sortExpression="&quot;massa_dagua&quot;" actionWidgetStyle="dropDown" sortOrder="0">
<columns>
