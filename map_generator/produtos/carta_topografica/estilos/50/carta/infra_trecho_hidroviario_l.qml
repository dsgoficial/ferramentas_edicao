...
<rule key="{ca40f577-44d7-4ee8-9374-b931ba44499f}" filter="&quot;tipo&quot; = 1" label="Balsa" symbol="0"/>
<rule key="{eaf08c88-bc9e-459e-b11e-03ff397dc4b6}" filter="ELSE" symbol="1"/>
</rules>
<symbols>
...
<rules key="{3c31e26e-dc0b-4970-9b51-f73ae3537c5c}">
<rule description="Balsa" key="{5fbea860-a695-4619-ad96-1be4640bbaea}" filter="&quot;tipo&quot; = 1 and &quot;carta_mini&quot; is false">
...
<Option type="QString" value="1" name="Balsa (1)"/>
<Option type="QString" value="0" name="Desconhecido (0)"/>
<Option type="QString" value="2" name="Embarcação de pequeno porte (2)"/>
<Option type="QString" value="3" name="Empurrador-balsa (3)"/>
<Option type="QString" value="4" name="Lancha (4)"/>
</Option>
</Option>
</config>
</editWidget>
