...
<qgis minScale="100000000" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" simplifyDrawingHints="0" version="3.18.3-Zürich" styleCategories="AllStyleCategories" simplifyAlgorithm="0" maxScale="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="1" readOnly="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" type="RuleRenderer">
    <rules key="{1d7422bf-70f7-4ad1-9f57-2f77792cb04d}">
      <rule label="Balsa" filter="&quot;tipo&quot; = 1" symbol="0" key="{ca40f577-44d7-4ee8-9374-b931ba44499f}"/>
      <rule filter="ELSE" symbol="1" key="{eaf08c88-bc9e-459e-b11e-03ff397dc4b6}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{b0953b96-36f8-4219-90f4-ed9809617091}">
      <rule filter="&quot;tipo&quot; = 1 and &quot;carta_mini&quot; is false" description="Balsa" key="{2ed924ca-cd8d-47db-8baa-ffd00fe0f2c0}">
        <settings calloutType="simple">
          <text-style fieldName="texto_edicao" fontFamily="Noto Sans" previewBkgrdColor="255,255,255,255" useSubstitutions="0" allowHtml="0" fontWordSpacing="0" fontStrikeout="0" isExpression="0" fontSize="6" fontKerning="1" textColor="0,0,0,255" fontItalic="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" capitalization="0" textOpacity="1" namedStyle="Condensed" fontWeight="50" textOrientation="horizontal" fontLetterSpacing="0" fontSizeUnit="Point" blendMode="0" multilineHeight="1" fontUnderline="0">
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="Map">
              ...
              <Option name="Balsa (1)" type="QString" value="1"/>
              <Option name="Desconhecido (0)" type="QString" value="0"/>
              <Option name="Embarcação de pequeno porte (2)" type="QString" value="2"/>
              <Option name="Empurrador-balsa (3)" type="QString" value="3"/>
              <Option name="Lancha (4)" type="QString" value="4"/>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias name="" field="lenght_otf" index="16"/>
  </aliases>
  <defaults>
