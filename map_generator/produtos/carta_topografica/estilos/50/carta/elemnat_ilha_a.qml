...
<text-style fontFamily="Noto Sans" fontStrikeout="0" fontSizeUnit="Point" fontSize="6" capitalization="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" fontLetterSpacing="0" textColor="0,0,0,255" multilineHeight="1" blendMode="0" fontWordSpacing="0" textOpacity="1" isExpression="0" fontWeight="50" textOrientation="horizontal" fieldName="texto_edicao" namedStyle="Condensed Italic" fontItalic="1" previewBkgrdColor="255,255,255,255" allowHtml="0" fontKerning="1" useSubstitutions="0">
...
<placement rotationAngle="0" maxCurvedCharAngleIn="25" repeatDistance="0" lineAnchorType="0" xOffset="0" polygonPlacementFlags="2" quadOffset="4" yOffset="0" offsetType="0" placement="1" dist="0" repeatDistanceUnits="MM" maxCurvedCharAngleOut="-25" distMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" geometryGeneratorEnabled="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" priority="5" geometryGeneratorType="PolygonGeometry" fitInPolygonOnly="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('auxiliar_moldura', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" centroidInside="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" layerType="PolygonGeometry" centroidWhole="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" overrunDistanceUnit="MM" placementFlags="10" preserveRotation="1" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistance="0"/>
...
<alias name="" field="tamanho_txt" index="13"/>
...
<alias name="" field="tamanho_calc" index="18"/>
</aliases>
<defaults>
...
<default applyOnUpdate="0" field="tamanho_calc" expression=""/>
</defaults>
<constraints>
...
<constraint notnull_strength="0" field="tamanho_calc" exp_strength="0" unique_strength="0" constraints="0"/>
</constraints>
...
<column hidden="0" width="321" type="field" name="texto_edicao"/>
<column hidden="0" width="-1" type="field" name="carta_mini"/>
<column hidden="0" width="187" type="field" name="area_otf"/>
...
<column hidden="0" width="-1" type="field" name="tamanho_calc"/>
</columns>
