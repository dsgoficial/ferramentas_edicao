...
<text-style textOrientation="horizontal" fontFamily="Noto Sans" blendMode="0" previewBkgrdColor="255,255,255,255" capitalization="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSize="6" fontSizeUnit="Point" isExpression="0" fontKerning="1" fontStrikeout="0" fontWordSpacing="0" fontUnderline="0" namedStyle="Condensed Italic" fieldName="texto_edicao" allowHtml="0" fontLetterSpacing="0" fontWeight="50" useSubstitutions="0" textColor="0,0,0,255" fontItalic="1" textOpacity="1" multilineHeight="1">
...
<Option value="1" name="Fluvial (1)" type="QString"/>
<Option value="3" name="Lacustre (3)" type="QString"/>
<Option value="2" name="Marítima (2)" type="QString"/>
</Option>
</Option>
</config>
</editWidget>
...
<column width="321" hidden="0" name="texto_edicao" type="field"/>
<column width="-1" hidden="0" name="carta_mini" type="field"/>
<column width="187" hidden="0" name="area_otf" type="field"/>
