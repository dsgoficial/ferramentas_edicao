...
<rule key="{0ebf435c-b5a4-4ae5-9c53-4ef68833f942}" filter="&quot;tipo&quot; = 601" label="Grupo transformadores" symbol="0"/>
<rule key="{158fda86-5636-431b-a390-e6abea7a1d29}" filter="&quot;tipo&quot; in (409)" label="Estação geradora de energia" symbol="1"/>
<rule key="{94d5825b-bde3-47c6-a260-d867019a4b53}" filter="ELSE" symbol="2"/>
</rules>
<symbols>
...
<rules key="{f2f0cbed-cd55-489b-8bbc-cb1253f60571}">
<rule description="Elemento energia" key="{d14699ba-97ee-40b0-87a3-370357363f73}">
...
<Option type="QString" value="601" name="Grupo de transformadores (601)"/>
<Option type="QString" value="302" name="Linha de distribuição de energia (302)"/>
<Option type="QString" value="303" name="Linha de transmissão de energia (303)"/>
