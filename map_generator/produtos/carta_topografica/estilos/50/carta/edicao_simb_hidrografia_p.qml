...
<text-format rightDirectionSymbol=">" reverseDirectionSymbol="0" plussign="0" formatNumbers="0" autoWrapLength="0" placeDirectionSymbol="0" decimals="3" useMaxLineLengthForAutoWrap="1" multilineAlign="1" leftDirectionSymbol="&lt;" addDirectionSymbol="0" wrapChar="|"/>
...
<alias field="espacamento" name="" index="2"/>
<alias field="classe" name="" index="3"/>
<alias field="tamanho" name="" index="4"/>
<alias field="escala" name="" index="5"/>
<alias field="carta_mini" name="" index="6"/>
</aliases>
<defaults>
