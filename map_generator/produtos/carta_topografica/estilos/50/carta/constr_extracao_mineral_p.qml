...
<constraint notnull_strength="1" field="forma_extracao" exp_strength="0" unique_strength="0" constraints="1"/>
...
<column hidden="0" width="-1" type="field" name="forma_extracao"/>
