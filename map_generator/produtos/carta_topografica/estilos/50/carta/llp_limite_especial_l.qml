...
<qgis minScale="100000000" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyLocal="1" version="3.18.3-Zürich" styleCategories="AllStyleCategories" readOnly="0" simplifyMaxScale="1" labelsEnabled="1" simplifyAlgorithm="0" maxScale="0" simplifyDrawingHints="0">
  ...
  <renderer-v2 type="mergedFeatureRenderer" enableorderby="0" forceraster="0">
    <renderer-v2 symbollevels="0" type="RuleRenderer" enableorderby="0" forceraster="0">
      <rules key="{ff3995e7-5994-44a3-800a-da9a9d3e9d9f}">
        <rule filter="tipo = 2" key="{4cb62d00-cb4e-430b-9e64-a271c5211c1c}" description="Terra Indigena" symbol="0" label="A10418A"/>
        <rule filter="tipo = 5" key="{6f8527a2-61b5-4534-8c2f-b780432d5412}" description="Unidade de conservação" symbol="1" label="A10420A"/>
        <rule filter="ELSE" key="{2baa4cee-ab16-4f3e-852e-823d79eaa55f}" symbol="2"/>
      </rules>
      <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{8887ec33-a056-4610-b2cf-379c8fb26153}">
      <rule filter=" &quot;geometria_aproximada&quot; = 1" key="{210ad53e-4479-47f8-a30e-216d4912aa61}" description="Texto aproximado">
        <settings calloutType="simple">
          ...
          <placement priority="5" repeatDistanceUnits="MM" overrunDistance="0" centroidWhole="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" yOffset="0" centroidInside="0" repeatDistance="200" dist="0" placement="3" rotationAngle="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" distUnits="MM" offsetUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" layerType="LineGeometry" fitInPolygonOnly="0" preserveRotation="1" geometryGenerator="with_variable(&#xd;&#xd;&#xd;&#xa; 'moldura',&#xd;&#xd;&#xd;&#xa; geometry(get_feature('auxiliar_moldura', 'id', '1')),&#xd;&#xd;&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xd;&#xd;&#xa;THEN &#xd;&#xd;&#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xd;&#xd;&#xa;ELSE&#xd;&#xd;&#xd;&#xa;$geometry&#xd;&#xd;&#xd;&#xa;END&#xd;&#xd;&#xd;&#xa;)" polygonPlacementFlags="2" quadOffset="4" placementFlags="10" offsetType="0" xOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" lineAnchorType="0" geometryGeneratorType="LineGeometry" overrunDistanceUnit="MM" geometryGeneratorEnabled="1"/>
