...
<rule filter="tipo = 2" description="Terra Indigena" symbol="0" label="A10418A" key="{4cb62d00-cb4e-430b-9e64-a271c5211c1c}"/>
<rule filter="tipo = 5" description="Unidade de conservação" symbol="1" label="A10420A" key="{6f8527a2-61b5-4534-8c2f-b780432d5412}"/>
<rule filter="ELSE" symbol="2" key="{2baa4cee-ab16-4f3e-852e-823d79eaa55f}"/>
</rules>
<symbols>
...
<placement rotationAngle="0" maxCurvedCharAngleIn="25" repeatDistance="0" lineAnchorType="0" xOffset="0" polygonPlacementFlags="2" quadOffset="4" yOffset="0" offsetType="0" placement="6" dist="0" repeatDistanceUnits="MM" maxCurvedCharAngleOut="-25" distMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" geometryGeneratorEnabled="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" priority="5" geometryGeneratorType="PointGeometry" fitInPolygonOnly="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('auxiliar_moldura', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" centroidInside="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" layerType="LineGeometry" centroidWhole="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" overrunDistanceUnit="MM" placementFlags="10" preserveRotation="1" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistance="0"/>
