...
<Option name="Sumidouro (4)" value="4" type="QString"/>
<Option name="Vertedouro (5)" value="5" type="QString"/>
</Option>
</Option>
</config>
</editWidget>
...
<alias name="" index="3" field="data_modificacao"/>
<alias name="" index="4" field="controle_uuid"/>
<alias name="" index="5" field="usuario_criacao"/>
<alias name="" index="6" field="usuario_atualizacao"/>
<alias name="" index="7" field="insumo"/>
<alias name="" index="8" field="data_insumo"/>
<alias name="" index="9" field="visivel"/>
<alias name="" index="10" field="texto_edicao"/>
<alias name="" index="11" field="carta_mini"/>
<alias name="" index="12" field="label_x"/>
<alias name="" index="13" field="label_y"/>
<alias name="" index="14" field="justificativa_txt"/>
<alias name="" index="15" field="simb_x"/>
<alias name="" index="16" field="simb_y"/>
<alias name="" index="17" field="simb_rot"/>
</aliases>
<defaults>
