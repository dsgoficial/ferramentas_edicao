...
<rule filter="&quot;tipo&quot; = 204" description="Reservatório" symbol="0" label="A20403A" key="{b057ca41-ceaf-415e-a042-d27e7226c2d4}"/>
<rule filter="&quot;tipo&quot; = 305" description="Aterro sanitário" symbol="1" label="A20214D" key="{b057ca41-ceaf-415e-a042-d27e7226c2d4}"/>
<rule filter="&quot;tipo&quot; = 301" description="Tanque" symbol="2" label="A20214C" key="{216aafa8-c3e5-49c5-aaa2-b49a0a32cade}"/>
...
<rules key="{0581ecee-c75f-431c-aa5e-c34206c71782}">
<rule description="Depósito" key="{ecc0ffdd-f698-4716-add7-dd2f3b006877}">
...
<placement rotationAngle="0" maxCurvedCharAngleIn="25" repeatDistance="0" lineAnchorType="0" xOffset="0.5" polygonPlacementFlags="3" quadOffset="2" yOffset="-0.5" offsetType="0" placement="8" dist="0" repeatDistanceUnits="MM" maxCurvedCharAngleOut="-25" distMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" geometryGeneratorEnabled="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" priority="5" geometryGeneratorType="PolygonGeometry" fitInPolygonOnly="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('auxiliar_moldura', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" centroidInside="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" layerType="PolygonGeometry" centroidWhole="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" overrunDistanceUnit="MM" placementFlags="10" preserveRotation="1" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistance="0"/>
...
<constraint notnull_strength="1" field="tipo_exposicao" exp_strength="0" unique_strength="0" constraints="1"/>
...
<constraint notnull_strength="1" field="finalidade" exp_strength="0" unique_strength="0" constraints="1"/>
