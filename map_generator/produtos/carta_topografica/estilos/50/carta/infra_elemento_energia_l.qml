...
<text-style fontUnderline="0" fontSize="6" blendMode="0" namedStyle="Regular" capitalization="0" textOpacity="1" textOrientation="horizontal" fieldName="nome" useSubstitutions="0" fontSizeUnit="Point" allowHtml="0" fontStrikeout="0" isExpression="0" fontWordSpacing="0" fontLetterSpacing="0" textColor="0,0,0,255" multilineHeight="1" fontFamily="Arial" previewBkgrdColor="255,255,255,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontWeight="50" fontKerning="1">
