...
<rule filter="&quot;tipo&quot; in (302,303)" symbol="0" label="L10115A" key="{90ff15e2-032c-43c9-ab45-37487965c3d9}"/>
<rule filter="ELSE" symbol="1" key="{3b58d820-a458-4cd7-a31e-22d64d7765a3}"/>
</rules>
<symbols>
...
<text-style fontFamily="Arial" fontStrikeout="0" fontSizeUnit="Point" fontSize="6" capitalization="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" fontLetterSpacing="0" textColor="0,0,0,255" multilineHeight="1" blendMode="0" fontWordSpacing="0" textOpacity="1" isExpression="0" fontWeight="50" textOrientation="horizontal" fieldName="nome" namedStyle="Regular" fontItalic="0" previewBkgrdColor="255,255,255,255" allowHtml="0" fontKerning="1" useSubstitutions="0">
