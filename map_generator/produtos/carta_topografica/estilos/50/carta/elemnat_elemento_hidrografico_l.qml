...
<rule filter="&quot;tipo&quot; = 12" symbol="0" label="Corredeira" key="{f1b5746e-1f84-4aa7-9ef9-2690584acda1}"/>
<rule filter="&quot;tipo&quot; in (9,10,11)" symbol="1" label="Queda dágua" key="{1440372f-4a84-49c8-8a91-03da1a5f27e5}"/>
<rule filter="ELSE" symbol="2" key="{6830f428-f899-49ab-9bfe-e55ca7242e3f}"/>
</rules>
<symbols>
...
<symbol alpha="1" name="@0@0" clip_to_extent="1" type="line" force_rhr="0">
<data_defined_properties>
<Option type="Map">
<Option name="name" value="" type="QString"/>
<Option name="properties"/>
...
<rules key="{f2ed699a-27c7-404f-98a8-2426424a322a}">
<rule filter="&quot;tipo&quot; in (9,10,11,12)" description="Corredeira e queda dágua" key="{1a2aa135-0223-485d-aed6-71c486372fe7}">
...
<text-buffer bufferSize="0.2" bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferBlendMode="0" bufferOpacity="1" bufferColor="255,255,255,255" bufferNoFill="1" bufferDraw="1"/>
