...
<rule filter=" &quot;tipo&quot; =  9 and situacao_fisica in (0,3)" symbol="0" label="A10902A" key="{22d6fdb3-1c72-479c-8549-66074cbca65f}"/>
<rule filter=" &quot;tipo&quot; =  9 and situacao_fisica not in (0,3)" symbol="1" label="A10902B" key="{d0035644-de42-4109-b295-d7081690028b}"/>
<rule filter=" &quot;tipo&quot; = 10" symbol="2" label="A10902C" key="{c1e104b7-414b-4d44-8a57-f23f52a5db38}"/>
<rule filter="ELSE" symbol="3" key="{77bb8594-b470-4911-a6e8-a222e89cdb66}"/>
</rules>
<symbols>
...
<text-format autoWrapLength="0" multilineAlign="1" addDirectionSymbol="0" wrapChar="|" leftDirectionSymbol="&lt;" formatNumbers="0" useMaxLineLengthForAutoWrap="1" plussign="0" rightDirectionSymbol=">" placeDirectionSymbol="0" reverseDirectionSymbol="0" decimals="3"/>
<placement rotationAngle="0" maxCurvedCharAngleIn="25" repeatDistance="0" lineAnchorType="0" xOffset="0.5" polygonPlacementFlags="3" quadOffset="2" yOffset="-0.5" offsetType="0" placement="4" dist="0" repeatDistanceUnits="MM" maxCurvedCharAngleOut="-25" distMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" geometryGeneratorEnabled="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" priority="5" geometryGeneratorType="PolygonGeometry" fitInPolygonOnly="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('auxiliar_moldura', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" centroidInside="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" layerType="PolygonGeometry" centroidWhole="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" overrunDistanceUnit="MM" placementFlags="10" preserveRotation="1" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistance="0"/>
...
<alias name="" field="uso_pista" index="4"/>
<alias name="" field="situacao_fisica" index="5"/>
<alias name="" field="observacao" index="6"/>
<alias name="" field="data_modificacao" index="7"/>
<alias name="" field="controle_uuid" index="8"/>
<alias name="" field="usuario_criacao" index="9"/>
<alias name="" field="usuario_atualizacao" index="10"/>
<alias name="" field="insumo" index="11"/>
<alias name="" field="data_insumo" index="12"/>
<alias name="" field="visivel" index="13"/>
<alias name="" field="texto_edicao" index="14"/>
<alias name="" field="carta_mini" index="15"/>
<alias name="" field="label_x" index="16"/>
<alias name="" field="label_y" index="17"/>
<alias name="" field="justificativa_txt" index="18"/>
<alias name="" field="area_otf" index="19"/>
</aliases>
<defaults>
...
<constraint notnull_strength="1" field="uso_pista" exp_strength="0" unique_strength="0" constraints="1"/>
...
<column hidden="0" width="-1" type="field" name="uso_pista"/>
