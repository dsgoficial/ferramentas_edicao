...
<qgis labelsEnabled="1" simplifyDrawingTol="1" minScale="100000000" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyLocal="1" simplifyMaxScale="1" readOnly="0" version="3.18.3-Zürich" simplifyDrawingHints="0" maxScale="0">
  ...
  <labeling type="rule-based">
    <rules key="{5bd621e9-4a40-4406-bb50-ee746430d099}">
      <rule description="Named Location" key="{17410dd2-1ab6-4637-97b6-cf1d50206f67}">
        <settings calloutType="simple">
          <text-style fontLetterSpacing="0" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontFamily="Noto Sans" capitalization="1" namedStyle="Condensed Light" textOrientation="horizontal" allowHtml="0" textColor="0,0,0,255" blendMode="0" fontUnderline="0" fieldName="texto_edicao" fontSizeUnit="Point" fontItalic="0" isExpression="0" fontSize="10" useSubstitutions="0" multilineHeight="1" fontKerning="1" textOpacity="1" fontWordSpacing="0" fontWeight="25" previewBkgrdColor="255,255,255,255">
          ...
          <text-format wrapChar="" rightDirectionSymbol=">" decimals="3" useMaxLineLengthForAutoWrap="1" reverseDirectionSymbol="0" leftDirectionSymbol="&lt;" plussign="0" autoWrapLength="0" addDirectionSymbol="0" placeDirectionSymbol="0" multilineAlign="3" formatNumbers="0"/>
          <placement centroidWhole="0" dist="0" offsetType="0" repeatDistance="0" lineAnchorPercent="0.5" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" yOffset="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('auxiliar_moldura', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" priority="5" maxCurvedCharAngleIn="25" placement="0" centroidInside="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" geometryGeneratorType="PolygonGeometry" overrunDistanceUnit="MM" geometryGeneratorEnabled="1" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" fitInPolygonOnly="0" polygonPlacementFlags="2" xOffset="0" layerType="PolygonGeometry" quadOffset="4" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" overrunDistance="0" lineAnchorType="0" distUnits="MM" preserveRotation="1"/>
  ...
  <aliases>
    ...
    <alias index="17" name="" field="tamanho_txt"/>
    <alias index="18" name="" field="area_otf"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" notnull_strength="1" unique_strength="0" constraints="1" field="tamanho_txt"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="tamanho_txt"/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column type="field" width="-1" name="tamanho_txt" hidden="0"/>
    </columns>
