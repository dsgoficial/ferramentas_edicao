...
<rule key="{1021944e-1404-481f-92b6-0a561711263e}" filter="(&quot;tipo&quot; - &quot;tipo&quot;%100)/100 = 3" label="L20307A" symbol="0"/>
<rule key="{88e2c562-c955-4793-a4a5-7fb87d83d59c}" filter="ELSE" symbol="1"/>
</rules>
<symbols>
...
<rules key="{54b34be7-5b22-435e-a8ac-1e510249d055}">
<rule description="Ocupação do solo" key="{fa661db4-30d3-4eeb-aca8-783763c8f28a}">
...
<alias field="lenght_otf" name="" index="17"/>
</aliases>
<defaults>
...
<column type="field" width="187" name="tipo" hidden="0"/>
