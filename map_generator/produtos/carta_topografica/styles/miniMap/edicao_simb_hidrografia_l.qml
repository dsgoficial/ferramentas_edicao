...
<rules key="{d77c05cf-0c86-4fa3-90b6-105a8c2aef2f}">
<rule key="{e4029e93-9a01-4257-bde2-b30ce3b43042}" filter="&quot;classe&quot; =  'elemnat_trecho_drenagem_l' &#xd;&#xa;and &quot;carta_mini&quot; is true" description="Trecho de Drenagem">
<settings calloutType="simple">
<text-style multilineHeight="1" fontWeight="50" fontWordSpacing="0" useSubstitutions="0" fontStrikeout="0" fontSize="10" fontFamily="Noto Sans" isExpression="0" fontSizeUnit="Point" fontLetterSpacing="0" allowHtml="0" previewBkgrdColor="255,255,255,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="1" capitalization="0" fontUnderline="0" textOpacity="1" fontKerning="1" textOrientation="horizontal" fieldName="texto_edicao" textColor="0,160,223,255" blendMode="0" namedStyle="Condensed Italic">
...
<placement xOffset="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationAngle="0" fitInPolygonOnly="0" dist="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" layerType="LineGeometry" placementFlags="9" repeatDistanceUnits="MM" maxCurvedCharAngleOut="-25" centroidInside="0" lineAnchorType="0" overrunDistance="20" priority="5" placement="3" distUnits="MM" offsetType="0" geometryGenerator="with_variable(&#xd;&#xa; 'moldura',&#xd;&#xa; geometry(get_feature('auxiliar_moldura', 'id', '1')),&#xd;&#xa;CASE WHEN @moldura is not null &#xd;&#xa;THEN &#xd;&#xa;intersection($geometry,  @moldura) &#xd;&#xa;ELSE&#xd;&#xa;$geometry&#xd;&#xa;END&#xd;&#xa;)" geometryGeneratorType="LineGeometry" centroidWhole="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" polygonPlacementFlags="2" maxCurvedCharAngleIn="25" preserveRotation="1" lineAnchorPercent="0.5" offsetUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="1" yOffset="0" quadOffset="4" labelOffsetMapUnitScale="3x:0,0,0,0,0,0"/>
...
<Option name="expression" value="CASE&#xd;&#xa;WHEN &quot;tamanho&quot; &lt; 80* &quot;escala&quot; /1000&#xd;&#xa;THEN 6.0&#xd;&#xa;WHEN &quot;tamanho&quot; &lt; 120* &quot;escala&quot; /1000&#xd;&#xa;THEN 6.0&#xd;&#xa;WHEN &quot;tamanho&quot; &lt; 160* &quot;escala&quot; /1000&#xd;&#xa;THEN 7.0&#xd;&#xa;ELSE 8.0&#xd;&#xa;END" type="QString"/>
...
<rule key="{0f8bb4eb-1ff3-4033-9906-99104a8dea79}" filter="&quot;classe&quot; = 'cobter_massa_dagua_a'&#xd;&#xa;and &quot;carta_mini&quot; is true" description="Massa dagua">
<settings calloutType="simple">
<text-style multilineHeight="1" fontWeight="50" fontWordSpacing="0" useSubstitutions="0" fontStrikeout="0" fontSize="10" fontFamily="Noto Sans" isExpression="0" fontSizeUnit="Point" fontLetterSpacing="0" allowHtml="0" previewBkgrdColor="255,255,255,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="1" capitalization="1" fontUnderline="0" textOpacity="1" fontKerning="1" textOrientation="horizontal" fieldName="texto_edicao" textColor="0,160,223,255" blendMode="0" namedStyle="Condensed Italic">
<text-buffer bufferBlendMode="0" bufferOpacity="1" bufferColor="255,255,255,255" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferDraw="0" bufferNoFill="1" bufferJoinStyle="128" bufferSize="1" bufferSizeUnits="MM"/>
<text-mask maskSize="0.2" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSizeUnits="MM" maskJoinStyle="128" maskOpacity="1" maskType="0" maskedSymbolLayers="" maskEnabled="1"/>
<background shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeUnit="MM" shapeRotationType="0" shapeBlendMode="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeJoinStyle="64" shapeRadiiX="0" shapeOffsetY="0" shapeSizeX="0" shapeBorderWidth="0" shapeBorderWidthUnit="MM" shapeOpacity="1" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeFillColor="255,255,255,255" shapeRotation="0" shapeRadiiY="0" shapeSizeType="0" shapeSVGFile="" shapeOffsetUnit="MM" shapeSizeY="0" shapeDraw="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiUnit="MM" shapeOffsetX="0" shapeType="0">
<symbol clip_to_extent="1" name="markerSymbol" force_rhr="0" alpha="1" type="marker">
...
<Option name="Size" type="Map">
<Option name="active" value="true" type="bool"/>
<Option name="expression" value="CASE&#xd;&#xa;WHEN &quot;tamanho&quot; &lt; 65* &quot;escala&quot; /1000&#xd;&#xa;THEN 6.0&#xd;&#xa;WHEN &quot;tamanho&quot; &lt; 80* &quot;escala&quot; /1000&#xd;&#xa;THEN 7.0&#xd;&#xa;WHEN &quot;tamanho&quot; &lt; 100* &quot;escala&quot; /1000&#xd;&#xa;THEN 8.0&#xd;&#xa;WHEN &quot;tamanho&quot; &lt; 120* &quot;escala&quot; /1000&#xd;&#xa;THEN 9.0&#xd;&#xa;WHEN &quot;tamanho&quot; &lt; 160* &quot;escala&quot; /1000&#xd;&#xa;THEN 10.0&#xd;&#xa;WHEN &quot;tamanho&quot; &lt; 200* &quot;escala&quot; /1000&#xd;&#xa;THEN 12.0&#xd;&#xa;ELSE 14.0&#xd;&#xa;END" type="QString"/>
<Option name="type" value="3" type="int"/>
</Option>
</Option>
<Option name="type" value="collection" type="QString"/>
...
<field name="tamanho" configurationFlags="None">
<editWidget type="TextEdit">
<config>
<Option type="Map">
<Option name="IsMultiline" value="false" type="bool"/>
...
<alias name="" index="2" field="classe"/>
<alias name="" index="3" field="tamanho"/>
<alias name="" index="4" field="escala"/>
<alias name="" index="5" field="carta_mini"/>
<alias name="" index="6" field="lenght_otf"/>
</aliases>
<defaults>
<default applyOnUpdate="0" expression="" field="id"/>
<default applyOnUpdate="0" expression="" field="texto_edicao"/>
<default applyOnUpdate="0" expression="'elemnat_trecho_drenagem_l'" field="classe"/>
<default applyOnUpdate="0" expression="'26931.38269139989'" field="tamanho"/>
<default applyOnUpdate="0" expression="'50000'" field="escala"/>
<default applyOnUpdate="0" expression="'False'" field="carta_mini"/>
...
<constraint constraints="1" notnull_strength="1" unique_strength="0" field="texto_edicao" exp_strength="0"/>
<constraint constraints="1" notnull_strength="1" unique_strength="0" field="classe" exp_strength="0"/>
<constraint constraints="1" notnull_strength="1" unique_strength="0" field="tamanho" exp_strength="0"/>
<constraint constraints="1" notnull_strength="1" unique_strength="0" field="escala" exp_strength="0"/>
...
<constraint exp="" desc="" field="tamanho"/>
...
<attributetableconfig sortExpression="&quot;carta_mini&quot;" actionWidgetStyle="dropDown" sortOrder="1">
<columns>
<column name="id" hidden="0" width="-1" type="field"/>
<column name="carta_mini" hidden="0" width="-1" type="field"/>
<column name="lenght_otf" hidden="0" width="159" type="field"/>
<column hidden="1" width="-1" type="actions"/>
<column name="classe" hidden="0" width="179" type="field"/>
<column name="tamanho" hidden="0" width="-1" type="field"/>
<column name="escala" hidden="0" width="-1" type="field"/>
...
<field name="parte" editable="1"/>
<field name="tamanho" editable="1"/>
...
<field name="parte" labelOnTop="0"/>
<field name="tamanho" labelOnTop="0"/>
