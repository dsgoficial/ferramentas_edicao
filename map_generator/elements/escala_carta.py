...
class EscalaCarta:
	...
	def changeScaleLabels(self):
		# label_direita
		id_label_direita = "label_escala_direita" 
		text_label_direita = "ESCALA 1:" + '{:.3f}'.format((int(self.scale)/1000))
		composition_label_label_direita = self.composition.itemById(id_label_direita)
		...
		composition_label_label_escala = self.composition.itemById(id_label_escala)
		...
		composition_label_e1 = self.composition.itemById(id_label_e1)
		...
		composition_label_e2 = self.composition.itemById(id_label_e2)
		...
		composition_label_e3 = self.composition.itemById(id_label_e3)
		...
		composition_label_e4 = self.composition.itemById(id_label_e4)
		...
		composition_label_e5 = self.composition.itemById(id_label_e5)
